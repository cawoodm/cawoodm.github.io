 ...
 */const Rr=globalThis,Vs=Rr.ShadowRoot&&(Rr.ShadyCSS===void 0||Rr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ys=Symbol(),zi=new WeakMap;let _o=class{constructor(t,r,s){if(this._$cssResult$=!0,s!==Ys)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(Vs&&t===void 0){const s=r!==void 0&&r.length===1;s&&(t=zi.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&zi.set(r,t))}return t}toString(){return this.cssText}};const Ka=e=>new _o(typeof e=="string"?e:e+"",void 0,Ys),ot=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((s,n,a)=>s+(c=>{if(c._$cssResult$===!0)return c.cssText;if(typeof c=="number")return c;throw Error("Value passed to 'css' function must be a 'css' function result: "+c+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+e[a+1],e[0]);return new _o(r,e,Ys)},Va=(e,t)=>{if(Vs)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const s=document.createElement("style"),n=Rr.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=r.cssText,e.appendChild(s)}},Ii=Vs?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const s of t.cssRules)r+=s.cssText;return Ka(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Ya,defineProperty:Xa,getOwnPropertyDescriptor:Ga,getOwnPropertyNames:Ja,getOwnPropertySymbols:Qa,getPrototypeOf:Za}=Object,Wr=globalThis,Li=Wr.trustedTypes,el=Li?Li.emptyScript:"",tl=Wr.reactiveElementPolyfillSupport,er=(e,t)=>e,Lr={toAttribute(e,t){switch(t){case Boolean:e=e?el:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},Xs=(e,t)=>!Ya(e,t),Bi={attribute:!0,type:String,converter:Lr,reflect:!1,useDefault:!1,hasChanged:Xs};Symbol.metadata??=Symbol("metadata"),Wr.litPropertyMetadata??=new WeakMap;let Ln=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=Bi){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const s=Symbol(),n=this.getPropertyDescriptor(t,s,r);n!==void 0&&Xa(this.prototype,t,n)}}static getPropertyDescriptor(t,r,s){const{get:n,set:a}=Ga(this.prototype,t)??{get(){return this[r]},set(c){this[r]=c}};return{get:n,set(c){const f=n?.call(this);a?.call(this,c),this.requestUpdate(t,f,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Bi}static _$Ei(){if(this.hasOwnProperty(er("elementProperties")))return;const t=Za(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(er("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(er("properties"))){const r=this.properties,s=[...Ja(r),...Qa(r)];for(const n of s)this.createProperty(n,r[n])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[s,n]of r)this.elementProperties.set(s,n)}this._$Eh=new Map;for(const[r,s]of this.elementProperties){const n=this._$Eu(r,s);n!==void 0&&this._$Eh.set(n,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const n of s)r.unshift(Ii(n))}else t!==void 0&&r.push(Ii(t));return r}static _$Eu(t,r){const s=r.attribute;return s===!1?void 0:typeof s=="string"?s:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const s of r.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Va(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,r,s){this._$AK(t,s)}_$ET(t,r){const s=this.constructor.elementProperties.get(t),n=this.constructor._$Eu(t,s);if(n!==void 0&&s.reflect===!0){const a=(s.converter?.toAttribute!==void 0?s.converter:Lr).toAttribute(r,s.type);this._$Em=t,a==null?this.removeAttribute(n):this.setAttribute(n,a),this._$Em=null}}_$AK(t,r){const s=this.constructor,n=s._$Eh.get(t);if(n!==void 0&&this._$Em!==n){const a=s.getPropertyOptions(n),c=typeof a.converter=="function"?{fromAttribute:a.converter}:a.converter?.fromAttribute!==void 0?a.converter:Lr;this._$Em=n;const f=c.fromAttribute(r,a.type);this[n]=f??this._$Ej?.get(n)??f,this._$Em=null}}requestUpdate(t,r,s,n=!1,a){if(t!==void 0){const c=this.constructor;if(n===!1&&(a=this[t]),s??=c.getPropertyOptions(t),!((s.hasChanged??Xs)(a,r)||s.useDefault&&s.reflect&&a===this._$Ej?.get(t)&&!this.hasAttribute(c._$Eu(t,s))))return;this.C(t,r,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:s,reflect:n,wrapped:a},c){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,c??r??this[t]),a!==!0||c!==void 0)||(this._$AL.has(t)||(this.hasUpdated||s||(r=void 0),this._$AL.set(t,r)),n===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,a]of this._$Ep)this[n]=a;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,a]of s){const{wrapped:c}=a,f=this[n];c!==!0||this._$AL.has(n)||f===void 0||this.C(n,void 0,a,f)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(r)):this._$EM()}catch(s){throw t=!1,this._$EM(),s}t&&this._$AE(r)}willUpdate(t){}_$AE(t){this._$EO?.forEach(r=>r.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(r=>this._$ET(r,this[r])),this._$EM()}updated(t){}firstUpdated(t){}};Ln.elementStyles=[],Ln.shadowRootOptions={mode:"open"},Ln[er("elementProperties")]=new Map,Ln[er("finalized")]=new Map,tl?.({ReactiveElement:Ln}),(Wr.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Gs=globalThis,Mi=e=>e,Br=Gs.trustedTypes,Ni=Br?Br.createPolicy("lit-html",{createHTML:e=>e}):void 0,Ao="$lit$",dn=`lit$${Math.random().toFixed(9).slice(2)}$`,Po="?"+dn,nl=`<${Po}>`,Sn=document,tr=()=>Sn.createComment(""),nr=e=>e===null||typeof e!="object"&&typeof e!="function",Js=Array.isArray,rl=e=>Js(e)||typeof e?.[Symbol.iterator]=="function",Ts=`[ 	
\f\r]`,Zn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,qi=/-->/g,Ui=/>/g,$n=RegExp(`>|${Ts}(?:([^\\s"'>=/]+)(${Ts}*=${Ts}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Wi=/'/g,Hi=/"/g,To=/^(?:script|style|textarea|title)$/i,sl=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),H=sl(1),_n=Symbol.for("lit-noChange"),ze=Symbol.for("lit-nothing"),Ki=new WeakMap,En=Sn.createTreeWalker(Sn,129);function Do(e,t){if(!Js(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ni!==void 0?Ni.createHTML(t):t}const il=(e,t)=>{const r=e.length-1,s=[];let n,a=t===2?"<svg>":t===3?"<math>":"",c=Zn;for(let f=0;f<r;f++){const p=e[f];let $,S,k=-1,z=0;for(;z<p.length&&(c.lastIndex=z,S=c.exec(p),S!==null);)z=c.lastIndex,c===Zn?S[1]==="!--"?c=qi:S[1]!==void 0?c=Ui:S[2]!==void 0?(To.test(S[2])&&(n=RegExp("</"+S[2],"g")),c=$n):S[3]!==void 0&&(c=$n):c===$n?S[0]===">"?(c=n??Zn,k=-1):S[1]===void 0?k=-2:(k=c.lastIndex-S[2].length,$=S[1],c=S[3]===void 0?$n:S[3]==='"'?Hi:Wi):c===Hi||c===Wi?c=$n:c===qi||c===Ui?c=Zn:(c=$n,n=void 0);const M=c===$n&&e[f+1].startsWith("/>")?" ":"";a+=c===Zn?p+nl:k>=0?(s.push($),p.slice(0,k)+Ao+p.slice(k)+dn+M):p+dn+(k===-2?f:M)}return[Do(e,a+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),s]};class rr{constructor({strings:t,_$litType$:r},s){let n;this.parts=[];let a=0,c=0;const f=t.length-1,p=this.parts,[$,S]=il(t,r);if(this.el=rr.createElement($,s),En.currentNode=this.el.content,r===2||r===3){const k=this.el.content.firstChild;k.replaceWith(...k.childNodes)}for(;(n=En.nextNode())!==null&&p.length<f;){if(n.nodeType===1){if(n.hasAttributes())for(const k of n.getAttributeNames())if(k.endsWith(Ao)){const z=S[c++],M=n.getAttribute(k).split(dn),q=/([.?@])?(.*)/.exec(z);p.push({type:1,index:a,name:q[2],strings:M,ctor:q[1]==="."?al:q[1]==="?"?ll:q[1]==="@"?cl:Hr}),n.removeAttribute(k)}else k.startsWith(dn)&&(p.push({type:6,index:a}),n.removeAttribute(k));if(To.test(n.tagName)){const k=n.textContent.split(dn),z=k.length-1;if(z>0){n.textContent=Br?Br.emptyScript:"";for(let M=0;M<z;M++)n.append(k[M],tr()),En.nextNode(),p.push({type:2,index:++a});n.append(k[z],tr())}}}else if(n.nodeType===8)if(n.data===Po)p.push({type:2,index:a});else{let k=-1;for(;(k=n.data.indexOf(dn,k+1))!==-1;)p.push({type:7,index:a}),k+=dn.length-1}a++}}static createElement(t,r){const s=Sn.createElement("template");return s.innerHTML=t,s}}function Mn(e,t,r=e,s){if(t===_n)return t;let n=s!==void 0?r._$Co?.[s]:r._$Cl;const a=nr(t)?void 0:t._$litDirective$;return n?.constructor!==a&&(n?._$AO?.(!1),a===void 0?n=void 0:(n=new a(e),n._$AT(e,r,s)),s!==void 0?(r._$Co??=[])[s]=n:r._$Cl=n),n!==void 0&&(t=Mn(e,n._$AS(e,t.values),n,s)),t}class ol{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:s}=this._$AD,n=(t?.creationScope??Sn).importNode(r,!0);En.currentNode=n;let a=En.nextNode(),c=0,f=0,p=s[0];for(;p!==void 0;){if(c===p.index){let $;p.type===2?$=new ir(a,a.nextSibling,this,t):p.type===1?$=new p.ctor(a,p.name,p.strings,this,t):p.type===6&&($=new ul(a,this,t)),this._$AV.push($),p=s[++f]}c!==p?.index&&(a=En.nextNode(),c++)}return En.currentNode=Sn,n}p(t){let r=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(t,s,r),r+=s.strings.length-2):s._$AI(t[r])),r++}}class ir{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,s,n){this.type=2,this._$AH=ze,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Mn(this,t,r),nr(t)?t===ze||t==null||t===""?(this._$AH!==ze&&this._$AR(),this._$AH=ze):t!==this._$AH&&t!==_n&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):rl(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==ze&&nr(this._$AH)?this._$AA.nextSibling.data=t:this.T(Sn.createTextNode(t)),this._$AH=t}$(t){const{values:r,_$litType$:s}=t,n=typeof s=="number"?this._$AC(t):(s.el===void 0&&(s.el=rr.createElement(Do(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(r);else{const a=new ol(n,this),c=a.u(this.options);a.p(r),this.T(c),this._$AH=a}}_$AC(t){let r=Ki.get(t.strings);return r===void 0&&Ki.set(t.strings,r=new rr(t)),r}k(t){Js(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let s,n=0;for(const a of t)n===r.length?r.push(s=new ir(this.O(tr()),this.O(tr()),this,this.options)):s=r[n],s._$AI(a),n++;n<r.length&&(this._$AR(s&&s._$AB.nextSibling,n),r.length=n)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){const s=Mi(t).nextSibling;Mi(t).remove(),t=s}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Hr{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,s,n,a){this.type=1,this._$AH=ze,this._$AN=void 0,this.element=t,this.name=r,this._$AM=n,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=ze}_$AI(t,r=this,s,n){const a=this.strings;let c=!1;if(a===void 0)t=Mn(this,t,r,0),c=!nr(t)||t!==this._$AH&&t!==_n,c&&(this._$AH=t);else{const f=t;let p,$;for(t=a[0],p=0;p<a.length-1;p++)$=Mn(this,f[s+p],r,p),$===_n&&($=this._$AH[p]),c||=!nr($)||$!==this._$AH[p],$===ze?t=ze:t!==ze&&(t+=($??"")+a[p+1]),this._$AH[p]=$}c&&!n&&this.j(t)}j(t){t===ze?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class al extends Hr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===ze?void 0:t}}class ll extends Hr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==ze)}}class cl extends Hr{constructor(t,r,s,n,a){super(t,r,s,n,a),this.type=5}_$AI(t,r=this){if((t=Mn(this,t,r,0)??ze)===_n)return;const s=this._$AH,n=t===ze&&s!==ze||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,a=t!==ze&&(s===ze||n);n&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class ul{constructor(t,r,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Mn(this,t)}}const dl=Gs.litHtmlPolyfillSupport;dl?.(rr,ir),(Gs.litHtmlVersions??=[]).push("3.3.3");const fl=(e,t,r)=>{const s=r?.renderBefore??t;let n=s._$litPart$;if(n===void 0){const a=r?.renderBefore??null;s._$litPart$=n=new ir(t.insertBefore(tr(),a),a,void 0,r??{})}return n._$AI(e),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Qs=globalThis;let nt=class extends Ln{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=fl(r,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return _n}};nt._$litElement$=!0,nt.finalized=!0,Qs.litElementHydrateSupport?.({LitElement:nt});const hl=Qs.litElementPolyfillSupport;hl?.({LitElement:nt});(Qs.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Kr(e,t){return(r,s,n)=>{const a=c=>c.renderRoot?.querySelector(e)??null;return gl(r,s,{get(){return a(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ls extends Is{}Ls.directiveName="unsafeSVG",Ls.resultType=2;const vl=yl(Ls);var xl=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function $l(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var zr={exports:{}},Cl=zr.exports,Vi;function El(){return Vi||(Vi=1,(function(e,t){(function(r,s){e.exports=s()})(Cl,function(){var r=function(i,o){return(r=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(l,u){l.__proto__=u}||function(l,u){for(var d in u)Object.prototype.hasOwnProperty.call(u,d)&&(l[d]=u[d])})(i,o)},s=function(){return(s=Object.assign||function(i){for(var o,l=1,u=arguments.length;l<u;l++)for(var d in o=arguments[l])Object.prototype.hasOwnProperty.call(o,d)&&(i[d]=o[d]);return i}).apply(this,arguments)};function n(i,o,l){for(var u,d=0,h=o.length;d<h;d++)!u&&d in o||((u=u||Array.prototype.slice.call(o,0,d))[d]=o[d]);return i.concat(u||Array.prototype.slice.call(o))}var a=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:xl,c=Object.keys,f=Array.isArray;function p(i,o){return typeof o!="object"||c(o).forEach(function(l){i[l]=o[l]}),i}typeof Promise>"u"||a.Promise||(a.Promise=Promise);var $=Object.getPrototypeOf,S={}.hasOwnProperty;function k(i,o){return S.call(i,o)}function z(i,o){typeof o=="function"&&(o=o($(i))),(typeof Reflect>"u"?c:Reflect.ownKeys)(o).forEach(function(l){q(i,l,o[l])})}var M=Object.defineProperty;function q(i,o,l,u){M(i,o,p(l&&k(l,"get")&&typeof l.get=="function"?{get:l.get,set:l.set,configurable:!0}:{value:l,configurable:!0,writable:!0},u))}function te(i){return{from:function(o){return i.prototype=Object.create(o.prototype),q(i.prototype,"constructor",i),{extend:z.bind(null,i.prototype)}}}}var ne=Object.getOwnPropertyDescriptor,ie=[].slice;function me(i,o,l){return ie.call(i,o,l)}function Re(i,o){return o(i)}function ae(i){if(!i)throw new Error("Assertion Failed")}function be(i){a.setImmediate?setImmediate(i):setTimeout(i,0)}function Te(i,o){if(typeof o=="string"&&k(i,o))return i[o];if(!o)return i;if(typeof o!="string"){for(var l=[],u=0,d=o.length;u<d;++u){var h=Te(i,o[u]);l.push(h)}return l}var g=o.indexOf(".");if(g!==-1){var y=i[o.substr(0,g)];return y==null?void 0:Te(y,o.substr(g+1))}}function We(i,o,l){if(i&&o!==void 0&&!("isFrozen"in Object&&Object.isFrozen(i)))if(typeof o!="string"&&"length"in o){ae(typeof l!="string"&&"length"in l);for(var u=0,d=o.length;u<d;++u)We(i,o[u],l[u])}else{var h,g,y=o.indexOf(".");y!==-1?(h=o.substr(0,y),(g=o.substr(y+1))===""?l===void 0?f(i)&&!isNaN(parseInt(h))?i.splice(h,1):delete i[h]:i[h]=l:We(y=!(y=i[h])||!k(i,h)?i[h]={}:y,g,l)):l===void 0?f(i)&&!isNaN(parseInt(o))?i.splice(o,1):delete i[o]:i[o]=l}}function Ot(i){var o,l={};for(o in i)k(i,o)&&(l[o]=i[o]);return l}var tn=[].concat;function jn(i){return tn.apply([],i)}var Gt="BigUint64Array,BigInt64Array,Array,Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,FileSystemDirectoryHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(jn([8,16,32,64].map(function(i){return["Int","Uint","Float"].map(function(o){return o+i+"Array"})}))).filter(function(i){return a[i]}),m=new Set(Gt.map(function(i){return a[i]})),v=null;function O(i){return v=new WeakMap,i=(function o(l){if(!l||typeof l!="object")return l;var u=v.get(l);if(u)return u;if(f(l)){u=[],v.set(l,u);for(var d=0,h=l.length;d<h;++d)u.push(o(l[d]))}else if(m.has(l.constructor))u=l;else{var g,y=$(l);for(g in u=y===Object.prototype?{}:Object.create(y),v.set(l,u),l)k(l,g)&&(u[g]=o(l[g]))}return u})(i),v=null,i}var b={}.toString;function x(i){return b.call(i).slice(8,-1)}var le=typeof Symbol<"u"?Symbol.iterator:"@@iterator",de=typeof le=="symbol"?function(i){var o;return i!=null&&(o=i[le])&&o.apply(i)}:function(){return null};function N(i,o){return o=i.indexOf(o),0<=o&&i.splice(o,1),0<=o}var K={};function He(i){var o,l,u,d;if(arguments.length===1){if(f(i))return i.slice();if(this===K&&typeof i=="string")return[i];if(d=de(i)){for(l=[];!(u=d.next()).done;)l.push(u.value);return l}if(i==null)return[i];if(typeof(o=i.length)!="number")return[i];for(l=new Array(o);o--;)l[o]=i[o];return l}for(o=arguments.length,l=new Array(o);o--;)l[o]=arguments[o];return l}var rt=typeof Symbol<"u"?function(i){return i[Symbol.toStringTag]==="AsyncFunction"}:function(){return!1},$e=["Unknown","Constraint","Data","TransactionInactive","ReadOnly","Version","NotFound","InvalidState","InvalidAccess","Abort","Timeout","QuotaExceeded","Syntax","DataClone"],Tt=["Modify","Bulk","OpenFailed","VersionChange","Schema","Upgrade","InvalidTable","MissingAPI","NoSuchDatabase","InvalidArgument","SubTransaction","Unsupported","Internal","DatabaseClosed","PrematureCommit","ForeignAwait"].concat($e),Nt={VersionChanged:"Database version changed by other database connection",DatabaseClosed:"Database has been closed",Abort:"Transaction aborted",TransactionInactive:"Transaction has already completed or failed",MissingAPI:"IndexedDB API missing. Please visit https://tinyurl.com/y2uuvskb"};function Be(i,o){this.name=i,this.message=o}function Fe(i,o){return i+". Errors: "+Object.keys(o).map(function(l){return o[l].toString()}).filter(function(l,u,d){return d.indexOf(l)===u}).join(`
`)}function ve(i,o,l,u){this.failures=o,this.failedKeys=u,this.successCount=l,this.message=Fe(i,o)}function Se(i,o){this.name="BulkError",this.failures=Object.keys(o).map(function(l){return o[l]}),this.failuresByPos=o,this.message=Fe(i,this.failures)}te(Be).from(Error).extend({toString:function(){return this.name+": "+this.message}}),te(ve).from(Be),te(Se).from(Be);var Ke=Tt.reduce(function(i,o){return i[o]=o+"Error",i},{}),Ee=Be,Q=Tt.reduce(function(i,o){var l=o+"Error";function u(d,h){this.name=l,d?typeof d=="string"?(this.message="".concat(d).concat(h?`
 `+h:""),this.inner=h||null):typeof d=="object"&&(this.message="".concat(d.name," ").concat(d.message),this.inner=d):(this.message=Nt[o]||l,this.inner=null)}return te(u).from(Ee),i[o]=u,i},{});Q.Syntax=SyntaxError,Q.Type=TypeError,Q.Range=RangeError;var Ve=$e.reduce(function(i,o){return i[o+"Error"]=Q[o],i},{}),Oe=Tt.reduce(function(i,o){return["Syntax","Type","Range"].indexOf(o)===-1&&(i[o+"Error"]=Q[o]),i},{});function ue(){}function ge(i){return i}function $t(i,o){return i==null||i===ge?o:function(l){return o(i(l))}}function oe(i,o){return function(){i.apply(this,arguments),o.apply(this,arguments)}}function Ye(i,o){return i===ue?o:function(){var l=i.apply(this,arguments);l!==void 0&&(arguments[0]=l);var u=this.onsuccess,d=this.onerror;this.onsuccess=null,this.onerror=null;var h=o.apply(this,arguments);return u&&(this.onsuccess=this.onsuccess?oe(u,this.onsuccess):u),d&&(this.onerror=this.onerror?oe(d,this.onerror):d),h!==void 0?h:l}}function nn(i,o){return i===ue?o:function(){i.apply(this,arguments);var l=this.onsuccess,u=this.onerror;this.onsuccess=this.onerror=null,o.apply(this,arguments),l&&(this.onsuccess=this.onsuccess?oe(l,this.onsuccess):l),u&&(this.onerror=this.onerror?oe(u,this.onerror):u)}}function Rt(i,o){return i===ue?o:function(l){var u=i.apply(this,arguments);p(l,u);var d=this.onsuccess,h=this.onerror;return this.onsuccess=null,this.onerror=null,l=o.apply(this,arguments),d&&(this.onsuccess=this.onsuccess?oe(d,this.onsuccess):d),h&&(this.onerror=this.onerror?oe(h,this.onerror):h),u===void 0?l===void 0?void 0:l:p(u,l)}}function Ge(i,o){return i===ue?o:function(){return o.apply(this,arguments)!==!1&&i.apply(this,arguments)}}function Ct(i,o){return i===ue?o:function(){var l=i.apply(this,arguments);if(l&&typeof l.then=="function"){for(var u=this,d=arguments.length,h=new Array(d);d--;)h[d]=arguments[d];return l.then(function(){return o.apply(u,h)})}return o.apply(this,arguments)}}Oe.ModifyError=ve,Oe.DexieError=Be,Oe.BulkError=Se;var Pe=typeof location<"u"&&/^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);function Me(i){Pe=i}var yt={},Je=100,Gt=typeof Promise>"u"?[]:(function(){var i=Promise.resolve();if(typeof crypto>"u"||!crypto.subtle)return[i,$(i),i];var o=crypto.subtle.digest("SHA-512",new Uint8Array([0]));return[o,$(o),i]})(),$e=Gt[0],Tt=Gt[1],Gt=Gt[2],Tt=Tt&&Tt.then,xe=$e&&$e.constructor,Et=!!Gt,Ne=function(i,o){Ze.push([i,o]),st&&(queueMicrotask(fe),st=!1)},ft=!0,st=!0,Qe=[],Ie=[],ce=ge,Xe={id:"global",global:!0,ref:0,unhandleds:[],onunhandled:ue,pgp:!1,env:{},finalize:ue},Y=Xe,Ze=[],at=0,vt=[];function X(i){if(typeof this!="object")throw new TypeError("Promises must be constructed via new");this._listeners=[],this._lib=!1;var o=this._PSD=Y;if(typeof i!="function"){if(i!==yt)throw new TypeError("Not a function");return this._state=arguments[1],this._value=arguments[2],void(this._state===!1&&it(this,this._value))}this._state=null,this._value=null,++o.ref,(function l(u,d){try{d(function(h){if(u._state===null){if(h===u)throw new TypeError("A promise cannot be resolved with itself.");var g=u._lib&&De();h&&typeof h.then=="function"?l(u,function(y,C){h instanceof X?h._then(y,C):h.then(y,C)}):(u._state=!0,u._value=h,rn(u)),g&&qe()}},it.bind(null,u))}catch(h){it(u,h)}})(this,i)}var qt={get:function(){var i=Y,o=dr;function l(u,d){var h=this,g=!i.global&&(i!==Y||o!==dr),y=g&&!on(),C=new X(function(_,T){re(h,new Yt(ai(u,i,g,y),ai(d,i,g,y),_,T,i))});return this._consoleTask&&(C._consoleTask=this._consoleTask),C}return l.prototype=yt,l},set:function(i){q(this,"then",i&&i.prototype===yt?qt:{get:function(){return i},set:qt.set})}};function Yt(i,o,l,u,d){this.onFulfilled=typeof i=="function"?i:null,this.onRejected=typeof o=="function"?o:null,this.resolve=l,this.reject=u,this.psd=d}function it(i,o){var l,u;Ie.push(o),i._state===null&&(l=i._lib&&De(),o=ce(o),i._state=!1,i._value=o,u=i,Qe.some(function(d){return d._value===u._value})||Qe.push(u),rn(i),l&&qe())}function rn(i){var o=i._listeners;i._listeners=[];for(var l=0,u=o.length;l<u;++l)re(i,o[l]);var d=i._PSD;--d.ref||d.finalize(),at===0&&(++at,Ne(function(){--at==0&&_e()},[]))}function re(i,o){if(i._state!==null){var l=i._state?o.onFulfilled:o.onRejected;if(l===null)return(i._state?o.resolve:o.reject)(i._value);++o.psd.ref,++at,Ne(ke,[l,i,o])}else i._listeners.push(o)}function ke(i,o,l){try{var u,d=o._value;!o._state&&Ie.length&&(Ie=[]),u=Pe&&o._consoleTask?o._consoleTask.run(function(){return i(d)}):i(d),o._state||Ie.indexOf(d)!==-1||(function(h){for(var g=Qe.length;g;)if(Qe[--g]._value===h._value)return Qe.splice(g,1)})(o),l.resolve(u)}catch(h){l.reject(h)}finally{--at==0&&_e(),--l.psd.ref||l.psd.finalize()}}function fe(){gn(Xe,function(){De()&&qe()})}function De(){var i=ft;return st=ft=!1,i}function qe(){var i,o,l;do for(;0<Ze.length;)for(i=Ze,Ze=[],l=i.length,o=0;o<l;++o){var u=i[o];u[0].apply(null,u[1])}while(0<Ze.length);st=ft=!0}function _e(){var i=Qe;Qe=[],i.forEach(function(u){u._PSD.onunhandled.call(null,u._value,u)});for(var o=vt.slice(0),l=o.length;l;)o[--l]()}function zt(i){return new X(yt,!1,i)}function Le(i,o){var l=Y;return function(){var u=De(),d=Y;try{return an(l,!0),i.apply(this,arguments)}catch(h){o&&o(h)}finally{an(d,!1),u&&qe()}}}z(X.prototype,{then:qt,_then:function(i,o){re(this,new Yt(null,null,i,o,Y))},catch:function(i){if(arguments.length===1)return this.then(null,i);var o=i,l=arguments[1];return typeof o=="function"?this.then(null,function(u){return(u instanceof o?l:zt)(u)}):this.then(null,function(u){return(u&&u.name===o?l:zt)(u)})},finally:function(i){return this.then(function(o){return X.resolve(i()).then(function(){return o})},function(o){return X.resolve(i()).then(function(){return zt(o)})})},timeout:function(i,o){var l=this;return i<1/0?new X(function(u,d){var h=setTimeout(function(){return d(new Q.Timeout(o))},i);l.then(u,d).finally(clearTimeout.bind(null,h))}):this}}),typeof Symbol<"u"&&Symbol.toStringTag&&q(X.prototype,Symbol.toStringTag,"Dexie.Promise"),Xe.env=oi(),z(X,{all:function(){var i=He.apply(null,arguments).map(fr);return new X(function(o,l){i.length===0&&o([]);var u=i.length;i.forEach(function(d,h){return X.resolve(d).then(function(g){i[h]=g,--u||o(i)},l)})})},resolve:function(i){return i instanceof X?i:i&&typeof i.then=="function"?new X(function(o,l){i.then(o,l)}):new X(yt,!0,i)},reject:zt,race:function(){var i=He.apply(null,arguments).map(fr);return new X(function(o,l){i.map(function(u){return X.resolve(u).then(o,l)})})},PSD:{get:function(){return Y},set:function(i){return Y=i}},totalEchoes:{get:function(){return dr}},newPSD:sn,usePSD:gn,scheduler:{get:function(){return Ne},set:function(i){Ne=i}},rejectionMapper:{get:function(){return ce},set:function(i){ce=i}},follow:function(i,o){return new X(function(l,u){return sn(function(d,h){var g=Y;g.unhandleds=[],g.onunhandled=h,g.finalize=oe(function(){var y,C=this;y=function(){C.unhandleds.length===0?d():h(C.unhandleds[0])},vt.push(function _(){y(),vt.splice(vt.indexOf(_),1)}),++at,Ne(function(){--at==0&&_e()},[])},g.finalize),i()},o,l,u)})}}),xe&&(xe.allSettled&&q(X,"allSettled",function(){var i=He.apply(null,arguments).map(fr);return new X(function(o){i.length===0&&o([]);var l=i.length,u=new Array(l);i.forEach(function(d,h){return X.resolve(d).then(function(g){return u[h]={status:"fulfilled",value:g}},function(g){return u[h]={status:"rejected",reason:g}}).then(function(){return--l||o(u)})})})}),xe.any&&typeof AggregateError<"u"&&q(X,"any",function(){var i=He.apply(null,arguments).map(fr);return new X(function(o,l){i.length===0&&l(new AggregateError([]));var u=i.length,d=new Array(u);i.forEach(function(h,g){return X.resolve(h).then(function(y){return o(y)},function(y){d[g]=y,--u||l(new AggregateError(d))})})})}),xe.withResolvers&&(X.withResolvers=xe.withResolvers));var lt={awaits:0,echoes:0,id:0},va=0,cr=[],ur=0,dr=0,xa=0;function sn(i,o,l,u){var d=Y,h=Object.create(d);return h.parent=d,h.ref=0,h.global=!1,h.id=++xa,Xe.env,h.env=Et?{Promise:X,PromiseProp:{value:X,configurable:!0,writable:!0},all:X.all,race:X.race,allSettled:X.allSettled,any:X.any,resolve:X.resolve,reject:X.reject}:{},o&&p(h,o),++d.ref,h.finalize=function(){--this.parent.ref||this.parent.finalize()},u=gn(h,i,l,u),h.ref===0&&h.finalize(),u}function Fn(){return lt.id||(lt.id=++va),++lt.awaits,lt.echoes+=Je,lt.id}function on(){return!!lt.awaits&&(--lt.awaits==0&&(lt.id=0),lt.echoes=lt.awaits*Je,!0)}function fr(i){return lt.echoes&&i&&i.constructor===xe?(Fn(),i.then(function(o){return on(),o},function(o){return on(),et(o)})):i}function $a(){var i=cr[cr.length-1];cr.pop(),an(i,!1)}function an(i,o){var l,u=Y;(o?!lt.echoes||ur++&&i===Y:!ur||--ur&&i===Y)||queueMicrotask(o?function(d){++dr,lt.echoes&&--lt.echoes!=0||(lt.echoes=lt.awaits=lt.id=0),cr.push(Y),an(d,!0)}.bind(null,i):$a),i!==Y&&(Y=i,u===Xe&&(Xe.env=oi()),Et&&(l=Xe.env.Promise,o=i.env,(u.global||i.global)&&(Object.defineProperty(a,"Promise",o.PromiseProp),l.all=o.all,l.race=o.race,l.resolve=o.resolve,l.reject=o.reject,o.allSettled&&(l.allSettled=o.allSettled),o.any&&(l.any=o.any))))}function oi(){var i=a.Promise;return Et?{Promise:i,PromiseProp:Object.getOwnPropertyDescriptor(a,"Promise"),all:i.all,race:i.race,allSettled:i.allSettled,any:i.any,resolve:i.resolve,reject:i.reject}:{}}function gn(i,o,l,u,d){var h=Y;try{return an(i,!0),o(l,u,d)}finally{an(h,!1)}}function ai(i,o,l,u){return typeof i!="function"?i:function(){var d=Y;l&&Fn(),an(o,!0);try{return i.apply(this,arguments)}finally{an(d,!1),u&&queueMicrotask(on)}}}function ns(i){Promise===xe&&lt.echoes===0?ur===0?i():enqueueNativeMicroTask(i):setTimeout(i,0)}(""+Tt).indexOf("[native code]")===-1&&(Fn=on=ue);var et=X.reject,bn="￿",Xt="Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.",li="String expected.",On=[],hr="__dbnames",rs="readonly",ss="readwrite";function yn(i,o){return i?o?function(){return i.apply(this,arguments)&&o.apply(this,arguments)}:i:o}var ci={type:3,lower:-1/0,lowerOpen:!1,upper:[[]],upperOpen:!1};function pr(i){return typeof i!="string"||/\./.test(i)?function(o){return o}:function(o){return o[i]===void 0&&i in o&&delete(o=O(o))[i],o}}function ui(){throw Q.Type()}function Ce(i,o){try{var l=di(i),u=di(o);if(l!==u)return l==="Array"?1:u==="Array"?-1:l==="binary"?1:u==="binary"?-1:l==="string"?1:u==="string"?-1:l==="Date"?1:u!=="Date"?NaN:-1;switch(l){case"number":case"Date":case"string":return o<i?1:i<o?-1:0;case"binary":return(function(d,h){for(var g=d.length,y=h.length,C=g<y?g:y,_=0;_<C;++_)if(d[_]!==h[_])return d[_]<h[_]?-1:1;return g===y?0:g<y?-1:1})(fi(i),fi(o));case"Array":return(function(d,h){for(var g=d.length,y=h.length,C=g<y?g:y,_=0;_<C;++_){var T=Ce(d[_],h[_]);if(T!==0)return T}return g===y?0:g<y?-1:1})(i,o)}}catch{}return NaN}function di(i){var o=typeof i;return o!="object"?o:ArrayBuffer.isView(i)?"binary":(i=x(i),i==="ArrayBuffer"?"binary":i)}function fi(i){return i instanceof Uint8Array?i:ArrayBuffer.isView(i)?new Uint8Array(i.buffer,i.byteOffset,i.byteLength):new Uint8Array(i)}var hi=(Ue.prototype._trans=function(i,o,l){var u=this._tx||Y.trans,d=this.name,h=Pe&&typeof console<"u"&&console.createTask&&console.createTask("Dexie: ".concat(i==="readonly"?"read":"write"," ").concat(this.name));function g(_,T,w){if(!w.schema[d])throw new Q.NotFound("Table "+d+" not part of transaction");return o(w.idbtrans,w)}var y=De();try{var C=u&&u.db._novip===this.db._novip?u===Y.trans?u._promise(i,g,l):sn(function(){return u._promise(i,g,l)},{trans:u,transless:Y.transless||Y}):(function _(T,w,j,E){if(T.idbdb&&(T._state.openComplete||Y.letThrough||T._vip)){var P=T._createTransaction(w,j,T._dbSchema);try{P.create(),T._state.PR1398_maxLoop=3}catch(D){return D.name===Ke.InvalidState&&T.isOpen()&&0<--T._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),T.close({disableAutoOpen:!1}),T.open().then(function(){return _(T,w,j,E)})):et(D)}return P._promise(w,function(D,A){return sn(function(){return Y.trans=P,E(D,A,P)})}).then(function(D){if(w==="readwrite")try{P.idbtrans.commit()}catch{}return w==="readonly"?D:P._completion.then(function(){return D})})}if(T._state.openComplete)return et(new Q.DatabaseClosed(T._state.dbOpenError));if(!T._state.isBeingOpened){if(!T._state.autoOpen)return et(new Q.DatabaseClosed);T.open().catch(ue)}return T._state.dbReadyPromise.then(function(){return _(T,w,j,E)})})(this.db,i,[this.name],g);return h&&(C._consoleTask=h,C=C.catch(function(_){return console.trace(_),et(_)})),C}finally{y&&qe()}},Ue.prototype.get=function(i,o){var l=this;return i&&i.constructor===Object?this.where(i).first(o):i==null?et(new Q.Type("Invalid argument to Table.get()")):this._trans("readonly",function(u){return l.core.get({trans:u,key:i}).then(function(d){return l.hook.reading.fire(d)})}).then(o)},Ue.prototype.where=function(i){if(typeof i=="string")return new this.db.WhereClause(this,i);if(f(i))return new this.db.WhereClause(this,"[".concat(i.join("+"),"]"));var o=c(i);if(o.length===1)return this.where(o[0]).equals(i[o[0]]);var l=this.schema.indexes.concat(this.schema.primKey).filter(function(y){if(y.compound&&o.every(function(_){return 0<=y.keyPath.indexOf(_)})){for(var C=0;C<o.length;++C)if(o.indexOf(y.keyPath[C])===-1)return!1;return!0}return!1}).sort(function(y,C){return y.keyPath.length-C.keyPath.length})[0];if(l&&this.db._maxKey!==bn){var h=l.keyPath.slice(0,o.length);return this.where(h).equals(h.map(function(C){return i[C]}))}!l&&Pe&&console.warn("The query ".concat(JSON.stringify(i)," on ").concat(this.name," would benefit from a ")+"compound index [".concat(o.join("+"),"]"));var u=this.schema.idxByName;function d(y,C){return Ce(y,C)===0}var g=o.reduce(function(w,C){var _=w[0],T=w[1],w=u[C],j=i[C];return[_||w,_||!w?yn(T,w&&w.multi?function(E){return E=Te(E,C),f(E)&&E.some(function(P){return d(j,P)})}:function(E){return d(j,Te(E,C))}):T]},[null,null]),h=g[0],g=g[1];return h?this.where(h.name).equals(i[h.keyPath]).filter(g):l?this.filter(g):this.where(o).equals("")},Ue.prototype.filter=function(i){return this.toCollection().and(i)},Ue.prototype.count=function(i){return this.toCollection().count(i)},Ue.prototype.offset=function(i){return this.toCollection().offset(i)},Ue.prototype.limit=function(i){return this.toCollection().limit(i)},Ue.prototype.each=function(i){return this.toCollection().each(i)},Ue.prototype.toArray=function(i){return this.toCollection().toArray(i)},Ue.prototype.toCollection=function(){return new this.db.Collection(new this.db.WhereClause(this))},Ue.prototype.orderBy=function(i){return new this.db.Collection(new this.db.WhereClause(this,f(i)?"[".concat(i.join("+"),"]"):i))},Ue.prototype.reverse=function(){return this.toCollection().reverse()},Ue.prototype.mapToClass=function(i){var o,l=this.db,u=this.name;function d(){return o!==null&&o.apply(this,arguments)||this}(this.schema.mappedClass=i).prototype instanceof ui&&((function(C,_){if(typeof _!="function"&&_!==null)throw new TypeError("Class extends value "+String(_)+" is not a constructor or null");function T(){this.constructor=C}r(C,_),C.prototype=_===null?Object.create(_):(T.prototype=_.prototype,new T)})(d,o=i),Object.defineProperty(d.prototype,"db",{get:function(){return l},enumerable:!1,configurable:!0}),d.prototype.table=function(){return u},i=d);for(var h=new Set,g=i.prototype;g;g=$(g))Object.getOwnPropertyNames(g).forEach(function(C){return h.add(C)});function y(C){if(!C)return C;var _,T=Object.create(i.prototype);for(_ in C)if(!h.has(_))try{T[_]=C[_]}catch{}return T}return this.schema.readHook&&this.hook.reading.unsubscribe(this.schema.readHook),this.schema.readHook=y,this.hook("reading",y),i},Ue.prototype.defineClass=function(){return this.mapToClass(function(i){p(this,i)})},Ue.prototype.add=function(i,o){var l=this,u=this.schema.primKey,d=u.auto,h=u.keyPath,g=i;return h&&d&&(g=pr(h)(i)),this._trans("readwrite",function(y){return l.core.mutate({trans:y,type:"add",keys:o!=null?[o]:null,values:[g]})}).then(function(y){return y.numFailures?X.reject(y.failures[0]):y.lastResult}).then(function(y){if(h)try{We(i,h,y)}catch{}return y})},Ue.prototype.update=function(i,o){return typeof i!="object"||f(i)?this.where(":id").equals(i).modify(o):(i=Te(i,this.schema.primKey.keyPath),i===void 0?et(new Q.InvalidArgument("Given object does not contain its primary key")):this.where(":id").equals(i).modify(o))},Ue.prototype.put=function(i,o){var l=this,u=this.schema.primKey,d=u.auto,h=u.keyPath,g=i;return h&&d&&(g=pr(h)(i)),this._trans("readwrite",function(y){return l.core.mutate({trans:y,type:"put",values:[g],keys:o!=null?[o]:null})}).then(function(y){return y.numFailures?X.reject(y.failures[0]):y.lastResult}).then(function(y){if(h)try{We(i,h,y)}catch{}return y})},Ue.prototype.delete=function(i){var o=this;return this._trans("readwrite",function(l){return o.core.mutate({trans:l,type:"delete",keys:[i]})}).then(function(l){return l.numFailures?X.reject(l.failures[0]):void 0})},Ue.prototype.clear=function(){var i=this;return this._trans("readwrite",function(o){return i.core.mutate({trans:o,type:"deleteRange",range:ci})}).then(function(o){return o.numFailures?X.reject(o.failures[0]):void 0})},Ue.prototype.bulkGet=function(i){var o=this;return this._trans("readonly",function(l){return o.core.getMany({keys:i,trans:l}).then(function(u){return u.map(function(d){return o.hook.reading.fire(d)})})})},Ue.prototype.bulkAdd=function(i,o,l){var u=this,d=Array.isArray(o)?o:void 0,h=(l=l||(d?void 0:o))?l.allKeys:void 0;return this._trans("readwrite",function(g){var _=u.schema.primKey,y=_.auto,_=_.keyPath;if(_&&d)throw new Q.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");if(d&&d.length!==i.length)throw new Q.InvalidArgument("Arguments objects and keys must have the same length");var C=i.length,_=_&&y?i.map(pr(_)):i;return u.core.mutate({trans:g,type:"add",keys:d,values:_,wantResults:h}).then(function(P){var w=P.numFailures,j=P.results,E=P.lastResult,P=P.failures;if(w===0)return h?j:E;throw new Se("".concat(u.name,".bulkAdd(): ").concat(w," of ").concat(C," operations failed"),P)})})},Ue.prototype.bulkPut=function(i,o,l){var u=this,d=Array.isArray(o)?o:void 0,h=(l=l||(d?void 0:o))?l.allKeys:void 0;return this._trans("readwrite",function(g){var _=u.schema.primKey,y=_.auto,_=_.keyPath;if(_&&d)throw new Q.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");if(d&&d.length!==i.length)throw new Q.InvalidArgument("Arguments objects and keys must have the same length");var C=i.length,_=_&&y?i.map(pr(_)):i;return u.core.mutate({trans:g,type:"put",keys:d,values:_,wantResults:h}).then(function(P){var w=P.numFailures,j=P.results,E=P.lastResult,P=P.failures;if(w===0)return h?j:E;throw new Se("".concat(u.name,".bulkPut(): ").concat(w," of ").concat(C," operations failed"),P)})})},Ue.prototype.bulkUpdate=function(i){var o=this,l=this.core,u=i.map(function(g){return g.key}),d=i.map(function(g){return g.changes}),h=[];return this._trans("readwrite",function(g){return l.getMany({trans:g,keys:u,cache:"clone"}).then(function(y){var C=[],_=[];i.forEach(function(w,j){var E=w.key,P=w.changes,D=y[j];if(D){for(var A=0,R=Object.keys(P);A<R.length;A++){var I=R[A],L=P[I];if(I===o.schema.primKey.keyPath){if(Ce(L,E)!==0)throw new Q.Constraint("Cannot update primary key in bulkUpdate()")}else We(D,I,L)}h.push(j),C.push(E),_.push(D)}});var T=C.length;return l.mutate({trans:g,type:"put",keys:C,values:_,updates:{keys:u,changeSpecs:d}}).then(function(w){var j=w.numFailures,E=w.failures;if(j===0)return T;for(var P=0,D=Object.keys(E);P<D.length;P++){var A,R=D[P],I=h[Number(R)];I!=null&&(A=E[R],delete E[R],E[I]=A)}throw new Se("".concat(o.name,".bulkUpdate(): ").concat(j," of ").concat(T," operations failed"),E)})})})},Ue.prototype.bulkDelete=function(i){var o=this,l=i.length;return this._trans("readwrite",function(u){return o.core.mutate({trans:u,type:"delete",keys:i})}).then(function(g){var d=g.numFailures,h=g.lastResult,g=g.failures;if(d===0)return h;throw new Se("".concat(o.name,".bulkDelete(): ").concat(d," of ").concat(l," operations failed"),g)})},Ue);function Ue(){}function Wn(i){function o(g,y){if(y){for(var C=arguments.length,_=new Array(C-1);--C;)_[C-1]=arguments[C];return l[g].subscribe.apply(null,_),i}if(typeof g=="string")return l[g]}var l={};o.addEventType=h;for(var u=1,d=arguments.length;u<d;++u)h(arguments[u]);return o;function h(g,y,C){if(typeof g!="object"){var _;y=y||Ge;var T={subscribers:[],fire:C=C||ue,subscribe:function(w){T.subscribers.indexOf(w)===-1&&(T.subscribers.push(w),T.fire=y(T.fire,w))},unsubscribe:function(w){T.subscribers=T.subscribers.filter(function(j){return j!==w}),T.fire=T.subscribers.reduce(y,C)}};return l[g]=o[g]=T}c(_=g).forEach(function(w){var j=_[w];if(f(j))h(w,_[w][0],_[w][1]);else{if(j!=="asap")throw new Q.InvalidArgument("Invalid event config");var E=h(w,ge,function(){for(var P=arguments.length,D=new Array(P);P--;)D[P]=arguments[P];E.subscribers.forEach(function(A){be(function(){A.apply(null,D)})})})}})}}function Hn(i,o){return te(o).from({prototype:i}),o}function Rn(i,o){return!(i.filter||i.algorithm||i.or)&&(o?i.justLimit:!i.replayFilter)}function is(i,o){i.filter=yn(i.filter,o)}function os(i,o,l){var u=i.replayFilter;i.replayFilter=u?function(){return yn(u(),o())}:o,i.justLimit=l&&!u}function mr(i,o){if(i.isPrimKey)return o.primaryKey;var l=o.getIndexByKeyPath(i.index);if(!l)throw new Q.Schema("KeyPath "+i.index+" on object store "+o.name+" is not indexed");return l}function pi(i,o,l){var u=mr(i,o.schema);return o.openCursor({trans:l,values:!i.keysOnly,reverse:i.dir==="prev",unique:!!i.unique,query:{index:u,range:i.range}})}function gr(i,o,l,u){var d=i.replayFilter?yn(i.filter,i.replayFilter()):i.filter;if(i.or){var h={},g=function(y,C,_){var T,w;d&&!d(C,_,function(j){return C.stop(j)},function(j){return C.fail(j)})||((w=""+(T=C.primaryKey))=="[object ArrayBuffer]"&&(w=""+new Uint8Array(T)),k(h,w)||(h[w]=!0,o(y,C,_)))};return Promise.all([i.or._iterate(g,l),mi(pi(i,u,l),i.algorithm,g,!i.keysOnly&&i.valueMapper)])}return mi(pi(i,u,l),yn(i.algorithm,d),o,!i.keysOnly&&i.valueMapper)}function mi(i,o,l,u){var d=Le(u?function(h,g,y){return l(u(h),g,y)}:l);return i.then(function(h){if(h)return h.start(function(){var g=function(){return h.continue()};o&&!o(h,function(y){return g=y},function(y){h.stop(y),g=ue},function(y){h.fail(y),g=ue})||d(h.value,h,function(y){return g=y}),g()})})}var Gt=Symbol(),Kn=(gi.prototype.execute=function(i){if(this.add!==void 0){var o=this.add;if(f(o))return n(n([],f(i)?i:[],!0),o).sort();if(typeof o=="number")return(Number(i)||0)+o;if(typeof o=="bigint")try{return BigInt(i)+o}catch{return BigInt(0)+o}throw new TypeError("Invalid term ".concat(o))}if(this.remove!==void 0){var l=this.remove;if(f(l))return f(i)?i.filter(function(u){return!l.includes(u)}).sort():[];if(typeof l=="number")return Number(i)-l;if(typeof l=="bigint")try{return BigInt(i)-l}catch{return BigInt(0)-l}throw new TypeError("Invalid subtrahend ".concat(l))}return o=(o=this.replacePrefix)===null||o===void 0?void 0:o[0],o&&typeof i=="string"&&i.startsWith(o)?this.replacePrefix[1]+i.substring(o.length):i},gi);function gi(i){Object.assign(this,i)}var Ca=(Ae.prototype._read=function(i,o){var l=this._ctx;return l.error?l.table._trans(null,et.bind(null,l.error)):l.table._trans("readonly",i).then(o)},Ae.prototype._write=function(i){var o=this._ctx;return o.error?o.table._trans(null,et.bind(null,o.error)):o.table._trans("readwrite",i,"locked")},Ae.prototype._addAlgorithm=function(i){var o=this._ctx;o.algorithm=yn(o.algorithm,i)},Ae.prototype._iterate=function(i,o){return gr(this._ctx,i,o,this._ctx.table.core)},Ae.prototype.clone=function(i){var o=Object.create(this.constructor.prototype),l=Object.create(this._ctx);return i&&p(l,i),o._ctx=l,o},Ae.prototype.raw=function(){return this._ctx.valueMapper=null,this},Ae.prototype.each=function(i){var o=this._ctx;return this._read(function(l){return gr(o,i,l,o.table.core)})},Ae.prototype.count=function(i){var o=this;return this._read(function(l){var u=o._ctx,d=u.table.core;if(Rn(u,!0))return d.count({trans:l,query:{index:mr(u,d.schema),range:u.range}}).then(function(g){return Math.min(g,u.limit)});var h=0;return gr(u,function(){return++h,!1},l,d).then(function(){return h})}).then(i)},Ae.prototype.sortBy=function(i,o){var l=i.split(".").reverse(),u=l[0],d=l.length-1;function h(C,_){return _?h(C[l[_]],_-1):C[u]}var g=this._ctx.dir==="next"?1:-1;function y(C,_){return Ce(h(C,d),h(_,d))*g}return this.toArray(function(C){return C.sort(y)}).then(o)},Ae.prototype.toArray=function(i){var o=this;return this._read(function(l){var u=o._ctx;if(u.dir==="next"&&Rn(u,!0)&&0<u.limit){var d=u.valueMapper,h=mr(u,u.table.core.schema);return u.table.core.query({trans:l,limit:u.limit,values:!0,query:{index:h,range:u.range}}).then(function(y){return y=y.result,d?y.map(d):y})}var g=[];return gr(u,function(y){return g.push(y)},l,u.table.core).then(function(){return g})},i)},Ae.prototype.offset=function(i){var o=this._ctx;return i<=0||(o.offset+=i,Rn(o)?os(o,function(){var l=i;return function(u,d){return l===0||(l===1?--l:d(function(){u.advance(l),l=0}),!1)}}):os(o,function(){var l=i;return function(){return--l<0}})),this},Ae.prototype.limit=function(i){return this._ctx.limit=Math.min(this._ctx.limit,i),os(this._ctx,function(){var o=i;return function(l,u,d){return--o<=0&&u(d),0<=o}},!0),this},Ae.prototype.until=function(i,o){return is(this._ctx,function(l,u,d){return!i(l.value)||(u(d),o)}),this},Ae.prototype.first=function(i){return this.limit(1).toArray(function(o){return o[0]}).then(i)},Ae.prototype.last=function(i){return this.reverse().first(i)},Ae.prototype.filter=function(i){var o;return is(this._ctx,function(l){return i(l.value)}),(o=this._ctx).isMatch=yn(o.isMatch,i),this},Ae.prototype.and=function(i){return this.filter(i)},Ae.prototype.or=function(i){return new this.db.WhereClause(this._ctx.table,i,this)},Ae.prototype.reverse=function(){return this._ctx.dir=this._ctx.dir==="prev"?"next":"prev",this._ondirectionchange&&this._ondirectionchange(this._ctx.dir),this},Ae.prototype.desc=function(){return this.reverse()},Ae.prototype.eachKey=function(i){var o=this._ctx;return o.keysOnly=!o.isMatch,this.each(function(l,u){i(u.key,u)})},Ae.prototype.eachUniqueKey=function(i){return this._ctx.unique="unique",this.eachKey(i)},Ae.prototype.eachPrimaryKey=function(i){var o=this._ctx;return o.keysOnly=!o.isMatch,this.each(function(l,u){i(u.primaryKey,u)})},Ae.prototype.keys=function(i){var o=this._ctx;o.keysOnly=!o.isMatch;var l=[];return this.each(function(u,d){l.push(d.key)}).then(function(){return l}).then(i)},Ae.prototype.primaryKeys=function(i){var o=this._ctx;if(o.dir==="next"&&Rn(o,!0)&&0<o.limit)return this._read(function(u){var d=mr(o,o.table.core.schema);return o.table.core.query({trans:u,values:!1,limit:o.limit,query:{index:d,range:o.range}})}).then(function(u){return u.result}).then(i);o.keysOnly=!o.isMatch;var l=[];return this.each(function(u,d){l.push(d.primaryKey)}).then(function(){return l}).then(i)},Ae.prototype.uniqueKeys=function(i){return this._ctx.unique="unique",this.keys(i)},Ae.prototype.firstKey=function(i){return this.limit(1).keys(function(o){return o[0]}).then(i)},Ae.prototype.lastKey=function(i){return this.reverse().firstKey(i)},Ae.prototype.distinct=function(){var i=this._ctx,i=i.index&&i.table.schema.idxByName[i.index];if(!i||!i.multi)return this;var o={};return is(this._ctx,function(d){var u=d.primaryKey.toString(),d=k(o,u);return o[u]=!0,!d}),this},Ae.prototype.modify=function(i){var o=this,l=this._ctx;return this._write(function(u){var d,h,g;g=typeof i=="function"?i:(d=c(i),h=d.length,function(A){for(var R=!1,I=0;I<h;++I){var L=d[I],B=i[L],U=Te(A,L);B instanceof Kn?(We(A,L,B.execute(U)),R=!0):U!==B&&(We(A,L,B),R=!0)}return R});var y=l.table.core,w=y.schema.primaryKey,C=w.outbound,_=w.extractKey,T=200,w=o.db._options.modifyChunkSize;w&&(T=typeof w=="object"?w[y.name]||w["*"]||200:w);function j(A,L){var I=L.failures,L=L.numFailures;P+=A-L;for(var B=0,U=c(I);B<U.length;B++){var J=U[B];E.push(I[J])}}var E=[],P=0,D=[];return o.clone().primaryKeys().then(function(A){function R(L){var B=Math.min(T,A.length-L);return y.getMany({trans:u,keys:A.slice(L,L+B),cache:"immutable"}).then(function(U){for(var J=[],W=[],V=C?[]:null,Z=[],G=0;G<B;++G){var se=U[G],pe={value:O(se),primKey:A[L+G]};g.call(pe,pe.value,pe)!==!1&&(pe.value==null?Z.push(A[L+G]):C||Ce(_(se),_(pe.value))===0?(W.push(pe.value),C&&V.push(A[L+G])):(Z.push(A[L+G]),J.push(pe.value)))}return Promise.resolve(0<J.length&&y.mutate({trans:u,type:"add",values:J}).then(function(ye){for(var we in ye.failures)Z.splice(parseInt(we),1);j(J.length,ye)})).then(function(){return(0<W.length||I&&typeof i=="object")&&y.mutate({trans:u,type:"put",keys:V,values:W,criteria:I,changeSpec:typeof i!="function"&&i,isAdditionalChunk:0<L}).then(function(ye){return j(W.length,ye)})}).then(function(){return(0<Z.length||I&&i===as)&&y.mutate({trans:u,type:"delete",keys:Z,criteria:I,isAdditionalChunk:0<L}).then(function(ye){return j(Z.length,ye)})}).then(function(){return A.length>L+B&&R(L+T)})})}var I=Rn(l)&&l.limit===1/0&&(typeof i!="function"||i===as)&&{index:l.index,range:l.range};return R(0).then(function(){if(0<E.length)throw new ve("Error modifying one or more objects",E,P,D);return A.length})})})},Ae.prototype.delete=function(){var i=this._ctx,o=i.range;return Rn(i)&&(i.isPrimKey||o.type===3)?this._write(function(l){var u=i.table.core.schema.primaryKey,d=o;return i.table.core.count({trans:l,query:{index:u,range:d}}).then(function(h){return i.table.core.mutate({trans:l,type:"deleteRange",range:d}).then(function(g){var y=g.failures;if(g.lastResult,g.results,g=g.numFailures,g)throw new ve("Could not delete some values",Object.keys(y).map(function(C){return y[C]}),h-g);return h-g})})}):this.modify(as)},Ae);function Ae(){}var as=function(i,o){return o.value=null};function Ea(i,o){return i<o?-1:i===o?0:1}function ka(i,o){return o<i?-1:i===o?0:1}function kt(i,o,l){return i=i instanceof yi?new i.Collection(i):i,i._ctx.error=new(l||TypeError)(o),i}function zn(i){return new i.Collection(i,function(){return bi("")}).limit(0)}function br(i,o,l,u){var d,h,g,y,C,_,T,w=l.length;if(!l.every(function(P){return typeof P=="string"}))return kt(i,li);function j(P){d=P==="next"?function(A){return A.toUpperCase()}:function(A){return A.toLowerCase()},h=P==="next"?function(A){return A.toLowerCase()}:function(A){return A.toUpperCase()},g=P==="next"?Ea:ka;var D=l.map(function(A){return{lower:h(A),upper:d(A)}}).sort(function(A,R){return g(A.lower,R.lower)});y=D.map(function(A){return A.upper}),C=D.map(function(A){return A.lower}),T=(_=P)==="next"?"":u}j("next"),i=new i.Collection(i,function(){return ln(y[0],C[w-1]+u)}),i._ondirectionchange=function(P){j(P)};var E=0;return i._addAlgorithm(function(P,D,A){var R=P.key;if(typeof R!="string")return!1;var I=h(R);if(o(I,C,E))return!0;for(var L=null,B=E;B<w;++B){var U=(function(J,W,V,Z,G,se){for(var pe=Math.min(J.length,Z.length),ye=-1,we=0;we<pe;++we){var St=W[we];if(St!==Z[we])return G(J[we],V[we])<0?J.substr(0,we)+V[we]+V.substr(we+1):G(J[we],Z[we])<0?J.substr(0,we)+Z[we]+V.substr(we+1):0<=ye?J.substr(0,ye)+W[ye]+V.substr(ye+1):null;G(J[we],St)<0&&(ye=we)}return pe<Z.length&&se==="next"?J+V.substr(J.length):pe<J.length&&se==="prev"?J.substr(0,V.length):ye<0?null:J.substr(0,ye)+Z[ye]+V.substr(ye+1)})(R,I,y[B],C[B],g,_);U===null&&L===null?E=B+1:(L===null||0<g(L,U))&&(L=U)}return D(L!==null?function(){P.continue(L+T)}:A),!1}),i}function ln(i,o,l,u){return{type:2,lower:i,upper:o,lowerOpen:l,upperOpen:u}}function bi(i){return{type:1,lower:i,upper:i}}var yi=(Object.defineProperty(ct.prototype,"Collection",{get:function(){return this._ctx.table.db.Collection},enumerable:!1,configurable:!0}),ct.prototype.between=function(i,o,l,u){l=l!==!1,u=u===!0;try{return 0<this._cmp(i,o)||this._cmp(i,o)===0&&(l||u)&&(!l||!u)?zn(this):new this.Collection(this,function(){return ln(i,o,!l,!u)})}catch{return kt(this,Xt)}},ct.prototype.equals=function(i){return i==null?kt(this,Xt):new this.Collection(this,function(){return bi(i)})},ct.prototype.above=function(i){return i==null?kt(this,Xt):new this.Collection(this,function(){return ln(i,void 0,!0)})},ct.prototype.aboveOrEqual=function(i){return i==null?kt(this,Xt):new this.Collection(this,function(){return ln(i,void 0,!1)})},ct.prototype.below=function(i){return i==null?kt(this,Xt):new this.Collection(this,function(){return ln(void 0,i,!1,!0)})},ct.prototype.belowOrEqual=function(i){return i==null?kt(this,Xt):new this.Collection(this,function(){return ln(void 0,i)})},ct.prototype.startsWith=function(i){return typeof i!="string"?kt(this,li):this.between(i,i+bn,!0,!0)},ct.prototype.startsWithIgnoreCase=function(i){return i===""?this.startsWith(i):br(this,function(o,l){return o.indexOf(l[0])===0},[i],bn)},ct.prototype.equalsIgnoreCase=function(i){return br(this,function(o,l){return o===l[0]},[i],"")},ct.prototype.anyOfIgnoreCase=function(){var i=He.apply(K,arguments);return i.length===0?zn(this):br(this,function(o,l){return l.indexOf(o)!==-1},i,"")},ct.prototype.startsWithAnyOfIgnoreCase=function(){var i=He.apply(K,arguments);return i.length===0?zn(this):br(this,function(o,l){return l.some(function(u){return o.indexOf(u)===0})},i,bn)},ct.prototype.anyOf=function(){var i=this,o=He.apply(K,arguments),l=this._cmp;try{o.sort(l)}catch{return kt(this,Xt)}if(o.length===0)return zn(this);var u=new this.Collection(this,function(){return ln(o[0],o[o.length-1])});u._ondirectionchange=function(h){l=h==="next"?i._ascending:i._descending,o.sort(l)};var d=0;return u._addAlgorithm(function(h,g,y){for(var C=h.key;0<l(C,o[d]);)if(++d===o.length)return g(y),!1;return l(C,o[d])===0||(g(function(){h.continue(o[d])}),!1)}),u},ct.prototype.notEqual=function(i){return this.inAnyRange([[-1/0,i],[i,this.db._maxKey]],{includeLowers:!1,includeUppers:!1})},ct.prototype.noneOf=function(){var i=He.apply(K,arguments);if(i.length===0)return new this.Collection(this);try{i.sort(this._ascending)}catch{return kt(this,Xt)}var o=i.reduce(function(l,u){return l?l.concat([[l[l.length-1][1],u]]):[[-1/0,u]]},null);return o.push([i[i.length-1],this.db._maxKey]),this.inAnyRange(o,{includeLowers:!1,includeUppers:!1})},ct.prototype.inAnyRange=function(R,o){var l=this,u=this._cmp,d=this._ascending,h=this._descending,g=this._min,y=this._max;if(R.length===0)return zn(this);if(!R.every(function(I){return I[0]!==void 0&&I[1]!==void 0&&d(I[0],I[1])<=0}))return kt(this,"First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower",Q.InvalidArgument);var C=!o||o.includeLowers!==!1,_=o&&o.includeUppers===!0,T,w=d;function j(I,L){return w(I[0],L[0])}try{(T=R.reduce(function(I,L){for(var B=0,U=I.length;B<U;++B){var J=I[B];if(u(L[0],J[1])<0&&0<u(L[1],J[0])){J[0]=g(J[0],L[0]),J[1]=y(J[1],L[1]);break}}return B===U&&I.push(L),I},[])).sort(j)}catch{return kt(this,Xt)}var E=0,P=_?function(I){return 0<d(I,T[E][1])}:function(I){return 0<=d(I,T[E][1])},D=C?function(I){return 0<h(I,T[E][0])}:function(I){return 0<=h(I,T[E][0])},A=P,R=new this.Collection(this,function(){return ln(T[0][0],T[T.length-1][1],!C,!_)});return R._ondirectionchange=function(I){w=I==="next"?(A=P,d):(A=D,h),T.sort(j)},R._addAlgorithm(function(I,L,B){for(var U,J=I.key;A(J);)if(++E===T.length)return L(B),!1;return!P(U=J)&&!D(U)||(l._cmp(J,T[E][1])===0||l._cmp(J,T[E][0])===0||L(function(){w===d?I.continue(T[E][0]):I.continue(T[E][1])}),!1)}),R},ct.prototype.startsWithAnyOf=function(){var i=He.apply(K,arguments);return i.every(function(o){return typeof o=="string"})?i.length===0?zn(this):this.inAnyRange(i.map(function(o){return[o,o+bn]})):kt(this,"startsWithAnyOf() only works with strings")},ct);function ct(){}function Ut(i){return Le(function(o){return Vn(o),i(o.target.error),!1})}function Vn(i){i.stopPropagation&&i.stopPropagation(),i.preventDefault&&i.preventDefault()}var Yn="storagemutated",ls="x-storagemutated-1",cn=Wn(null,Yn),Sa=(Wt.prototype._lock=function(){return ae(!Y.global),++this._reculock,this._reculock!==1||Y.global||(Y.lockOwnerFor=this),this},Wt.prototype._unlock=function(){if(ae(!Y.global),--this._reculock==0)for(Y.global||(Y.lockOwnerFor=null);0<this._blockedFuncs.length&&!this._locked();){var i=this._blockedFuncs.shift();try{gn(i[1],i[0])}catch{}}return this},Wt.prototype._locked=function(){return this._reculock&&Y.lockOwnerFor!==this},Wt.prototype.create=function(i){var o=this;if(!this.mode)return this;var l=this.db.idbdb,u=this.db._state.dbOpenError;if(ae(!this.idbtrans),!i&&!l)switch(u&&u.name){case"DatabaseClosedError":throw new Q.DatabaseClosed(u);case"MissingAPIError":throw new Q.MissingAPI(u.message,u);default:throw new Q.OpenFailed(u)}if(!this.active)throw new Q.TransactionInactive;return ae(this._completion._state===null),(i=this.idbtrans=i||(this.db.core||l).transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability})).onerror=Le(function(d){Vn(d),o._reject(i.error)}),i.onabort=Le(function(d){Vn(d),o.active&&o._reject(new Q.Abort(i.error)),o.active=!1,o.on("abort").fire(d)}),i.oncomplete=Le(function(){o.active=!1,o._resolve(),"mutatedParts"in i&&cn.storagemutated.fire(i.mutatedParts)}),this},Wt.prototype._promise=function(i,o,l){var u=this;if(i==="readwrite"&&this.mode!=="readwrite")return et(new Q.ReadOnly("Transaction is readonly"));if(!this.active)return et(new Q.TransactionInactive);if(this._locked())return new X(function(h,g){u._blockedFuncs.push([function(){u._promise(i,o,l).then(h,g)},Y])});if(l)return sn(function(){var h=new X(function(g,y){u._lock();var C=o(g,y,u);C&&C.then&&C.then(g,y)});return h.finally(function(){return u._unlock()}),h._lib=!0,h});var d=new X(function(h,g){var y=o(h,g,u);y&&y.then&&y.then(h,g)});return d._lib=!0,d},Wt.prototype._root=function(){return this.parent?this.parent._root():this},Wt.prototype.waitFor=function(i){var o,l=this._root(),u=X.resolve(i);l._waitingFor?l._waitingFor=l._waitingFor.then(function(){return u}):(l._waitingFor=u,l._waitingQueue=[],o=l.idbtrans.objectStore(l.storeNames[0]),(function h(){for(++l._spinCount;l._waitingQueue.length;)l._waitingQueue.shift()();l._waitingFor&&(o.get(-1/0).onsuccess=h)})());var d=l._waitingFor;return new X(function(h,g){u.then(function(y){return l._waitingQueue.push(Le(h.bind(null,y)))},function(y){return l._waitingQueue.push(Le(g.bind(null,y)))}).finally(function(){l._waitingFor===d&&(l._waitingFor=null)})})},Wt.prototype.abort=function(){this.active&&(this.active=!1,this.idbtrans&&this.idbtrans.abort(),this._reject(new Q.Abort))},Wt.prototype.table=function(i){var o=this._memoizedTables||(this._memoizedTables={});if(k(o,i))return o[i];var l=this.schema[i];if(!l)throw new Q.NotFound("Table "+i+" not part of transaction");return l=new this.db.Table(i,l,this),l.core=this.db.core.table(i),o[i]=l},Wt);function Wt(){}function cs(i,o,l,u,d,h,g){return{name:i,keyPath:o,unique:l,multi:u,auto:d,compound:h,src:(l&&!g?"&":"")+(u?"*":"")+(d?"++":"")+wi(o)}}function wi(i){return typeof i=="string"?i:i?"["+[].join.call(i,"+")+"]":""}function us(i,o,l){return{name:i,primKey:o,indexes:l,mappedClass:null,idxByName:(u=function(d){return[d.name,d]},l.reduce(function(d,h,g){return g=u(h,g),g&&(d[g[0]]=g[1]),d},{}))};var u}var Xn=function(i){try{return i.only([[]]),Xn=function(){return[[]]},[[]]}catch{return Xn=function(){return bn},bn}};function ds(i){return i==null?function(){}:typeof i=="string"?(o=i).split(".").length===1?function(l){return l[o]}:function(l){return Te(l,o)}:function(l){return Te(l,i)};var o}function vi(i){return[].slice.call(i)}var _a=0;function Gn(i){return i==null?":id":typeof i=="string"?i:"[".concat(i.join("+"),"]")}function Aa(i,o,C){function u(A){if(A.type===3)return null;if(A.type===4)throw new Error("Cannot convert never type to IDBKeyRange");var E=A.lower,P=A.upper,D=A.lowerOpen,A=A.upperOpen;return E===void 0?P===void 0?null:o.upperBound(P,!!A):P===void 0?o.lowerBound(E,!!D):o.bound(E,P,!!D,!!A)}function d(j){var E,P=j.name;return{name:P,schema:j,mutate:function(D){var A=D.trans,R=D.type,I=D.keys,L=D.values,B=D.range;return new Promise(function(U,J){U=Le(U);var W=A.objectStore(P),V=W.keyPath==null,Z=R==="put"||R==="add";if(!Z&&R!=="delete"&&R!=="deleteRange")throw new Error("Invalid operation type: "+R);var G,se=(I||L||{length:1}).length;if(I&&L&&I.length!==L.length)throw new Error("Given keys array must have same length as given values array.");if(se===0)return U({numFailures:0,failures:{},results:[],lastResult:void 0});function pe(wt){++St,Vn(wt)}var ye=[],we=[],St=0;if(R==="deleteRange"){if(B.type===4)return U({numFailures:St,failures:we,results:[],lastResult:void 0});B.type===3?ye.push(G=W.clear()):ye.push(G=W.delete(u(B)))}else{var V=Z?V?[L,I]:[L,null]:[I,null],he=V[0],pt=V[1];if(Z)for(var mt=0;mt<se;++mt)ye.push(G=pt&&pt[mt]!==void 0?W[R](he[mt],pt[mt]):W[R](he[mt])),G.onerror=pe;else for(mt=0;mt<se;++mt)ye.push(G=W[R](he[mt])),G.onerror=pe}function Tr(wt){wt=wt.target.result,ye.forEach(function(xn,Ps){return xn.error!=null&&(we[Ps]=xn.error)}),U({numFailures:St,failures:we,results:R==="delete"?I:ye.map(function(xn){return xn.result}),lastResult:wt})}G.onerror=function(wt){pe(wt),Tr(wt)},G.onsuccess=Tr})},getMany:function(D){var A=D.trans,R=D.keys;return new Promise(function(I,L){I=Le(I);for(var B,U=A.objectStore(P),J=R.length,W=new Array(J),V=0,Z=0,G=function(ye){ye=ye.target,W[ye._pos]=ye.result,++Z===V&&I(W)},se=Ut(L),pe=0;pe<J;++pe)R[pe]!=null&&((B=U.get(R[pe]))._pos=pe,B.onsuccess=G,B.onerror=se,++V);V===0&&I(W)})},get:function(D){var A=D.trans,R=D.key;return new Promise(function(I,L){I=Le(I);var B=A.objectStore(P).get(R);B.onsuccess=function(U){return I(U.target.result)},B.onerror=Ut(L)})},query:(E=_,function(D){return new Promise(function(A,R){A=Le(A);var I,L,B,V=D.trans,U=D.values,J=D.limit,G=D.query,W=J===1/0?void 0:J,Z=G.index,G=G.range,V=V.objectStore(P),Z=Z.isPrimaryKey?V:V.index(Z.name),G=u(G);if(J===0)return A({result:[]});E?((W=U?Z.getAll(G,W):Z.getAllKeys(G,W)).onsuccess=function(se){return A({result:se.target.result})},W.onerror=Ut(R)):(I=0,L=!U&&"openKeyCursor"in Z?Z.openKeyCursor(G):Z.openCursor(G),B=[],L.onsuccess=function(se){var pe=L.result;return pe?(B.push(U?pe.value:pe.primaryKey),++I===J?A({result:B}):void pe.continue()):A({result:B})},L.onerror=Ut(R))})}),openCursor:function(D){var A=D.trans,R=D.values,I=D.query,L=D.reverse,B=D.unique;return new Promise(function(U,J){U=Le(U);var Z=I.index,W=I.range,V=A.objectStore(P),V=Z.isPrimaryKey?V:V.index(Z.name),Z=L?B?"prevunique":"prev":B?"nextunique":"next",G=!R&&"openKeyCursor"in V?V.openKeyCursor(u(W),Z):V.openCursor(u(W),Z);G.onerror=Ut(J),G.onsuccess=Le(function(se){var pe,ye,we,St,he=G.result;he?(he.___id=++_a,he.done=!1,pe=he.continue.bind(he),ye=(ye=he.continuePrimaryKey)&&ye.bind(he),we=he.advance.bind(he),St=function(){throw new Error("Cursor not stopped")},he.trans=A,he.stop=he.continue=he.continuePrimaryKey=he.advance=function(){throw new Error("Cursor not started")},he.fail=Le(J),he.next=function(){var pt=this,mt=1;return this.start(function(){return mt--?pt.continue():pt.stop()}).then(function(){return pt})},he.start=function(pt){function mt(){if(G.result)try{pt()}catch(wt){he.fail(wt)}else he.done=!0,he.start=function(){throw new Error("Cursor behind last entry")},he.stop()}var Tr=new Promise(function(wt,xn){wt=Le(wt),G.onerror=Ut(xn),he.fail=xn,he.stop=function(Ps){he.stop=he.continue=he.continuePrimaryKey=he.advance=St,wt(Ps)}});return G.onsuccess=Le(function(wt){G.onsuccess=mt,mt()}),he.continue=pe,he.continuePrimaryKey=ye,he.advance=we,mt(),Tr},U(he)):U(null)},J)})},count:function(D){var A=D.query,R=D.trans,I=A.index,L=A.range;return new Promise(function(B,U){var J=R.objectStore(P),W=I.isPrimaryKey?J:J.index(I.name),J=u(L),W=J?W.count(J):W.count();W.onsuccess=Le(function(V){return B(V.target.result)}),W.onerror=Ut(U)})}}}var h,g,y,T=(g=C,y=vi((h=i).objectStoreNames),{schema:{name:h.name,tables:y.map(function(j){return g.objectStore(j)}).map(function(j){var E=j.keyPath,A=j.autoIncrement,P=f(E),D={},A={name:j.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:E==null,compound:P,keyPath:E,autoIncrement:A,unique:!0,extractKey:ds(E)},indexes:vi(j.indexNames).map(function(R){return j.index(R)}).map(function(B){var I=B.name,L=B.unique,U=B.multiEntry,B=B.keyPath,U={name:I,compound:f(B),keyPath:B,unique:L,multiEntry:U,extractKey:ds(B)};return D[Gn(B)]=U}),getIndexByKeyPath:function(R){return D[Gn(R)]}};return D[":id"]=A.primaryKey,E!=null&&(D[Gn(E)]=A.primaryKey),A})},hasGetAll:0<y.length&&"getAll"in g.objectStore(y[0])&&!(typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604)}),C=T.schema,_=T.hasGetAll,T=C.tables.map(d),w={};return T.forEach(function(j){return w[j.name]=j}),{stack:"dbcore",transaction:i.transaction.bind(i),table:function(j){if(!w[j])throw new Error("Table '".concat(j,"' not found"));return w[j]},MIN_KEY:-1/0,MAX_KEY:Xn(o),schema:C}}function Pa(i,o,l,u){var d=l.IDBKeyRange;return l.indexedDB,{dbcore:(u=Aa(o,d,u),i.dbcore.reduce(function(h,g){return g=g.create,s(s({},h),g(h))},u))}}function yr(i,u){var l=u.db,u=Pa(i._middlewares,l,i._deps,u);i.core=u.dbcore,i.tables.forEach(function(d){var h=d.name;i.core.schema.tables.some(function(g){return g.name===h})&&(d.core=i.core.table(h),i[h]instanceof i.Table&&(i[h].core=d.core))})}function wr(i,o,l,u){l.forEach(function(d){var h=u[d];o.forEach(function(g){var y=(function C(_,T){return ne(_,T)||(_=$(_))&&C(_,T)})(g,d);(!y||"value"in y&&y.value===void 0)&&(g===i.Transaction.prototype||g instanceof i.Transaction?q(g,d,{get:function(){return this.table(d)},set:function(C){M(this,d,{value:C,writable:!0,configurable:!0,enumerable:!0})}}):g[d]=new i.Table(d,h))})})}function fs(i,o){o.forEach(function(l){for(var u in l)l[u]instanceof i.Table&&delete l[u]})}function Ta(i,o){return i._cfg.version-o._cfg.version}function Da(i,o,l,u){var d=i._dbSchema;l.objectStoreNames.contains("$meta")&&!d.$meta&&(d.$meta=us("$meta",$i("")[0],[]),i._storeNames.push("$meta"));var h=i._createTransaction("readwrite",i._storeNames,d);h.create(l),h._completion.catch(u);var g=h._reject.bind(h),y=Y.transless||Y;sn(function(){return Y.trans=h,Y.transless=y,o!==0?(yr(i,l),_=o,((C=h).storeNames.includes("$meta")?C.table("$meta").get("version").then(function(T){return T??_}):X.resolve(_)).then(function(T){return j=T,E=h,P=l,D=[],T=(w=i)._versions,A=w._dbSchema=xr(0,w.idbdb,P),(T=T.filter(function(R){return R._cfg.version>=j})).length!==0?(T.forEach(function(R){D.push(function(){var I=A,L=R._cfg.dbschema;$r(w,I,P),$r(w,L,P),A=w._dbSchema=L;var B=hs(I,L);B.add.forEach(function(Z){ps(P,Z[0],Z[1].primKey,Z[1].indexes)}),B.change.forEach(function(Z){if(Z.recreate)throw new Q.Upgrade("Not yet support for changing primary key");var G=P.objectStore(Z.name);Z.add.forEach(function(se){return vr(G,se)}),Z.change.forEach(function(se){G.deleteIndex(se.name),vr(G,se)}),Z.del.forEach(function(se){return G.deleteIndex(se)})});var U=R._cfg.contentUpgrade;if(U&&R._cfg.version>j){yr(w,P),E._memoizedTables={};var J=Ot(L);B.del.forEach(function(Z){J[Z]=I[Z]}),fs(w,[w.Transaction.prototype]),wr(w,[w.Transaction.prototype],c(J),J),E.schema=J;var W,V=rt(U);return V&&Fn(),B=X.follow(function(){var Z;(W=U(E))&&V&&(Z=on.bind(null,null),W.then(Z,Z))}),W&&typeof W.then=="function"?X.resolve(W):B.then(function(){return W})}}),D.push(function(I){var L,B,U=R._cfg.dbschema;L=U,B=I,[].slice.call(B.db.objectStoreNames).forEach(function(J){return L[J]==null&&B.db.deleteObjectStore(J)}),fs(w,[w.Transaction.prototype]),wr(w,[w.Transaction.prototype],w._storeNames,w._dbSchema),E.schema=w._dbSchema}),D.push(function(I){w.idbdb.objectStoreNames.contains("$meta")&&(Math.ceil(w.idbdb.version/10)===R._cfg.version?(w.idbdb.deleteObjectStore("$meta"),delete w._dbSchema.$meta,w._storeNames=w._storeNames.filter(function(L){return L!=="$meta"})):I.objectStore("$meta").put(R._cfg.version,"version"))})}),(function R(){return D.length?X.resolve(D.shift()(E.idbtrans)).then(R):X.resolve()})().then(function(){xi(A,P)})):X.resolve();var w,j,E,P,D,A}).catch(g)):(c(d).forEach(function(T){ps(l,T,d[T].primKey,d[T].indexes)}),yr(i,l),void X.follow(function(){return i.on.populate.fire(h)}).catch(g));var C,_})}function ja(i,o){xi(i._dbSchema,o),o.db.version%10!=0||o.objectStoreNames.contains("$meta")||o.db.createObjectStore("$meta").add(Math.ceil(o.db.version/10-1),"version");var l=xr(0,i.idbdb,o);$r(i,i._dbSchema,o);for(var u=0,d=hs(l,i._dbSchema).change;u<d.length;u++){var h=(function(g){if(g.change.length||g.recreate)return console.warn("Unable to patch indexes of table ".concat(g.name," because it has changes on the type of index or primary key.")),{value:void 0};var y=o.objectStore(g.name);g.add.forEach(function(C){Pe&&console.debug("Dexie upgrade patch: Creating missing index ".concat(g.name,".").concat(C.src)),vr(y,C)})})(d[u]);if(typeof h=="object")return h.value}}function hs(i,o){var l,u={del:[],add:[],change:[]};for(l in i)o[l]||u.del.push(l);for(l in o){var d=i[l],h=o[l];if(d){var g={name:l,def:h,recreate:!1,del:[],add:[],change:[]};if(""+(d.primKey.keyPath||"")!=""+(h.primKey.keyPath||"")||d.primKey.auto!==h.primKey.auto)g.recreate=!0,u.change.push(g);else{var y=d.idxByName,C=h.idxByName,_=void 0;for(_ in y)C[_]||g.del.push(_);for(_ in C){var T=y[_],w=C[_];T?T.src!==w.src&&g.change.push(w):g.add.push(w)}(0<g.del.length||0<g.add.length||0<g.change.length)&&u.change.push(g)}}else u.add.push([l,h])}return u}function ps(i,o,l,u){var d=i.db.createObjectStore(o,l.keyPath?{keyPath:l.keyPath,autoIncrement:l.auto}:{autoIncrement:l.auto});return u.forEach(function(h){return vr(d,h)}),d}function xi(i,o){c(i).forEach(function(l){o.db.objectStoreNames.contains(l)||(Pe&&console.debug("Dexie: Creating missing table",l),ps(o,l,i[l].primKey,i[l].indexes))})}function vr(i,o){i.createIndex(o.name,o.keyPath,{unique:o.unique,multiEntry:o.multi})}function xr(i,o,l){var u={};return me(o.objectStoreNames,0).forEach(function(d){for(var h=l.objectStore(d),g=cs(wi(_=h.keyPath),_||"",!0,!1,!!h.autoIncrement,_&&typeof _!="string",!0),y=[],C=0;C<h.indexNames.length;++C){var T=h.index(h.indexNames[C]),_=T.keyPath,T=cs(T.name,_,!!T.unique,!!T.multiEntry,!1,_&&typeof _!="string",!1);y.push(T)}u[d]=us(d,g,y)}),u}function $r(i,o,l){for(var u=l.db.objectStoreNames,d=0;d<u.length;++d){var h=u[d],g=l.objectStore(h);i._hasGetAll="getAll"in g;for(var y=0;y<g.indexNames.length;++y){var C=g.indexNames[y],_=g.index(C).keyPath,T=typeof _=="string"?_:"["+me(_).join("+")+"]";!o[h]||(_=o[h].idxByName[T])&&(_.name=C,delete o[h].idxByName[T],o[h].idxByName[C]=_)}}typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&a.WorkerGlobalScope&&a instanceof a.WorkerGlobalScope&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604&&(i._hasGetAll=!1)}function $i(i){return i.split(",").map(function(o,l){var u=(o=o.trim()).replace(/([&*]|\+\+)/g,""),d=/^\[/.test(u)?u.match(/^\[(.*)\]$/)[1].split("+"):u;return cs(u,d||null,/\&/.test(o),/\*/.test(o),/\+\+/.test(o),f(d),l===0)})}var Fa=(Cr.prototype._parseStoresSpec=function(i,o){c(i).forEach(function(l){if(i[l]!==null){var u=$i(i[l]),d=u.shift();if(d.unique=!0,d.multi)throw new Q.Schema("Primary key cannot be multi-valued");u.forEach(function(h){if(h.auto)throw new Q.Schema("Only primary key can be marked as autoIncrement (++)");if(!h.keyPath)throw new Q.Schema("Index must have a name and cannot be an empty string")}),o[l]=us(l,d,u)}})},Cr.prototype.stores=function(l){var o=this.db;this._cfg.storesSource=this._cfg.storesSource?p(this._cfg.storesSource,l):l;var l=o._versions,u={},d={};return l.forEach(function(h){p(u,h._cfg.storesSource),d=h._cfg.dbschema={},h._parseStoresSpec(u,d)}),o._dbSchema=d,fs(o,[o._allTables,o,o.Transaction.prototype]),wr(o,[o._allTables,o,o.Transaction.prototype,this._cfg.tables],c(d),d),o._storeNames=c(d),this},Cr.prototype.upgrade=function(i){return this._cfg.contentUpgrade=Ct(this._cfg.contentUpgrade||ue,i),this},Cr);function Cr(){}function ms(i,o){var l=i._dbNamesDB;return l||(l=i._dbNamesDB=new Jt(hr,{addons:[],indexedDB:i,IDBKeyRange:o})).version(1).stores({dbnames:"name"}),l.table("dbnames")}function gs(i){return i&&typeof i.databases=="function"}function bs(i){return sn(function(){return Y.letThrough=!0,i()})}function ys(i){return!("from"in i)}var ht=function(i,o){if(!this){var l=new ht;return i&&"d"in i&&p(l,i),l}p(this,arguments.length?{d:1,from:i,to:1<arguments.length?o:i}:{d:0})};function Jn(i,o,l){var u=Ce(o,l);if(!isNaN(u)){if(0<u)throw RangeError();if(ys(i))return p(i,{from:o,to:l,d:1});var d=i.l,u=i.r;if(Ce(l,i.from)<0)return d?Jn(d,o,l):i.l={from:o,to:l,d:1,l:null,r:null},Ei(i);if(0<Ce(o,i.to))return u?Jn(u,o,l):i.r={from:o,to:l,d:1,l:null,r:null},Ei(i);Ce(o,i.from)<0&&(i.from=o,i.l=null,i.d=u?u.d+1:1),0<Ce(l,i.to)&&(i.to=l,i.r=null,i.d=i.l?i.l.d+1:1),l=!i.r,d&&!i.l&&Qn(i,d),u&&l&&Qn(i,u)}}function Qn(i,o){ys(o)||(function l(u,C){var h=C.from,g=C.to,y=C.l,C=C.r;Jn(u,h,g),y&&l(u,y),C&&l(u,C)})(i,o)}function Ci(i,o){var l=Er(o),u=l.next();if(u.done)return!1;for(var d=u.value,h=Er(i),g=h.next(d.from),y=g.value;!u.done&&!g.done;){if(Ce(y.from,d.to)<=0&&0<=Ce(y.to,d.from))return!0;Ce(d.from,y.from)<0?d=(u=l.next(y.from)).value:y=(g=h.next(d.from)).value}return!1}function Er(i){var o=ys(i)?null:{s:0,n:i};return{next:function(l){for(var u=0<arguments.length;o;)switch(o.s){case 0:if(o.s=1,u)for(;o.n.l&&Ce(l,o.n.from)<0;)o={up:o,n:o.n.l,s:1};else for(;o.n.l;)o={up:o,n:o.n.l,s:1};case 1:if(o.s=2,!u||Ce(l,o.n.to)<=0)return{value:o.n,done:!1};case 2:if(o.n.r){o.s=3,o={up:o,n:o.n.r,s:0};continue}case 3:o=o.up}return{done:!0}}}}function Ei(i){var o,l,u=(((o=i.r)===null||o===void 0?void 0:o.d)||0)-(((l=i.l)===null||l===void 0?void 0:l.d)||0),d=1<u?"r":u<-1?"l":"";d&&(o=d=="r"?"l":"r",l=s({},i),u=i[d],i.from=u.from,i.to=u.to,i[d]=u[d],l[d]=u[o],(i[o]=l).d=ki(l)),i.d=ki(i)}function ki(l){var o=l.r,l=l.l;return(o?l?Math.max(o.d,l.d):o.d:l?l.d:0)+1}function kr(i,o){return c(o).forEach(function(l){i[l]?Qn(i[l],o[l]):i[l]=(function u(d){var h,g,y={};for(h in d)k(d,h)&&(g=d[h],y[h]=!g||typeof g!="object"||m.has(g.constructor)?g:u(g));return y})(o[l])}),i}function ws(i,o){return i.all||o.all||Object.keys(i).some(function(l){return o[l]&&Ci(o[l],i[l])})}z(ht.prototype,((Tt={add:function(i){return Qn(this,i),this},addKey:function(i){return Jn(this,i,i),this},addKeys:function(i){var o=this;return i.forEach(function(l){return Jn(o,l,l)}),this},hasKey:function(i){var o=Er(this).next(i).value;return o&&Ce(o.from,i)<=0&&0<=Ce(o.to,i)}})[le]=function(){return Er(this)},Tt));var wn={},vs={},xs=!1;function Sr(i){kr(vs,i),xs||(xs=!0,setTimeout(function(){xs=!1,$s(vs,!(vs={}))},0))}function $s(i,o){o===void 0&&(o=!1);var l=new Set;if(i.all)for(var u=0,d=Object.values(wn);u<d.length;u++)Si(g=d[u],i,l,o);else for(var h in i){var g,y=/^idb\:\/\/(.*)\/(.*)\//.exec(h);y&&(h=y[1],y=y[2],(g=wn["idb://".concat(h,"/").concat(y)])&&Si(g,i,l,o))}l.forEach(function(C){return C()})}function Si(i,o,l,u){for(var d=[],h=0,g=Object.entries(i.queries.query);h<g.length;h++){for(var y=g[h],C=y[0],_=[],T=0,w=y[1];T<w.length;T++){var j=w[T];ws(o,j.obsSet)?j.subscribers.forEach(function(A){return l.add(A)}):u&&_.push(j)}u&&d.push([C,_])}if(u)for(var E=0,P=d;E<P.length;E++){var D=P[E],C=D[0],_=D[1];i.queries.query[C]=_}}function Oa(i){var o=i._state,l=i._deps.indexedDB;if(o.isBeingOpened||i.idbdb)return o.dbReadyPromise.then(function(){return o.dbOpenError?et(o.dbOpenError):i});o.isBeingOpened=!0,o.dbOpenError=null,o.openComplete=!1;var u=o.openCanceller,d=Math.round(10*i.verno),h=!1;function g(){if(o.openCanceller!==u)throw new Q.DatabaseClosed("db.open() was cancelled")}function y(){return new X(function(j,E){if(g(),!l)throw new Q.MissingAPI;var P=i.name,D=o.autoSchema||!d?l.open(P):l.open(P,d);if(!D)throw new Q.MissingAPI;D.onerror=Ut(E),D.onblocked=Le(i._fireOnBlocked),D.onupgradeneeded=Le(function(A){var R;T=D.transaction,o.autoSchema&&!i._options.allowEmptyDB?(D.onerror=Vn,T.abort(),D.result.close(),(R=l.deleteDatabase(P)).onsuccess=R.onerror=Le(function(){E(new Q.NoSuchDatabase("Database ".concat(P," doesnt exist")))})):(T.onerror=Ut(E),A=A.oldVersion>Math.pow(2,62)?0:A.oldVersion,w=A<1,i.idbdb=D.result,h&&ja(i,T),Da(i,A/10,T,E))},E),D.onsuccess=Le(function(){T=null;var A,R,I,L,B,U=i.idbdb=D.result,J=me(U.objectStoreNames);if(0<J.length)try{var W=U.transaction((L=J).length===1?L[0]:L,"readonly");if(o.autoSchema)R=U,I=W,(A=i).verno=R.version/10,I=A._dbSchema=xr(0,R,I),A._storeNames=me(R.objectStoreNames,0),wr(A,[A._allTables],c(I),I);else if($r(i,i._dbSchema,W),((B=hs(xr(0,(B=i).idbdb,W),B._dbSchema)).add.length||B.change.some(function(V){return V.add.length||V.change.length}))&&!h)return console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Dexie will add missing parts and increment native version number to workaround this."),U.close(),d=U.version+1,h=!0,j(y());yr(i,W)}catch{}On.push(i),U.onversionchange=Le(function(V){o.vcFired=!0,i.on("versionchange").fire(V)}),U.onclose=Le(function(V){i.on("close").fire(V)}),w&&(B=i._deps,W=P,U=B.indexedDB,B=B.IDBKeyRange,gs(U)||W===hr||ms(U,B).put({name:W}).catch(ue)),j()},E)}).catch(function(j){switch(j?.name){case"UnknownError":if(0<o.PR1398_maxLoop)return o.PR1398_maxLoop--,console.warn("Dexie: Workaround for Chrome UnknownError on open()"),y();break;case"VersionError":if(0<d)return d=0,y()}return X.reject(j)})}var C,_=o.dbReadyResolve,T=null,w=!1;return X.race([u,(typeof navigator>"u"?X.resolve():!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent)&&indexedDB.databases?new Promise(function(j){function E(){return indexedDB.databases().finally(j)}C=setInterval(E,100),E()}).finally(function(){return clearInterval(C)}):Promise.resolve()).then(y)]).then(function(){return g(),o.onReadyBeingFired=[],X.resolve(bs(function(){return i.on.ready.fire(i.vip)})).then(function j(){if(0<o.onReadyBeingFired.length){var E=o.onReadyBeingFired.reduce(Ct,ue);return o.onReadyBeingFired=[],X.resolve(bs(function(){return E(i.vip)})).then(j)}})}).finally(function(){o.openCanceller===u&&(o.onReadyBeingFired=null,o.isBeingOpened=!1)}).catch(function(j){o.dbOpenError=j;try{T&&T.abort()}catch{}return u===o.openCanceller&&i._close(),et(j)}).finally(function(){o.openComplete=!0,_()}).then(function(){var j;return w&&(j={},i.tables.forEach(function(E){E.schema.indexes.forEach(function(P){P.name&&(j["idb://".concat(i.name,"/").concat(E.name,"/").concat(P.name)]=new ht(-1/0,[[[]]]))}),j["idb://".concat(i.name,"/").concat(E.name,"/")]=j["idb://".concat(i.name,"/").concat(E.name,"/:dels")]=new ht(-1/0,[[[]]])}),cn(Yn).fire(j),$s(j,!0)),i})}function Cs(i){function o(h){return i.next(h)}var l=d(o),u=d(function(h){return i.throw(h)});function d(h){return function(C){var y=h(C),C=y.value;return y.done?C:C&&typeof C.then=="function"?C.then(l,u):f(C)?Promise.all(C).then(l,u):l(C)}}return d(o)()}function _r(i,o,l){for(var u=f(i)?i.slice():[i],d=0;d<l;++d)u.push(o);return u}var Ra={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:function(i){return s(s({},i),{table:function(o){var l=i.table(o),u=l.schema,d={},h=[];function g(w,j,E){var P=Gn(w),D=d[P]=d[P]||[],A=w==null?0:typeof w=="string"?1:w.length,R=0<j,R=s(s({},E),{name:R?"".concat(P,"(virtual-from:").concat(E.name,")"):E.name,lowLevelIndex:E,isVirtual:R,keyTail:j,keyLength:A,extractKey:ds(w),unique:!R&&E.unique});return D.push(R),R.isPrimaryKey||h.push(R),1<A&&g(A===2?w[0]:w.slice(0,A-1),j+1,E),D.sort(function(I,L){return I.keyTail-L.keyTail}),R}o=g(u.primaryKey.keyPath,0,u.primaryKey),d[":id"]=[o];for(var y=0,C=u.indexes;y<C.length;y++){var _=C[y];g(_.keyPath,0,_)}function T(w){var j,E=w.query.index;return E.isVirtual?s(s({},w),{query:{index:E.lowLevelIndex,range:(j=w.query.range,E=E.keyTail,{type:j.type===1?2:j.type,lower:_r(j.lower,j.lowerOpen?i.MAX_KEY:i.MIN_KEY,E),lowerOpen:!0,upper:_r(j.upper,j.upperOpen?i.MIN_KEY:i.MAX_KEY,E),upperOpen:!0})}}):w}return s(s({},l),{schema:s(s({},u),{primaryKey:o,indexes:h,getIndexByKeyPath:function(w){return(w=d[Gn(w)])&&w[0]}}),count:function(w){return l.count(T(w))},query:function(w){return l.query(T(w))},openCursor:function(w){var j=w.query.index,E=j.keyTail,P=j.isVirtual,D=j.keyLength;return P?l.openCursor(T(w)).then(function(R){return R&&A(R)}):l.openCursor(w);function A(R){return Object.create(R,{continue:{value:function(I){I!=null?R.continue(_r(I,w.reverse?i.MAX_KEY:i.MIN_KEY,E)):w.unique?R.continue(R.key.slice(0,D).concat(w.reverse?i.MIN_KEY:i.MAX_KEY,E)):R.continue()}},continuePrimaryKey:{value:function(I,L){R.continuePrimaryKey(_r(I,i.MAX_KEY,E),L)}},primaryKey:{get:function(){return R.primaryKey}},key:{get:function(){var I=R.key;return D===1?I[0]:I.slice(0,D)}},value:{get:function(){return R.value}}})}}})}})}};function Es(i,o,l,u){return l=l||{},u=u||"",c(i).forEach(function(d){var h,g,y;k(o,d)?(h=i[d],g=o[d],typeof h=="object"&&typeof g=="object"&&h&&g?(y=x(h))!==x(g)?l[u+d]=o[d]:y==="Object"?Es(h,g,l,u+d+"."):h!==g&&(l[u+d]=o[d]):h!==g&&(l[u+d]=o[d])):l[u+d]=void 0}),c(o).forEach(function(d){k(i,d)||(l[u+d]=o[d])}),l}function ks(i,o){return o.type==="delete"?o.keys:o.keys||o.values.map(i.extractKey)}var za={stack:"dbcore",name:"HooksMiddleware",level:2,create:function(i){return s(s({},i),{table:function(o){var l=i.table(o),u=l.schema.primaryKey;return s(s({},l),{mutate:function(d){var h=Y.trans,g=h.table(o).hook,y=g.deleting,C=g.creating,_=g.updating;switch(d.type){case"add":if(C.fire===ue)break;return h._promise("readwrite",function(){return T(d)},!0);case"put":if(C.fire===ue&&_.fire===ue)break;return h._promise("readwrite",function(){return T(d)},!0);case"delete":if(y.fire===ue)break;return h._promise("readwrite",function(){return T(d)},!0);case"deleteRange":if(y.fire===ue)break;return h._promise("readwrite",function(){return(function w(j,E,P){return l.query({trans:j,values:!1,query:{index:u,range:E},limit:P}).then(function(D){var A=D.result;return T({type:"delete",keys:A,trans:j}).then(function(R){return 0<R.numFailures?Promise.reject(R.failures[0]):A.length<P?{failures:[],numFailures:0,lastResult:void 0}:w(j,s(s({},E),{lower:A[A.length-1],lowerOpen:!0}),P)})})})(d.trans,d.range,1e4)},!0)}return l.mutate(d);function T(w){var j,E,P,D=Y.trans,A=w.keys||ks(u,w);if(!A)throw new Error("Keys missing");return(w=w.type==="add"||w.type==="put"?s(s({},w),{keys:A}):s({},w)).type!=="delete"&&(w.values=n([],w.values)),w.keys&&(w.keys=n([],w.keys)),j=l,P=A,((E=w).type==="add"?Promise.resolve([]):j.getMany({trans:E.trans,keys:P,cache:"immutable"})).then(function(R){var I=A.map(function(L,B){var U,J,W,V=R[B],Z={onerror:null,onsuccess:null};return w.type==="delete"?y.fire.call(Z,L,V,D):w.type==="add"||V===void 0?(U=C.fire.call(Z,L,w.values[B],D),L==null&&U!=null&&(w.keys[B]=L=U,u.outbound||We(w.values[B],u.keyPath,L))):(U=Es(V,w.values[B]),(J=_.fire.call(Z,U,L,V,D))&&(W=w.values[B],Object.keys(J).forEach(function(G){k(W,G)?W[G]=J[G]:We(W,G,J[G])}))),Z});return l.mutate(w).then(function(L){for(var B=L.failures,U=L.results,J=L.numFailures,L=L.lastResult,W=0;W<A.length;++W){var V=(U||A)[W],Z=I[W];V==null?Z.onerror&&Z.onerror(B[W]):Z.onsuccess&&Z.onsuccess(w.type==="put"&&R[W]?w.values[W]:V)}return{failures:B,results:U,numFailures:J,lastResult:L}}).catch(function(L){return I.forEach(function(B){return B.onerror&&B.onerror(L)}),Promise.reject(L)})})}}})}})}};function _i(i,o,l){try{if(!o||o.keys.length<i.length)return null;for(var u=[],d=0,h=0;d<o.keys.length&&h<i.length;++d)Ce(o.keys[d],i[h])===0&&(u.push(l?O(o.values[d]):o.values[d]),++h);return u.length===i.length?u:null}catch{return null}}var Ia={stack:"dbcore",level:-1,create:function(i){return{table:function(o){var l=i.table(o);return s(s({},l),{getMany:function(u){if(!u.cache)return l.getMany(u);var d=_i(u.keys,u.trans._cache,u.cache==="clone");return d?X.resolve(d):l.getMany(u).then(function(h){return u.trans._cache={keys:u.keys,values:u.cache==="clone"?O(h):h},h})},mutate:function(u){return u.type!=="add"&&(u.trans._cache=null),l.mutate(u)}})}}}};function Ai(i,o){return i.trans.mode==="readonly"&&!!i.subscr&&!i.trans.explicit&&i.trans.db._options.cache!=="disabled"&&!o.schema.primaryKey.outbound}function Pi(i,o){switch(i){case"query":return o.values&&!o.unique;case"get":case"getMany":case"count":case"openCursor":return!1}}var La={stack:"dbcore",level:0,name:"Observability",create:function(i){var o=i.schema.name,l=new ht(i.MIN_KEY,i.MAX_KEY);return s(s({},i),{transaction:function(u,d,h){if(Y.subscr&&d!=="readonly")throw new Q.ReadOnly("Readwrite transaction in liveQuery context. Querier source: ".concat(Y.querier));return i.transaction(u,d,h)},table:function(u){var d=i.table(u),h=d.schema,g=h.primaryKey,w=h.indexes,y=g.extractKey,C=g.outbound,_=g.autoIncrement&&w.filter(function(E){return E.compound&&E.keyPath.includes(g.keyPath)}),T=s(s({},d),{mutate:function(E){function P(G){return G="idb://".concat(o,"/").concat(u,"/").concat(G),L[G]||(L[G]=new ht)}var D,A,R,I=E.trans,L=E.mutatedParts||(E.mutatedParts={}),B=P(""),U=P(":dels"),J=E.type,Z=E.type==="deleteRange"?[E.range]:E.type==="delete"?[E.keys]:E.values.length<50?[ks(g,E).filter(function(G){return G}),E.values]:[],W=Z[0],V=Z[1],Z=E.trans._cache;return f(W)?(B.addKeys(W),(Z=J==="delete"||W.length===V.length?_i(W,Z):null)||U.addKeys(W),(Z||V)&&(D=P,A=Z,R=V,h.indexes.forEach(function(G){var se=D(G.name||"");function pe(we){return we!=null?G.extractKey(we):null}function ye(we){return G.multiEntry&&f(we)?we.forEach(function(St){return se.addKey(St)}):se.addKey(we)}(A||R).forEach(function(we,pt){var he=A&&pe(A[pt]),pt=R&&pe(R[pt]);Ce(he,pt)!==0&&(he!=null&&ye(he),pt!=null&&ye(pt))})}))):W?(V={from:(V=W.lower)!==null&&V!==void 0?V:i.MIN_KEY,to:(V=W.upper)!==null&&V!==void 0?V:i.MAX_KEY},U.add(V),B.add(V)):(B.add(l),U.add(l),h.indexes.forEach(function(G){return P(G.name).add(l)})),d.mutate(E).then(function(G){return!W||E.type!=="add"&&E.type!=="put"||(B.addKeys(G.results),_&&_.forEach(function(se){for(var pe=E.values.map(function(he){return se.extractKey(he)}),ye=se.keyPath.findIndex(function(he){return he===g.keyPath}),we=0,St=G.results.length;we<St;++we)pe[we][ye]=G.results[we];P(se.name).addKeys(pe)})),I.mutatedParts=kr(I.mutatedParts||{},L),G})}}),w=function(P){var D=P.query,P=D.index,D=D.range;return[P,new ht((P=D.lower)!==null&&P!==void 0?P:i.MIN_KEY,(D=D.upper)!==null&&D!==void 0?D:i.MAX_KEY)]},j={get:function(E){return[g,new ht(E.key)]},getMany:function(E){return[g,new ht().addKeys(E.keys)]},count:w,query:w,openCursor:w};return c(j).forEach(function(E){T[E]=function(P){var D=Y.subscr,A=!!D,R=Ai(Y,d)&&Pi(E,P)?P.obsSet={}:D;if(A){var I=function(V){return V="idb://".concat(o,"/").concat(u,"/").concat(V),R[V]||(R[V]=new ht)},L=I(""),B=I(":dels"),D=j[E](P),A=D[0],D=D[1];if((E==="query"&&A.isPrimaryKey&&!P.values?B:I(A.name||"")).add(D),!A.isPrimaryKey){if(E!=="count"){var U=E==="query"&&C&&P.values&&d.query(s(s({},P),{values:!1}));return d[E].apply(this,arguments).then(function(V){if(E==="query"){if(C&&P.values)return U.then(function(pe){return pe=pe.result,L.addKeys(pe),V});var Z=P.values?V.result.map(y):V.result;(P.values?L:B).addKeys(Z)}else if(E==="openCursor"){var G=V,se=P.values;return G&&Object.create(G,{key:{get:function(){return B.addKey(G.primaryKey),G.key}},primaryKey:{get:function(){var pe=G.primaryKey;return B.addKey(pe),pe}},value:{get:function(){return se&&L.addKey(G.primaryKey),G.value}}})}return V})}B.add(l)}}return d[E].apply(this,arguments)}}),T}})}};function Ti(i,o,l){if(l.numFailures===0)return o;if(o.type==="deleteRange")return null;var u=o.keys?o.keys.length:"values"in o&&o.values?o.values.length:1;return l.numFailures===u?null:(o=s({},o),f(o.keys)&&(o.keys=o.keys.filter(function(d,h){return!(h in l.failures)})),"values"in o&&f(o.values)&&(o.values=o.values.filter(function(d,h){return!(h in l.failures)})),o)}function Ss(i,o){return l=i,((u=o).lower===void 0||(u.lowerOpen?0<Ce(l,u.lower):0<=Ce(l,u.lower)))&&(i=i,(o=o).upper===void 0||(o.upperOpen?Ce(i,o.upper)<0:Ce(i,o.upper)<=0));var l,u}function Di(i,o,j,u,d,h){if(!j||j.length===0)return i;var g=o.query.index,y=g.multiEntry,C=o.query.range,_=u.schema.primaryKey.extractKey,T=g.extractKey,w=(g.lowLevelIndex||g).extractKey,j=j.reduce(function(E,P){var D=E,A=[];if(P.type==="add"||P.type==="put")for(var R=new ht,I=P.values.length-1;0<=I;--I){var L,B=P.values[I],U=_(B);R.hasKey(U)||(L=T(B),(y&&f(L)?L.some(function(G){return Ss(G,C)}):Ss(L,C))&&(R.addKey(U),A.push(B)))}switch(P.type){case"add":var J=new ht().addKeys(o.values?E.map(function(se){return _(se)}):E),D=E.concat(o.values?A.filter(function(se){return se=_(se),!J.hasKey(se)&&(J.addKey(se),!0)}):A.map(function(se){return _(se)}).filter(function(se){return!J.hasKey(se)&&(J.addKey(se),!0)}));break;case"put":var W=new ht().addKeys(P.values.map(function(se){return _(se)}));D=E.filter(function(se){return!W.hasKey(o.values?_(se):se)}).concat(o.values?A:A.map(function(se){return _(se)}));break;case"delete":var V=new ht().addKeys(P.keys);D=E.filter(function(se){return!V.hasKey(o.values?_(se):se)});break;case"deleteRange":var Z=P.range;D=E.filter(function(se){return!Ss(_(se),Z)})}return D},i);return j===i?i:(j.sort(function(E,P){return Ce(w(E),w(P))||Ce(_(E),_(P))}),o.limit&&o.limit<1/0&&(j.length>o.limit?j.length=o.limit:i.length===o.limit&&j.length<o.limit&&(d.dirty=!0)),h?Object.freeze(j):j)}function ji(i,o){return Ce(i.lower,o.lower)===0&&Ce(i.upper,o.upper)===0&&!!i.lowerOpen==!!o.lowerOpen&&!!i.upperOpen==!!o.upperOpen}function Ba(i,o){return(function(l,u,d,h){if(l===void 0)return u!==void 0?-1:0;if(u===void 0)return 1;if((u=Ce(l,u))===0){if(d&&h)return 0;if(d)return 1;if(h)return-1}return u})(i.lower,o.lower,i.lowerOpen,o.lowerOpen)<=0&&0<=(function(l,u,d,h){if(l===void 0)return u!==void 0?1:0;if(u===void 0)return-1;if((u=Ce(l,u))===0){if(d&&h)return 0;if(d)return-1;if(h)return 1}return u})(i.upper,o.upper,i.upperOpen,o.upperOpen)}function Ma(i,o,l,u){i.subscribers.add(l),u.addEventListener("abort",function(){var d,h;i.subscribers.delete(l),i.subscribers.size===0&&(d=i,h=o,setTimeout(function(){d.subscribers.size===0&&N(h,d)},3e3))})}var Na={stack:"dbcore",level:0,name:"Cache",create:function(i){var o=i.schema.name;return s(s({},i),{transaction:function(l,u,d){var h,g,y=i.transaction(l,u,d);return u==="readwrite"&&(g=(h=new AbortController).signal,d=function(C){return function(){if(h.abort(),u==="readwrite"){for(var _=new Set,T=0,w=l;T<w.length;T++){var j=w[T],E=wn["idb://".concat(o,"/").concat(j)];if(E){var P=i.table(j),D=E.optimisticOps.filter(function(se){return se.trans===y});if(y._explicit&&C&&y.mutatedParts)for(var A=0,R=Object.values(E.queries.query);A<R.length;A++)for(var I=0,L=(J=R[A]).slice();I<L.length;I++)ws((W=L[I]).obsSet,y.mutatedParts)&&(N(J,W),W.subscribers.forEach(function(se){return _.add(se)}));else if(0<D.length){E.optimisticOps=E.optimisticOps.filter(function(se){return se.trans!==y});for(var B=0,U=Object.values(E.queries.query);B<U.length;B++)for(var J,W,V,Z=0,G=(J=U[B]).slice();Z<G.length;Z++)(W=G[Z]).res!=null&&y.mutatedParts&&(C&&!W.dirty?(V=Object.isFrozen(W.res),V=Di(W.res,W.req,D,P,W,V),W.dirty?(N(J,W),W.subscribers.forEach(function(se){return _.add(se)})):V!==W.res&&(W.res=V,W.promise=X.resolve({result:V}))):(W.dirty&&N(J,W),W.subscribers.forEach(function(se){return _.add(se)})))}}}_.forEach(function(se){return se()})}}},y.addEventListener("abort",d(!1),{signal:g}),y.addEventListener("error",d(!1),{signal:g}),y.addEventListener("complete",d(!0),{signal:g})),y},table:function(l){var u=i.table(l),d=u.schema.primaryKey;return s(s({},u),{mutate:function(h){var g=Y.trans;if(d.outbound||g.db._options.cache==="disabled"||g.explicit||g.idbtrans.mode!=="readwrite")return u.mutate(h);var y=wn["idb://".concat(o,"/").concat(l)];return y?(g=u.mutate(h),h.type!=="add"&&h.type!=="put"||!(50<=h.values.length||ks(d,h).some(function(C){return C==null}))?(y.optimisticOps.push(h),h.mutatedParts&&Sr(h.mutatedParts),g.then(function(C){0<C.numFailures&&(N(y.optimisticOps,h),(C=Ti(0,h,C))&&y.optimisticOps.push(C),h.mutatedParts&&Sr(h.mutatedParts))}),g.catch(function(){N(y.optimisticOps,h),h.mutatedParts&&Sr(h.mutatedParts)})):g.then(function(C){var _=Ti(0,s(s({},h),{values:h.values.map(function(T,w){var j;return C.failures[w]?T:(T=(j=d.keyPath)!==null&&j!==void 0&&j.includes(".")?O(T):s({},T),We(T,d.keyPath,C.results[w]),T)})}),C);y.optimisticOps.push(_),queueMicrotask(function(){return h.mutatedParts&&Sr(h.mutatedParts)})}),g):u.mutate(h)},query:function(h){if(!Ai(Y,u)||!Pi("query",h))return u.query(h);var g=((_=Y.trans)===null||_===void 0?void 0:_.db._options.cache)==="immutable",w=Y,y=w.requery,C=w.signal,_=(function(P,D,A,R){var I=wn["idb://".concat(P,"/").concat(D)];if(!I)return[];if(!(D=I.queries[A]))return[null,!1,I,null];var L=D[(R.query?R.query.index.name:null)||""];if(!L)return[null,!1,I,null];switch(A){case"query":var B=L.find(function(U){return U.req.limit===R.limit&&U.req.values===R.values&&ji(U.req.query.range,R.query.range)});return B?[B,!0,I,L]:[L.find(function(U){return("limit"in U.req?U.req.limit:1/0)>=R.limit&&(!R.values||U.req.values)&&Ba(U.req.query.range,R.query.range)}),!1,I,L];case"count":return B=L.find(function(U){return ji(U.req.query.range,R.query.range)}),[B,!!B,I,L]}})(o,l,"query",h),T=_[0],w=_[1],j=_[2],E=_[3];return T&&w?T.obsSet=h.obsSet:(w=u.query(h).then(function(P){var D=P.result;if(T&&(T.res=D),g){for(var A=0,R=D.length;A<R;++A)Object.freeze(D[A]);Object.freeze(D)}else P.result=O(D);return P}).catch(function(P){return E&&T&&N(E,T),Promise.reject(P)}),T={obsSet:h.obsSet,promise:w,subscribers:new Set,type:"query",req:h,dirty:!1},E?E.push(T):(E=[T],(j=j||(wn["idb://".concat(o,"/").concat(l)]={queries:{query:{},count:{}},objs:new Map,optimisticOps:[],unsignaledParts:{}})).queries.query[h.query.index.name||""]=E)),Ma(T,E,y,C),T.promise.then(function(P){return{result:Di(P.result,h,j?.optimisticOps,u,T,g)}})}})}})}};function Ar(i,o){return new Proxy(i,{get:function(l,u,d){return u==="db"?o:Reflect.get(l,u,d)}})}var Jt=(tt.prototype.version=function(i){if(isNaN(i)||i<.1)throw new Q.Type("Given version is not a positive number");if(i=Math.round(10*i)/10,this.idbdb||this._state.isBeingOpened)throw new Q.Schema("Cannot add version when database is open");this.verno=Math.max(this.verno,i);var o=this._versions,l=o.filter(function(u){return u._cfg.version===i})[0];return l||(l=new this.Version(i),o.push(l),o.sort(Ta),l.stores({}),this._state.autoSchema=!1,l)},tt.prototype._whenReady=function(i){var o=this;return this.idbdb&&(this._state.openComplete||Y.letThrough||this._vip)?i():new X(function(l,u){if(o._state.openComplete)return u(new Q.DatabaseClosed(o._state.dbOpenError));if(!o._state.isBeingOpened){if(!o._state.autoOpen)return void u(new Q.DatabaseClosed);o.open().catch(ue)}o._state.dbReadyPromise.then(l,u)}).then(i)},tt.prototype.use=function(i){var o=i.stack,l=i.create,u=i.level,d=i.name;return d&&this.unuse({stack:o,name:d}),i=this._middlewares[o]||(this._middlewares[o]=[]),i.push({stack:o,create:l,level:u??10,name:d}),i.sort(function(h,g){return h.level-g.level}),this},tt.prototype.unuse=function(i){var o=i.stack,l=i.name,u=i.create;return o&&this._middlewares[o]&&(this._middlewares[o]=this._middlewares[o].filter(function(d){return u?d.create!==u:!!l&&d.name!==l})),this},tt.prototype.open=function(){var i=this;return gn(Xe,function(){return Oa(i)})},tt.prototype._close=function(){var i=this._state,o=On.indexOf(this);if(0<=o&&On.splice(o,1),this.idbdb){try{this.idbdb.close()}catch{}this.idbdb=null}i.isBeingOpened||(i.dbReadyPromise=new X(function(l){i.dbReadyResolve=l}),i.openCanceller=new X(function(l,u){i.cancelOpen=u}))},tt.prototype.close=function(l){var o=(l===void 0?{disableAutoOpen:!0}:l).disableAutoOpen,l=this._state;o?(l.isBeingOpened&&l.cancelOpen(new Q.DatabaseClosed),this._close(),l.autoOpen=!1,l.dbOpenError=new Q.DatabaseClosed):(this._close(),l.autoOpen=this._options.autoOpen||l.isBeingOpened,l.openComplete=!1,l.dbOpenError=null)},tt.prototype.delete=function(i){var o=this;i===void 0&&(i={disableAutoOpen:!0});var l=0<arguments.length&&typeof arguments[0]!="object",u=this._state;return new X(function(d,h){function g(){o.close(i);var y=o._deps.indexedDB.deleteDatabase(o.name);y.onsuccess=Le(function(){var C,_,T;C=o._deps,_=o.name,T=C.indexedDB,C=C.IDBKeyRange,gs(T)||_===hr||ms(T,C).delete(_).catch(ue),d()}),y.onerror=Ut(h),y.onblocked=o._fireOnBlocked}if(l)throw new Q.InvalidArgument("Invalid closeOptions argument to db.delete()");u.isBeingOpened?u.dbReadyPromise.then(g):g()})},tt.prototype.backendDB=function(){return this.idbdb},tt.prototype.isOpen=function(){return this.idbdb!==null},tt.prototype.hasBeenClosed=function(){var i=this._state.dbOpenError;return i&&i.name==="DatabaseClosed"},tt.prototype.hasFailed=function(){return this._state.dbOpenError!==null},tt.prototype.dynamicallyOpened=function(){return this._state.autoSchema},Object.defineProperty(tt.prototype,"tables",{get:function(){var i=this;return c(this._allTables).map(function(o){return i._allTables[o]})},enumerable:!1,configurable:!0}),tt.prototype.transaction=function(){var i=function(o,l,u){var d=arguments.length;if(d<2)throw new Q.InvalidArgument("Too few arguments");for(var h=new Array(d-1);--d;)h[d-1]=arguments[d];return u=h.pop(),[o,jn(h),u]}.apply(this,arguments);return this._transaction.apply(this,i)},tt.prototype._transaction=function(i,o,l){var u=this,d=Y.trans;d&&d.db===this&&i.indexOf("!")===-1||(d=null);var h,g,y=i.indexOf("?")!==-1;i=i.replace("!","").replace("?","");try{if(g=o.map(function(_){if(_=_ instanceof u.Table?_.name:_,typeof _!="string")throw new TypeError("Invalid table argument to Dexie.transaction(). Only Table or String are allowed");return _}),i=="r"||i===rs)h=rs;else{if(i!="rw"&&i!=ss)throw new Q.InvalidArgument("Invalid transaction mode: "+i);h=ss}if(d){if(d.mode===rs&&h===ss){if(!y)throw new Q.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");d=null}d&&g.forEach(function(_){if(d&&d.storeNames.indexOf(_)===-1){if(!y)throw new Q.SubTransaction("Table "+_+" not included in parent transaction.");d=null}}),y&&d&&!d.active&&(d=null)}}catch(_){return d?d._promise(null,function(T,w){w(_)}):et(_)}var C=function _(T,w,j,E,P){return X.resolve().then(function(){var D=Y.transless||Y,A=T._createTransaction(w,j,T._dbSchema,E);if(A.explicit=!0,D={trans:A,transless:D},E)A.idbtrans=E.idbtrans;else try{A.create(),A.idbtrans._explicit=!0,T._state.PR1398_maxLoop=3}catch(L){return L.name===Ke.InvalidState&&T.isOpen()&&0<--T._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),T.close({disableAutoOpen:!1}),T.open().then(function(){return _(T,w,j,null,P)})):et(L)}var R,I=rt(P);return I&&Fn(),D=X.follow(function(){var L;(R=P.call(A,A))&&(I?(L=on.bind(null,null),R.then(L,L)):typeof R.next=="function"&&typeof R.throw=="function"&&(R=Cs(R)))},D),(R&&typeof R.then=="function"?X.resolve(R).then(function(L){return A.active?L:et(new Q.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))}):D.then(function(){return R})).then(function(L){return E&&A._resolve(),A._completion.then(function(){return L})}).catch(function(L){return A._reject(L),et(L)})})}.bind(null,this,h,g,d,l);return d?d._promise(h,C,"lock"):Y.trans?gn(Y.transless,function(){return u._whenReady(C)}):this._whenReady(C)},tt.prototype.table=function(i){if(!k(this._allTables,i))throw new Q.InvalidTable("Table ".concat(i," does not exist"));return this._allTables[i]},tt);function tt(i,o){var l=this;this._middlewares={},this.verno=0;var u=tt.dependencies;this._options=o=s({addons:tt.addons,autoOpen:!0,indexedDB:u.indexedDB,IDBKeyRange:u.IDBKeyRange,cache:"cloned"},o),this._deps={indexedDB:o.indexedDB,IDBKeyRange:o.IDBKeyRange},u=o.addons,this._dbSchema={},this._versions=[],this._storeNames=[],this._allTables={},this.idbdb=null,this._novip=this;var d,h,g,y,C,_={dbOpenError:null,isBeingOpened:!1,onReadyBeingFired:null,openComplete:!1,dbReadyResolve:ue,dbReadyPromise:null,cancelOpen:ue,openCanceller:null,autoSchema:!0,PR1398_maxLoop:3,autoOpen:o.autoOpen};_.dbReadyPromise=new X(function(w){_.dbReadyResolve=w}),_.openCanceller=new X(function(w,j){_.cancelOpen=j}),this._state=_,this.name=i,this.on=Wn(this,"populate","blocked","versionchange","close",{ready:[Ct,ue]}),this.on.ready.subscribe=Re(this.on.ready.subscribe,function(w){return function(j,E){tt.vip(function(){var P,D=l._state;D.openComplete?(D.dbOpenError||X.resolve().then(j),E&&w(j)):D.onReadyBeingFired?(D.onReadyBeingFired.push(j),E&&w(j)):(w(j),P=l,E||w(function A(){P.on.ready.unsubscribe(j),P.on.ready.unsubscribe(A)}))})}}),this.Collection=(d=this,Hn(Ca.prototype,function(R,A){this.db=d;var E=ci,P=null;if(A)try{E=A()}catch(I){P=I}var D=R._ctx,A=D.table,R=A.hook.reading.fire;this._ctx={table:A,index:D.index,isPrimKey:!D.index||A.schema.primKey.keyPath&&D.index===A.schema.primKey.name,range:E,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:P,or:D.or,valueMapper:R!==ge?R:null}})),this.Table=(h=this,Hn(hi.prototype,function(w,j,E){this.db=h,this._tx=E,this.name=w,this.schema=j,this.hook=h._allTables[w]?h._allTables[w].hook:Wn(null,{creating:[Ye,ue],reading:[$t,ge],updating:[Rt,ue],deleting:[nn,ue]})})),this.Transaction=(g=this,Hn(Sa.prototype,function(w,j,E,P,D){var A=this;this.db=g,this.mode=w,this.storeNames=j,this.schema=E,this.chromeTransactionDurability=P,this.idbtrans=null,this.on=Wn(this,"complete","error","abort"),this.parent=D||null,this.active=!0,this._reculock=0,this._blockedFuncs=[],this._resolve=null,this._reject=null,this._waitingFor=null,this._waitingQueue=null,this._spinCount=0,this._completion=new X(function(R,I){A._resolve=R,A._reject=I}),this._completion.then(function(){A.active=!1,A.on.complete.fire()},function(R){var I=A.active;return A.active=!1,A.on.error.fire(R),A.parent?A.parent._reject(R):I&&A.idbtrans&&A.idbtrans.abort(),et(R)})})),this.Version=(y=this,Hn(Fa.prototype,function(w){this.db=y,this._cfg={version:w,storesSource:null,dbschema:{},tables:{},contentUpgrade:null}})),this.WhereClause=(C=this,Hn(yi.prototype,function(w,j,E){if(this.db=C,this._ctx={table:w,index:j===":id"?null:j,or:E},this._cmp=this._ascending=Ce,this._descending=function(P,D){return Ce(D,P)},this._max=function(P,D){return 0<Ce(P,D)?P:D},this._min=function(P,D){return Ce(P,D)<0?P:D},this._IDBKeyRange=C._deps.IDBKeyRange,!this._IDBKeyRange)throw new Q.MissingAPI})),this.on("versionchange",function(w){0<w.newVersion?console.warn("Another connection wants to upgrade database '".concat(l.name,"'. Closing db now to resume the upgrade.")):console.warn("Another connection wants to delete database '".concat(l.name,"'. Closing db now to resume the delete request.")),l.close({disableAutoOpen:!1})}),this.on("blocked",function(w){!w.newVersion||w.newVersion<w.oldVersion?console.warn("Dexie.delete('".concat(l.name,"') was blocked")):console.warn("Upgrade '".concat(l.name,"' blocked by other connection holding version ").concat(w.oldVersion/10))}),this._maxKey=Xn(o.IDBKeyRange),this._createTransaction=function(w,j,E,P){return new l.Transaction(w,j,E,l._options.chromeTransactionDurability,P)},this._fireOnBlocked=function(w){l.on("blocked").fire(w),On.filter(function(j){return j.name===l.name&&j!==l&&!j._state.vcFired}).map(function(j){return j.on("versionchange").fire(w)})},this.use(Ia),this.use(Na),this.use(La),this.use(Ra),this.use(za);var T=new Proxy(this,{get:function(w,j,E){if(j==="_vip")return!0;if(j==="table")return function(D){return Ar(l.table(D),T)};var P=Reflect.get(w,j,E);return P instanceof hi?Ar(P,T):j==="tables"?P.map(function(D){return Ar(D,T)}):j==="_createTransaction"?function(){return Ar(P.apply(this,arguments),T)}:P}});this.vip=T,u.forEach(function(w){return w(l)})}var Pr,Tt=typeof Symbol<"u"&&"observable"in Symbol?Symbol.observable:"@@observable",qa=(_s.prototype.subscribe=function(i,o,l){return this._subscribe(i&&typeof i!="function"?i:{next:i,error:o,complete:l})},_s.prototype[Tt]=function(){return this},_s);function _s(i){this._subscribe=i}try{Pr={indexedDB:a.indexedDB||a.mozIndexedDB||a.webkitIndexedDB||a.msIndexedDB,IDBKeyRange:a.IDBKeyRange||a.webkitIDBKeyRange}}catch{Pr={indexedDB:null,IDBKeyRange:null}}function Fi(i){var o,l=!1,u=new qa(function(d){var h=rt(i),g,y=!1,C={},_={},T={get closed(){return y},unsubscribe:function(){y||(y=!0,g&&g.abort(),w&&cn.storagemutated.unsubscribe(E))}};d.start&&d.start(T);var w=!1,j=function(){return ns(P)},E=function(D){kr(C,D),ws(_,C)&&j()},P=function(){var D,A,R;!y&&Pr.indexedDB&&(C={},D={},g&&g.abort(),g=new AbortController,R=(function(I){var L=De();try{h&&Fn();var B=sn(i,I);return B=h?B.finally(on):B}finally{L&&qe()}})(A={subscr:D,signal:g.signal,requery:j,querier:i,trans:null}),Promise.resolve(R).then(function(I){l=!0,o=I,y||A.signal.aborted||(C={},(function(L){for(var B in L)if(k(L,B))return;return 1})(_=D)||w||(cn(Yn,E),w=!0),ns(function(){return!y&&d.next&&d.next(I)}))},function(I){l=!1,["DatabaseClosedError","AbortError"].includes(I?.name)||y||ns(function(){y||d.error&&d.error(I)})}))};return setTimeout(j,0),T});return u.hasValue=function(){return l},u.getValue=function(){return o},u}var vn=Jt;function As(i){var o=un;try{un=!0,cn.storagemutated.fire(i),$s(i,!0)}finally{un=o}}z(vn,s(s({},Oe),{delete:function(i){return new vn(i,{addons:[]}).delete()},exists:function(i){return new vn(i,{addons:[]}).open().then(function(o){return o.close(),!0}).catch("NoSuchDatabaseError",function(){return!1})},getDatabaseNames:function(i){try{return o=vn.dependencies,l=o.indexedDB,o=o.IDBKeyRange,(gs(l)?Promise.resolve(l.databases()).then(function(u){return u.map(function(d){return d.name}).filter(function(d){return d!==hr})}):ms(l,o).toCollection().primaryKeys()).then(i)}catch{return et(new Q.MissingAPI)}var o,l},defineClass:function(){return function(i){p(this,i)}},ignoreTransaction:function(i){return Y.trans?gn(Y.transless,i):i()},vip:bs,async:function(i){return function(){try{var o=Cs(i.apply(this,arguments));return o&&typeof o.then=="function"?o:X.resolve(o)}catch(l){return et(l)}}},spawn:function(i,o,l){try{var u=Cs(i.apply(l,o||[]));return u&&typeof u.then=="function"?u:X.resolve(u)}catch(d){return et(d)}},currentTransaction:{get:function(){return Y.trans||null}},waitFor:function(i,o){return o=X.resolve(typeof i=="function"?vn.ignoreTransaction(i):i).timeout(o||6e4),Y.trans?Y.trans.waitFor(o):o},Promise:X,debug:{get:function(){return Pe},set:function(i){Me(i)}},derive:te,extend:p,props:z,override:Re,Events:Wn,on:cn,liveQuery:Fi,extendObservabilitySet:kr,getByKeyPath:Te,setByKeyPath:We,delByKeyPath:function(i,o){typeof o=="string"?We(i,o,void 0):"length"in o&&[].map.call(o,function(l){We(i,l,void 0)})},shallowClone:Ot,deepClone:O,getObjectDiff:Es,cmp:Ce,asap:be,minKey:-1/0,addons:[],connections:On,errnames:Ke,dependencies:Pr,cache:wn,semVer:"4.0.10",version:"4.0.10".split(".").map(function(i){return parseInt(i)}).reduce(function(i,o,l){return i+o/Math.pow(10,2*l)})})),vn.maxKey=Xn(vn.dependencies.IDBKeyRange),typeof dispatchEvent<"u"&&typeof addEventListener<"u"&&(cn(Yn,function(i){un||(i=new CustomEvent(ls,{detail:i}),un=!0,dispatchEvent(i),un=!1)}),addEventListener(ls,function(i){i=i.detail,un||As(i)}));var In,un=!1,Oi=function(){};return typeof BroadcastChannel<"u"&&((Oi=function(){(In=new BroadcastChannel(ls)).onmessage=function(i){return i.data&&As(i.data)}})(),typeof In.unref=="function"&&In.unref(),cn(Yn,function(i){un||In.postMessage(i)})),typeof addEventListener<"u"&&(addEventListener("pagehide",function(i){if(!Jt.disableBfCache&&i.persisted){Pe&&console.debug("Dexie: handling persisted pagehide"),In?.close();for(var o=0,l=On;o<l.length;o++)l[o].close({disableAutoOpen:!1})}}),addEventListener("pageshow",function(i){!Jt.disableBfCache&&i.persisted&&(Pe&&console.debug("Dexie: handling persisted pageshow"),Oi(),As({all:new ht(-1/0,[[]])}))})),X.rejectionMapper=function(i,o){return!i||i instanceof Be||i instanceof TypeError||i instanceof SyntaxError||!i.name||!Ve[i.name]?i:(o=new Ve[i.name](o||i.message,i),"stack"in i&&q(o,"stack",{get:function(){return this.inner.stack}}),o)},Me(Pe),s(Jt,Object.freeze({__proto__:null,Dexie:Jt,liveQuery:Fi,Entity:ui,cmp:Ce,PropModSymbol:Gt,PropModification:Kn,replacePrefix:function(i,o){return new Kn({replacePrefix:[i,o]})},add:function(i){return new Kn({add:i})},remove:function(i){return new Kn({remove:i})},default:Jt,RangeSet:ht,mergeRanges:Qn,rangesOverlap:Ci}),{default:Jt}),Jt})})(zr)),zr.exports}var kl=El();const Bs=$l(kl),Yi=Symbol.for("Dexie"),Mr=globalThis[Yi]||(globalThis[Yi]=Bs);if(Bs.semVer!==Mr.semVer)throw new Error(`Two different versions of Dexie loaded in the same app: ${Bs.semVer} and ${Mr.semVer}`);const{liveQuery:jo,mergeRanges:Wf,rangesOverlap:Hf,RangeSet:Kf,cmp:Vf,Entity:Yf,PropModSymbol:Xf,PropModification:Gf,replacePrefix:Jf,add:Qf,remove:Zf}=Mr,Sl="easydb";let Dr=null;function _l(){if(Dr)return Dr;const e=new Mr(Sl);return e.version(1).stores({workspaces:"id",tables:"id, workspaceId, updatedAt",rows:"id, tableId, updatedAt",settings:"key",plugins:"url"}),Dr={raw:e,workspaces:e.table("workspaces"),tables:e.table("tables"),rows:e.table("rows"),settings:e.table("settings"),plugins:e.table("plugins")},Dr}function jr(e){return{async find(t){if(!t||Object.keys(t).length===0)return e.toArray();const r=Object.entries(t);return e.filter(s=>Fo(s,r)).toArray()},async findOne(t){return await e.get(t)??null},async insert(t){return await e.add(t),t},async bulkInsert(t){return t.length===0?[]:(await e.bulkAdd(t),t)},async upsert(t){return await e.put(t),t},async patch(t,r){if(await e.update(t,r)===0)throw new Error(`patch: no doc with id=${t}`);const n=await e.get(t);if(!n)throw new Error(`patch: doc id=${t} vanished after update`);return n},async remove(t){await e.delete(t)},async bulkRemove(t){t.length!==0&&await e.bulkDelete(t)},subscribe(t){const s=jo(()=>e.toArray()).subscribe({next:n=>t(n)});return()=>s.unsubscribe()}}}function Al(e,t){return{async find(r){const s=e.where("tableId").equals(t);if(!r||Object.keys(r).length===0)return s.toArray();const n=Object.entries(r);return s.filter(a=>Fo(a,n)).toArray()},async findOne(r){const s=await e.get(r);return s&&s.tableId===t?s:null},async insert(r){const s={...r,tableId:t};return await e.add(s),s},async bulkInsert(r){if(r.length===0)return[];const s=r.map(n=>({...n,tableId:t}));return await e.bulkAdd(s),s},async upsert(r){const s={...r,tableId:t};return await e.put(s),s},async patch(r,s){if(await e.update(r,s)===0)throw new Error(`row patch: no row ${r}`);const a=await e.get(r);if(!a)throw new Error(`row patch: row ${r} vanished after update`);return a},async remove(r){await e.delete(r)},async bulkRemove(r){r.length!==0&&await e.bulkDelete(r)},subscribe(r){const n=jo(()=>e.where("tableId").equals(t).toArray()).subscribe({next:a=>r(a)});return()=>n.unsubscribe()}}}function Fo(e,t){for(const[r,s]of t)if(e[r]!==s)return!1;return!0}function Pl(e){return{workspaces:jr(e.workspaces),tables:jr(e.tables),settings:jr(e.settings),plugins:jr(e.plugins),rows:t=>Al(e.rows,t)}}function Tl(e){const{base:t,providers:r,tableById:s,ctx:n}=e,a=new Map;return{...t,rows(c){const f=s(c),p=f?.source;if(p){const $=r.get(p.type);if($){const S=JSON.stringify(p),k=a.get(c);if(k&&k.key===S)return k.coll;const z=$.create(f,n);return a.set(c,{key:S,coll:z}),z}}return a.delete(c),t.rows(c)}}}function Dl(){const e=new Map;return{on(t,r){let s=e.get(t);return s||(s=new Set,e.set(t,s)),s.add(r),()=>{s.delete(r)}},emit(t,r){const s=e.get(t);if(s)for(const n of s)try{n(r)}catch(a){console.error(`[event:${String(t)}] listener threw`,a)}}}}const fn=ot`
  :host {
    display: contents;
  }
  dialog {
...
`;var Ol=Object.defineProperty,Rl=Object.getOwnPropertyDescriptor,Ro=(e,t,r,s)=>{for(var n=s>1?void 0:s?Rl(t,r):t,a=e.length-1,c;a>=0;a--)(c=e[a])&&(n=(s?c(t,r,n):c(n))||n);return s&&n&&Ol(t,r,n),n};let Qt=class extends nt{constructor(){super(...arguments),this.toasts=[],this.nextId=1}connectedCallback(){super.connectedCallback(),Qt.instance=this}disconnectedCallback(){super.disconnectedCallback(),Qt.instance===this&&(Qt.instance=null)}show(e,t){const r={id:this.nextId++,kind:t?.kind??"info",message:e,...t?.title?{title:t.title}:{}};this.toasts=[...this.toasts,r];const s=t?.durationMs??(r.kind==="error"||r.kind==="warning"?7e3:4e3);r.timer=window.setTimeout(()=>this.dismiss(r.id),s)}dismiss(e){const t=this.toasts.find(r=>r.id===e);t?.timer!=null&&window.clearTimeout(t.timer),this.toasts=this.toasts.filter(r=>r.id!==e)}render(){return H`
      ${this.toasts.map(e=>H`
