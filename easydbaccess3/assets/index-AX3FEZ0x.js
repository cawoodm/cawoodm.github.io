...
`;function gt(e){if(e.key!=="Enter"||!e.ctrlKey&&!e.metaKey)return;const t=e.currentTarget;if(!(t instanceof HTMLElement))return;const n=t.querySelector("form");n&&(e.preventDefault(),n.requestSubmit())}const Mu=new WeakSet;function bt(e,t){if(Mu.has(t))return;Mu.add(t);let n=0,r=0,i=0,s=0,o=!1;t.style.cursor="grab",t.style.touchAction="none",t.style.userSelect="none",t.addEventListener("pointerdown",c=>{if(c.target.closest("button, input, textarea, select, a, label"))return;o=!0,n=c.clientX,r=c.clientY;const f=e.getBoundingClientRect();i=f.left,s=f.top,t.setPointerCapture(c.pointerId),t.style.cursor="grabbing"}),t.addEventListener("pointermove",c=>{if(!o)return;const d=c.clientX-n,f=c.clientY-r,p=-e.offsetWidth+80,b=window.innerWidth-80,y=0,$=window.innerHeight-40,k=Math.max(p,Math.min(b,i+d)),C=Math.max(y,Math.min($,s+f));e.style.position="fixed",e.style.left=`${k}px`,e.style.top=`${C}px`,e.style.margin="0"});const a=c=>{if(o){o=!1;try{t.releasePointerCapture(c.pointerId)}catch{}t.style.cursor="grab"}};t.addEventListener("pointerup",a),t.addEventListener("pointercancel",a)}var Lb=function(e,t,n,r){var i=arguments.length,s=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(i<3?o(s):i>3?o(t,n,s):o(t,n))||s);return i>3&&s&&Object.defineProperty(t,n,s),s};class lt extends ke{constructor(){super(...arguments),this.current=null,this.queue=[],this.dialogEl=null,this.onCancel=t=>{t.preventDefault();const n=this.current;n&&(n.kind==="alert"?this.closeAndResolve(void 0):this.closeAndResolve(null))},this.submitPrompt=t=>{t.preventDefault(),this.current?.kind==="prompt"&&this.closeAndResolve(this.current.value)},this.submitChoice=t=>{if(t.preventDefault(),this.current?.kind!=="choice")return;const n=this.current.options[0];n!==void 0&&this.closeAndResolve(n)},this.submitAlert=t=>{t.preventDefault(),this.closeAndResolve(void 0)},this.cancelPrompt=()=>this.closeAndResolve(null),this.onCloseX=()=>{this.dialogEl&&!this.dialogEl.dispatchEvent(new Event("cancel",{cancelable:!0}))||this.onCancel(new Event("cancel",{cancelable:!0}))}}static{this.instance=null}static{this.styles=[mt,Se`
    ...
    `}renderBody(t){switch(t.kind){case"alert":return v`
        ...
        `}}}Lb([z()],lt.prototype,"current",void 0);function Mb(e="host-dialogs"){customElements.get(e)||customElements.define(e,lt)}const Pb=Se`
  .mi {
...
`))}</blockquote>`);continue}if(o.includes("|")&&i+1<n.length&&Tf.test(n[i+1])&&n[i+1].includes("-")){const f=_a(o),p=_a(n[i+1]).map(Uy);i+=2;const b=s(k=>k.trim()!==""&&k.includes("|")),y=f.map((k,C)=>`<th${p[C]??""}>${nr(k)}</th>`).join(""),$=b.map(k=>`<tr>${_a(k).map((C,E)=>`<td${p[E]??""}>${nr(C)}</td>`).join("")}</tr>`);r.push(`<table><thead><tr>${y}</tr></thead><tbody>${$.join("")}</tbody></table>`);continue}if(Ef.test(o)){const f=s(p=>p.trim()!==""&&!Wa.test(p)&&!Ga.test(p));r.push(Af(f));continue}const d=s(f=>f.trim()!==""&&!Fy(f));if(d.length===0){r.push(`<p>${nr(o)}</p>`),i++;continue}r.push(`<p>${nr(d.join(`
`))}</p>`)}return r.join(`
...
`;function Vf(e,t,n){return t.bottom<=n?null:Math.round(e.top-t.height-Lv)}const Lv=4;var Kf=function(e,t,n,r){var i=arguments.length,s=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(i<3?o(s):i>3?o(t,n,s):o(t,n))||s);return i>3&&s&&Object.defineProperty(t,n,s),s};let as=null,Ja="anchored-menu";function Mv(){return as||(Wf(Ja),as=document.createElement(Ja),document.body.appendChild(as)),as}class Si extends ke{constructor(){super(...arguments),this.items=[],this.shown=!1,this.resolveFn=null,this.onOutside=t=>{t.composedPath().includes(this)||this.finish(null)},this.onKey=t=>{t.key==="Escape"&&(t.preventDefault(),this.finish(null))}}static open(t,n){return Mv().openMenu(t,n)}static{this.styles=[Hf,Se`
      :host {
        position: fixed;
...
`)],c=t.tableNames[n.alias]??n.tableName;a.push(`FROM ${Qe(c)} AS ${Qe(n.alias)}`);for(const y of e.sources.slice(1)){const $=t.tableNames[y.alias]??y.tableName;if(!y.join){a.push(`CROSS JOIN ${Qe($)} AS ${Qe(y.alias)}`);continue}const k=y.join.type==="inner"?"INNER JOIN":"LEFT JOIN",C=y.join.on.map(E=>`${Qe(y.alias)}.${Qe(E.field)} = ${Qe(E.eqAlias)}.${Qe(E.eqField)}`).join(" AND ");a.push(`${k} ${Qe($)} AS ${Qe(y.alias)} ON ${C||"1 = 1"}`)}const d=[],f=[];for(const[y,$]of Object.entries(e.filters??{})){if(!$)continue;const k=Cd(e,y);if(k){if(k.computed){f.push(`-- filter on ${Qe(y)} (${Sd($)}) applies to a computed column; enforced in-app only`);continue}d.push(`LOWER(${k.expr}) LIKE ${Sd(`%${$.toLowerCase()}%`)}`)}}d.length>0&&a.push(`WHERE ${d.join(`
  AND `)}`);const p=(t.orderBy??[]).map(y=>{const $=Cd(e,y.field);return!$||$.computed?null:`${$.expr} ${y.asc?"ASC":"DESC"}`}).filter(y=>y!==null);p.length>0&&a.push(`ORDER BY ${p.join(", ")}`);const b=i==null?"":r==="limit"?`
LIMIT ${i}`:r==="fetch"?`
FETCH FIRST ${i} ROWS ONLY`:"";return`${a.join(`
`)}${b};
${f.length>0?`${f.join(`
`)}
`:""}`}const t$={id:"sql-export",name:"SQL Export",type:"exporter",version:"0.1.0",description:"Export the current workspace as a portable .sql script (CREATE TABLE + INSERT).",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/sql-export.ts"};function n$(){}async function gp(e){const t=e.workspaceId();if(!t)throw new Error("sql-export: no active workspace");const n=(await e.store.tables.find()).filter(a=>a.workspaceId===t),r=n.filter(a=>a.source?.type!=="projection"),i=n.filter(a=>a.source?.type==="projection"),s=r$(n),o=["-- easyDBAccess SQL dump",`-- workspace: ${t}`,`-- exported:  ${new Date().toISOString()}`,`-- tables:    ${r.length}${i.length>0?` (+ ${i.length} projection${i.length===1?"":"s"})`:""}`,"-- Compatible with PostgreSQL and SQLite. For MySQL run","--   SET sql_mode='ANSI_QUOTES';",'-- before executing, or rewrite "ident" to `ident`.',"","BEGIN;",""];for(const a of r){const c=await e.store.rows(a.id).find();o.push(yp(a,c),"")}if(o.push("COMMIT;",""),i.length>0){o.push("","-- Projections (virtual tables). Each is the query behind one, reading the","-- tables above. Run them as-is, or wrap one in CREATE VIEW to keep it.","");for(const a of i)o.push(`-- projection: ${a.name}`,mc(a,s)??"","")}return o.join(`
`)}function r$(e){const t=new Map;for(const n of e)t.has(n.name)||t.set(n.name,mr(n.code||n.name));return n=>t.get(n)??mr(je(n))}function bp(e,t){const n=wp(e);return n||["-- easyDBAccess table export",`-- table:    ${e.name}`,`-- exported: ${new Date().toISOString()}`,"","BEGIN;","",yp(e,t),"","COMMIT;",""].join(`
...
`;var d1=Object.defineProperty,h1=Object.getOwnPropertyDescriptor,Er=(e,t,n,r)=>{for(var i=r>1?void 0:r?h1(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&d1(t,n,i),i};function Oa(e){return dn([{...e,negate:!1}])}let dt=class extends ke{constructor(){super(...arguments),this.values=[],this.blanks=0,this.current="",this.search="",this.states=new Map,this.resolveFn=null,this.onChange=null,this.exactValues=!1,this.onOutside=e=>{e.composedPath().includes(this)||this.close(null)},this.onKey=e=>{e.key==="Escape"&&(e.preventDefault(),this.close(null))}}open(e,t,n,r=0,i,s){return this.values=t,this.blanks=r,this.onChange=i??null,this.exactValues=s?.exact===!0,this.states=new Map(Hn(n??"").map(o=>[Oa(o),{state:o.negate?"not":"on",token:o}])),this.current=n??"",this.search="",this.style.top=`${Math.round(e.bottom+4)}px`,this.style.left=`${Math.round(e.left)}px`,this.removeAttribute("hidden"),new Promise(o=>{this.resolveFn=o,setTimeout(()=>document.addEventListener("mousedown",this.onOutside,!0),0),document.addEventListener("keydown",this.onKey,!0)})}cycle(e,t=this.exactValues){const n=t?{term:e,negate:!1,exact:!0}:{term:e,negate:!1},r=Oa(n),i=new Map(this.states),s=i.get(r);s===void 0?i.set(r,{state:"on",token:n}):s.state==="on"?i.set(r,{state:"not",token:s.token}):i.delete(r),this.states=i;const o=[...i.values()].map(a=>({...a.token,negate:a.state==="not"}));this.current=dn(o),this.onChange?.(this.current)}close(e){this.onChange=null,document.removeEventListener("mousedown",this.onOutside,!0),document.removeEventListener("keydown",this.onKey,!0),this.setAttribute("hidden","");const t=this.resolveFn;this.resolveFn=null,t?.(e)}connectedCallback(){super.connectedCallback(),dt.instance=this,this.setAttribute("hidden","")}disconnectedCallback(){super.disconnectedCallback(),dt.instance===this&&(dt.instance=null)}render(){const e=this.search.toLowerCase(),t=this.values.filter(o=>o.value.toLowerCase().includes(e)),n=this.blanks>0&&"(blanks)".includes(e),r=(o,a=this.exactValues)=>this.states.get(Oa(a?{term:o,negate:!1,exact:!0}:{term:o,negate:!1}))?.state,i=o=>v` <span class=${`cb${o?` ${o}`:""}`}>${o==="on"?"✓":o==="not"?"✕":""}</span> `,s=o=>o==="on"?"Included — click to exclude":o==="not"?"Excluded — click to clear":"Click to include → exclude → off";return v`
      <header>
  ...
  `;Ft([Ye({type:String})],Ct.prototype,"value",2);Ft([Ye({type:Array})],Ct.prototype,"options",2);Ft([Ye({type:String})],Ct.prototype,"placeholder",2);Ft([z()],Ct.prototype,"open",2);Ft([z()],Ct.prototype,"highlightIdx",2);Ft([z()],Ct.prototype,"dropTop",2);Ft([z()],Ct.prototype,"dropLeft",2);Ft([z()],Ct.prototype,"dropMinWidth",2);Ft([z()],Ct.prototype,"editing",2);Ft([Kt("input")],Ct.prototype,"inputEl",2);Ct=Ft([Re("filter-combobox")],Ct);const bm=50,m1=500,g1=100;function Ks(e){return typeof e=="string"?e:String(e)}function b1(e,t){return t==="array"?ft(e):e==null||e===""?[]:[Ks(e)]}function wm(e,t,n){const r=n?.maxLen??bm;if(e.length===0)return!1;for(const i of e.slice(0,g1)){const s=i.data[t];if(s!=null){if(n?.type==="array"){if(ft(s).some(o=>o.length>=r))return!1;continue}if(Ks(s).length>=r)return!1}}return!0}function w1(e,t,n){const r=n?.maxLen??bm,i=n?.maxOptions??m1,s=new Set;for(const o of e)for(const a of b1(o.data[t],n?.type))if(!(a.length>=r)&&(s.add(a),s.size>=i))return[...s].sort();return[...s].sort()}function ym(e,t,n){const r=new Map;let i=0;for(const o of e){const a=o.data[t],c=n?.type==="array"?ft(a):a==null||Ks(a).trim()===""?[]:[Ks(a)];if(c.length===0){i++;continue}for(const d of c)r.set(d,(r.get(d)??0)+1)}let s=[...r.entries()].map(([o,a])=>({value:o,count:a})).sort((o,a)=>a.count-o.count||o.value.localeCompare(a.value));return n?.type==="boolean"&&(s=[...["true","false"].map(a=>({value:a,count:r.get(a)??0})),...s.filter(a=>a.value!=="true"&&a.value!=="false")]),{values:s,blanks:i}}const Lo="grid";async function y1(e){return await e.get(Lo,"sortDescFirst")!==!1}async function v1(e){return await e.get(Lo,"highlightNulls")!==!1}const pl="easydb:settings-changed";function $1(e,t){typeof document>"u"||document.dispatchEvent(new CustomEvent(pl,{detail:{pluginId:e,key:t}}))}function k1(e,t,n={}){const r=n.additive===!0,i=n.descFirst!==!0,s=e.find(c=>c.field===t),o=e.length===1&&e[0]?.field===t;if(!r&&!o)return[{field:t,asc:i}];const a=r?e.filter(c=>c.field!==t):[];return s?s.asc===i?[...a,{field:t,asc:!i}]:[...a]:[...a,{field:t,asc:i}]}const sr=new Map;function x1(e,t){let n=sr.get(e);return n||(n=new Set,sr.set(e,n)),n.add(t),()=>{const r=sr.get(e);r&&(r.delete(t),r.size===0&&sr.delete(e))}}function S1(e){return(sr.get(e)?.size??0)>0}function C1(e){const t=sr.get(e.key);if(!(!t||t.size===0))for(const n of[...t])try{n(e)}catch(r){console.warn("[visible-rows] listener failed",r)}}var _1=Object.defineProperty,E1=Object.getOwnPropertyDescriptor,Pe=(e,t,n,r)=>{for(var i=r>1?void 0:r?E1(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&_1(t,n,i),i};const T1=200,I1=250,A1=10,Da=32;let Oe=class extends ke{constructor(){super(...arguments),this.tableId="",this.viewInstanceId="",this.columns=[],this.rows=[],this.matchingTotal=0,this.tableTotal=0,this.truncated=!1,this.sortSpecs=[],this.filters={},this.globalQuery="",this.localQuery="",this.dragSourceField=null,this.dropTargetField=null,this.dropEdge=null,this.resizing=null,this.cellRenderers=new Map,this.scrollY=0,this.viewportHeight=0,this.loading=!1,this.externalLoading=!1,this.externalProgress=null,this.highlightNulls=!0,this.rowHeight=28,this.resizeObs=null,this.filterSaveTimer=null,this.rowColl=null,this.loadGeneration=0,this.reloadTimer=null,this.viewInst=null,this.tableColumns=[],this.tableReadonly=!1,this.renderedCount=0,this.renderedRows=null,this.lastEmittedCount=-1,this.lastEmittedTotal=-1,this.VIRT_THRESHOLD=200,this.OVERSCAN=8,this.onScroll=()=>{this.scrollY=this.scrollTop},this.onGlobalSearch=e=>{const t=e.detail.query??"";t!==this.globalQuery&&(this.globalQuery=t,this.scheduleReload())},this.onTableSearch=e=>{const t=e.detail;if(t.tableId===this.tableId||this.viewMode&&t.tableId===this.viewInstanceId){const n=t.query??"";if(n===this.localQuery)return;this.localQuery=n,this.scheduleReload()}},this.onTableLoading=e=>{const t=e.detail;t.tableId===this.tableId&&(this.externalLoading=t.loading,this.externalProgress=t.loading&&typeof t.progress=="number"?t.progress:null)},this.onSettingsChanged=e=>{e.detail?.pluginId===Lo&&this.readGridSettings()}}get searchIsActive(){return this.localQuery.trim()!==""||this.globalQuery.trim()!==""}get viewMode(){return!!this.viewInstanceId}get readOnlyView(){return this.viewMode&&!!this.viewInst?.readonly}get readOnly(){return this.readOnlyView||this.tableReadonly}async connectedCallback(){super.connectedCallback(),document.addEventListener("easydb:global-search",this.onGlobalSearch),document.addEventListener("easydb:table-search",this.onTableSearch),document.addEventListener(Za,this.onTableLoading),document.addEventListener(pl,this.onSettingsChanged),this.readGridSettings(),this.readLoadingState(),this.addEventListener("scroll",this.onScroll,{passive:!0}),this.resizeObs=new ResizeObserver(()=>{this.viewportHeight=this.clientHeight}),this.resizeObs.observe(this),await this.bind()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("easydb:global-search",this.onGlobalSearch),document.removeEventListener("easydb:table-search",this.onTableSearch),document.removeEventListener(Za,this.onTableLoading),document.removeEventListener(pl,this.onSettingsChanged),this.removeEventListener("scroll",this.onScroll),this.resizeObs?.disconnect(),this.resizeObs=null,this.unsubscribe?.(),this.tableSubUnsub?.(),this.viewSubUnsub?.(),this.reloadTimer!=null&&(window.clearTimeout(this.reloadTimer),this.reloadTimer=null),this.resizing=null}async readGridSettings(){try{const e=await J();this.highlightNulls=await v1(e.api.settings)}catch{}}readLoadingState(){const e=Uv(this.tableId);this.externalLoading=e!==void 0,this.externalProgress=typeof e=="number"?e:null}async updated(e){(e.has("tableId")||e.has("viewInstanceId"))&&this.tableId&&(this.unsubscribe?.(),this.tableSubUnsub?.(),this.viewSubUnsub?.(),e.has("tableId")&&this.readLoadingState(),await this.bind());const t=this.shadowRoot?.querySelector("tbody tr:not(.spacer)");t&&t.offsetHeight>0&&(this.rowHeight=t.offsetHeight),this.viewportHeight||(this.viewportHeight=this.clientHeight),this.emitCount(),this.emitRows()}get visibleRowsKey(){return(this.viewMode?this.viewInstanceId:this.tableId)||""}emitRows(){const e=this.visibleRowsKey,t=this.renderedRows;!e||!t||C1({key:e,rows:t,total:Math.max(this.matchingTotal,t.length),truncated:this.truncated,searching:this.searchIsActive})}emitCount(){const e=this.viewMode?this.viewInstanceId:this.tableId;if(!e)return;const t=this.renderedCount,n=Math.max(this.tableTotal,this.matchingTotal,this.rows.length);t===this.lastEmittedCount&&n===this.lastEmittedTotal||(this.lastEmittedCount=t,this.lastEmittedTotal=n,sm(e,t,n))}async bind(){if(!this.tableId)return;const e=await J(),t=await e.store.tables.findOne(this.tableId);t&&(this.viewMode?(this.tableColumns=t.columns,this.viewInst=await e.store.viewInstances.findOne(this.viewInstanceId)??null,this.applyView(),this.tableSubUnsub?.(),this.tableSubUnsub=e.store.tables.subscribe(n=>{const r=n.find(i=>i.id===this.tableId);r&&(this.tableColumns=r.columns,this.applyView())}),this.viewSubUnsub?.(),this.viewSubUnsub=e.store.viewInstances.subscribe(n=>{const r=n.find(i=>i.id===this.viewInstanceId);r&&(this.viewInst=r,this.applyView())})):(this.applyTable(t),this.tableSubUnsub?.(),this.tableSubUnsub=e.store.tables.subscribe(n=>{const r=n.find(i=>i.id===this.tableId);r&&this.applyTable(r)})),this.cellRenderers=new Map(e.registries.cellRenderers),e.events.on("app:ready",()=>this.cellRenderers=new Map(e.registries.cellRenderers)),this.rowColl=e.store.rows(this.tableId),this.unsubscribe=this.rowColl.watch?this.rowColl.watch(()=>void this.loadRows()):this.rowColl.subscribe(()=>void this.loadRows()),await this.loadRows())}async loadRows(){const e=this.rowColl;if(!e)return;const t=++this.loadGeneration,n=window.setTimeout(()=>this.loading=!0,T1);try{const r=await Ii(e,this.rowRequest(),jn);if(t!==this.loadGeneration)return;if(this.rows=r.rows,this.matchingTotal=r.total,this.truncated=r.truncated===!0,e.count){const i=await e.count();if(t!==this.loadGeneration)return;this.tableTotal=i}else this.tableTotal=r.total}catch(r){if(t!==this.loadGeneration)return;this.rows=[],this.matchingTotal=0,this.tableTotal=0,(await J()).api.ui.dialogs.toast(`Couldn't load rows: ${r?.message??String(r)}`,{kind:"error",title:"Load failed"})}finally{window.clearTimeout(n),t===this.loadGeneration&&(this.loading=!1)}}rowRequest(){const e=[this.localQuery.trim(),this.globalQuery.trim()].filter(Boolean).join(" ");return{columns:this.columns,filters:this.filters,...e?{search:e}:{},...this.sortSpecs.length>0?{sort:this.sortSpecs}:{}}}scheduleReload(){this.reloadTimer!=null&&window.clearTimeout(this.reloadTimer),this.reloadTimer=window.setTimeout(()=>{this.reloadTimer=null,this.loadRows()},I1)}applyTable(e){this.resizing==null&&(this.columns=e.columns),this.tableReadonly=!!e.readonly,this.sortSpecs=fl(e),this.filterSaveTimer==null&&(this.filters={...e.filters??{}})}applyView(){const e=this.viewInst;if(!e)return;const t=new Map(this.tableColumns.map(r=>[r.field,r])),n=e.columnWidths??{};this.columns=e.visibleColumns.map(r=>t.get(r)).filter(r=>!!r).map(r=>{const i=n[r.field];return typeof i=="number"?{...r,width:i}:r}),this.sortSpecs=fl(e),this.filterSaveTimer==null&&(this.filters={...e.filters??{}})}async setCell(e,t,n){const r=await J();await this.commitCell(r,e,t,n)}async commitCell(e,t,n,r){const i=this.columns.find(s=>s.field===n);if(this.readOnly||i?.readonly===!0){e.api.ui.dialogs.toast(this.readOnly?"This table is read-only.":`“${i?.label??n}” is a read-only column.`,{kind:"warning",title:"Not saved"}),this.requestUpdate();return}if(i){const s=D1(i,r,this.rows,t.id,t);if(s){await e.api.ui.dialogs.alert(s,`Cannot save ${i.label}`),this.requestUpdate();return}}try{await e.store.rows(this.tableId).patch(t.id,{data:{...t.data,[n]:r},updatedAt:Date.now()})}catch(s){await e.api.ui.dialogs.alert(s?.message??"Could not save the change.","Save failed"),this.requestUpdate()}}cancelCellEdit(e,t){if(e.key!=="Escape")return;e.stopPropagation();const n=e.target;typeof t=="boolean"?n.checked=t:n.value=t,n.blur()}renderInvalidCell(e,t,n,r){const i=String(n);return v`<input
    ...
    />`}renderReadonlyCell(e,t){if(e.type==="boolean")return v`<input type="checkbox" .checked=${t===!0||t==="true"||t===1||t==="1"} disabled />`;if(t==null||t==="")return v``;if(e.type==="array"&&ft(t).length===0)return v``;const n=$p(e.type,t);return n!==null?v`${n}`:v`${String(t)}`}renderScriptedCell(e,t){const n=Cr(t.script,e.data);if(!n.ok)return v`<span class="script-err" title=${n.message}>⚠ ${n.label}</span>`;const r=t.renderer?this.cellRenderers?.get(t.renderer):void 0;if(!r)return v`${n.value==null?"":String(n.value)}`;const i=dl(r);return hl`<${i}
      .value=${n.value??""}
    ...
    ></${i}>`}renderCell(e,t){const n=e.data[t.field];if(t.script?.trim())return this.renderScriptedCell(e,t);const r=this.readOnly||t.readonly===!0,i=t.renderer,s=i?this.cellRenderers?.get(i):void 0;if(s){const o=dl(s);return hl`<${o}
      ...
      ></${o}>`}if(r)return this.renderReadonlyCell(t,n);switch(t.type){case"date":return eh(n,ri(n))?this.renderInvalidCell(e,t,n,`Not a valid date: "${String(n)}"`):v`<input
          type="date"
          .value=${ri(n)}
          @keydown=${o=>this.cancelCellEdit(o,ri(n))}
          @change=${o=>this.setCell(e,t.field,o.target.value||null)}
        />`;case"datetime":return eh(n,ii(n))?this.renderInvalidCell(e,t,n,`Not a valid datetime: "${String(n)}"`):v`<input
          type="datetime-local"
          .value=${ii(n)}
      ...
      <table style=${this.tableSizingStyle(t)??X}>
        ...
        <thead>
          <tr>
            ${t.map(a=>{const c=a.sortable!==!1,d=a.filterable!==!1&&!dm(a,this.rows),f=this.sortSpecs.findIndex(L=>L.field===a.field),p=f>=0?this.sortSpecs[f]:void 0,b=p?p.asc?"asc":"desc":null,y=c?b==="asc"?"▲":b==="desc"?"▼":"⇅":"",$=this.sortSpecs.length>1&&f>=0?String(f+1):"",k=`t-${a.type}`,C=this.dragSourceField===a.field,E=this.dropTargetField===a.field,T=E&&this.dropEdge==="before"?" drop-before":E&&this.dropEdge==="after"?" drop-after":"",Y=(a.description?`${a.description}
...
`:"")+`${a.field} — ${c?"click to sort, shift-click to add a sort level, ":"not sortable · "}drag to reorder`+(d?"":" · not filterable");return v`
    ...
    `];Ai([Ye({type:String})],Bn.prototype,"tableId",2);Ai([z()],Bn.prototype,"query",2);Ai([z()],Bn.prototype,"open",2);Ai([Kt("input")],Bn.prototype,"inputEl",2);Bn=Ai([Re("panel-search")],Bn);var P1=Object.defineProperty,N1=Object.getOwnPropertyDescriptor,Vn=(e,t,n,r)=>{for(var i=r>1?void 0:r?N1(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&P1(t,n,i),i};let Jt=class extends ke{constructor(){super(...arguments),this.tableId="",this.active=!0,this.rowCount=0,this.tableButtons=[],this.table=null,this.fixedSchemaSources=new Set,this.rowsActive=!1,this.runTableButton=async(e,t)=>{const n=t?.currentTarget??void 0,r=await J();try{await Promise.resolve(e.onClick(r.api,{tableId:this.tableId,anchor:n}))}catch(i){console.error(`[table-button:${e.id}]`,i)}}}async connectedCallback(){super.connectedCallback();const e=await J();this.tableButtons=[...e.registries.tableButtons],this.fixedSchemaSources=th(e.registries.rowSources),e.events.on("app:ready",()=>{this.tableButtons=[...e.registries.tableButtons],this.fixedSchemaSources=th(e.registries.rowSources)}),this.table=await e.store.tables.findOne(this.tableId)??null,this.unsubTables=e.store.tables.subscribe(t=>{this.table=t.find(n=>n.id===this.tableId)??null}),this.active&&this.startRows()}disconnectedCallback(){super.disconnectedCallback(),this.stopRows(),this.unsubTables?.()}updated(e){e.has("active")&&(this.active?this.startRows():this.stopRows())}async startRows(){if(this.rowsActive)return;this.rowsActive=!0;const e=await J();this.rowsActive&&(this.unsubRows=e.store.rows(this.tableId).subscribe(t=>this.rowCount=t.length))}stopRows(){this.rowsActive=!1,this.unsubRows?.(),this.unsubRows=void 0}async addRow(){const e=await J(),t=await e.store.tables.findOne(this.tableId);if(!t)return;const n={};for(const r of t.columns)n[r.field]=j1(r);await e.store.rows(this.tableId).insert({id:crypto.randomUUID(),tableId:this.tableId,data:n,updatedAt:Date.now()})}editColumns(){document.dispatchEvent(new CustomEvent("easydb:edit-columns",{detail:{tableId:this.tableId}}))}get schemaEditable(){const e=this.table?.source?.type;return!e||!this.fixedSchemaSources.has(e)}render(){return v`
      ...
      ${this.tableButtons.filter(e=>!e.visible||this.table!=null&&e.visible(this.table)).map(e=>v`<button class=${e.danger?"danger":""} title=${e.tooltip??e.label} aria-label=${e.label} @click=${t=>this.runTableButton(e,t)}>
              ${e.icon?e.icon.trimStart().startsWith("<svg")?v`<span class="icon-svg">${Il(e.icon)}</span>`:v`<span class="mi sm">${e.icon}</span>`:v`<span>${e.label}</span>`}
            </button>`)}
    ...
    `}renderDbPicker(){return!this.listDatabases||!ah(this.url.trim(),this.resolvedKind)?X:v`
      <label>
        Database
  ...
  `}static get properties(){return{kind:{type:String},data:{attribute:!1},options:{attribute:!1},emptyText:{type:String}}}connectedCallback(){super.connectedCallback(),this.ro=new ResizeObserver(()=>this.chart?.resize()),this.ro.observe(this)}disconnectedCallback(){super.disconnectedCallback(),this.generation++,this.ro?.disconnect(),this.ro=null,this.chart?.destroy(),this.chart=null}updated(t){(t.has("data")||t.has("options")||t.has("kind"))&&this.draw()}get hasData(){return this.data.categories.length>0&&this.data.series.length>0}buildConfig(t){const n=Oc(this),r=this.options,i=this.kind==="pie",s=this.kind==="line",o=this.kind==="bar",a=r.legend??(i?!0:this.data.series.length>1);t.defaults.font.family=n.fontFamily,t.defaults.font.size=n.fontSize,t.defaults.color=n.text;const c=this.data.series.map((p,b)=>{const y=n.palette[b%n.palette.length]??"#2563eb";return i?{label:p.label,data:p.points,backgroundColor:this.data.categories.map(($,k)=>n.palette[k%n.palette.length]??y),borderColor:n.grid,borderWidth:1}:{label:p.label,data:p.points,backgroundColor:s?iC(y,r.area?.25:0):y,borderColor:y,borderWidth:s?2:0,fill:s?r.area??!1:!1,tension:s&&r.smooth?.35:0,pointRadius:s?2:0,spanGaps:!1}}),d={beginAtZero:r.beginAtZero??!0,stacked:r.stacked??!1,grid:{color:n.grid},border:{color:n.grid},ticks:{color:n.text,callback:p=>typeof p=="number"?hh.format(p):String(p)},title:r.yTitle?{display:!0,text:r.yTitle,color:n.text}:{display:!1}},f={stacked:r.stacked??!1,grid:{display:!1,color:n.grid},border:{color:n.grid},ticks:{color:n.text,autoSkip:!0,maxRotation:0},title:r.xTitle?{display:!0,text:r.xTitle,color:n.text}:{display:!1}};return{type:i?"pie":s?"line":"bar",data:{labels:this.data.categories,datasets:c},options:{responsive:!0,maintainAspectRatio:!1,animation:!1,...o?{indexAxis:"y"}:{},plugins:{legend:{display:a,labels:{color:n.text}},tooltip:{enabled:!0}},...i?{}:{scales:o?{x:d,y:f}:{x:f,y:d}}}}}async draw(){const t=++this.generation;if(!this.hasData){this.chart?.destroy(),this.chart=null;return}const n=await sC();if(t!==this.generation||!this.isConnected)return;const r=this.renderRoot.querySelector("canvas");r&&(this.chart?.destroy(),this.chart=new n(r,this.buildConfig(n)))}summary(){const t=this.data.categories.length,n=this.data.series.map(r=>r.label).join(", ");return`${this.kind} chart, ${t} ${t===1?"category":"categories"}${n?`, showing ${n}`:""}`}render(){return this.hasData?v`
    ...
    `}}function pC(){customElements.get("viz-point-map")||customElements.define("viz-point-map",fC)}function mC(e,t,n){if(e.length===0)return[];const r=e.map(o=>o.count),i=Math.min(...r),s=Math.max(...r);return e.map(o=>{const a=s===i?.5:(Math.sqrt(o.count)-Math.sqrt(i))/(Math.sqrt(s)-Math.sqrt(i));return{...o,size:Math.round(t+a*(n-t))}})}function gC(e,t,n,r){const s=Math.max(1,t)*Math.max(1,n)/Math.max(1,e),o=Math.sqrt(s)*.42,a=Math.min(o,Math.min(t,n)/5);return Math.max(r+4,Math.round(a))}class bC extends ke{constructor(){super(...arguments),this.terms=[],this.options={},this.emptyText="No words to show.",this.placed=[],this.dropped=0,this.w=0,this.h=0,this.generation=0,this.ro=null}static{this.styles=Se`
    :host {
      display: block;
      position: relative;
      height: 100%;
  ...
  `;gn([Ye({type:String})],Vt.prototype,"viewInstanceId",2);gn([z()],Vt.prototype,"instance",2);gn([z()],Vt.prototype,"template",2);gn([z()],Vt.prototype,"columns",2);gn([z()],Vt.prototype,"frame",2);gn([z()],Vt.prototype,"error",2);gn([z()],Vt.prototype,"loaded",2);Vt=gn([Re("viz-panel")],Vt);var kC=Object.defineProperty,xC=Object.getOwnPropertyDescriptor,Ri=(e,t,n,r)=>{for(var i=r>1?void 0:r?xC(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&kC(t,n,i),i};const SC=22;let qn=class extends ke{constructor(){super(...arguments),this.viewInstanceId="",this.label="",this.collapsed=!1,this.busy=!1}async reload(){await this.renderRoot.querySelector("viz-panel")?.reload?.()}async patch(e){if(!(this.busy||!this.viewInstanceId)){this.busy=!0;try{await(await J()).store.viewInstances.patch(this.viewInstanceId,{...e,updatedAt:Date.now()})}finally{this.busy=!1}}}toggleCollapse(){this.collapsed=!this.collapsed,this.dispatchEvent(new CustomEvent("viz-pane-collapse",{detail:{collapsed:this.collapsed},bubbles:!0,composed:!0}))}async edit(){if(!this.viewInstanceId)return;const t=await(await J()).store.viewInstances.findOne(this.viewInstanceId);t&&br(t.tableId,{editInstanceId:this.viewInstanceId})}undock(){this.patch({dock:void 0})}close(){this.patch({open:!1})}render(){return v`
    ...
    `}renderTemplated(){const e=this.template;if(!e)return v`<div class="vw-empty">This view's template is missing.</div>`;if(C$(e.rowHtml)){const t=this.instance?.mapping??{},n=new Map(this.tableColumns.map(c=>[c.field,c])),r=this.instance?.readonly===!0,i=this.instance?.tokenScripts??{},s=this.instance?.tokenRaw??{},o=this.rows.map(c=>b$(e.rowHtml,c,t,{columns:n,readonly:r,scripts:i,renderers:this.cellRenderers,raw:s})).join(""),a=(e.headerHtml??"")+o+(e.footerHtml??"");return v`<div class="vw-root">${ar(a)}</div>`}return v`<div class="vw-root">
      ...
      <button class="danger" aria-label="Delete view" title="Delete this view (the table stays)" @click=${()=>void this.deleteView()}>
        ...
        </div>`,n=e&&this.truncated?Sc({shown:this.rows.length,total:this.allRows.length,searching:this.searchIsActive,searched:jn}):null;return v`${this.renderSortBar()}${n?v`<div class="vw-note" role="status">${n}</div>`:X}${t}${this.renderFooter()}`}};st.styles=[_t,Se`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
...
`}],WC=[{label:"Required — reject an empty cell",source:`function validate(value, row) {
...
`}];var GC=Object.defineProperty,YC=Object.getOwnPropertyDescriptor,Kn=(e,t,n,r)=>{for(var i=r>1?void 0:r?YC(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&GC(t,n,i),i};const QC=`function render(row) {
  // \`row\` is the full row object — access any field by name (row.field).
  // Return the value this column should display.
  return row.name ?? '';
}
`;function JC(e){return`function render(row) {
  // \`row\` is the full row object — access any field by name (row.field).
  // Return what this token should show; HTML is rendered, not escaped.
  return ${e?`row.${e}`:"row.name"} ?? '';
}
`}const XC=`function validate(value, row) {
...
`;function ZC(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}async function e_(){try{const t=await(await J()).store.settings.findOne(jm);return UC(t?.value)}catch{return[]}}async function yh(e){await(await J()).store.settings.upsert({name:jm,value:[...e]})}let it=class extends ke{constructor(){super(...arguments),this.text="",this.columnLabel="",this.kind="render",this.undoText=null,this.userSamples=[],this.pickedUserId=null,this.dialogEl=null,this.resolver=null,this.onCancel=()=>this.resolve(null),this.onSubmit=e=>{e.preventDefault(),this.resolve(this.text)}}connectedCallback(){super.connectedCallback(),it.instance=this}disconnectedCallback(){super.disconnectedCallback(),it.instance===this&&(it.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&bt(this.dialogEl,e),this.dialogEl&&Xt("script-editor",this.dialogEl)}async open(e,t,n="render",r){return this.resolver&&(this.resolver(null),this.resolver=null),this.kind=n,this.undoText=null,this.pickedUserId=null,this.text=e&&e.trim()?e:this.blankFor(n,r?.field??""),this.columnLabel=t??"",this.userSamples=await e_(),await this.updateComplete,this.dialogEl?.showModal(),new Promise(i=>{this.resolver=i})}blankFor(e,t){return e==="validate"?XC:e==="token"?JC(t):QC}resolve(e){const t=this.resolver;this.resolver=null,this.dialogEl?.close(),t&&t(e)}get sampleKind(){return this.kind==="validate"?"validate":"render"}get samples(){return FC(this.sampleKind)}get mySamples(){return qC(this.userSamples,this.sampleKind)}applySample(e){const t=e.target,n=t.value;t.value="";const r=n.startsWith("u:")?this.mySamples.find(i=>i.id===n.slice(2)):this.samples[Number(n.slice(2))];r&&(this.undoText=this.text,this.text=r.source,this.pickedUserId=n.startsWith("u:")?n.slice(2):null)}undoSample(){this.undoText!==null&&(this.text=this.undoText,this.undoText=null)}onInput(e){this.text=e.target.value,this.undoText=null}async saveAsSample(){if(!this.text.trim())return;const e=lt.instance;if(!e)return;const t=await e.prompt("Name this sample — it appears in the dropdown for every script of this kind.","","Add to samples");if(t===null||!t.trim())return;const n={id:ZC(),kind:this.sampleKind,label:t.trim(),source:this.text};this.userSamples=HC(this.userSamples,n),this.pickedUserId=n.id,await yh(this.userSamples)}async deletePickedSample(){const e=this.pickedUserId,t=e?this.mySamples.find(i=>i.id===e):void 0,n=lt.instance;!e||!t||!n||!await n.confirm(`Delete the sample "${t.label}"? The script in the editor stays as it is.`,"Delete sample")||(this.userSamples=VC(this.userSamples,e),this.pickedUserId=null,await yh(this.userSamples))}renderHints(){return this.kind==="token"?v`
    ...
    `}renderVizOption(e,t){const n=t[e.key]??e.default,r=i=>this.setViz({options:{...t,[e.key]:i}});return e.type==="boolean"?v`<label class="field-inline">
        <input type="checkbox" .checked=${n===!0} @change=${i=>r(i.target.checked)} />
        ${e.label}
      </label>`:e.type==="number"?v`<label class="field">
        ${e.label} ${e.description?v`<span class="hint">${e.description}</span>`:X}
        ...
        <select @change=${i=>r(i.target.value)}>
          ${e.options.map(i=>v`<option value=${i} ?selected=${n===i}>${i}</option>`)}
        </select>
      ...
      <p class="hint">
        ${this.isVizDraft(e)?e.id?v`Editing this visualization. Use <strong>Chart</strong> in the window footer to change the kind, the aggregate or the options — those are shared by every view of this chart.`:v`The visualization reads this table's rows; a docked one follows the grid's filters live.`:e.id?v`Editing name and column mapping. The snapshotted sort, filters and visible columns are kept.`:v`The view snapshots this table's current sort, filters and visible columns.`}
      </p>
    ...
    `}};kt.instance=null;kt.styles=[mt,Se`
      dialog {
        min-width: 520px;
        max-width: 680px;
      }
...
${s>0?`About ${s.toLocaleString()} rows are left. `:""}Copying can be stopped from the Database menu once it starts.`,[o,a],"Unfinished import");if(c!==o){c===a&&await e.store.settings.remove(za);return}const d=Um(r.sourcePath),f=r.sizeBytes??0,p=await Gm(e,t,r.sourcePath,r.plan,[],`Converting ${d}${f>0?` (${Bm(f)})`:""}`);await e.store.settings.remove(za),$l(e,r.sourcePath,p)}const Xm={pickCandidates:(e,t)=>oE(e,t)};async function oE(e,t){const{chooseDatabaseObjects:n}=await Ie(async()=>{const{chooseDatabaseObjects:s}=await Promise.resolve().then(()=>oy);return{chooseDatabaseObjects:s}},void 0),r=t.map(s=>({name:s.name,size:s.rowCount<0?null:s.rowCount,kind:s.isView?"view":"table",...s.collides?{detail:"⚠ name already in use"}:{}})),i=await n(r,{title:"Import database",message:"Tables bring their rows. A view can come in as a Projection — its query, recomputed — or as Data, a snapshot you can edit.",confirmLabel:"Import",offerViewModes:!0});return i?i.map(s=>({candidate:t[s.index],mode:s.mode})):[]}async function aE(e,t,n){const r=t.columns??[],s=(await e.store.tables.find()).find(d=>d.workspaceId===n&&d.name.toLowerCase()===t.name.toLowerCase())?.columns??[],o=new Set(s.map(d=>d.field.toLowerCase()));if(r.length===0||s.length===0||r.every(d=>o.has(d.toLowerCase())))return{action:"append"};const{mapColumnsToTable:a}=await Ie(async()=>{const{mapColumnsToTable:d}=await import("./column-map-dialog-5lQqt7Hz.js");return{mapColumnsToTable:d}},[]),c=await a([...r],[...s],t.name);return c?{action:"append",mapping:c}:null}function Zm(e,t){if(!t.has(e.toLowerCase()))return e;for(let n=2;;n++){const r=`${e} (${n})`;if(!t.has(r.toLowerCase()))return r}}function $l(e,t,n){const r={created:n.filter(o=>o.action==="created").length,renamed:n.filter(o=>o.action==="renamed").length,overwritten:n.filter(o=>o.action==="overwritten").length,skipped:n.filter(o=>o.action==="skipped").length},i=n.reduce((o,a)=>o+a.rowCount,0),s=[];if(r.created&&s.push(`${r.created} new`),r.renamed&&s.push(`${r.renamed} renamed`),r.overwritten&&s.push(`${r.overwritten} overwritten`),r.skipped&&s.push(`${r.skipped} skipped`),s.length===0){e.ui.dialogs.toast(`Nothing imported from "${t}".`,{kind:"warning",title:"Import database"});return}e.ui.dialogs.toast(`Imported from "${t}": ${s.join(", ")} (${i} row${i===1?"":"s"} total).`,{kind:"success",title:"Import database"})}const lE=Object.freeze(Object.defineProperty({__proto__:null,LARGE_SOURCE_BYTES:Fm,cancelImport:Qm,handleDatabaseFile:Mc,handleDroppedFile:Hm,importDeps:Xm,importFlow:No,init:tE,isImporting:Ym,load:nE,meta:X_,openFlow:qm,resumePendingImport:Jm},Symbol.toStringTag,{value:"Module"})),cE={id:"sqlitefile-source",name:"Browse a database file",type:"source",version:"0.1.0",description:"Reads tables and views out of a .db file, read-only (Electron desktop build only).",author:"Marc Cawood",repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/sqlitefile-source.ts"};function eg(e){const t=e.source?.config;return!t||typeof t.path!="string"||typeof t.objectName!="string"?null:{path:t.path,objectName:t.objectName,isView:!!t.isView}}function Rn(e){throw new Error(`This table is a read-only browse of a database file — ${e} is not possible. Use Import to bring the data into your workspace first.`)}function uE(e,t){const n=eg(e),r=new Set;let i=null;async function s(){return n?(i=(await t.browseRows(n.path,n.objectName,e.columns)).map(c=>({id:c.id,tableId:e.id,data:c.data,updatedAt:0})),i):[]}function o(a){for(const c of r)c(a)}return{async find(){return i??await s()},async findOne(a){return(i??await s()).find(c=>c.id===a)},async count(){return(i??await s()).length},async refresh(){o(await s())},subscribe(a){return r.add(a),(i?Promise.resolve(i):s()).then(a),()=>void r.delete(a)},insert:()=>Rn("adding a row"),bulkInsert:()=>Rn("adding rows"),upsert:()=>Rn("changing a row"),patch:()=>Rn("changing a row"),remove:()=>Rn("deleting a row"),bulkRemove:()=>Rn("deleting rows"),clear:()=>Rn("clearing the table")}}function dE(e){const t=window.easydb?.db;t&&typeof e.registerRowSource=="function"&&e.registerRowSource({type:"sqlitefile",create:n=>uE(n,t),schemaEditable:!1})}const hE=Object.freeze(Object.defineProperty({__proto__:null,init:dE,meta:cE,parseConfig:eg},Symbol.toStringTag,{value:"Module"})),fE=[{id:"press-ctrl-k-to-run-commands",text:"Press Ctrl+K to run commands"},{id:"drag-in-a-file-to-import-csv-json",text:"Drag in a file to import (.csv, .json)"},{id:"right-click-and-drag-the-workspace-to-pan-deskto",text:"Right-click and drag the workspace to pan (Desktop)"}],pE={tips:fE},wr={id:"tips",name:"Tips",type:"ui",version:"0.1.0",description:'Shows one unseen tip on startup, plus a "Show tip" command. Compiled from docs/help/tips.md.',author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 21h6"/><path d="M10 18h4"/><path d="M12 3a6 6 0 0 0-3.5 10.9c.3.3.5.7.5 1.1v0h6v0c0-.4.2-.8.5-1.1A6 6 0 0 0 12 3z"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/tips.ts"},Ws="seen",Gs=pE.tips;function mE(){if(typeof location>"u")return!0;const e=new URLSearchParams(location.search);return e.get("tips")==="1"?!1:e.get("test")==="1"}async function Pc(e){const t=await e.settings.get(wr.id,Ws);return Array.isArray(t)?t.filter(n=>typeof n=="string"):[]}async function gE(e){const t=Ns(wr.id),n=await e.store.plugins.findOne(t);await e.store.plugins.upsert({...n??{url:t,lastFetched:0},url:t,enabled:!1,lastFetched:n?.lastFetched??0}),await e.settings.set(wr.id,Ws,[],"user")}async function tg(e,t){const n=await Pc(e),r=Gs[t];if(!r)return;await e.settings.set(wr.id,Ws,[...new Set([...n,r.id])],"user");const{TipsDialog:i}=await Ie(async()=>{const{TipsDialog:o}=await import("./tips-dialog-D1v7AP8F.js");return{TipsDialog:o}},[]),s=await i.open({tips:Gs,startIndex:t});if(s.dontShowAgain){await gE(e);return}await e.settings.set(wr.id,Ws,[...new Set([...n,...s.viewed])],"user")}function bE(e){e.ui.registerCommand({id:"tips:show",title:"Show tip",group:"Help",icon:"lightbulb",keywords:["tip","hint","help"],run:async t=>{const n=await Pc(t),r=Gs.findIndex(i=>!n.includes(i.id));await tg(t,r===-1?0:r)}})}async function wE(e){if(mE())return;const t=await Pc(e),n=Gs.findIndex(r=>!t.includes(r.id));n!==-1&&await tg(e,n)}const yE=Object.freeze(Object.defineProperty({__proto__:null,init:bE,load:wE,meta:wr},Symbol.toStringTag,{value:"Module"}));var vE=Object.defineProperty,$E=Object.getOwnPropertyDescriptor,Nc=(e,t,n,r)=>{for(var i=r>1?void 0:r?$E(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&vE(t,n,i),i};const jc="https://github.com/cawoodm/easydbaccess/blob/main/docs/help/commandlets.md";let bs=null;function kE(){return bs||(bs=document.createElement("commandlet-dialog"),document.body.appendChild(bs)),bs}let yr=class extends ke{constructor(){super(...arguments),this.value="",this.verdict=null,this.check=null,this.checkSeq=0,this.dialogEl=null,this.resolveFn=null,this.onInput=e=>{this.value=e.target.value,this.revalidate()},this.onSubmit=e=>{e.preventDefault();const t=this.value.trim();!t||this.verdict?.ok===!1||this.finish(t)},this.onCancel=e=>{e.preventDefault(),this.finish(null)}}static open(e,t=""){return kE().openDialog(e,t)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&bt(this.dialogEl,e),this.dialogEl&&Xt("commandlet",this.dialogEl)}openDialog(e,t){return this.check=e,this.value=t,this.verdict=null,t&&this.revalidate(),new Promise(n=>{this.resolveFn=n,this.updateComplete.then(()=>{this.dialogEl?.showModal();const r=this.shadowRoot?.querySelector("input.commandlet");r?.focus(),r?.select()})})}async revalidate(){const e=++this.checkSeq,t=this.value.trim();if(!t||!this.check){this.verdict=null;return}const n=await this.check(t);e===this.checkSeq&&(this.verdict=n)}finish(e){this.dialogEl?.close();const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}render(){const e=this.verdict;return v`
    ...
    `];Nc([z()],yr.prototype,"value",2);Nc([z()],yr.prototype,"verdict",2);yr=Nc([Re("commandlet-dialog")],yr);const xE=Object.freeze(Object.defineProperty({__proto__:null,COMMANDLET_HELP_URL:jc,get CommandletDialog(){return yr}},Symbol.toStringTag,{value:"Module"}));let ng;const SE=new Promise(e=>{ng=e});function CE(){ng()}function _E(){return SE}async function EE(e,t={}){const n=Of(e),r=await rg(t);for(const i of n)await AE(Df(i,r),t)}async function TE(e,t={}){const n=e.trim();if(!n)return{ok:!1,message:""};let r;try{r=Of(n)}catch(o){return{ok:!1,message:o instanceof Error?o.message:String(o)}}const i=await rg(t),s=[];for(const o of r)try{s.push(await IE(Df(o,i),t))}catch(a){return{ok:!1,message:a instanceof Error?a.message:String(a)}}return{ok:!0,message:s.join(", then ")}}async function IE(e,t={}){switch(e.verb){case"goto":{const n=await ag(e.targets[0]??""),r=Object.keys(e.filters).map(o=>vr(n,o)),i=Ys(e.options.sort,n),s=[`open ${n.name}`];return r.length>0&&s.push(`filter ${r.join(" + ")}`),e.options.clear!==void 0&&s.push("clear filters"),e.options.search!==void 0&&s.push(`search "${e.options.search}"`),i&&i.length>0&&s.push(`sort by ${i.map(o=>`${o.field}${o.asc?"":" ↓"}`).join(", ")}`),s.join(", ")}case"search":return`search all tables for "${e.targets[0]??""}"`;case"view":{const n=await ig(e,t),r=await sg(n),i=Object.keys(e.filters).map(a=>vr(r,a)),s=Ys(e.options.sort,r),o=[`open view "${n.name}"`];return i.length>0&&o.push(`filter ${i.join(" + ")}`),e.options.clear!==void 0&&o.push("clear filters"),e.options.search!==void 0&&o.push(`search "${e.options.search}"`),s&&s.length>0&&o.push(`sort by ${s.map(a=>`${a.field}${a.asc?"":" ↓"}`).join(", ")}`),o.join(", ")}case"cmd":return`run "${(await og(e.targets[0]??"")).title}"`;case"preview":case"ui":throw new ct(`"${e.verb}" is not wired up yet.`)}}async function rg(e){const t=await J(),n={WORKSPACE:t.workspaceId,...e.vars??{}};if(e.field!==void 0&&(n.FIELD=e.field),e.value!==void 0&&(n.VALUE=e.value),e.tableId){const r=await t.store.tables.findOne(e.tableId);r&&(n.TABLE=r.name)}return n}async function AE(e,t={}){switch(e.verb){case"goto":return RE(e);case"search":return OE(e);case"view":return DE(e,t);case"cmd":return LE(e);case"preview":case"ui":throw new ct(`"${e.verb}" is not wired up yet.`)}}async function RE(e){const t=e.targets[0]??"",n=await ag(t),r={},i=e.options.clear===void 0?{...n.filters??{}}:{};for(const[a,c]of Object.entries(e.filters)){const d=vr(n,a);c===""?delete i[d]:i[d]=c}(Object.keys(e.filters).length>0||e.options.clear!==void 0)&&(r.filters=Object.keys(i).length>0?i:void 0);const s=Ys(e.options.sort,n);s&&(r.sortBy=s.length>0?s:void 0,r.sortColumn=s[0]?.field,r.sortAsc=s[0]?s[0].asc:void 0),Object.keys(r).length>0&&await(await J()).store.tables.patch(n.id,{...r,updatedAt:Date.now()}),Cc(n.id);const o=e.options.search;o!==void 0&&document.dispatchEvent(new CustomEvent("easydb:table-search",{detail:{tableId:n.id,query:o}}))}function Ys(e,t){return e===void 0?null:e.split(",").map(n=>n.trim()).filter(Boolean).map(n=>n.startsWith("-")?{field:vr(t,n.slice(1)),asc:!1}:{field:vr(t,n),asc:!0})}function vr(e,t){const n=new Map;for(const i of e.columns??[])n.set(i.field.toLowerCase(),i.field),i.label&&n.set(i.label.toLowerCase(),i.field);const r=n.get(t.trim().toLowerCase());if(!r){const i=(e.columns??[]).map(s=>s.field).join(", ");throw new ct(`"${e.name}" has no column "${t}"${i?` — it has ${i}`:""}.`)}return r}function OE(e){const t=e.targets[0]??"";document.dispatchEvent(new CustomEvent("easydb:set-search",{detail:{query:t}}))}async function DE(e,t){const n=await ig(e,t),r=await sg(n),i={},s=e.options.clear===void 0?{...n.pillFilters??{}}:{};for(const[c,d]of Object.entries(e.filters)){const f=vr(r,c);d===""?delete s[f]:s[f]=d}(Object.keys(e.filters).length>0||e.options.clear!==void 0)&&(i.pillFilters=Object.keys(s).length>0?s:void 0);const o=Ys(e.options.sort,r);o&&(i.sortBy=o.length>0?o:void 0,i.sortColumn=o[0]?.field,i.sortAsc=o[0]?o[0].asc:void 0),Object.keys(i).length>0&&await(await J()).store.viewInstances.patch(n.id,{...i,updatedAt:Date.now()}),await Lc(n.id);const a=e.options.search;a!==void 0&&document.dispatchEvent(new CustomEvent("easydb:table-search",{detail:{tableId:n.id,query:a}}))}async function ig(e,t){const n=(e.targets[0]??"").trim();if(n)return ME(n);if(!t.viewInstanceId)throw new ct('"view" with no name means the view you are in — this was not run from one, so name the view.');const i=await(await J()).store.viewInstances.findOne(t.viewInstanceId);if(!i)throw new ct("That view no longer exists.");return i}async function sg(e){const n=await(await J()).store.tables.findOne(e.tableId);if(!n)throw new ct(`The view "${e.name}" has no table.`);return n}async function LE(e){const t=await og(e.targets[0]??""),n=await J();await t.run(n.api)}async function ME(e){const t=e.trim(),n=await J(),r=(await n.store.viewInstances.find()).filter(s=>s.workspaceId===n.workspaceId),i=r.find(s=>s.name===t)??r.find(s=>s.name.toLowerCase()===t.toLowerCase());if(!i)throw new ct(`No view called "${t}".`);return i}async function og(e){const t=await J(),n=t.registries.commands.find(r=>r.id===e)??t.registries.commands.find(r=>r.id.toLowerCase()===e.toLowerCase());if(!n)throw new ct(`No command with id "${e}".`);return n}async function ag(e){const t=e.trim();if(!t)throw new ct("No table name given.");const n=await J(),r=(await n.store.tables.find()).filter(s=>s.workspaceId===n.workspaceId),i=r.find(s=>s.name===t)??r.find(s=>s.name.toLowerCase()===t.toLowerCase());if(!i)throw new ct(`No table called "${t}".`);return i}const zc={id:"commandlets",name:"Commandlets",type:"ui",version:"0.1.0",description:"Run URL-shaped actions like goto/bible?Book=Matthew — from a link, a #hash, ?cmdlet= or the palette.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="4 17 10 11 4 5"/><line x1="12" y1="19" x2="20" y2="19"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/commandlets.ts"},PE="cmdlet",lg="default";function NE(e){e.ui.registerSettings(zc.id,"Commandlets",[{key:lg,label:"Default commandlet",type:"string",scope:"workspace",description:"Run this when the URL hash is not a commandlet itself. Blank ⇒ a plain #anchor is ignored, as before.",help:"Anchors like #Matthew carry no verb, so nothing runs unless this template says what to do with one. $HASH is the whole anchor text and $1…$9 are its /-separated parts, e.g. goto/bible?Title=$HASH&@sort=Title turns #Matthew into goto/bible?Title=Matthew&@sort=Title. The text is substituted after parsing, so an anchor containing & or ; cannot break the command.",helpUrl:jc,helpLinkLabel:"Commandlets guide"}]),e.ui.registerCommand({id:"commandlets:run",title:"Run commandlet…",group:"App",icon:"terminal",keywords:["command","goto","action","link","url"],run:t=>FE(t)}),e.ui.registerCommandFallback?.(t=>Yl(t)?{id:"commandlets:run-this",title:`Run this commandlet: ${t}`,group:"Commands",icon:"terminal",run:n=>$r(n,t)}:null)}function jE(e){document.addEventListener("click",t=>void BE(e,t),!0),window.addEventListener("hashchange",()=>void cg(e)),_E().then(()=>zE(e))}async function zE(e){const t=new URLSearchParams(location.search).get(PE);t&&await $r(e,t),await cg(e)}async function FE(e,t=""){const{CommandletDialog:n}=await Ie(async()=>{const{CommandletDialog:i}=await Promise.resolve().then(()=>xE);return{CommandletDialog:i}},void 0),r=await n.open(i=>TE(i),t);r!==null&&await $r(e,r)}async function cg(e){const t=location.hash.replace(/^#/,"");if(!t)return;if(Yl(t)){kh(),await $r(e,t);return}const n=(await e.settings.get(zc.id,lg))?.trim();if(!n)return;const r=UE(t),i=r.split("/"),s={HASH:r};i.forEach((o,a)=>{s[String(a+1)]=o}),kh(),await $r(e,n,{vars:s})}function kh(){history.replaceState(null,"",location.pathname+location.search)}function UE(e){try{return decodeURIComponent(e)}catch{return e}}async function BE(e,t){if(t.defaultPrevented||t.button!==0||t.ctrlKey||t.metaKey||t.shiftKey||t.altKey)return;const n=t.composedPath(),r=n.find(o=>o instanceof HTMLAnchorElement);if(!r)return;const i=r.getAttribute("href")??"";if(!i.startsWith("#"))return;const s=i.slice(1);Yl(s)&&(t.preventDefault(),await $r(e,s,qE(n)))}function qE(e){const t={};for(const n of e){if(!t.tableId){const r=Cm(n);r&&(t.tableId=r)}if(!t.viewInstanceId&&n instanceof HTMLElement&&n.tagName==="VIEW-WINDOW"){const r=n.viewInstanceId;r&&(t.viewInstanceId=r)}if(t.field===void 0&&n instanceof HTMLElement){const r=n;r.column?.field&&(t.field=r.column.field,r.value!=null&&(t.value=String(r.value)))}}return t}async function $r(e,t,n){try{await EE(t,n??{})}catch(r){const i=r instanceof ct||r instanceof Error?r.message:String(r);e.ui.dialogs.toast(i,{kind:"error",title:"Commandlet"})}}const HE=Object.freeze(Object.defineProperty({__proto__:null,init:NE,load:jE,meta:zc},Symbol.toStringTag,{value:"Module"})),VE=[v_,Z$,Qw,xy,Dv,zv,T0,K0,Z0,ty,I$,a$,H$,Q$,lk,fk,bk,$k,Ok,nx,ox,ux,bx,kx,Ix,Q1,nS,LS,Om,b_,z_,B_,V_,G_,J_,lE,hE,yE,HE];function KE(e){if(!e.meta)throw new Error("Built-in plugin is missing meta");return e.meta}const ug=VE.map(e=>{const t=KE(e);return{id:t.id,meta:t,module:e}}),WE=ug;async function GE(e){const t=[];for(const n of ug)if(!await YE(e,n)){t.push(n);try{await n.module.init?.(e)}catch(r){e.events.emit("plugin:error",{url:n.id,phase:"init",error:r})}}return async()=>{for(const n of t)try{await n.module.load?.(e)}catch(r){e.events.emit("plugin:error",{url:n.id,phase:"load",error:r})}}}async function YE(e,t){return t.meta.fixed?!1:Tt==="all-optional"?!0:(await e.store.plugins.findOne(Ns(t.id)))?.enabled===!1}function dg(e){return e.filter(t=>t.status!=="minimized")}function QE(e,t,n){if(e<=0)return[];const r=Math.ceil(Math.sqrt(e)),i=Math.ceil(e/r),s=(t.w-n*(r+1))/r,o=(t.h-n*(i+1))/i;return Array.from({length:e},(a,c)=>{const d=c%r,f=Math.floor(c/r);return{x:t.x+n+d*(s+n),y:t.y+n+f*(o+n),w:s,h:o}})}function Ar(){return Kk()}function JE(){for(const e of Ar())e.close?.()}function XE(){for(const e of Ar())e.minimize?.()}function ZE(){for(const e of Ar())e.normalize?.()}function e2(){for(const e of Ar())e.maximize?.()}function hg(){const e=document.getElementById("easydb-panels"),t=e?.clientWidth??window.innerWidth,n=e?.clientHeight??window.innerHeight,r=qs()?.snapshot(),i=r?.scale&&r.scale>0?r.scale:1,s=r?.x??0,o=r?.y??0;return{x:-s/i,y:-o/i,w:t/i,h:n/i}}function fg(e,t,n,r,i){e.style.left=`${Math.round(t)}px`,e.style.top=`${Math.round(n)}px`,e.style.width=`${Math.round(r)}px`,e.style.height=`${Math.round(i)}px`}function t2(){const e=dg(Ar()).reverse();if(e.length===0)return;const t=hg(),n=32,r=Math.min(680,Math.max(320,t.w*.6)),i=Math.min(480,Math.max(240,t.h*.6));e.forEach((s,o)=>{s.normalize?.(),fg(s,t.x+24+o*n,t.y+24+o*n,r,i)}),pg()}function pg(){$m(),AC()}function n2(){const e=dg(Ar()).reverse();if(e.length===0)return;const n=QE(e.length,hg(),8);e.forEach((r,i)=>{r.normalize?.();const s=n[i];s&&fg(r,s.x,s.y,s.w,s.h)}),pg()}function ws(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}async function r2(e,t){const{from:n,to:r,name:i,mode:s}=t,o=await e.workspaces.get(n);if(await e.workspaces.put({id:r,name:i,createdAt:Date.now(),pluginUrls:s==="empty"?[]:[...o?.pluginUrls??[]]}),s==="empty")return r;if(s==="all"){const c=await e.tables.where("workspaceId").equals(n).toArray(),d=new Map;for(const y of c){const $=ws();d.set(y.id,$),await e.tables.put({...y,id:$,workspaceId:r,updatedAt:Date.now()})}for(const[y,$]of d){const k=await e.rows.where("tableId").equals(y).toArray();k.length>0&&await e.rows.bulkPut(k.map(C=>({...C,id:ws(),tableId:$})))}const f=await e.viewTemplates.where("workspaceId").equals(n).toArray(),p=new Map;for(const y of f){const $=ws();p.set(y.id,$),await e.viewTemplates.put({...y,id:$,workspaceId:r})}const b=await e.viewInstances.where("workspaceId").equals(n).toArray();for(const y of b){const $=d.get(y.tableId);$&&await e.viewInstances.put({...y,id:ws(),workspaceId:r,tableId:$,templateId:p.get(y.templateId)??y.templateId})}}const a=await e.settings.where("workspaceId").equals(n).toArray();for(const c of a)await e.settings.put({...c,key:It(r,c.name),workspaceId:r,name:c.name});return r}async function mg(e,t){return(await e.tables.where("workspaceId").equals(t).toArray()).map(r=>r.id)}async function gg(e,t){const n=await mg(e,t),r=n.length===0?0:await e.rows.where("tableId").anyOf(n).count();return{tables:n.length,rows:r,views:await e.viewInstances.where("workspaceId").equals(t).count(),templates:await e.viewTemplates.where("workspaceId").equals(t).count(),settings:await e.settings.where("workspaceId").equals(t).count()}}async function i2(e,t){const n=await gg(e,t),r=await mg(e,t);if(r.length>0){const a=await e.rows.where("tableId").anyOf(r).toArray();await e.rows.bulkDelete(a.map(c=>c.id)),await e.tables.bulkDelete(r)}const i=await e.viewInstances.where("workspaceId").equals(t).toArray();await e.viewInstances.bulkDelete(i.map(a=>a.id));const s=await e.viewTemplates.where("workspaceId").equals(t).toArray();await e.viewTemplates.bulkDelete(s.map(a=>a.id));const o=await e.settings.where("workspaceId").equals(t).toArray();return await e.settings.bulkDelete(o.map(a=>a.key).filter(a=>typeof a=="string")),await e.workspaces.delete(t),n}const xh="Clone everything (tables, views, settings)",Sh="Clone settings only (no data)",s2="Empty workspace";function jo(e){const t=new URLSearchParams(location.search);t.set("space",e),location.assign(`${location.pathname}?${t.toString()}${location.hash}`)}function o2(){const e=new URLSearchParams(location.search);e.delete("space");const t=e.toString();location.assign(`${location.pathname}${t?`?${t}`:""}${location.hash}`)}async function a2(){const e=await J(),t=(await e.store.workspaces.find()).filter(r=>r.id!==e.workspaceId);if(t.length===0){e.api.ui.dialogs.toast("This is the only workspace.",{kind:"info",title:"Workspaces"});return}const n=await e.api.ui.dialogs.choice("Open which workspace?",t.map(r=>r.name),"Switch workspace");n&&jo(n)}async function bg(){const e=await J(),t=await e.api.ui.dialogs.prompt("Name the new workspace. It will become active after creation.","","New workspace");if(!t||!t.trim())return;const n=await e.api.ui.dialogs.choice(`What should "${t.trim()}" start with?`,[xh,Sh,s2],"New workspace");if(!n)return;const r=n===xh?"all":n===Sh?"settings":"empty";await r2(Ms(),{from:e.workspaceId,to:vg(t.trim()),name:t.trim(),mode:r}),jo(t.trim())}async function wg(){const e=await J(),t=await e.store.workspaces.find();let n=t.find(c=>c.id===e.workspaceId)??t[0];if(!n)return;if(t.length>1){const c=await e.api.ui.dialogs.choice("Delete which workspace? Everything in it goes with it.",t.map(d=>d.name),"Delete workspace");if(!c)return;n=t.find(d=>d.name===c)??n}const r=await gg(Ms(),n.id),i=[`${r.tables} table${r.tables===1?"":"s"}`,`${r.rows.toLocaleString()} row${r.rows===1?"":"s"}`,`${r.views} view${r.views===1?"":"s"}`,`${r.settings} setting${r.settings===1?"":"s"}`].join(", "),s=t.length===1;if(!await e.api.ui.dialogs.confirm(`Delete the workspace "${n.name}"?

${i} will be deleted. This cannot be undone.`+(s?`

It is the only workspace, so an empty one will be created in its place.`:""),"Delete workspace"))return;if(await i2(Ms(),n.id),p2(n.id),n.id!==e.workspaceId){e.api.ui.dialogs.toast(`Deleted "${n.name}" (${i}).`,{kind:"success",title:"Workspace deleted"});return}const a=t.find(c=>c.id!==n.id);a?jo(a.name):o2()}function l2(e){const t=[{id:"windows:minimize-all",title:"Minimize all windows",icon:"remove",run:XE},{id:"windows:restore-all",title:"Restore all windows",icon:"crop_square",run:ZE},{id:"windows:maximize-all",title:"Maximize all windows",icon:"fullscreen",run:e2},{id:"windows:cascade",title:"Cascade windows",icon:"view_agenda",run:t2},{id:"windows:tile",title:"Tile windows",icon:"grid_view",run:n2},{id:"windows:close-all",title:"Close all windows",icon:"close",run:JE}];for(const s of t)e.ui.registerCommand({id:s.id,title:s.title,group:"Windows",icon:s.icon,run:s.run});const n=[{id:"workspace:switch",title:"Switch workspace",icon:"swap_horiz",keywords:["space","open","change"],run:a2},{id:"workspace:new",title:"New workspace",icon:"add",keywords:["space","add","create","clone"],run:bg},{id:"workspace:delete",title:"Delete workspace",icon:"delete",keywords:["space","remove","drop"],run:wg}];for(const s of n)e.ui.registerCommand({id:s.id,title:s.title,group:"Workspace",icon:s.icon,keywords:s.keywords,run:s.run});const r="https://github.com/cawoodm/easydbaccess/blob/main/CHANGELOG.md",i="https://github.com/cawoodm/easydbaccess/tree/main/docs";e.ui.registerCommand({id:"app:search",title:"Search all tables",group:"App",icon:"search",keywords:["find","global search","filter"],run:()=>{document.dispatchEvent(new CustomEvent("easydb:focus-search"))}}),e.ui.registerCommand({id:"app:plugins",title:"Plugins",group:"App",icon:"extension",keywords:["plugin manager","install","extensions"],run:s=>s.ui.openPluginManager()}),e.ui.registerCommand({id:"app:changelog",title:"Changelog",group:"App",icon:"history",keywords:["releases","version","whats new"],run:()=>{window.open(r,"_blank","noopener")}}),e.ui.registerCommand({id:"app:docs",title:"Documentation",group:"App",icon:"menu_book",keywords:["docs","help","guide","manual"],run:()=>{window.open(i,"_blank","noopener")}})}async function c2(e){if(Tt==="url-plugins"||Tt==="all-optional")return async()=>{};const t=e.workspaceId();if(!t)return async()=>{};const r=(await e.store.workspaces.findOne(t))?.pluginUrls??[],i=[];for(const s of r)try{const o=await e.store.plugins.findOne(s);if(o&&o.enabled===!1)continue;let a=o?.cachedBody??"";if(a)u2(e,s,a);else{try{a=await yg(s)}catch(f){await e.store.plugins.upsert({url:s,enabled:o?.enabled??!0,lastFetched:Date.now(),lastError:`fetch: ${f.message}`}),e.events.emit("plugin:error",{url:s,phase:"fetch",error:f});continue}await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),cachedBody:a})}const c=new Blob([a],{type:"text/javascript"}),d=URL.createObjectURL(c);try{const f=await import(d);await f.init?.(e),i.push({url:s,mod:f})}finally{setTimeout(()=>URL.revokeObjectURL(d),5e3)}}catch(o){await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),lastError:`init: ${o.message}`}),e.events.emit("plugin:error",{url:s,phase:"init",error:o})}return async()=>{for(const{url:s,mod:o}of i)try{await o.load?.(e)}catch(a){await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),lastError:`load: ${a.message}`}),e.events.emit("plugin:error",{url:s,phase:"load",error:a})}}}async function yg(e){const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} ${t.statusText}`);const n=await t.text();if((t.headers.get("content-type")??"").toLowerCase().includes("text/html")||/^\s*<(!doctype|html|head|body)/i.test(n))throw new Error("response is HTML, not a JS module (URL likely 404 → SPA fallback)");return n}function u2(e,t,n){return(async()=>{try{const r=await yg(t);if(r===n)return;await e.store.plugins.upsert({url:t,enabled:!0,lastFetched:Date.now(),cachedBody:r})}catch{}})()}let Fa=null;function J(){return Fa||(Fa=d2()),Fa}async function d2(){let e="";const t=window.easydb?.store?tw(window.easydb.store,()=>e):Qb(await Ms(),()=>e),n=nw(),r=iw(),i=new Map;t.tables.subscribe(C=>{i.clear();for(const E of C)i.set(E.id,E)});const s=Xb(t.tables),o={...s,insert:async C=>{const E=await s.insert(C);return i.set(E.id,E),E},upsert:async C=>{const E=await s.upsert(C);return i.set(E.id,E),E}};let a=null;const c={get backend(){if(!a)throw new Error("[host] row-source ctx used before app init completed");return a.backend},events:n,settings:t.settings,workspaceId:()=>b},d=Jb({base:{...t,tables:o},providers:r.rowSources,tableById:C=>i.get(C),ctx:c}),f=h2(),p=await d.workspaces.find();let b;if(f){const C=vg(f),E=p.find(T=>T.id===C||T.name===f);E?b=E.id:b=(await d.workspaces.insert({id:C,name:f,createdAt:Date.now(),pluginUrls:[]})).id}else{const C=f2(),E=C?p.find(T=>T.id===C):void 0;E?b=E.id:p.length>0?b=p[0].id:b=(await d.workspaces.insert({id:"default",name:"default",createdAt:Date.now(),pluginUrls:[]})).id}e=b,m2(b);const y=fw({store:d,events:n,registries:r,workspaceId:()=>b});a=y,l2(y),n.on("import:after",({source:C,tableId:E,rowCount:T})=>{C!=="datasette"&&y.store.tables.findOne(E).then(Y=>{y.ui.dialogs.toast(`Imported ${T} row${T===1?"":"s"} into "${Y?.name??E}".`,{kind:"success",title:C.toUpperCase()+" import"})})}),n.on("plugin:error",({url:C,phase:E,error:T})=>{y.ui.dialogs.toast(`[${E}] ${T?.message??String(T)}`,{kind:"error",title:`Plugin: ${C}`})});const $=await GE(y),k=await c2(y);return queueMicrotask(async()=>{n.emit("app:ready",{workspaceId:b}),await $(),await k(),Tt==="all-optional"?y.ui.dialogs.toast("Safe mode is ON: only fixed built-ins (Settings, core rendering) loaded. All other built-in plugins and URL-installed plugins are disabled for this session only — nothing was changed. Disable the culprit below, then reload without ?safemode.",{kind:"warning",title:"Safe mode"}):Tt==="url-plugins"&&y.ui.dialogs.toast("Safe mode (URL plugins) is ON: URL-installed plugins were not loaded this session. Built-in plugins are unaffected. Reload without ?safemode1 to restore them.",{kind:"warning",title:"Safe mode"}),Tt!=="off"&&y.ui.openPluginManager()}),globalThis.api=y,{store:d,events:n,workspaceId:b,registries:r,api:y}}function h2(){if(typeof location>"u")return null;const t=new URLSearchParams(location.search).get("space");return t&&t.trim().length>0?t.trim():null}const Qs="eda:lastWorkspaceId";function f2(){try{return globalThis.localStorage?.getItem(Qs)??null}catch{return null}}function p2(e){try{globalThis.localStorage?.getItem(Qs)===e&&globalThis.localStorage.removeItem(Qs)}catch{}}function m2(e){try{globalThis.localStorage?.setItem(Qs,e)}catch{}}function vg(e){return e.toLowerCase().trim().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"default"}var g2=Object.defineProperty,b2=Object.getOwnPropertyDescriptor,zo=(e,t,n,r)=>{for(var i=r>1?void 0:r?b2(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&g2(t,n,i),i};let kr=class extends ke{constructor(){super(...arguments),this.name="",this.text="",this.errorMsg="",this.dialogEl=null}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&bt(this.dialogEl,e),this.dialogEl&&Xt("csv-paste",this.dialogEl)}async open(){this.name="",this.text="",this.errorMsg="",await this.updateComplete,this.dialogEl?.showModal()}close(){this.dialogEl?.close()}async submit(e){e.preventDefault();const t=this.name.trim()||"pasted";if(this.text.trim().length===0){this.errorMsg="Paste some CSV first.";return}let n;try{n=Sr(this.text)}catch(o){this.errorMsg=`Couldn't parse the CSV: ${o.message}`;return}if(n.columns.length===0||n.rows.length===0){this.errorMsg="No data found in the pasted text.";return}const r=await J(),i=crypto.randomUUID();await r.store.tables.insert({id:i,workspaceId:r.workspaceId,name:t,code:je(t),columns:n.columns,view:"table",updatedAt:Date.now()});const s=n.rows.map(o=>({id:crypto.randomUUID(),tableId:i,data:o,updatedAt:Date.now()}));await r.store.rows(i).bulkInsert(s),r.api.ui.dialogs.toast(`Imported ${n.rows.length} row${n.rows.length===1?"":"s"} into "${t}".`,{kind:"success",title:"CSV paste"}),this.close()}render(){return v`
      <dialog @cancel=${this.close} @keydown=${gt}>
        <button type="button" class="close-x" title="Close" @click=${this.close}>×</button>
        <form @submit=${this.submit}>
          <div class="dialog-header">
...
…and ${V.length-5} more.`:""}`;return}}const y=new Set(this.columns.map(I=>I.origField).filter(I=>!!I)),$=new Set(c.map(I=>I.field)),k=(f?.columns??[]).map(I=>I.field).filter(I=>!y.has(I)),C=f?.deletedColumns??[],E=[...new Set([...C,...k])].filter(I=>!$.has(I));let T=null;if(f&&f.name!==t){const I=(await n.store.viewInstances.find()).filter(K=>K.workspaceId===n.workspaceId);T=y2(f.name,r,I,d);const V=S2(T);if(V&&!await R2(f.name,t,V))return}const Y={name:t,title:a,columns:c,readonly:this.tableReadonly,updatedAt:Date.now()};(E.length>0||C.length>0)&&(Y.deletedColumns=E);const L=f?.name;await n.store.tables.patch(d,Y);const ne=k.filter(I=>!$.has(I)),W=this.fieldRenames();if(!f?.source&&(ne.length>0||W.length>0)){const I=await n.store.rows(d).find();for(const V of I){let K=!1,ie={...V.data};const de=Ju(ie,W);de&&(ie=de,K=!0);for(const H of ne)H in ie&&(delete ie[H],K=!0);K&&await n.store.rows(d).patch(V.id,{data:ie,updatedAt:Date.now()})}}await A2(d,L??t,W,r),L!==void 0&&L!==t&&await I2(d,L,t,T)}else await n.store.tables.insert({id:Ee(),workspaceId:n.workspaceId,name:t,title:a,code:je(t),columns:c,view:"table",updatedAt:Date.now()});this.close()}renderPreview(){if(this.previewRows.length===0){const i=this.previewState==="loading"?"Reading rows for the preview…":this.previewState==="error"?"The rows could not be read, so there is no preview. Your column changes still save.":"No rows to preview.";return v`<div class="preview"><div class="empty" data-testid="preview-empty">${i}</div></div>`}const e=this.fieldRenames(),t=e.length>0?this.previewRows.map(i=>({...i,data:Ju(i.data,e)??i.data})):this.previewRows,n=new Map;for(const i of this.columns){if(!i.unique)continue;const s=new Set,o=new Set;for(const a of t){const c=a.data[i.field];c==null||c===""||(s.has(c)&&o.add(c),s.add(c))}n.set(i.field,o)}const r=this.columns.filter(i=>!i.hidden);return v`
      <div class="preview">
        ...
        <table>
          ...
          <tbody>
            ${t.map(i=>v`
                <tr>
                  ${r.map(s=>{const o=i.data[s.field],a=D2(s,o,n.get(s.field));return v`<td class=${a?"violation":""} title=${a??""}>${O2(o)}</td>`})}
                </tr>
              `)}
          </tbody>
        </table>
            ...
            <div class="columns">
              ...
              ${this.columns.map((n,r)=>{const i=this.dragSrcIdx===r,s=this.dropTargetIdx===r,o=s&&this.dropEdge==="before"?" drop-before":s&&this.dropEdge==="after"?" drop-after":"";return v`
                  ...
                  >
                    ...
                    >
                      ${E2.map(a=>v`<option value=${a} ?selected=${a===n.type}>${a}</option>`)}
                    </select>
                    <select
                    ...
                    >
                      ...
                      ${T2(this.rendererOptions,n.renderer).map(a=>v`<option value=${a} ?selected=${a===n.renderer}>${a}</option>`)}
                    </select>
                    <button
                      type="button"
          ...
          <div class="dialog-body">
            ...
            <div class="filters">
              <div class="chips">
                ...
                ${this.renderTri("Enabled",this.statusFilter,()=>this.cycleStatusFilter(),"status",U2)}
              </div>
              <div class="search">
    ...
    `];ut([z()],Xe.prototype,"urls",2);ut([z()],Xe.prototype,"records",2);ut([z()],Xe.prototype,"addUrl",2);ut([z()],Xe.prototype,"catalog",2);ut([z()],Xe.prototype,"catalogError",2);ut([z()],Xe.prototype,"serverCatalog",2);ut([z()],Xe.prototype,"serverCatalogError",2);ut([z()],Xe.prototype,"installing",2);ut([z()],Xe.prototype,"catalogUrls",2);ut([z()],Xe.prototype,"activeCatalogUrl",2);ut([z()],Xe.prototype,"search",2);ut([z()],Xe.prototype,"filterStates",2);ut([z()],Xe.prototype,"typeFilters",2);ut([z()],Xe.prototype,"statusFilter",2);Xe=ut([Re("plugin-manager-dialog")],Xe);var B2=Object.defineProperty,q2=Object.getOwnPropertyDescriptor,Zt=(e,t,n,r)=>{for(var i=r>1?void 0:r?q2(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&B2(t,n,i),i};const ei="__general__";let ht=class extends ke{constructor(){super(...arguments),this.tabs=[],this.active=ei,this.values={},this.placements={},this.secretsText="",this.workspaceTitle="",this.secretError="",this.openHelp="",this.dialogEl=null,this.attemptClose=e=>{const t=this.invalidSecrets();if(t.length>0){e?.preventDefault();const r=t[0];this.active=r.tab.id,this.secretError=`“${r.field.label}” must be empty or a \${secret:name} reference. Move the value into the secrets store (General tab) and reference it, so the raw secret is never saved or synced.`;return}const n=this.danglingSecrets();if(n.length>0){e?.preventDefault();const r=n[0];this.active=r.tab.id;const i=r.names.map(s=>`“${s}”`).join(", ");this.secretError=`“${r.field.label}” references ${i}, which the secrets store does not have. Add it in the General tab or correct the name — an unknown reference is passed on as the literal \${secret:name} text.`;return}this.secretError="",this.dialogEl?.close()},this.onSubmit=e=>{e.preventDefault(),this.attemptClose()}}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&bt(this.dialogEl,e),this.dialogEl&&Xt("settings",this.dialogEl)}async open(){const e=await J(),t=[...e.registries.settings];this.tabs=t.map(([s,o])=>({id:s,name:o.name,fields:o.fields}));const n=await e.store.workspaces.findOne(e.workspaceId);this.workspaceTitle=n?.title??"";const r={},i={};for(const s of this.tabs)for(const o of s.fields){const a=`${s.id}:${o.key}`,c=await e.api.settings.placement(s.id,o.key);c==="user"?(r[a]=Ps(a),i[a]="user"):c==="workspace"?(r[a]=(await e.store.settings.findOne(a))?.value,i[a]="workspace"):(r[a]=o.default,i[a]=o.scope??"workspace")}this.values=r,this.placements=i,this.secretsText=ui(),this.active=ei,await this.updateComplete,this.dialogEl?.showModal()}static rawSecret(e){return typeof e=="string"&&e!==""&&!e.includes("${secret:")}invalidSecrets(){const e=[];for(const t of this.tabs)for(const n of t.fields)n.type==="secret"&&ht.rawSecret(this.values[`${t.id}:${n.key}`])&&e.push({tab:t,field:n});return e}static secretRefs(e){return typeof e!="string"?[]:[...e.matchAll(/\$\{secret:([^}]*)\}/g)].map(t=>(t[1]??"").trim())}missingRefs(e){const t=new Set(Object.keys(ur(this.secretsText)));return ht.secretRefs(e).filter(n=>!t.has(n))}danglingSecrets(){const e=[];for(const t of this.tabs)for(const n of t.fields){const r=this.missingRefs(this.values[`${t.id}:${n.key}`]);r.length>0&&e.push({tab:t,field:n,names:r})}return e}async setValue(e,t,n){const r=`${e.id}:${t.key}`;this.values={...this.values,[r]:n},this.clearSecretErrorIfFixed(),await(await J()).api.settings.set(e.id,t.key,n,this.placements[r]),$1(e.id,t.key)}async toggleScope(e,t,n){const r=`${e.id}:${t.key}`,i=n?"user":"workspace";this.placements={...this.placements,[r]:i},await(await J()).api.settings.set(e.id,t.key,this.values[r],i)}clearSecretErrorIfFixed(){this.secretError&&this.invalidSecrets().length===0&&this.danglingSecrets().length===0&&(this.secretError="")}onSecretsInput(e){this.secretsText=e.target.value,Vh(this.secretsText),this.clearSecretErrorIfFixed()}downloadSecrets(){const e=new Blob([this.secretsText],{type:"text/plain;charset=utf-8"}),t=URL.createObjectURL(e),n=document.createElement("a");n.href=t,n.download="secrets.txt",n.click(),URL.revokeObjectURL(t)}async setWorkspaceTitle(e){this.workspaceTitle=e;const t=await J();await t.store.workspaces.patch(t.workspaceId,{title:e.trim()||void 0})}renderControl(e,t){const n=`${e.id}:${t.key}`,r=this.values[n];switch(t.type){case"text":return v`<textarea .value=${String(r??"")} @change=${i=>this.setValue(e,t,i.target.value)}></textarea>`;case"number":return v`<input
        ...
        />`;case"boolean":return v`<label class="scope"><input type="checkbox" .checked=${!!r} @change=${i=>this.setValue(e,t,i.target.checked)} /> enabled</label>`;case"date":return v`<input type="date" .value=${String(r??"")} @change=${i=>this.setValue(e,t,i.target.value)} />`;case"secret":return this.renderSecretControl(e,t,r);case"option":return v`<div class="radios">
          ...
          ${(t.options??[]).map(s=>v`<label
                ...
                />${s}</label
              >`)}
        </div>`}case"string":default:return v`<input type="text" .value=${String(r??"")} @change=${i=>this.setValue(e,t,i.target.value)} />`}}renderSecretControl(e,t,n){const r=Object.keys(ur(this.secretsText)),i=ht.rawSecret(n)||this.missingRefs(n).length>0;return v`<div class="secret-row">
      <input
        type="text"
        class=${i?"invalid":""}
      ...
      ${r&&i?v`<div class="help-panel">
            ${t.help?v`<p>${t.help}</p>`:X} ${t.helpUrl?v`<a href=${t.helpUrl} target="_blank" rel="noopener noreferrer">${t.helpLinkLabel||H2(t.helpUrl)}</a>`:X}
          </div>`:X}
    ...
    `}renderPanel(){if(this.active===ei)return this.renderGeneral();const e=this.tabs.find(t=>t.id===this.active);return e?v`
      <h3>${e.name}</h3>
    ...
    `];Zt([z()],ht.prototype,"tabs",2);Zt([z()],ht.prototype,"active",2);Zt([z()],ht.prototype,"values",2);Zt([z()],ht.prototype,"placements",2);Zt([z()],ht.prototype,"secretsText",2);Zt([z()],ht.prototype,"workspaceTitle",2);Zt([z()],ht.prototype,"secretError",2);Zt([z()],ht.prototype,"openHelp",2);ht=Zt([Re("settings-dialog")],ht);function H2(e){try{return new URL(e).host}catch{return e}}const Sg=5,Ua="palette:recent",Cg="Recent";function V2(e,t,n=Sg){return[t,...e.filter(r=>r!==t)].slice(0,n)}function K2(e){return Array.isArray(e)?e.filter(t=>typeof t=="string").slice(0,Sg):[]}function W2(e,t){const n=t instanceof Set?t:new Set(t);return e.filter(r=>n.has(r))}function G2(e,t){if(t.length===0)return e;const n=new Map(e.map(s=>[s.id,s])),r=[];for(const s of t){const o=n.get(s);o&&r.push({...o,group:Cg})}if(r.length===0)return e;const i=new Set(r.map(s=>s.id));return[...r,...e.filter(s=>!i.has(s.id))]}var Y2=Object.defineProperty,Q2=Object.getOwnPropertyDescriptor,Rr=(e,t,n,r)=>{for(var i=r>1?void 0:r?Q2(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&Y2(t,n,i),i};const J2={[Cg]:-1,Windows:0,Actions:1,App:2,Tables:3,Views:4};function Rh(e){return J2[e]??3}function X2(e){return e?e.trimStart().startsWith("<svg")?v`<span class="cmd-svg">${Il(e)}</span>`:v`<span class="mi sm">${e}</span>`:v`<span class="mi sm">chevron_right</span>`}let pn=class extends ke{constructor(){super(...arguments),this.search="",this.items=[],this.selected=0,this.api=null,this.commandFallbacks=[],this.recentIds=[],this.onDialogClick=e=>{if(e.detail===0||!this.dialogEl)return;const t=this.dialogEl.getBoundingClientRect();e.clientX>=t.left&&e.clientX<=t.right&&e.clientY>=t.top&&e.clientY<=t.bottom||this.close()}}async open(){const e=await J();this.api=e.api,this.commandFallbacks=e.registries.commandFallbacks,this.recentIds=K2((await e.api.store.settings.findOne(Ua))?.value),this.items=await this.buildItems(),await this.forgetVanished(),this.search="",this.selected=0,await this.updateComplete,this.dialogEl&&!this.dialogEl.open&&this.dialogEl.showModal(),this.inputEl?.focus()}async buildItems(){const e=await J(),t=e.api,n=[];for(const s of e.registries.commands)n.push({id:s.id,title:s.title,group:s.group??"Commands",...s.icon?{icon:s.icon}:{},haystack:[s.title,s.group,...s.keywords??[]].join(" ").toLowerCase(),run:()=>s.run(t)});for(const s of[...e.registries.headerButtons,...e.registries.footerButtons])n.push({id:`button:${s.id}`,title:s.label,group:"Actions",...s.icon?{icon:s.icon}:{},haystack:`${s.label} ${s.tooltip??""}`.toLowerCase(),run:()=>s.onClick(t)});const r=await t.store.tables.find({workspaceId:e.workspaceId});r.sort((s,o)=>s.name.localeCompare(o.name));for(const s of r)n.push({id:`goto:${s.id}`,title:`Go to: ${s.name}`,group:"Tables",icon:"table_chart",haystack:`${s.name} go to table`.toLowerCase(),run:()=>{Cc(s.id)}});const i=await t.store.viewInstances.find({workspaceId:e.workspaceId});i.sort((s,o)=>s.name.localeCompare(o.name));for(const s of i)n.push({id:`goto-view:${s.id}`,title:`Go to view: ${s.name}`,group:"Views",icon:"view_quilt",haystack:`${s.name} go to view`.toLowerCase(),run:async()=>{await Lc(s.id)}});return G2(n,this.recentIds).map((s,o)=>({it:s,i:o})).sort((s,o)=>Rh(s.it.group)-Rh(o.it.group)||s.i-o.i).map(({it:s})=>s)}get filtered(){const e=this.search.trim();if(!e)return this.items;const t=this.items.filter(n=>n.haystack.includes(e.toLowerCase()));return t.length>0?t:this.fallbackItems(e)}fallbackItems(e){const t=this.api;if(!t)return[];const n=[];for(const r of this.commandFallbacks){let i;try{i=r(e)}catch{continue}i&&n.push({id:i.id,title:i.title,group:i.group??"Commands",...i.icon?{icon:i.icon}:{},haystack:i.title.toLowerCase(),run:()=>i.run(t)})}return n}close(){this.dialogEl?.close()}onInput(e){this.search=e.target.value,this.selected=0}onKeydown(e){const t=this.filtered;if(e.key==="ArrowDown")e.preventDefault(),this.selected=t.length?(this.selected+1)%t.length:0;else if(e.key==="ArrowUp")e.preventDefault(),this.selected=t.length?(this.selected-1+t.length)%t.length:0;else if(e.key==="Enter"){e.preventDefault();const n=t[this.selected];n&&this.execute(n)}}async execute(e){this.close(),this.remember(e.id);try{await e.run()}catch(t){console.error(`[command:${e.id}]`,t)}}async forgetVanished(){const e=W2(this.recentIds,this.items.map(t=>t.id));if(e.length!==this.recentIds.length){this.recentIds=e;try{await this.api?.store.settings.upsert({name:Ua,value:e})}catch{}}}async remember(e){this.recentIds=V2(this.recentIds,e);try{await this.api?.store.settings.upsert({name:Ua,value:this.recentIds})}catch(t){console.warn("[command-palette] could not save recent commands",t)}}render(){const e=this.filtered;let t="";return v`
  ...
  `;Fo([z()],xr.prototype,"label",2);Fo([z()],xr.prototype,"fraction",2);Fo([z()],xr.prototype,"detail",2);xr=Fo([Re("app-progress")],xr);var tT=Object.defineProperty,nT=Object.getOwnPropertyDescriptor,_g=(e,t,n,r)=>{for(var i=r>1?void 0:r?nT(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&tT(t,n,i),i};let Js=class extends ke{constructor(){super(...arguments),this.tables=[],this.workspaceId=""}async connectedCallback(){super.connectedCallback();const e=await J();this.workspaceId=e.workspaceId,this.unsubscribe=e.store.tables.subscribe(n=>this.tables=n.filter(r=>r.workspaceId===this.workspaceId));const t=await e.store.tables.find();this.tables=t.filter(n=>n.workspaceId===this.workspaceId),await xm(),await LC(),CE()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.()}render(){return this.tables.length>0?v``:v`<div class="empty">No tables yet. Drop a <strong>.csv</strong> or <strong>.json</strong> file anywhere on the page, or click <strong>+ New Table</strong> above.</div>`}};Js.styles=Se`
    :host {
      display: block;
      height: 100%;
      box-sizing: border-box;
  ...
  `;_g([z()],Js.prototype,"tables",2);Js=_g([Re("table-list")],Js);var rT=Object.defineProperty,iT=Object.getOwnPropertyDescriptor,Bc=(e,t,n,r)=>{for(var i=r>1?void 0:r?iT(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&rT(t,n,i),i};let wi=class extends ke{constructor(){super(...arguments),this.workspaces=[],this.current=""}async connectedCallback(){super.connectedCallback();const e=await J();this.current=e.workspaceId,this.unsubscribe=e.store.workspaces.subscribe(t=>this.workspaces=t),this.workspaces=await e.store.workspaces.find()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.()}switchWorkspace(e){const t=this.workspaces.find(n=>n.id===e);t&&jo(t.name)}render(){return v`
