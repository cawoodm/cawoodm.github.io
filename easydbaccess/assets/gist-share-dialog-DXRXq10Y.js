import{i as h,m as p,b as u,d as b,a as y,r as d,t as g}from"./index-B-yWu3mp.js";var m=Object.defineProperty,f=Object.getOwnPropertyDescriptor,c=(e,o,i,l)=>{for(var t=l>1?void 0:l?f(o,i):o,n=e.length-1,r;n>=0;n--)(r=e[n])&&(t=(l?r(o,i,t):r(t))||t);return l&&t&&m(o,i,t),t};let a=null;function v(){return a||(a=document.createElement("gist-share-dialog"),document.body.appendChild(a)),a}let s=class extends h{constructor(){super(...arguments),this.link="",this.copyLabel="Copy",this.dialogEl=null,this.resolveFn=null,this.onCancel=e=>{e.preventDefault(),this.finish()},this.onFocusInput=e=>{e.target.select()},this.copy=async()=>{try{await navigator.clipboard.writeText(this.link),this.copyLabel="Copied!"}catch{this.copyLabel="Copy failed"}setTimeout(()=>{this.copyLabel="Copy"},1500)}}static open(e){return v().openDialog(e)}connectedCallback(){super.connectedCallback()}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&p(this.dialogEl,e)}openDialog(e){return this.link=e,this.copyLabel="Copy",new Promise(o=>{this.resolveFn=o,this.updateComplete.then(()=>{this.dialogEl?.showModal();const i=this.shadowRoot?.querySelector("input.link");i?.focus(),i?.select()})})}finish(){this.dialogEl?.close();const e=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>e?.())}render(){return u`
    ...
    `];c([d()],s.prototype,"link",2);c([d()],s.prototype,"copyLabel",2);s=c([g("gist-share-dialog")],s);export{s as GistShareDialog};
//# sourceMappingURL=gist-share-dialog-DXRXq10Y.js.map
