(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const l of n)if(l.type==="childList")for(const c of l.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function r(n){const l={};return n.integrity&&(l.integrity=n.integrity),n.referrerPolicy&&(l.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?l.credentials="include":n.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function o(n){if(n.ep)return;n.ep=!0;const l=r(n);fetch(n.href,l)}})();const ba="modulepreload",ya=function(e){return"/easydbaccess2/"+e},Co={},va=function(t,r,o){let n=Promise.resolve();if(r&&r.length>0){let c=function(T){return Promise.all(T.map(j=>Promise.resolve(j).then(z=>({status:"fulfilled",value:z}),z=>({status:"rejected",reason:z}))))};document.getElementsByTagName("link");const f=document.querySelector("meta[property=csp-nonce]"),m=f?.nonce||f?.getAttribute("nonce");n=c(r.map(T=>{if(T=ya(T),T in Co)return;Co[T]=!0;const j=T.endsWith(".css"),z=j?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${T}"]${z}`))return;const F=document.createElement("link");if(F.rel=j?"stylesheet":ba,j||(F.as="script"),F.crossOrigin="",F.href=T,m&&F.setAttribute("nonce",m),document.head.appendChild(F),j)return new Promise((N,Z)=>{F.addEventListener("load",N),F.addEventListener("error",()=>Z(new Error(`Unable to preload CSS for ${T}`)))})}))}function l(c){const f=new Event("vite:preloadError",{cancelable:!0});if(f.payload=c,window.dispatchEvent(f),!f.defaultPrevented)throw c}return n.then(c=>{for(const f of c||[])f.status==="rejected"&&l(f.reason);return t().catch(l)})};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Sr=globalThis,Ri=Sr.ShadowRoot&&(Sr.ShadyCSS===void 0||Sr.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,zi=Symbol(),ko=new WeakMap;let ds=class{constructor(t,r,o){if(this._$cssResult$=!0,o!==zi)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(Ri&&t===void 0){const o=r!==void 0&&r.length===1;o&&(t=ko.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),o&&ko.set(r,t))}return t}toString(){return this.cssText}};const wa=e=>new ds(typeof e=="string"?e:e+"",void 0,zi),ot=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((o,n,l)=>o+(c=>{if(c._$cssResult$===!0)return c.cssText;if(typeof c=="number")return c;throw Error("Value passed to 'css' function must be a 'css' function result: "+c+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+e[l+1],e[0]);return new ds(r,e,zi)},xa=(e,t)=>{if(Ri)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const o=document.createElement("style"),n=Sr.litNonce;n!==void 0&&o.setAttribute("nonce",n),o.textContent=r.cssText,e.appendChild(o)}},So=Ri?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const o of t.cssRules)r+=o.cssText;return wa(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:$a,defineProperty:Ea,getOwnPropertyDescriptor:Ca,getOwnPropertyNames:ka,getOwnPropertySymbols:Sa,getPrototypeOf:_a}=Object,Dr=globalThis,_o=Dr.trustedTypes,Pa=_o?_o.emptyScript:"",Aa=Dr.reactiveElementPolyfillSupport,Vn=(e,t)=>e,jr={toAttribute(e,t){switch(t){case Boolean:e=e?Pa:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},Ii=(e,t)=>!$a(e,t),Po={attribute:!0,type:String,converter:jr,reflect:!1,useDefault:!1,hasChanged:Ii};Symbol.metadata??=Symbol("metadata"),Dr.litPropertyMetadata??=new WeakMap;let An=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=Po){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const o=Symbol(),n=this.getPropertyDescriptor(t,o,r);n!==void 0&&Ea(this.prototype,t,n)}}static getPropertyDescriptor(t,r,o){const{get:n,set:l}=Ca(this.prototype,t)??{get(){return this[r]},set(c){this[r]=c}};return{get:n,set(c){const f=n?.call(this);l?.call(this,c),this.requestUpdate(t,f,o)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??Po}static _$Ei(){if(this.hasOwnProperty(Vn("elementProperties")))return;const t=_a(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Vn("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Vn("properties"))){const r=this.properties,o=[...ka(r),...Sa(r)];for(const n of o)this.createProperty(n,r[n])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[o,n]of r)this.elementProperties.set(o,n)}this._$Eh=new Map;for(const[r,o]of this.elementProperties){const n=this._$Eu(r,o);n!==void 0&&this._$Eh.set(n,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const o=new Set(t.flat(1/0).reverse());for(const n of o)r.unshift(So(n))}else t!==void 0&&r.push(So(t));return r}static _$Eu(t,r){const o=r.attribute;return o===!1?void 0:typeof o=="string"?o:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const o of r.keys())this.hasOwnProperty(o)&&(t.set(o,this[o]),delete this[o]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return xa(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,r,o){this._$AK(t,o)}_$ET(t,r){const o=this.constructor.elementProperties.get(t),n=this.constructor._$Eu(t,o);if(n!==void 0&&o.reflect===!0){const l=(o.converter?.toAttribute!==void 0?o.converter:jr).toAttribute(r,o.type);this._$Em=t,l==null?this.removeAttribute(n):this.setAttribute(n,l),this._$Em=null}}_$AK(t,r){const o=this.constructor,n=o._$Eh.get(t);if(n!==void 0&&this._$Em!==n){const l=o.getPropertyOptions(n),c=typeof l.converter=="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:jr;this._$Em=n;const f=c.fromAttribute(r,l.type);this[n]=f??this._$Ej?.get(n)??f,this._$Em=null}}requestUpdate(t,r,o,n=!1,l){if(t!==void 0){const c=this.constructor;if(n===!1&&(l=this[t]),o??=c.getPropertyOptions(t),!((o.hasChanged??Ii)(l,r)||o.useDefault&&o.reflect&&l===this._$Ej?.get(t)&&!this.hasAttribute(c._$Eu(t,o))))return;this.C(t,r,o)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:o,reflect:n,wrapped:l},c){o&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,c??r??this[t]),l!==!0||c!==void 0)||(this._$AL.has(t)||(this.hasUpdated||o||(r=void 0),this._$AL.set(t,r)),n===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,l]of this._$Ep)this[n]=l;this._$Ep=void 0}const o=this.constructor.elementProperties;if(o.size>0)for(const[n,l]of o){const{wrapped:c}=l,f=this[n];c!==!0||this._$AL.has(n)||f===void 0||this.C(n,void 0,l,f)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),this._$EO?.forEach(o=>o.hostUpdate?.()),this.update(r)):this._$EM()}catch(o){throw t=!1,this._$EM(),o}t&&this._$AE(r)}willUpdate(t){}_$AE(t){this._$EO?.forEach(r=>r.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(r=>this._$ET(r,this[r])),this._$EM()}updated(t){}firstUpdated(t){}};An.elementStyles=[],An.shadowRootOptions={mode:"open"},An[Vn("elementProperties")]=new Map,An[Vn("finalized")]=new Map,Aa?.({ReactiveElement:An}),(Dr.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Bi=globalThis,Ao=e=>e,Tr=Bi.trustedTypes,jo=Tr?Tr.createPolicy("lit-html",{createHTML:e=>e}):void 0,fs="$lit$",sn=`lit$${Math.random().toFixed(9).slice(2)}$`,hs="?"+sn,ja=`<${hs}>`,yn=document,Yn=()=>yn.createComment(""),Xn=e=>e===null||typeof e!="object"&&typeof e!="function",Li=Array.isArray,Ta=e=>Li(e)||typeof e?.[Symbol.iterator]=="function",$i=`[ 	
\f\r]`,Kn=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,To=/-->/g,Fo=/>/g,mn=RegExp(`>|${$i}(?:([^\\s"'>=/]+)(${$i}*=${$i}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Oo=/'/g,Do=/"/g,ps=/^(?:script|style|textarea|title)$/i,Fa=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),G=Fa(1),Tn=Symbol.for("lit-noChange"),Ue=Symbol.for("lit-nothing"),Ro=new WeakMap,bn=yn.createTreeWalker(yn,129);function ms(e,t){if(!Li(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return jo!==void 0?jo.createHTML(t):t}const Oa=(e,t)=>{const r=e.length-1,o=[];let n,l=t===2?"<svg>":t===3?"<math>":"",c=Kn;for(let f=0;f<r;f++){const m=e[f];let T,j,z=-1,F=0;for(;F<m.length&&(c.lastIndex=F,j=c.exec(m),j!==null);)F=c.lastIndex,c===Kn?j[1]==="!--"?c=To:j[1]!==void 0?c=Fo:j[2]!==void 0?(ps.test(j[2])&&(n=RegExp("</"+j[2],"g")),c=mn):j[3]!==void 0&&(c=mn):c===mn?j[0]===">"?(c=n??Kn,z=-1):j[1]===void 0?z=-2:(z=c.lastIndex-j[2].length,T=j[1],c=j[3]===void 0?mn:j[3]==='"'?Do:Oo):c===Do||c===Oo?c=mn:c===To||c===Fo?c=Kn:(c=mn,n=void 0);const N=c===mn&&e[f+1].startsWith("/>")?" ":"";l+=c===Kn?m+ja:z>=0?(o.push(T),m.slice(0,z)+fs+m.slice(z)+sn+N):m+sn+(z===-2?f:N)}return[ms(e,l+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),o]};class Gn{constructor({strings:t,_$litType$:r},o){let n;this.parts=[];let l=0,c=0;const f=t.length-1,m=this.parts,[T,j]=Oa(t,r);if(this.el=Gn.createElement(T,o),bn.currentNode=this.el.content,r===2||r===3){const z=this.el.content.firstChild;z.replaceWith(...z.childNodes)}for(;(n=bn.nextNode())!==null&&m.length<f;){if(n.nodeType===1){if(n.hasAttributes())for(const z of n.getAttributeNames())if(z.endsWith(fs)){const F=j[c++],N=n.getAttribute(z).split(sn),Z=/([.?@])?(.*)/.exec(F);m.push({type:1,index:l,name:Z[2],strings:N,ctor:Z[1]==="."?Ra:Z[1]==="?"?za:Z[1]==="@"?Ia:Rr}),n.removeAttribute(z)}else z.startsWith(sn)&&(m.push({type:6,index:l}),n.removeAttribute(z));if(ps.test(n.tagName)){const z=n.textContent.split(sn),F=z.length-1;if(F>0){n.textContent=Tr?Tr.emptyScript:"";for(let N=0;N<F;N++)n.append(z[N],Yn()),bn.nextNode(),m.push({type:2,index:++l});n.append(z[F],Yn())}}}else if(n.nodeType===8)if(n.data===hs)m.push({type:2,index:l});else{let z=-1;for(;(z=n.data.indexOf(sn,z+1))!==-1;)m.push({type:7,index:l}),z+=sn.length-1}l++}}static createElement(t,r){const o=yn.createElement("template");return o.innerHTML=t,o}}function Fn(e,t,r=e,o){if(t===Tn)return t;let n=o!==void 0?r._$Co?.[o]:r._$Cl;const l=Xn(t)?void 0:t._$litDirective$;return n?.constructor!==l&&(n?._$AO?.(!1),l===void 0?n=void 0:(n=new l(e),n._$AT(e,r,o)),o!==void 0?(r._$Co??=[])[o]=n:r._$Cl=n),n!==void 0&&(t=Fn(e,n._$AS(e,t.values),n,o)),t}class Da{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:o}=this._$AD,n=(t?.creationScope??yn).importNode(r,!0);bn.currentNode=n;let l=bn.nextNode(),c=0,f=0,m=o[0];for(;m!==void 0;){if(c===m.index){let T;m.type===2?T=new Jn(l,l.nextSibling,this,t):m.type===1?T=new m.ctor(l,m.name,m.strings,this,t):m.type===6&&(T=new Ba(l,this,t)),this._$AV.push(T),m=o[++f]}c!==m?.index&&(l=bn.nextNode(),c++)}return bn.currentNode=yn,n}p(t){let r=0;for(const o of this._$AV)o!==void 0&&(o.strings!==void 0?(o._$AI(t,o,r),r+=o.strings.length-2):o._$AI(t[r])),r++}}class Jn{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,o,n){this.type=2,this._$AH=Ue,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=o,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=Fn(this,t,r),Xn(t)?t===Ue||t==null||t===""?(this._$AH!==Ue&&this._$AR(),this._$AH=Ue):t!==this._$AH&&t!==Tn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Ta(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Ue&&Xn(this._$AH)?this._$AA.nextSibling.data=t:this.T(yn.createTextNode(t)),this._$AH=t}$(t){const{values:r,_$litType$:o}=t,n=typeof o=="number"?this._$AC(t):(o.el===void 0&&(o.el=Gn.createElement(ms(o.h,o.h[0]),this.options)),o);if(this._$AH?._$AD===n)this._$AH.p(r);else{const l=new Da(n,this),c=l.u(this.options);l.p(r),this.T(c),this._$AH=l}}_$AC(t){let r=Ro.get(t.strings);return r===void 0&&Ro.set(t.strings,r=new Gn(t)),r}k(t){Li(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let o,n=0;for(const l of t)n===r.length?r.push(o=new Jn(this.O(Yn()),this.O(Yn()),this,this.options)):o=r[n],o._$AI(l),n++;n<r.length&&(this._$AR(o&&o._$AB.nextSibling,n),r.length=n)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){const o=Ao(t).nextSibling;Ao(t).remove(),t=o}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Rr{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,o,n,l){this.type=1,this._$AH=Ue,this._$AN=void 0,this.element=t,this.name=r,this._$AM=n,this.options=l,o.length>2||o[0]!==""||o[1]!==""?(this._$AH=Array(o.length-1).fill(new String),this.strings=o):this._$AH=Ue}_$AI(t,r=this,o,n){const l=this.strings;let c=!1;if(l===void 0)t=Fn(this,t,r,0),c=!Xn(t)||t!==this._$AH&&t!==Tn,c&&(this._$AH=t);else{const f=t;let m,T;for(t=l[0],m=0;m<l.length-1;m++)T=Fn(this,f[o+m],r,m),T===Tn&&(T=this._$AH[m]),c||=!Xn(T)||T!==this._$AH[m],T===Ue?t=Ue:t!==Ue&&(t+=(T??"")+l[m+1]),this._$AH[m]=T}c&&!n&&this.j(t)}j(t){t===Ue?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Ra extends Rr{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Ue?void 0:t}}class za extends Rr{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Ue)}}class Ia extends Rr{constructor(t,r,o,n,l){super(t,r,o,n,l),this.type=5}_$AI(t,r=this){if((t=Fn(this,t,r,0)??Ue)===Tn)return;const o=this._$AH,n=t===Ue&&o!==Ue||t.capture!==o.capture||t.once!==o.once||t.passive!==o.passive,l=t!==Ue&&(o===Ue||n);n&&this.element.removeEventListener(this.name,this,o),l&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Ba{constructor(t,r,o){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=o}get _$AU(){return this._$AM._$AU}_$AI(t){Fn(this,t)}}const La=Bi.litHtmlPolyfillSupport;La?.(Gn,Jn),(Bi.litHtmlVersions??=[]).push("3.3.3");const Ma=(e,t,r)=>{const o=r?.renderBefore??t;let n=o._$litPart$;if(n===void 0){const l=r?.renderBefore??null;o._$litPart$=n=new Jn(t.insertBefore(Yn(),l),l,void 0,r??{})}return n._$AI(e),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Mi=globalThis;class Ge extends An{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Ma(r,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Tn}}Ge._$litElement$=!0,Ge.finalized=!0,Mi.litElementHydrateSupport?.({LitElement:Ge});const Na=Mi.litElementPolyfillSupport;Na?.({LitElement:Ge});(Mi.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function zr(e,t){return(r,o,n)=>{const l=c=>c.renderRoot?.querySelector(e)??null;return Wa(r,o,{get(){return l(this)}})}}var Ha=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function Ka(e){return e&&e.__esModule&&Object.prototype.hasOwnProperty.call(e,"default")?e.default:e}var _r={exports:{}},Va=_r.exports,zo;function Ya(){return zo||(zo=1,(function(e,t){(function(r,o){e.exports=o()})(Va,function(){var r=function(i,s){return(r=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(a,u){a.__proto__=u}||function(a,u){for(var d in u)Object.prototype.hasOwnProperty.call(u,d)&&(a[d]=u[d])})(i,s)},o=function(){return(o=Object.assign||function(i){for(var s,a=1,u=arguments.length;a<u;a++)for(var d in s=arguments[a])Object.prototype.hasOwnProperty.call(s,d)&&(i[d]=s[d]);return i}).apply(this,arguments)};function n(i,s,a){for(var u,d=0,h=s.length;d<h;d++)!u&&d in s||((u=u||Array.prototype.slice.call(s,0,d))[d]=s[d]);return i.concat(u||Array.prototype.slice.call(s))}var l=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:Ha,c=Object.keys,f=Array.isArray;function m(i,s){return typeof s!="object"||c(s).forEach(function(a){i[a]=s[a]}),i}typeof Promise>"u"||l.Promise||(l.Promise=Promise);var T=Object.getPrototypeOf,j={}.hasOwnProperty;function z(i,s){return j.call(i,s)}function F(i,s){typeof s=="function"&&(s=s(T(i))),(typeof Reflect>"u"?c:Reflect.ownKeys)(s).forEach(function(a){Z(i,a,s[a])})}var N=Object.defineProperty;function Z(i,s,a,u){N(i,s,m(a&&z(a,"get")&&typeof a.get=="function"?{get:a.get,set:a.set,configurable:!0}:{value:a,configurable:!0,writable:!0},u))}function le(i){return{from:function(s){return i.prototype=Object.create(s.prototype),Z(i.prototype,"constructor",i),{extend:F.bind(null,i.prototype)}}}}var Ze=Object.getOwnPropertyDescriptor,Ce=[].slice;function et(i,s,a){return Ce.call(i,s,a)}function Ct(i,s){return s(i)}function ln(i){if(!i)throw new Error("Assertion Failed")}function zn(i){l.setImmediate?setImmediate(i):setTimeout(i,0)}function kt(i,s){if(typeof s=="string"&&z(i,s))return i[s];if(!s)return i;if(typeof s!="string"){for(var a=[],u=0,d=s.length;u<d;++u){var h=kt(i,s[u]);a.push(h)}return a}var g=s.indexOf(".");if(g!==-1){var y=i[s.substr(0,g)];return y==null?void 0:kt(y,s.substr(g+1))}}function st(i,s,a){if(i&&s!==void 0&&!("isFrozen"in Object&&Object.isFrozen(i)))if(typeof s!="string"&&"length"in s){ln(typeof a!="string"&&"length"in a);for(var u=0,d=s.length;u<d;++u)st(i,s[u],a[u])}else{var h,g,y=s.indexOf(".");y!==-1?(h=s.substr(0,y),(g=s.substr(y+1))===""?a===void 0?f(i)&&!isNaN(parseInt(h))?i.splice(h,1):delete i[h]:i[h]=a:st(y=!(y=i[h])||!z(i,h)?i[h]={}:y,g,a)):a===void 0?f(i)&&!isNaN(parseInt(s))?i.splice(s,1):delete i[s]:i[s]=a}}function Ut(i){var s,a={};for(s in i)z(i,s)&&(a[s]=i[s]);return a}var Zn=[].concat;function En(i){return Zn.apply([],i)}var Kt="BigUint64Array,BigInt64Array,Array,Boolean,String,Date,RegExp,Blob,File,FileList,FileSystemFileHandle,FileSystemDirectoryHandle,ArrayBuffer,DataView,Uint8ClampedArray,ImageBitmap,ImageData,Map,Set,CryptoKey".split(",").concat(En([8,16,32,64].map(function(i){return["Int","Uint","Float"].map(function(s){return s+i+"Array"})}))).filter(function(i){return l[i]}),p=new Set(Kt.map(function(i){return l[i]})),w=null;function D(i){return w=new WeakMap,i=(function s(a){if(!a||typeof a!="object")return a;var u=w.get(a);if(u)return u;if(f(a)){u=[],w.set(a,u);for(var d=0,h=a.length;d<h;++d)u.push(s(a[d]))}else if(p.has(a.constructor))u=a;else{var g,y=T(a);for(g in u=y===Object.prototype?{}:Object.create(y),w.set(a,u),a)z(a,g)&&(u[g]=s(a[g]))}return u})(i),w=null,i}var b={}.toString;function x(i){return b.call(i).slice(8,-1)}var ie=typeof Symbol<"u"?Symbol.iterator:"@@iterator",ae=typeof ie=="symbol"?function(i){var s;return i!=null&&(s=i[ie])&&s.apply(i)}:function(){return null};function M(i,s){return s=i.indexOf(s),0<=s&&i.splice(s,1),0<=s}var W={};function Ie(i){var s,a,u,d;if(arguments.length===1){if(f(i))return i.slice();if(this===W&&typeof i=="string")return[i];if(d=ae(i)){for(a=[];!(u=d.next()).done;)a.push(u.value);return a}if(i==null)return[i];if(typeof(s=i.length)!="number")return[i];for(a=new Array(s);s--;)a[s]=i[s];return a}for(s=arguments.length,a=new Array(s);s--;)a[s]=arguments[s];return a}var Xe=typeof Symbol<"u"?function(i){return i[Symbol.toStringTag]==="AsyncFunction"}:function(){return!1},be=["Unknown","Constraint","Data","TransactionInactive","ReadOnly","Version","NotFound","InvalidState","InvalidAccess","Abort","Timeout","QuotaExceeded","Syntax","DataClone"],St=["Modify","Bulk","OpenFailed","VersionChange","Schema","Upgrade","InvalidTable","MissingAPI","NoSuchDatabase","InvalidArgument","SubTransaction","Unsupported","Internal","DatabaseClosed","PrematureCommit","ForeignAwait"].concat(be),It={VersionChanged:"Database version changed by other database connection",DatabaseClosed:"Database has been closed",Abort:"Transaction aborted",TransactionInactive:"Transaction has already completed or failed",MissingAPI:"IndexedDB API missing. Please visit https://tinyurl.com/y2uuvskb"};function Fe(i,s){this.name=i,this.message=s}function Pe(i,s){return i+". Errors: "+Object.keys(s).map(function(a){return s[a].toString()}).filter(function(a,u,d){return d.indexOf(a)===u}).join(`
`)}function me(i,s,a,u){this.failures=s,this.failedKeys=u,this.successCount=a,this.message=Pe(i,s)}function xe(i,s){this.name="BulkError",this.failures=Object.keys(s).map(function(a){return s[a]}),this.failuresByPos=s,this.message=Pe(i,this.failures)}le(Fe).from(Error).extend({toString:function(){return this.name+": "+this.message}}),le(me).from(Fe),le(xe).from(Fe);var Be=St.reduce(function(i,s){return i[s]=s+"Error",i},{}),ve=Fe,Q=St.reduce(function(i,s){var a=s+"Error";function u(d,h){this.name=a,d?typeof d=="string"?(this.message="".concat(d).concat(h?`
 `+h:""),this.inner=h||null):typeof d=="object"&&(this.message="".concat(d.name," ").concat(d.message),this.inner=d):(this.message=It[s]||a,this.inner=null)}return le(u).from(ve),i[s]=u,i},{});Q.Syntax=SyntaxError,Q.Type=TypeError,Q.Range=RangeError;var Le=be.reduce(function(i,s){return i[s+"Error"]=Q[s],i},{}),Ae=St.reduce(function(i,s){return["Syntax","Type","Range"].indexOf(s)===-1&&(i[s+"Error"]=Q[s]),i},{});function se(){}function fe(i){return i}function bt(i,s){return i==null||i===fe?s:function(a){return s(i(a))}}function re(i,s){return function(){i.apply(this,arguments),s.apply(this,arguments)}}function Me(i,s){return i===se?s:function(){var a=i.apply(this,arguments);a!==void 0&&(arguments[0]=a);var u=this.onsuccess,d=this.onerror;this.onsuccess=null,this.onerror=null;var h=s.apply(this,arguments);return u&&(this.onsuccess=this.onsuccess?re(u,this.onsuccess):u),d&&(this.onerror=this.onerror?re(d,this.onerror):d),h!==void 0?h:a}}function Qt(i,s){return i===se?s:function(){i.apply(this,arguments);var a=this.onsuccess,u=this.onerror;this.onsuccess=this.onerror=null,s.apply(this,arguments),a&&(this.onsuccess=this.onsuccess?re(a,this.onsuccess):a),u&&(this.onerror=this.onerror?re(u,this.onerror):u)}}function jt(i,s){return i===se?s:function(a){var u=i.apply(this,arguments);m(a,u);var d=this.onsuccess,h=this.onerror;return this.onsuccess=null,this.onerror=null,a=s.apply(this,arguments),d&&(this.onsuccess=this.onsuccess?re(d,this.onsuccess):d),h&&(this.onerror=this.onerror?re(h,this.onerror):h),u===void 0?a===void 0?void 0:a:m(u,a)}}function qe(i,s){return i===se?s:function(){return s.apply(this,arguments)!==!1&&i.apply(this,arguments)}}function yt(i,s){return i===se?s:function(){var a=i.apply(this,arguments);if(a&&typeof a.then=="function"){for(var u=this,d=arguments.length,h=new Array(d);d--;)h[d]=arguments[d];return a.then(function(){return s.apply(u,h)})}return s.apply(this,arguments)}}Ae.ModifyError=me,Ae.DexieError=Fe,Ae.BulkError=xe;var ke=typeof location<"u"&&/^(http|https):\/\/(localhost|127\.0\.0\.1)/.test(location.href);function Oe(i){ke=i}var ht={},We=100,Kt=typeof Promise>"u"?[]:(function(){var i=Promise.resolve();if(typeof crypto>"u"||!crypto.subtle)return[i,T(i),i];var s=crypto.subtle.digest("SHA-512",new Uint8Array([0]));return[s,T(s),i]})(),be=Kt[0],St=Kt[1],Kt=Kt[2],St=St&&St.then,ge=be&&be.constructor,vt=!!Kt,De=function(i,s){Ke.push([i,s]),Qe&&(queueMicrotask(ce),Qe=!1)},at=!0,Qe=!0,He=[],je=[],oe=fe,Ne={id:"global",global:!0,ref:0,unhandleds:[],onunhandled:se,pgp:!1,env:{},finalize:se},K=Ne,Ke=[],tt=0,mt=[];function V(i){if(typeof this!="object")throw new TypeError("Promises must be constructed via new");this._listeners=[],this._lib=!1;var s=this._PSD=K;if(typeof i!="function"){if(i!==ht)throw new TypeError("Not a function");return this._state=arguments[1],this._value=arguments[2],void(this._state===!1&&Je(this,this._value))}this._state=null,this._value=null,++s.ref,(function a(u,d){try{d(function(h){if(u._state===null){if(h===u)throw new TypeError("A promise cannot be resolved with itself.");var g=u._lib&&Se();h&&typeof h.then=="function"?a(u,function(y,$){h instanceof V?h._then(y,$):h.then(y,$)}):(u._state=!0,u._value=h,Jt(u)),g&&Re()}},Je.bind(null,u))}catch(h){Je(u,h)}})(this,i)}var Bt={get:function(){var i=K,s=nr;function a(u,d){var h=this,g=!i.global&&(i!==K||s!==nr),y=g&&!en(),$=new V(function(C,_){ee(h,new Wt(Xi(u,i,g,y),Xi(d,i,g,y),C,_,i))});return this._consoleTask&&($._consoleTask=this._consoleTask),$}return a.prototype=ht,a},set:function(i){Z(this,"then",i&&i.prototype===ht?Bt:{get:function(){return i},set:Bt.set})}};function Wt(i,s,a,u,d){this.onFulfilled=typeof i=="function"?i:null,this.onRejected=typeof s=="function"?s:null,this.resolve=a,this.reject=u,this.psd=d}function Je(i,s){var a,u;je.push(s),i._state===null&&(a=i._lib&&Se(),s=oe(s),i._state=!1,i._value=s,u=i,He.some(function(d){return d._value===u._value})||He.push(u),Jt(i),a&&Re())}function Jt(i){var s=i._listeners;i._listeners=[];for(var a=0,u=s.length;a<u;++a)ee(i,s[a]);var d=i._PSD;--d.ref||d.finalize(),tt===0&&(++tt,De(function(){--tt==0&&$e()},[]))}function ee(i,s){if(i._state!==null){var a=i._state?s.onFulfilled:s.onRejected;if(a===null)return(i._state?s.resolve:s.reject)(i._value);++s.psd.ref,++tt,De(we,[a,i,s])}else i._listeners.push(s)}function we(i,s,a){try{var u,d=s._value;!s._state&&je.length&&(je=[]),u=ke&&s._consoleTask?s._consoleTask.run(function(){return i(d)}):i(d),s._state||je.indexOf(d)!==-1||(function(h){for(var g=He.length;g;)if(He[--g]._value===h._value)return He.splice(g,1)})(s),a.resolve(u)}catch(h){a.reject(h)}finally{--tt==0&&$e(),--a.psd.ref||a.psd.finalize()}}function ce(){cn(Ne,function(){Se()&&Re()})}function Se(){var i=at;return Qe=at=!1,i}function Re(){var i,s,a;do for(;0<Ke.length;)for(i=Ke,Ke=[],a=i.length,s=0;s<a;++s){var u=i[s];u[0].apply(null,u[1])}while(0<Ke.length);Qe=at=!0}function $e(){var i=He;He=[],i.forEach(function(u){u._PSD.onunhandled.call(null,u._value,u)});for(var s=mt.slice(0),a=s.length;a;)s[--a]()}function Tt(i){return new V(ht,!1,i)}function Te(i,s){var a=K;return function(){var u=Se(),d=K;try{return tn(a,!0),i.apply(this,arguments)}catch(h){s&&s(h)}finally{tn(d,!1),u&&Re()}}}F(V.prototype,{then:Bt,_then:function(i,s){ee(this,new Wt(null,null,i,s,K))},catch:function(i){if(arguments.length===1)return this.then(null,i);var s=i,a=arguments[1];return typeof s=="function"?this.then(null,function(u){return(u instanceof s?a:Tt)(u)}):this.then(null,function(u){return(u&&u.name===s?a:Tt)(u)})},finally:function(i){return this.then(function(s){return V.resolve(i()).then(function(){return s})},function(s){return V.resolve(i()).then(function(){return Tt(s)})})},timeout:function(i,s){var a=this;return i<1/0?new V(function(u,d){var h=setTimeout(function(){return d(new Q.Timeout(s))},i);a.then(u,d).finally(clearTimeout.bind(null,h))}):this}}),typeof Symbol<"u"&&Symbol.toStringTag&&Z(V.prototype,Symbol.toStringTag,"Dexie.Promise"),Ne.env=Yi(),F(V,{all:function(){var i=Ie.apply(null,arguments).map(rr);return new V(function(s,a){i.length===0&&s([]);var u=i.length;i.forEach(function(d,h){return V.resolve(d).then(function(g){i[h]=g,--u||s(i)},a)})})},resolve:function(i){return i instanceof V?i:i&&typeof i.then=="function"?new V(function(s,a){i.then(s,a)}):new V(ht,!0,i)},reject:Tt,race:function(){var i=Ie.apply(null,arguments).map(rr);return new V(function(s,a){i.map(function(u){return V.resolve(u).then(s,a)})})},PSD:{get:function(){return K},set:function(i){return K=i}},totalEchoes:{get:function(){return nr}},newPSD:Zt,usePSD:cn,scheduler:{get:function(){return De},set:function(i){De=i}},rejectionMapper:{get:function(){return oe},set:function(i){oe=i}},follow:function(i,s){return new V(function(a,u){return Zt(function(d,h){var g=K;g.unhandleds=[],g.onunhandled=h,g.finalize=re(function(){var y,$=this;y=function(){$.unhandleds.length===0?d():h($.unhandleds[0])},mt.push(function C(){y(),mt.splice(mt.indexOf(C),1)}),++tt,De(function(){--tt==0&&$e()},[])},g.finalize),i()},s,a,u)})}}),ge&&(ge.allSettled&&Z(V,"allSettled",function(){var i=Ie.apply(null,arguments).map(rr);return new V(function(s){i.length===0&&s([]);var a=i.length,u=new Array(a);i.forEach(function(d,h){return V.resolve(d).then(function(g){return u[h]={status:"fulfilled",value:g}},function(g){return u[h]={status:"rejected",reason:g}}).then(function(){return--a||s(u)})})})}),ge.any&&typeof AggregateError<"u"&&Z(V,"any",function(){var i=Ie.apply(null,arguments).map(rr);return new V(function(s,a){i.length===0&&a(new AggregateError([]));var u=i.length,d=new Array(u);i.forEach(function(h,g){return V.resolve(h).then(function(y){return s(y)},function(y){d[g]=y,--u||a(new AggregateError(d))})})})}),ge.withResolvers&&(V.withResolvers=ge.withResolvers));var nt={awaits:0,echoes:0,id:0},Ys=0,er=[],tr=0,nr=0,Xs=0;function Zt(i,s,a,u){var d=K,h=Object.create(d);return h.parent=d,h.ref=0,h.global=!1,h.id=++Xs,Ne.env,h.env=vt?{Promise:V,PromiseProp:{value:V,configurable:!0,writable:!0},all:V.all,race:V.race,allSettled:V.allSettled,any:V.any,resolve:V.resolve,reject:V.reject}:{},s&&m(h,s),++d.ref,h.finalize=function(){--this.parent.ref||this.parent.finalize()},u=cn(h,i,a,u),h.ref===0&&h.finalize(),u}function Cn(){return nt.id||(nt.id=++Ys),++nt.awaits,nt.echoes+=We,nt.id}function en(){return!!nt.awaits&&(--nt.awaits==0&&(nt.id=0),nt.echoes=nt.awaits*We,!0)}function rr(i){return nt.echoes&&i&&i.constructor===ge?(Cn(),i.then(function(s){return en(),s},function(s){return en(),Ve(s)})):i}function Gs(){var i=er[er.length-1];er.pop(),tn(i,!1)}function tn(i,s){var a,u=K;(s?!nt.echoes||tr++&&i===K:!tr||--tr&&i===K)||queueMicrotask(s?function(d){++nr,nt.echoes&&--nt.echoes!=0||(nt.echoes=nt.awaits=nt.id=0),er.push(K),tn(d,!0)}.bind(null,i):Gs),i!==K&&(K=i,u===Ne&&(Ne.env=Yi()),vt&&(a=Ne.env.Promise,s=i.env,(u.global||i.global)&&(Object.defineProperty(l,"Promise",s.PromiseProp),a.all=s.all,a.race=s.race,a.resolve=s.resolve,a.reject=s.reject,s.allSettled&&(a.allSettled=s.allSettled),s.any&&(a.any=s.any))))}function Yi(){var i=l.Promise;return vt?{Promise:i,PromiseProp:Object.getOwnPropertyDescriptor(l,"Promise"),all:i.all,race:i.race,allSettled:i.allSettled,any:i.any,resolve:i.resolve,reject:i.reject}:{}}function cn(i,s,a,u,d){var h=K;try{return tn(i,!0),s(a,u,d)}finally{tn(h,!1)}}function Xi(i,s,a,u){return typeof i!="function"?i:function(){var d=K;a&&Cn(),tn(s,!0);try{return i.apply(this,arguments)}finally{tn(d,!1),u&&queueMicrotask(en)}}}function Yr(i){Promise===ge&&nt.echoes===0?tr===0?i():enqueueNativeMicroTask(i):setTimeout(i,0)}(""+St).indexOf("[native code]")===-1&&(Cn=en=se);var Ve=V.reject,un="￿",Ht="Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.",Gi="String expected.",kn=[],ir="__dbnames",Xr="readonly",Gr="readwrite";function dn(i,s){return i?s?function(){return i.apply(this,arguments)&&s.apply(this,arguments)}:i:s}var Qi={type:3,lower:-1/0,lowerOpen:!1,upper:[[]],upperOpen:!1};function or(i){return typeof i!="string"||/\./.test(i)?function(s){return s}:function(s){return s[i]===void 0&&i in s&&delete(s=D(s))[i],s}}function Ji(){throw Q.Type()}function ye(i,s){try{var a=Zi(i),u=Zi(s);if(a!==u)return a==="Array"?1:u==="Array"?-1:a==="binary"?1:u==="binary"?-1:a==="string"?1:u==="string"?-1:a==="Date"?1:u!=="Date"?NaN:-1;switch(a){case"number":case"Date":case"string":return s<i?1:i<s?-1:0;case"binary":return(function(d,h){for(var g=d.length,y=h.length,$=g<y?g:y,C=0;C<$;++C)if(d[C]!==h[C])return d[C]<h[C]?-1:1;return g===y?0:g<y?-1:1})(eo(i),eo(s));case"Array":return(function(d,h){for(var g=d.length,y=h.length,$=g<y?g:y,C=0;C<$;++C){var _=ye(d[C],h[C]);if(_!==0)return _}return g===y?0:g<y?-1:1})(i,s)}}catch{}return NaN}function Zi(i){var s=typeof i;return s!="object"?s:ArrayBuffer.isView(i)?"binary":(i=x(i),i==="ArrayBuffer"?"binary":i)}function eo(i){return i instanceof Uint8Array?i:ArrayBuffer.isView(i)?new Uint8Array(i.buffer,i.byteOffset,i.byteLength):new Uint8Array(i)}var to=(ze.prototype._trans=function(i,s,a){var u=this._tx||K.trans,d=this.name,h=ke&&typeof console<"u"&&console.createTask&&console.createTask("Dexie: ".concat(i==="readonly"?"read":"write"," ").concat(this.name));function g(C,_,v){if(!v.schema[d])throw new Q.NotFound("Table "+d+" not part of transaction");return s(v.idbtrans,v)}var y=Se();try{var $=u&&u.db._novip===this.db._novip?u===K.trans?u._promise(i,g,a):Zt(function(){return u._promise(i,g,a)},{trans:u,transless:K.transless||K}):(function C(_,v,A,E){if(_.idbdb&&(_._state.openComplete||K.letThrough||_._vip)){var S=_._createTransaction(v,A,_._dbSchema);try{S.create(),_._state.PR1398_maxLoop=3}catch(P){return P.name===Be.InvalidState&&_.isOpen()&&0<--_._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),_.close({disableAutoOpen:!1}),_.open().then(function(){return C(_,v,A,E)})):Ve(P)}return S._promise(v,function(P,k){return Zt(function(){return K.trans=S,E(P,k,S)})}).then(function(P){if(v==="readwrite")try{S.idbtrans.commit()}catch{}return v==="readonly"?P:S._completion.then(function(){return P})})}if(_._state.openComplete)return Ve(new Q.DatabaseClosed(_._state.dbOpenError));if(!_._state.isBeingOpened){if(!_._state.autoOpen)return Ve(new Q.DatabaseClosed);_.open().catch(se)}return _._state.dbReadyPromise.then(function(){return C(_,v,A,E)})})(this.db,i,[this.name],g);return h&&($._consoleTask=h,$=$.catch(function(C){return console.trace(C),Ve(C)})),$}finally{y&&Re()}},ze.prototype.get=function(i,s){var a=this;return i&&i.constructor===Object?this.where(i).first(s):i==null?Ve(new Q.Type("Invalid argument to Table.get()")):this._trans("readonly",function(u){return a.core.get({trans:u,key:i}).then(function(d){return a.hook.reading.fire(d)})}).then(s)},ze.prototype.where=function(i){if(typeof i=="string")return new this.db.WhereClause(this,i);if(f(i))return new this.db.WhereClause(this,"[".concat(i.join("+"),"]"));var s=c(i);if(s.length===1)return this.where(s[0]).equals(i[s[0]]);var a=this.schema.indexes.concat(this.schema.primKey).filter(function(y){if(y.compound&&s.every(function(C){return 0<=y.keyPath.indexOf(C)})){for(var $=0;$<s.length;++$)if(s.indexOf(y.keyPath[$])===-1)return!1;return!0}return!1}).sort(function(y,$){return y.keyPath.length-$.keyPath.length})[0];if(a&&this.db._maxKey!==un){var h=a.keyPath.slice(0,s.length);return this.where(h).equals(h.map(function($){return i[$]}))}!a&&ke&&console.warn("The query ".concat(JSON.stringify(i)," on ").concat(this.name," would benefit from a ")+"compound index [".concat(s.join("+"),"]"));var u=this.schema.idxByName;function d(y,$){return ye(y,$)===0}var g=s.reduce(function(v,$){var C=v[0],_=v[1],v=u[$],A=i[$];return[C||v,C||!v?dn(_,v&&v.multi?function(E){return E=kt(E,$),f(E)&&E.some(function(S){return d(A,S)})}:function(E){return d(A,kt(E,$))}):_]},[null,null]),h=g[0],g=g[1];return h?this.where(h.name).equals(i[h.keyPath]).filter(g):a?this.filter(g):this.where(s).equals("")},ze.prototype.filter=function(i){return this.toCollection().and(i)},ze.prototype.count=function(i){return this.toCollection().count(i)},ze.prototype.offset=function(i){return this.toCollection().offset(i)},ze.prototype.limit=function(i){return this.toCollection().limit(i)},ze.prototype.each=function(i){return this.toCollection().each(i)},ze.prototype.toArray=function(i){return this.toCollection().toArray(i)},ze.prototype.toCollection=function(){return new this.db.Collection(new this.db.WhereClause(this))},ze.prototype.orderBy=function(i){return new this.db.Collection(new this.db.WhereClause(this,f(i)?"[".concat(i.join("+"),"]"):i))},ze.prototype.reverse=function(){return this.toCollection().reverse()},ze.prototype.mapToClass=function(i){var s,a=this.db,u=this.name;function d(){return s!==null&&s.apply(this,arguments)||this}(this.schema.mappedClass=i).prototype instanceof Ji&&((function($,C){if(typeof C!="function"&&C!==null)throw new TypeError("Class extends value "+String(C)+" is not a constructor or null");function _(){this.constructor=$}r($,C),$.prototype=C===null?Object.create(C):(_.prototype=C.prototype,new _)})(d,s=i),Object.defineProperty(d.prototype,"db",{get:function(){return a},enumerable:!1,configurable:!0}),d.prototype.table=function(){return u},i=d);for(var h=new Set,g=i.prototype;g;g=T(g))Object.getOwnPropertyNames(g).forEach(function($){return h.add($)});function y($){if(!$)return $;var C,_=Object.create(i.prototype);for(C in $)if(!h.has(C))try{_[C]=$[C]}catch{}return _}return this.schema.readHook&&this.hook.reading.unsubscribe(this.schema.readHook),this.schema.readHook=y,this.hook("reading",y),i},ze.prototype.defineClass=function(){return this.mapToClass(function(i){m(this,i)})},ze.prototype.add=function(i,s){var a=this,u=this.schema.primKey,d=u.auto,h=u.keyPath,g=i;return h&&d&&(g=or(h)(i)),this._trans("readwrite",function(y){return a.core.mutate({trans:y,type:"add",keys:s!=null?[s]:null,values:[g]})}).then(function(y){return y.numFailures?V.reject(y.failures[0]):y.lastResult}).then(function(y){if(h)try{st(i,h,y)}catch{}return y})},ze.prototype.update=function(i,s){return typeof i!="object"||f(i)?this.where(":id").equals(i).modify(s):(i=kt(i,this.schema.primKey.keyPath),i===void 0?Ve(new Q.InvalidArgument("Given object does not contain its primary key")):this.where(":id").equals(i).modify(s))},ze.prototype.put=function(i,s){var a=this,u=this.schema.primKey,d=u.auto,h=u.keyPath,g=i;return h&&d&&(g=or(h)(i)),this._trans("readwrite",function(y){return a.core.mutate({trans:y,type:"put",values:[g],keys:s!=null?[s]:null})}).then(function(y){return y.numFailures?V.reject(y.failures[0]):y.lastResult}).then(function(y){if(h)try{st(i,h,y)}catch{}return y})},ze.prototype.delete=function(i){var s=this;return this._trans("readwrite",function(a){return s.core.mutate({trans:a,type:"delete",keys:[i]})}).then(function(a){return a.numFailures?V.reject(a.failures[0]):void 0})},ze.prototype.clear=function(){var i=this;return this._trans("readwrite",function(s){return i.core.mutate({trans:s,type:"deleteRange",range:Qi})}).then(function(s){return s.numFailures?V.reject(s.failures[0]):void 0})},ze.prototype.bulkGet=function(i){var s=this;return this._trans("readonly",function(a){return s.core.getMany({keys:i,trans:a}).then(function(u){return u.map(function(d){return s.hook.reading.fire(d)})})})},ze.prototype.bulkAdd=function(i,s,a){var u=this,d=Array.isArray(s)?s:void 0,h=(a=a||(d?void 0:s))?a.allKeys:void 0;return this._trans("readwrite",function(g){var C=u.schema.primKey,y=C.auto,C=C.keyPath;if(C&&d)throw new Q.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");if(d&&d.length!==i.length)throw new Q.InvalidArgument("Arguments objects and keys must have the same length");var $=i.length,C=C&&y?i.map(or(C)):i;return u.core.mutate({trans:g,type:"add",keys:d,values:C,wantResults:h}).then(function(S){var v=S.numFailures,A=S.results,E=S.lastResult,S=S.failures;if(v===0)return h?A:E;throw new xe("".concat(u.name,".bulkAdd(): ").concat(v," of ").concat($," operations failed"),S)})})},ze.prototype.bulkPut=function(i,s,a){var u=this,d=Array.isArray(s)?s:void 0,h=(a=a||(d?void 0:s))?a.allKeys:void 0;return this._trans("readwrite",function(g){var C=u.schema.primKey,y=C.auto,C=C.keyPath;if(C&&d)throw new Q.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");if(d&&d.length!==i.length)throw new Q.InvalidArgument("Arguments objects and keys must have the same length");var $=i.length,C=C&&y?i.map(or(C)):i;return u.core.mutate({trans:g,type:"put",keys:d,values:C,wantResults:h}).then(function(S){var v=S.numFailures,A=S.results,E=S.lastResult,S=S.failures;if(v===0)return h?A:E;throw new xe("".concat(u.name,".bulkPut(): ").concat(v," of ").concat($," operations failed"),S)})})},ze.prototype.bulkUpdate=function(i){var s=this,a=this.core,u=i.map(function(g){return g.key}),d=i.map(function(g){return g.changes}),h=[];return this._trans("readwrite",function(g){return a.getMany({trans:g,keys:u,cache:"clone"}).then(function(y){var $=[],C=[];i.forEach(function(v,A){var E=v.key,S=v.changes,P=y[A];if(P){for(var k=0,R=Object.keys(S);k<R.length;k++){var I=R[k],B=S[I];if(I===s.schema.primKey.keyPath){if(ye(B,E)!==0)throw new Q.Constraint("Cannot update primary key in bulkUpdate()")}else st(P,I,B)}h.push(A),$.push(E),C.push(P)}});var _=$.length;return a.mutate({trans:g,type:"put",keys:$,values:C,updates:{keys:u,changeSpecs:d}}).then(function(v){var A=v.numFailures,E=v.failures;if(A===0)return _;for(var S=0,P=Object.keys(E);S<P.length;S++){var k,R=P[S],I=h[Number(R)];I!=null&&(k=E[R],delete E[R],E[I]=k)}throw new xe("".concat(s.name,".bulkUpdate(): ").concat(A," of ").concat(_," operations failed"),E)})})})},ze.prototype.bulkDelete=function(i){var s=this,a=i.length;return this._trans("readwrite",function(u){return s.core.mutate({trans:u,type:"delete",keys:i})}).then(function(g){var d=g.numFailures,h=g.lastResult,g=g.failures;if(d===0)return h;throw new xe("".concat(s.name,".bulkDelete(): ").concat(d," of ").concat(a," operations failed"),g)})},ze);function ze(){}function In(i){function s(g,y){if(y){for(var $=arguments.length,C=new Array($-1);--$;)C[$-1]=arguments[$];return a[g].subscribe.apply(null,C),i}if(typeof g=="string")return a[g]}var a={};s.addEventType=h;for(var u=1,d=arguments.length;u<d;++u)h(arguments[u]);return s;function h(g,y,$){if(typeof g!="object"){var C;y=y||qe;var _={subscribers:[],fire:$=$||se,subscribe:function(v){_.subscribers.indexOf(v)===-1&&(_.subscribers.push(v),_.fire=y(_.fire,v))},unsubscribe:function(v){_.subscribers=_.subscribers.filter(function(A){return A!==v}),_.fire=_.subscribers.reduce(y,$)}};return a[g]=s[g]=_}c(C=g).forEach(function(v){var A=C[v];if(f(A))h(v,C[v][0],C[v][1]);else{if(A!=="asap")throw new Q.InvalidArgument("Invalid event config");var E=h(v,fe,function(){for(var S=arguments.length,P=new Array(S);S--;)P[S]=arguments[S];E.subscribers.forEach(function(k){zn(function(){k.apply(null,P)})})})}})}}function Bn(i,s){return le(s).from({prototype:i}),s}function Sn(i,s){return!(i.filter||i.algorithm||i.or)&&(s?i.justLimit:!i.replayFilter)}function Qr(i,s){i.filter=dn(i.filter,s)}function Jr(i,s,a){var u=i.replayFilter;i.replayFilter=u?function(){return dn(u(),s())}:s,i.justLimit=a&&!u}function sr(i,s){if(i.isPrimKey)return s.primaryKey;var a=s.getIndexByKeyPath(i.index);if(!a)throw new Q.Schema("KeyPath "+i.index+" on object store "+s.name+" is not indexed");return a}function no(i,s,a){var u=sr(i,s.schema);return s.openCursor({trans:a,values:!i.keysOnly,reverse:i.dir==="prev",unique:!!i.unique,query:{index:u,range:i.range}})}function ar(i,s,a,u){var d=i.replayFilter?dn(i.filter,i.replayFilter()):i.filter;if(i.or){var h={},g=function(y,$,C){var _,v;d&&!d($,C,function(A){return $.stop(A)},function(A){return $.fail(A)})||((v=""+(_=$.primaryKey))=="[object ArrayBuffer]"&&(v=""+new Uint8Array(_)),z(h,v)||(h[v]=!0,s(y,$,C)))};return Promise.all([i.or._iterate(g,a),ro(no(i,u,a),i.algorithm,g,!i.keysOnly&&i.valueMapper)])}return ro(no(i,u,a),dn(i.algorithm,d),s,!i.keysOnly&&i.valueMapper)}function ro(i,s,a,u){var d=Te(u?function(h,g,y){return a(u(h),g,y)}:a);return i.then(function(h){if(h)return h.start(function(){var g=function(){return h.continue()};s&&!s(h,function(y){return g=y},function(y){h.stop(y),g=se},function(y){h.fail(y),g=se})||d(h.value,h,function(y){return g=y}),g()})})}var Kt=Symbol(),Ln=(io.prototype.execute=function(i){if(this.add!==void 0){var s=this.add;if(f(s))return n(n([],f(i)?i:[],!0),s).sort();if(typeof s=="number")return(Number(i)||0)+s;if(typeof s=="bigint")try{return BigInt(i)+s}catch{return BigInt(0)+s}throw new TypeError("Invalid term ".concat(s))}if(this.remove!==void 0){var a=this.remove;if(f(a))return f(i)?i.filter(function(u){return!a.includes(u)}).sort():[];if(typeof a=="number")return Number(i)-a;if(typeof a=="bigint")try{return BigInt(i)-a}catch{return BigInt(0)-a}throw new TypeError("Invalid subtrahend ".concat(a))}return s=(s=this.replacePrefix)===null||s===void 0?void 0:s[0],s&&typeof i=="string"&&i.startsWith(s)?this.replacePrefix[1]+i.substring(s.length):i},io);function io(i){Object.assign(this,i)}var Qs=(Ee.prototype._read=function(i,s){var a=this._ctx;return a.error?a.table._trans(null,Ve.bind(null,a.error)):a.table._trans("readonly",i).then(s)},Ee.prototype._write=function(i){var s=this._ctx;return s.error?s.table._trans(null,Ve.bind(null,s.error)):s.table._trans("readwrite",i,"locked")},Ee.prototype._addAlgorithm=function(i){var s=this._ctx;s.algorithm=dn(s.algorithm,i)},Ee.prototype._iterate=function(i,s){return ar(this._ctx,i,s,this._ctx.table.core)},Ee.prototype.clone=function(i){var s=Object.create(this.constructor.prototype),a=Object.create(this._ctx);return i&&m(a,i),s._ctx=a,s},Ee.prototype.raw=function(){return this._ctx.valueMapper=null,this},Ee.prototype.each=function(i){var s=this._ctx;return this._read(function(a){return ar(s,i,a,s.table.core)})},Ee.prototype.count=function(i){var s=this;return this._read(function(a){var u=s._ctx,d=u.table.core;if(Sn(u,!0))return d.count({trans:a,query:{index:sr(u,d.schema),range:u.range}}).then(function(g){return Math.min(g,u.limit)});var h=0;return ar(u,function(){return++h,!1},a,d).then(function(){return h})}).then(i)},Ee.prototype.sortBy=function(i,s){var a=i.split(".").reverse(),u=a[0],d=a.length-1;function h($,C){return C?h($[a[C]],C-1):$[u]}var g=this._ctx.dir==="next"?1:-1;function y($,C){return ye(h($,d),h(C,d))*g}return this.toArray(function($){return $.sort(y)}).then(s)},Ee.prototype.toArray=function(i){var s=this;return this._read(function(a){var u=s._ctx;if(u.dir==="next"&&Sn(u,!0)&&0<u.limit){var d=u.valueMapper,h=sr(u,u.table.core.schema);return u.table.core.query({trans:a,limit:u.limit,values:!0,query:{index:h,range:u.range}}).then(function(y){return y=y.result,d?y.map(d):y})}var g=[];return ar(u,function(y){return g.push(y)},a,u.table.core).then(function(){return g})},i)},Ee.prototype.offset=function(i){var s=this._ctx;return i<=0||(s.offset+=i,Sn(s)?Jr(s,function(){var a=i;return function(u,d){return a===0||(a===1?--a:d(function(){u.advance(a),a=0}),!1)}}):Jr(s,function(){var a=i;return function(){return--a<0}})),this},Ee.prototype.limit=function(i){return this._ctx.limit=Math.min(this._ctx.limit,i),Jr(this._ctx,function(){var s=i;return function(a,u,d){return--s<=0&&u(d),0<=s}},!0),this},Ee.prototype.until=function(i,s){return Qr(this._ctx,function(a,u,d){return!i(a.value)||(u(d),s)}),this},Ee.prototype.first=function(i){return this.limit(1).toArray(function(s){return s[0]}).then(i)},Ee.prototype.last=function(i){return this.reverse().first(i)},Ee.prototype.filter=function(i){var s;return Qr(this._ctx,function(a){return i(a.value)}),(s=this._ctx).isMatch=dn(s.isMatch,i),this},Ee.prototype.and=function(i){return this.filter(i)},Ee.prototype.or=function(i){return new this.db.WhereClause(this._ctx.table,i,this)},Ee.prototype.reverse=function(){return this._ctx.dir=this._ctx.dir==="prev"?"next":"prev",this._ondirectionchange&&this._ondirectionchange(this._ctx.dir),this},Ee.prototype.desc=function(){return this.reverse()},Ee.prototype.eachKey=function(i){var s=this._ctx;return s.keysOnly=!s.isMatch,this.each(function(a,u){i(u.key,u)})},Ee.prototype.eachUniqueKey=function(i){return this._ctx.unique="unique",this.eachKey(i)},Ee.prototype.eachPrimaryKey=function(i){var s=this._ctx;return s.keysOnly=!s.isMatch,this.each(function(a,u){i(u.primaryKey,u)})},Ee.prototype.keys=function(i){var s=this._ctx;s.keysOnly=!s.isMatch;var a=[];return this.each(function(u,d){a.push(d.key)}).then(function(){return a}).then(i)},Ee.prototype.primaryKeys=function(i){var s=this._ctx;if(s.dir==="next"&&Sn(s,!0)&&0<s.limit)return this._read(function(u){var d=sr(s,s.table.core.schema);return s.table.core.query({trans:u,values:!1,limit:s.limit,query:{index:d,range:s.range}})}).then(function(u){return u.result}).then(i);s.keysOnly=!s.isMatch;var a=[];return this.each(function(u,d){a.push(d.primaryKey)}).then(function(){return a}).then(i)},Ee.prototype.uniqueKeys=function(i){return this._ctx.unique="unique",this.keys(i)},Ee.prototype.firstKey=function(i){return this.limit(1).keys(function(s){return s[0]}).then(i)},Ee.prototype.lastKey=function(i){return this.reverse().firstKey(i)},Ee.prototype.distinct=function(){var i=this._ctx,i=i.index&&i.table.schema.idxByName[i.index];if(!i||!i.multi)return this;var s={};return Qr(this._ctx,function(d){var u=d.primaryKey.toString(),d=z(s,u);return s[u]=!0,!d}),this},Ee.prototype.modify=function(i){var s=this,a=this._ctx;return this._write(function(u){var d,h,g;g=typeof i=="function"?i:(d=c(i),h=d.length,function(k){for(var R=!1,I=0;I<h;++I){var B=d[I],L=i[B],q=kt(k,B);L instanceof Ln?(st(k,B,L.execute(q)),R=!0):q!==L&&(st(k,B,L),R=!0)}return R});var y=a.table.core,v=y.schema.primaryKey,$=v.outbound,C=v.extractKey,_=200,v=s.db._options.modifyChunkSize;v&&(_=typeof v=="object"?v[y.name]||v["*"]||200:v);function A(k,B){var I=B.failures,B=B.numFailures;S+=k-B;for(var L=0,q=c(I);L<q.length;L++){var X=q[L];E.push(I[X])}}var E=[],S=0,P=[];return s.clone().primaryKeys().then(function(k){function R(B){var L=Math.min(_,k.length-B);return y.getMany({trans:u,keys:k.slice(B,B+L),cache:"immutable"}).then(function(q){for(var X=[],U=[],H=$?[]:null,J=[],Y=0;Y<L;++Y){var te=q[Y],de={value:D(te),primKey:k[B+Y]};g.call(de,de.value,de)!==!1&&(de.value==null?J.push(k[B+Y]):$||ye(C(te),C(de.value))===0?(U.push(de.value),$&&H.push(k[B+Y])):(J.push(k[B+Y]),X.push(de.value)))}return Promise.resolve(0<X.length&&y.mutate({trans:u,type:"add",values:X}).then(function(he){for(var pe in he.failures)J.splice(parseInt(pe),1);A(X.length,he)})).then(function(){return(0<U.length||I&&typeof i=="object")&&y.mutate({trans:u,type:"put",keys:H,values:U,criteria:I,changeSpec:typeof i!="function"&&i,isAdditionalChunk:0<B}).then(function(he){return A(U.length,he)})}).then(function(){return(0<J.length||I&&i===Zr)&&y.mutate({trans:u,type:"delete",keys:J,criteria:I,isAdditionalChunk:0<B}).then(function(he){return A(J.length,he)})}).then(function(){return k.length>B+L&&R(B+_)})})}var I=Sn(a)&&a.limit===1/0&&(typeof i!="function"||i===Zr)&&{index:a.index,range:a.range};return R(0).then(function(){if(0<E.length)throw new me("Error modifying one or more objects",E,S,P);return k.length})})})},Ee.prototype.delete=function(){var i=this._ctx,s=i.range;return Sn(i)&&(i.isPrimKey||s.type===3)?this._write(function(a){var u=i.table.core.schema.primaryKey,d=s;return i.table.core.count({trans:a,query:{index:u,range:d}}).then(function(h){return i.table.core.mutate({trans:a,type:"deleteRange",range:d}).then(function(g){var y=g.failures;if(g.lastResult,g.results,g=g.numFailures,g)throw new me("Could not delete some values",Object.keys(y).map(function($){return y[$]}),h-g);return h-g})})}):this.modify(Zr)},Ee);function Ee(){}var Zr=function(i,s){return s.value=null};function Js(i,s){return i<s?-1:i===s?0:1}function Zs(i,s){return s<i?-1:i===s?0:1}function wt(i,s,a){return i=i instanceof so?new i.Collection(i):i,i._ctx.error=new(a||TypeError)(s),i}function _n(i){return new i.Collection(i,function(){return oo("")}).limit(0)}function lr(i,s,a,u){var d,h,g,y,$,C,_,v=a.length;if(!a.every(function(S){return typeof S=="string"}))return wt(i,Gi);function A(S){d=S==="next"?function(k){return k.toUpperCase()}:function(k){return k.toLowerCase()},h=S==="next"?function(k){return k.toLowerCase()}:function(k){return k.toUpperCase()},g=S==="next"?Js:Zs;var P=a.map(function(k){return{lower:h(k),upper:d(k)}}).sort(function(k,R){return g(k.lower,R.lower)});y=P.map(function(k){return k.upper}),$=P.map(function(k){return k.lower}),_=(C=S)==="next"?"":u}A("next"),i=new i.Collection(i,function(){return nn(y[0],$[v-1]+u)}),i._ondirectionchange=function(S){A(S)};var E=0;return i._addAlgorithm(function(S,P,k){var R=S.key;if(typeof R!="string")return!1;var I=h(R);if(s(I,$,E))return!0;for(var B=null,L=E;L<v;++L){var q=(function(X,U,H,J,Y,te){for(var de=Math.min(X.length,J.length),he=-1,pe=0;pe<de;++pe){var xt=U[pe];if(xt!==J[pe])return Y(X[pe],H[pe])<0?X.substr(0,pe)+H[pe]+H.substr(pe+1):Y(X[pe],J[pe])<0?X.substr(0,pe)+J[pe]+H.substr(pe+1):0<=he?X.substr(0,he)+U[he]+H.substr(he+1):null;Y(X[pe],xt)<0&&(he=pe)}return de<J.length&&te==="next"?X+H.substr(X.length):de<X.length&&te==="prev"?X.substr(0,H.length):he<0?null:X.substr(0,he)+J[he]+H.substr(he+1)})(R,I,y[L],$[L],g,C);q===null&&B===null?E=L+1:(B===null||0<g(B,q))&&(B=q)}return P(B!==null?function(){S.continue(B+_)}:k),!1}),i}function nn(i,s,a,u){return{type:2,lower:i,upper:s,lowerOpen:a,upperOpen:u}}function oo(i){return{type:1,lower:i,upper:i}}var so=(Object.defineProperty(rt.prototype,"Collection",{get:function(){return this._ctx.table.db.Collection},enumerable:!1,configurable:!0}),rt.prototype.between=function(i,s,a,u){a=a!==!1,u=u===!0;try{return 0<this._cmp(i,s)||this._cmp(i,s)===0&&(a||u)&&(!a||!u)?_n(this):new this.Collection(this,function(){return nn(i,s,!a,!u)})}catch{return wt(this,Ht)}},rt.prototype.equals=function(i){return i==null?wt(this,Ht):new this.Collection(this,function(){return oo(i)})},rt.prototype.above=function(i){return i==null?wt(this,Ht):new this.Collection(this,function(){return nn(i,void 0,!0)})},rt.prototype.aboveOrEqual=function(i){return i==null?wt(this,Ht):new this.Collection(this,function(){return nn(i,void 0,!1)})},rt.prototype.below=function(i){return i==null?wt(this,Ht):new this.Collection(this,function(){return nn(void 0,i,!1,!0)})},rt.prototype.belowOrEqual=function(i){return i==null?wt(this,Ht):new this.Collection(this,function(){return nn(void 0,i)})},rt.prototype.startsWith=function(i){return typeof i!="string"?wt(this,Gi):this.between(i,i+un,!0,!0)},rt.prototype.startsWithIgnoreCase=function(i){return i===""?this.startsWith(i):lr(this,function(s,a){return s.indexOf(a[0])===0},[i],un)},rt.prototype.equalsIgnoreCase=function(i){return lr(this,function(s,a){return s===a[0]},[i],"")},rt.prototype.anyOfIgnoreCase=function(){var i=Ie.apply(W,arguments);return i.length===0?_n(this):lr(this,function(s,a){return a.indexOf(s)!==-1},i,"")},rt.prototype.startsWithAnyOfIgnoreCase=function(){var i=Ie.apply(W,arguments);return i.length===0?_n(this):lr(this,function(s,a){return a.some(function(u){return s.indexOf(u)===0})},i,un)},rt.prototype.anyOf=function(){var i=this,s=Ie.apply(W,arguments),a=this._cmp;try{s.sort(a)}catch{return wt(this,Ht)}if(s.length===0)return _n(this);var u=new this.Collection(this,function(){return nn(s[0],s[s.length-1])});u._ondirectionchange=function(h){a=h==="next"?i._ascending:i._descending,s.sort(a)};var d=0;return u._addAlgorithm(function(h,g,y){for(var $=h.key;0<a($,s[d]);)if(++d===s.length)return g(y),!1;return a($,s[d])===0||(g(function(){h.continue(s[d])}),!1)}),u},rt.prototype.notEqual=function(i){return this.inAnyRange([[-1/0,i],[i,this.db._maxKey]],{includeLowers:!1,includeUppers:!1})},rt.prototype.noneOf=function(){var i=Ie.apply(W,arguments);if(i.length===0)return new this.Collection(this);try{i.sort(this._ascending)}catch{return wt(this,Ht)}var s=i.reduce(function(a,u){return a?a.concat([[a[a.length-1][1],u]]):[[-1/0,u]]},null);return s.push([i[i.length-1],this.db._maxKey]),this.inAnyRange(s,{includeLowers:!1,includeUppers:!1})},rt.prototype.inAnyRange=function(R,s){var a=this,u=this._cmp,d=this._ascending,h=this._descending,g=this._min,y=this._max;if(R.length===0)return _n(this);if(!R.every(function(I){return I[0]!==void 0&&I[1]!==void 0&&d(I[0],I[1])<=0}))return wt(this,"First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower",Q.InvalidArgument);var $=!s||s.includeLowers!==!1,C=s&&s.includeUppers===!0,_,v=d;function A(I,B){return v(I[0],B[0])}try{(_=R.reduce(function(I,B){for(var L=0,q=I.length;L<q;++L){var X=I[L];if(u(B[0],X[1])<0&&0<u(B[1],X[0])){X[0]=g(X[0],B[0]),X[1]=y(X[1],B[1]);break}}return L===q&&I.push(B),I},[])).sort(A)}catch{return wt(this,Ht)}var E=0,S=C?function(I){return 0<d(I,_[E][1])}:function(I){return 0<=d(I,_[E][1])},P=$?function(I){return 0<h(I,_[E][0])}:function(I){return 0<=h(I,_[E][0])},k=S,R=new this.Collection(this,function(){return nn(_[0][0],_[_.length-1][1],!$,!C)});return R._ondirectionchange=function(I){v=I==="next"?(k=S,d):(k=P,h),_.sort(A)},R._addAlgorithm(function(I,B,L){for(var q,X=I.key;k(X);)if(++E===_.length)return B(L),!1;return!S(q=X)&&!P(q)||(a._cmp(X,_[E][1])===0||a._cmp(X,_[E][0])===0||B(function(){v===d?I.continue(_[E][0]):I.continue(_[E][1])}),!1)}),R},rt.prototype.startsWithAnyOf=function(){var i=Ie.apply(W,arguments);return i.every(function(s){return typeof s=="string"})?i.length===0?_n(this):this.inAnyRange(i.map(function(s){return[s,s+un]})):wt(this,"startsWithAnyOf() only works with strings")},rt);function rt(){}function Lt(i){return Te(function(s){return Mn(s),i(s.target.error),!1})}function Mn(i){i.stopPropagation&&i.stopPropagation(),i.preventDefault&&i.preventDefault()}var Nn="storagemutated",ei="x-storagemutated-1",rn=In(null,Nn),ea=(Mt.prototype._lock=function(){return ln(!K.global),++this._reculock,this._reculock!==1||K.global||(K.lockOwnerFor=this),this},Mt.prototype._unlock=function(){if(ln(!K.global),--this._reculock==0)for(K.global||(K.lockOwnerFor=null);0<this._blockedFuncs.length&&!this._locked();){var i=this._blockedFuncs.shift();try{cn(i[1],i[0])}catch{}}return this},Mt.prototype._locked=function(){return this._reculock&&K.lockOwnerFor!==this},Mt.prototype.create=function(i){var s=this;if(!this.mode)return this;var a=this.db.idbdb,u=this.db._state.dbOpenError;if(ln(!this.idbtrans),!i&&!a)switch(u&&u.name){case"DatabaseClosedError":throw new Q.DatabaseClosed(u);case"MissingAPIError":throw new Q.MissingAPI(u.message,u);default:throw new Q.OpenFailed(u)}if(!this.active)throw new Q.TransactionInactive;return ln(this._completion._state===null),(i=this.idbtrans=i||(this.db.core||a).transaction(this.storeNames,this.mode,{durability:this.chromeTransactionDurability})).onerror=Te(function(d){Mn(d),s._reject(i.error)}),i.onabort=Te(function(d){Mn(d),s.active&&s._reject(new Q.Abort(i.error)),s.active=!1,s.on("abort").fire(d)}),i.oncomplete=Te(function(){s.active=!1,s._resolve(),"mutatedParts"in i&&rn.storagemutated.fire(i.mutatedParts)}),this},Mt.prototype._promise=function(i,s,a){var u=this;if(i==="readwrite"&&this.mode!=="readwrite")return Ve(new Q.ReadOnly("Transaction is readonly"));if(!this.active)return Ve(new Q.TransactionInactive);if(this._locked())return new V(function(h,g){u._blockedFuncs.push([function(){u._promise(i,s,a).then(h,g)},K])});if(a)return Zt(function(){var h=new V(function(g,y){u._lock();var $=s(g,y,u);$&&$.then&&$.then(g,y)});return h.finally(function(){return u._unlock()}),h._lib=!0,h});var d=new V(function(h,g){var y=s(h,g,u);y&&y.then&&y.then(h,g)});return d._lib=!0,d},Mt.prototype._root=function(){return this.parent?this.parent._root():this},Mt.prototype.waitFor=function(i){var s,a=this._root(),u=V.resolve(i);a._waitingFor?a._waitingFor=a._waitingFor.then(function(){return u}):(a._waitingFor=u,a._waitingQueue=[],s=a.idbtrans.objectStore(a.storeNames[0]),(function h(){for(++a._spinCount;a._waitingQueue.length;)a._waitingQueue.shift()();a._waitingFor&&(s.get(-1/0).onsuccess=h)})());var d=a._waitingFor;return new V(function(h,g){u.then(function(y){return a._waitingQueue.push(Te(h.bind(null,y)))},function(y){return a._waitingQueue.push(Te(g.bind(null,y)))}).finally(function(){a._waitingFor===d&&(a._waitingFor=null)})})},Mt.prototype.abort=function(){this.active&&(this.active=!1,this.idbtrans&&this.idbtrans.abort(),this._reject(new Q.Abort))},Mt.prototype.table=function(i){var s=this._memoizedTables||(this._memoizedTables={});if(z(s,i))return s[i];var a=this.schema[i];if(!a)throw new Q.NotFound("Table "+i+" not part of transaction");return a=new this.db.Table(i,a,this),a.core=this.db.core.table(i),s[i]=a},Mt);function Mt(){}function ti(i,s,a,u,d,h,g){return{name:i,keyPath:s,unique:a,multi:u,auto:d,compound:h,src:(a&&!g?"&":"")+(u?"*":"")+(d?"++":"")+ao(s)}}function ao(i){return typeof i=="string"?i:i?"["+[].join.call(i,"+")+"]":""}function ni(i,s,a){return{name:i,primKey:s,indexes:a,mappedClass:null,idxByName:(u=function(d){return[d.name,d]},a.reduce(function(d,h,g){return g=u(h,g),g&&(d[g[0]]=g[1]),d},{}))};var u}var qn=function(i){try{return i.only([[]]),qn=function(){return[[]]},[[]]}catch{return qn=function(){return un},un}};function ri(i){return i==null?function(){}:typeof i=="string"?(s=i).split(".").length===1?function(a){return a[s]}:function(a){return kt(a,s)}:function(a){return kt(a,i)};var s}function lo(i){return[].slice.call(i)}var ta=0;function Un(i){return i==null?":id":typeof i=="string"?i:"[".concat(i.join("+"),"]")}function na(i,s,$){function u(k){if(k.type===3)return null;if(k.type===4)throw new Error("Cannot convert never type to IDBKeyRange");var E=k.lower,S=k.upper,P=k.lowerOpen,k=k.upperOpen;return E===void 0?S===void 0?null:s.upperBound(S,!!k):S===void 0?s.lowerBound(E,!!P):s.bound(E,S,!!P,!!k)}function d(A){var E,S=A.name;return{name:S,schema:A,mutate:function(P){var k=P.trans,R=P.type,I=P.keys,B=P.values,L=P.range;return new Promise(function(q,X){q=Te(q);var U=k.objectStore(S),H=U.keyPath==null,J=R==="put"||R==="add";if(!J&&R!=="delete"&&R!=="deleteRange")throw new Error("Invalid operation type: "+R);var Y,te=(I||B||{length:1}).length;if(I&&B&&I.length!==B.length)throw new Error("Given keys array must have same length as given values array.");if(te===0)return q({numFailures:0,failures:{},results:[],lastResult:void 0});function de(pt){++xt,Mn(pt)}var he=[],pe=[],xt=0;if(R==="deleteRange"){if(L.type===4)return q({numFailures:xt,failures:pe,results:[],lastResult:void 0});L.type===3?he.push(Y=U.clear()):he.push(Y=U.delete(u(L)))}else{var H=J?H?[B,I]:[B,null]:[I,null],ue=H[0],ct=H[1];if(J)for(var ut=0;ut<te;++ut)he.push(Y=ct&&ct[ut]!==void 0?U[R](ue[ut],ct[ut]):U[R](ue[ut])),Y.onerror=de;else for(ut=0;ut<te;++ut)he.push(Y=U[R](ue[ut])),Y.onerror=de}function xr(pt){pt=pt.target.result,he.forEach(function(pn,xi){return pn.error!=null&&(pe[xi]=pn.error)}),q({numFailures:xt,failures:pe,results:R==="delete"?I:he.map(function(pn){return pn.result}),lastResult:pt})}Y.onerror=function(pt){de(pt),xr(pt)},Y.onsuccess=xr})},getMany:function(P){var k=P.trans,R=P.keys;return new Promise(function(I,B){I=Te(I);for(var L,q=k.objectStore(S),X=R.length,U=new Array(X),H=0,J=0,Y=function(he){he=he.target,U[he._pos]=he.result,++J===H&&I(U)},te=Lt(B),de=0;de<X;++de)R[de]!=null&&((L=q.get(R[de]))._pos=de,L.onsuccess=Y,L.onerror=te,++H);H===0&&I(U)})},get:function(P){var k=P.trans,R=P.key;return new Promise(function(I,B){I=Te(I);var L=k.objectStore(S).get(R);L.onsuccess=function(q){return I(q.target.result)},L.onerror=Lt(B)})},query:(E=C,function(P){return new Promise(function(k,R){k=Te(k);var I,B,L,H=P.trans,q=P.values,X=P.limit,Y=P.query,U=X===1/0?void 0:X,J=Y.index,Y=Y.range,H=H.objectStore(S),J=J.isPrimaryKey?H:H.index(J.name),Y=u(Y);if(X===0)return k({result:[]});E?((U=q?J.getAll(Y,U):J.getAllKeys(Y,U)).onsuccess=function(te){return k({result:te.target.result})},U.onerror=Lt(R)):(I=0,B=!q&&"openKeyCursor"in J?J.openKeyCursor(Y):J.openCursor(Y),L=[],B.onsuccess=function(te){var de=B.result;return de?(L.push(q?de.value:de.primaryKey),++I===X?k({result:L}):void de.continue()):k({result:L})},B.onerror=Lt(R))})}),openCursor:function(P){var k=P.trans,R=P.values,I=P.query,B=P.reverse,L=P.unique;return new Promise(function(q,X){q=Te(q);var J=I.index,U=I.range,H=k.objectStore(S),H=J.isPrimaryKey?H:H.index(J.name),J=B?L?"prevunique":"prev":L?"nextunique":"next",Y=!R&&"openKeyCursor"in H?H.openKeyCursor(u(U),J):H.openCursor(u(U),J);Y.onerror=Lt(X),Y.onsuccess=Te(function(te){var de,he,pe,xt,ue=Y.result;ue?(ue.___id=++ta,ue.done=!1,de=ue.continue.bind(ue),he=(he=ue.continuePrimaryKey)&&he.bind(ue),pe=ue.advance.bind(ue),xt=function(){throw new Error("Cursor not stopped")},ue.trans=k,ue.stop=ue.continue=ue.continuePrimaryKey=ue.advance=function(){throw new Error("Cursor not started")},ue.fail=Te(X),ue.next=function(){var ct=this,ut=1;return this.start(function(){return ut--?ct.continue():ct.stop()}).then(function(){return ct})},ue.start=function(ct){function ut(){if(Y.result)try{ct()}catch(pt){ue.fail(pt)}else ue.done=!0,ue.start=function(){throw new Error("Cursor behind last entry")},ue.stop()}var xr=new Promise(function(pt,pn){pt=Te(pt),Y.onerror=Lt(pn),ue.fail=pn,ue.stop=function(xi){ue.stop=ue.continue=ue.continuePrimaryKey=ue.advance=xt,pt(xi)}});return Y.onsuccess=Te(function(pt){Y.onsuccess=ut,ut()}),ue.continue=de,ue.continuePrimaryKey=he,ue.advance=pe,ut(),xr},q(ue)):q(null)},X)})},count:function(P){var k=P.query,R=P.trans,I=k.index,B=k.range;return new Promise(function(L,q){var X=R.objectStore(S),U=I.isPrimaryKey?X:X.index(I.name),X=u(B),U=X?U.count(X):U.count();U.onsuccess=Te(function(H){return L(H.target.result)}),U.onerror=Lt(q)})}}}var h,g,y,_=(g=$,y=lo((h=i).objectStoreNames),{schema:{name:h.name,tables:y.map(function(A){return g.objectStore(A)}).map(function(A){var E=A.keyPath,k=A.autoIncrement,S=f(E),P={},k={name:A.name,primaryKey:{name:null,isPrimaryKey:!0,outbound:E==null,compound:S,keyPath:E,autoIncrement:k,unique:!0,extractKey:ri(E)},indexes:lo(A.indexNames).map(function(R){return A.index(R)}).map(function(L){var I=L.name,B=L.unique,q=L.multiEntry,L=L.keyPath,q={name:I,compound:f(L),keyPath:L,unique:B,multiEntry:q,extractKey:ri(L)};return P[Un(L)]=q}),getIndexByKeyPath:function(R){return P[Un(R)]}};return P[":id"]=k.primaryKey,E!=null&&(P[Un(E)]=k.primaryKey),k})},hasGetAll:0<y.length&&"getAll"in g.objectStore(y[0])&&!(typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604)}),$=_.schema,C=_.hasGetAll,_=$.tables.map(d),v={};return _.forEach(function(A){return v[A.name]=A}),{stack:"dbcore",transaction:i.transaction.bind(i),table:function(A){if(!v[A])throw new Error("Table '".concat(A,"' not found"));return v[A]},MIN_KEY:-1/0,MAX_KEY:qn(s),schema:$}}function ra(i,s,a,u){var d=a.IDBKeyRange;return a.indexedDB,{dbcore:(u=na(s,d,u),i.dbcore.reduce(function(h,g){return g=g.create,o(o({},h),g(h))},u))}}function cr(i,u){var a=u.db,u=ra(i._middlewares,a,i._deps,u);i.core=u.dbcore,i.tables.forEach(function(d){var h=d.name;i.core.schema.tables.some(function(g){return g.name===h})&&(d.core=i.core.table(h),i[h]instanceof i.Table&&(i[h].core=d.core))})}function ur(i,s,a,u){a.forEach(function(d){var h=u[d];s.forEach(function(g){var y=(function $(C,_){return Ze(C,_)||(C=T(C))&&$(C,_)})(g,d);(!y||"value"in y&&y.value===void 0)&&(g===i.Transaction.prototype||g instanceof i.Transaction?Z(g,d,{get:function(){return this.table(d)},set:function($){N(this,d,{value:$,writable:!0,configurable:!0,enumerable:!0})}}):g[d]=new i.Table(d,h))})})}function ii(i,s){s.forEach(function(a){for(var u in a)a[u]instanceof i.Table&&delete a[u]})}function ia(i,s){return i._cfg.version-s._cfg.version}function oa(i,s,a,u){var d=i._dbSchema;a.objectStoreNames.contains("$meta")&&!d.$meta&&(d.$meta=ni("$meta",uo("")[0],[]),i._storeNames.push("$meta"));var h=i._createTransaction("readwrite",i._storeNames,d);h.create(a),h._completion.catch(u);var g=h._reject.bind(h),y=K.transless||K;Zt(function(){return K.trans=h,K.transless=y,s!==0?(cr(i,a),C=s,(($=h).storeNames.includes("$meta")?$.table("$meta").get("version").then(function(_){return _??C}):V.resolve(C)).then(function(_){return A=_,E=h,S=a,P=[],_=(v=i)._versions,k=v._dbSchema=fr(0,v.idbdb,S),(_=_.filter(function(R){return R._cfg.version>=A})).length!==0?(_.forEach(function(R){P.push(function(){var I=k,B=R._cfg.dbschema;hr(v,I,S),hr(v,B,S),k=v._dbSchema=B;var L=oi(I,B);L.add.forEach(function(J){si(S,J[0],J[1].primKey,J[1].indexes)}),L.change.forEach(function(J){if(J.recreate)throw new Q.Upgrade("Not yet support for changing primary key");var Y=S.objectStore(J.name);J.add.forEach(function(te){return dr(Y,te)}),J.change.forEach(function(te){Y.deleteIndex(te.name),dr(Y,te)}),J.del.forEach(function(te){return Y.deleteIndex(te)})});var q=R._cfg.contentUpgrade;if(q&&R._cfg.version>A){cr(v,S),E._memoizedTables={};var X=Ut(B);L.del.forEach(function(J){X[J]=I[J]}),ii(v,[v.Transaction.prototype]),ur(v,[v.Transaction.prototype],c(X),X),E.schema=X;var U,H=Xe(q);return H&&Cn(),L=V.follow(function(){var J;(U=q(E))&&H&&(J=en.bind(null,null),U.then(J,J))}),U&&typeof U.then=="function"?V.resolve(U):L.then(function(){return U})}}),P.push(function(I){var B,L,q=R._cfg.dbschema;B=q,L=I,[].slice.call(L.db.objectStoreNames).forEach(function(X){return B[X]==null&&L.db.deleteObjectStore(X)}),ii(v,[v.Transaction.prototype]),ur(v,[v.Transaction.prototype],v._storeNames,v._dbSchema),E.schema=v._dbSchema}),P.push(function(I){v.idbdb.objectStoreNames.contains("$meta")&&(Math.ceil(v.idbdb.version/10)===R._cfg.version?(v.idbdb.deleteObjectStore("$meta"),delete v._dbSchema.$meta,v._storeNames=v._storeNames.filter(function(B){return B!=="$meta"})):I.objectStore("$meta").put(R._cfg.version,"version"))})}),(function R(){return P.length?V.resolve(P.shift()(E.idbtrans)).then(R):V.resolve()})().then(function(){co(k,S)})):V.resolve();var v,A,E,S,P,k}).catch(g)):(c(d).forEach(function(_){si(a,_,d[_].primKey,d[_].indexes)}),cr(i,a),void V.follow(function(){return i.on.populate.fire(h)}).catch(g));var $,C})}function sa(i,s){co(i._dbSchema,s),s.db.version%10!=0||s.objectStoreNames.contains("$meta")||s.db.createObjectStore("$meta").add(Math.ceil(s.db.version/10-1),"version");var a=fr(0,i.idbdb,s);hr(i,i._dbSchema,s);for(var u=0,d=oi(a,i._dbSchema).change;u<d.length;u++){var h=(function(g){if(g.change.length||g.recreate)return console.warn("Unable to patch indexes of table ".concat(g.name," because it has changes on the type of index or primary key.")),{value:void 0};var y=s.objectStore(g.name);g.add.forEach(function($){ke&&console.debug("Dexie upgrade patch: Creating missing index ".concat(g.name,".").concat($.src)),dr(y,$)})})(d[u]);if(typeof h=="object")return h.value}}function oi(i,s){var a,u={del:[],add:[],change:[]};for(a in i)s[a]||u.del.push(a);for(a in s){var d=i[a],h=s[a];if(d){var g={name:a,def:h,recreate:!1,del:[],add:[],change:[]};if(""+(d.primKey.keyPath||"")!=""+(h.primKey.keyPath||"")||d.primKey.auto!==h.primKey.auto)g.recreate=!0,u.change.push(g);else{var y=d.idxByName,$=h.idxByName,C=void 0;for(C in y)$[C]||g.del.push(C);for(C in $){var _=y[C],v=$[C];_?_.src!==v.src&&g.change.push(v):g.add.push(v)}(0<g.del.length||0<g.add.length||0<g.change.length)&&u.change.push(g)}}else u.add.push([a,h])}return u}function si(i,s,a,u){var d=i.db.createObjectStore(s,a.keyPath?{keyPath:a.keyPath,autoIncrement:a.auto}:{autoIncrement:a.auto});return u.forEach(function(h){return dr(d,h)}),d}function co(i,s){c(i).forEach(function(a){s.db.objectStoreNames.contains(a)||(ke&&console.debug("Dexie: Creating missing table",a),si(s,a,i[a].primKey,i[a].indexes))})}function dr(i,s){i.createIndex(s.name,s.keyPath,{unique:s.unique,multiEntry:s.multi})}function fr(i,s,a){var u={};return et(s.objectStoreNames,0).forEach(function(d){for(var h=a.objectStore(d),g=ti(ao(C=h.keyPath),C||"",!0,!1,!!h.autoIncrement,C&&typeof C!="string",!0),y=[],$=0;$<h.indexNames.length;++$){var _=h.index(h.indexNames[$]),C=_.keyPath,_=ti(_.name,C,!!_.unique,!!_.multiEntry,!1,C&&typeof C!="string",!1);y.push(_)}u[d]=ni(d,g,y)}),u}function hr(i,s,a){for(var u=a.db.objectStoreNames,d=0;d<u.length;++d){var h=u[d],g=a.objectStore(h);i._hasGetAll="getAll"in g;for(var y=0;y<g.indexNames.length;++y){var $=g.indexNames[y],C=g.index($).keyPath,_=typeof C=="string"?C:"["+et(C).join("+")+"]";!s[h]||(C=s[h].idxByName[_])&&(C.name=$,delete s[h].idxByName[_],s[h].idxByName[$]=C)}}typeof navigator<"u"&&/Safari/.test(navigator.userAgent)&&!/(Chrome\/|Edge\/)/.test(navigator.userAgent)&&l.WorkerGlobalScope&&l instanceof l.WorkerGlobalScope&&[].concat(navigator.userAgent.match(/Safari\/(\d*)/))[1]<604&&(i._hasGetAll=!1)}function uo(i){return i.split(",").map(function(s,a){var u=(s=s.trim()).replace(/([&*]|\+\+)/g,""),d=/^\[/.test(u)?u.match(/^\[(.*)\]$/)[1].split("+"):u;return ti(u,d||null,/\&/.test(s),/\*/.test(s),/\+\+/.test(s),f(d),a===0)})}var aa=(pr.prototype._parseStoresSpec=function(i,s){c(i).forEach(function(a){if(i[a]!==null){var u=uo(i[a]),d=u.shift();if(d.unique=!0,d.multi)throw new Q.Schema("Primary key cannot be multi-valued");u.forEach(function(h){if(h.auto)throw new Q.Schema("Only primary key can be marked as autoIncrement (++)");if(!h.keyPath)throw new Q.Schema("Index must have a name and cannot be an empty string")}),s[a]=ni(a,d,u)}})},pr.prototype.stores=function(a){var s=this.db;this._cfg.storesSource=this._cfg.storesSource?m(this._cfg.storesSource,a):a;var a=s._versions,u={},d={};return a.forEach(function(h){m(u,h._cfg.storesSource),d=h._cfg.dbschema={},h._parseStoresSpec(u,d)}),s._dbSchema=d,ii(s,[s._allTables,s,s.Transaction.prototype]),ur(s,[s._allTables,s,s.Transaction.prototype,this._cfg.tables],c(d),d),s._storeNames=c(d),this},pr.prototype.upgrade=function(i){return this._cfg.contentUpgrade=yt(this._cfg.contentUpgrade||se,i),this},pr);function pr(){}function ai(i,s){var a=i._dbNamesDB;return a||(a=i._dbNamesDB=new Vt(ir,{addons:[],indexedDB:i,IDBKeyRange:s})).version(1).stores({dbnames:"name"}),a.table("dbnames")}function li(i){return i&&typeof i.databases=="function"}function ci(i){return Zt(function(){return K.letThrough=!0,i()})}function ui(i){return!("from"in i)}var lt=function(i,s){if(!this){var a=new lt;return i&&"d"in i&&m(a,i),a}m(this,arguments.length?{d:1,from:i,to:1<arguments.length?s:i}:{d:0})};function Wn(i,s,a){var u=ye(s,a);if(!isNaN(u)){if(0<u)throw RangeError();if(ui(i))return m(i,{from:s,to:a,d:1});var d=i.l,u=i.r;if(ye(a,i.from)<0)return d?Wn(d,s,a):i.l={from:s,to:a,d:1,l:null,r:null},ho(i);if(0<ye(s,i.to))return u?Wn(u,s,a):i.r={from:s,to:a,d:1,l:null,r:null},ho(i);ye(s,i.from)<0&&(i.from=s,i.l=null,i.d=u?u.d+1:1),0<ye(a,i.to)&&(i.to=a,i.r=null,i.d=i.l?i.l.d+1:1),a=!i.r,d&&!i.l&&Hn(i,d),u&&a&&Hn(i,u)}}function Hn(i,s){ui(s)||(function a(u,$){var h=$.from,g=$.to,y=$.l,$=$.r;Wn(u,h,g),y&&a(u,y),$&&a(u,$)})(i,s)}function fo(i,s){var a=mr(s),u=a.next();if(u.done)return!1;for(var d=u.value,h=mr(i),g=h.next(d.from),y=g.value;!u.done&&!g.done;){if(ye(y.from,d.to)<=0&&0<=ye(y.to,d.from))return!0;ye(d.from,y.from)<0?d=(u=a.next(y.from)).value:y=(g=h.next(d.from)).value}return!1}function mr(i){var s=ui(i)?null:{s:0,n:i};return{next:function(a){for(var u=0<arguments.length;s;)switch(s.s){case 0:if(s.s=1,u)for(;s.n.l&&ye(a,s.n.from)<0;)s={up:s,n:s.n.l,s:1};else for(;s.n.l;)s={up:s,n:s.n.l,s:1};case 1:if(s.s=2,!u||ye(a,s.n.to)<=0)return{value:s.n,done:!1};case 2:if(s.n.r){s.s=3,s={up:s,n:s.n.r,s:0};continue}case 3:s=s.up}return{done:!0}}}}function ho(i){var s,a,u=(((s=i.r)===null||s===void 0?void 0:s.d)||0)-(((a=i.l)===null||a===void 0?void 0:a.d)||0),d=1<u?"r":u<-1?"l":"";d&&(s=d=="r"?"l":"r",a=o({},i),u=i[d],i.from=u.from,i.to=u.to,i[d]=u[d],a[d]=u[s],(i[s]=a).d=po(a)),i.d=po(i)}function po(a){var s=a.r,a=a.l;return(s?a?Math.max(s.d,a.d):s.d:a?a.d:0)+1}function gr(i,s){return c(s).forEach(function(a){i[a]?Hn(i[a],s[a]):i[a]=(function u(d){var h,g,y={};for(h in d)z(d,h)&&(g=d[h],y[h]=!g||typeof g!="object"||p.has(g.constructor)?g:u(g));return y})(s[a])}),i}function di(i,s){return i.all||s.all||Object.keys(i).some(function(a){return s[a]&&fo(s[a],i[a])})}F(lt.prototype,((St={add:function(i){return Hn(this,i),this},addKey:function(i){return Wn(this,i,i),this},addKeys:function(i){var s=this;return i.forEach(function(a){return Wn(s,a,a)}),this},hasKey:function(i){var s=mr(this).next(i).value;return s&&ye(s.from,i)<=0&&0<=ye(s.to,i)}})[ie]=function(){return mr(this)},St));var fn={},fi={},hi=!1;function br(i){gr(fi,i),hi||(hi=!0,setTimeout(function(){hi=!1,pi(fi,!(fi={}))},0))}function pi(i,s){s===void 0&&(s=!1);var a=new Set;if(i.all)for(var u=0,d=Object.values(fn);u<d.length;u++)mo(g=d[u],i,a,s);else for(var h in i){var g,y=/^idb\:\/\/(.*)\/(.*)\//.exec(h);y&&(h=y[1],y=y[2],(g=fn["idb://".concat(h,"/").concat(y)])&&mo(g,i,a,s))}a.forEach(function($){return $()})}function mo(i,s,a,u){for(var d=[],h=0,g=Object.entries(i.queries.query);h<g.length;h++){for(var y=g[h],$=y[0],C=[],_=0,v=y[1];_<v.length;_++){var A=v[_];di(s,A.obsSet)?A.subscribers.forEach(function(k){return a.add(k)}):u&&C.push(A)}u&&d.push([$,C])}if(u)for(var E=0,S=d;E<S.length;E++){var P=S[E],$=P[0],C=P[1];i.queries.query[$]=C}}function la(i){var s=i._state,a=i._deps.indexedDB;if(s.isBeingOpened||i.idbdb)return s.dbReadyPromise.then(function(){return s.dbOpenError?Ve(s.dbOpenError):i});s.isBeingOpened=!0,s.dbOpenError=null,s.openComplete=!1;var u=s.openCanceller,d=Math.round(10*i.verno),h=!1;function g(){if(s.openCanceller!==u)throw new Q.DatabaseClosed("db.open() was cancelled")}function y(){return new V(function(A,E){if(g(),!a)throw new Q.MissingAPI;var S=i.name,P=s.autoSchema||!d?a.open(S):a.open(S,d);if(!P)throw new Q.MissingAPI;P.onerror=Lt(E),P.onblocked=Te(i._fireOnBlocked),P.onupgradeneeded=Te(function(k){var R;_=P.transaction,s.autoSchema&&!i._options.allowEmptyDB?(P.onerror=Mn,_.abort(),P.result.close(),(R=a.deleteDatabase(S)).onsuccess=R.onerror=Te(function(){E(new Q.NoSuchDatabase("Database ".concat(S," doesnt exist")))})):(_.onerror=Lt(E),k=k.oldVersion>Math.pow(2,62)?0:k.oldVersion,v=k<1,i.idbdb=P.result,h&&sa(i,_),oa(i,k/10,_,E))},E),P.onsuccess=Te(function(){_=null;var k,R,I,B,L,q=i.idbdb=P.result,X=et(q.objectStoreNames);if(0<X.length)try{var U=q.transaction((B=X).length===1?B[0]:B,"readonly");if(s.autoSchema)R=q,I=U,(k=i).verno=R.version/10,I=k._dbSchema=fr(0,R,I),k._storeNames=et(R.objectStoreNames,0),ur(k,[k._allTables],c(I),I);else if(hr(i,i._dbSchema,U),((L=oi(fr(0,(L=i).idbdb,U),L._dbSchema)).add.length||L.change.some(function(H){return H.add.length||H.change.length}))&&!h)return console.warn("Dexie SchemaDiff: Schema was extended without increasing the number passed to db.version(). Dexie will add missing parts and increment native version number to workaround this."),q.close(),d=q.version+1,h=!0,A(y());cr(i,U)}catch{}kn.push(i),q.onversionchange=Te(function(H){s.vcFired=!0,i.on("versionchange").fire(H)}),q.onclose=Te(function(H){i.on("close").fire(H)}),v&&(L=i._deps,U=S,q=L.indexedDB,L=L.IDBKeyRange,li(q)||U===ir||ai(q,L).put({name:U}).catch(se)),A()},E)}).catch(function(A){switch(A?.name){case"UnknownError":if(0<s.PR1398_maxLoop)return s.PR1398_maxLoop--,console.warn("Dexie: Workaround for Chrome UnknownError on open()"),y();break;case"VersionError":if(0<d)return d=0,y()}return V.reject(A)})}var $,C=s.dbReadyResolve,_=null,v=!1;return V.race([u,(typeof navigator>"u"?V.resolve():!navigator.userAgentData&&/Safari\//.test(navigator.userAgent)&&!/Chrom(e|ium)\//.test(navigator.userAgent)&&indexedDB.databases?new Promise(function(A){function E(){return indexedDB.databases().finally(A)}$=setInterval(E,100),E()}).finally(function(){return clearInterval($)}):Promise.resolve()).then(y)]).then(function(){return g(),s.onReadyBeingFired=[],V.resolve(ci(function(){return i.on.ready.fire(i.vip)})).then(function A(){if(0<s.onReadyBeingFired.length){var E=s.onReadyBeingFired.reduce(yt,se);return s.onReadyBeingFired=[],V.resolve(ci(function(){return E(i.vip)})).then(A)}})}).finally(function(){s.openCanceller===u&&(s.onReadyBeingFired=null,s.isBeingOpened=!1)}).catch(function(A){s.dbOpenError=A;try{_&&_.abort()}catch{}return u===s.openCanceller&&i._close(),Ve(A)}).finally(function(){s.openComplete=!0,C()}).then(function(){var A;return v&&(A={},i.tables.forEach(function(E){E.schema.indexes.forEach(function(S){S.name&&(A["idb://".concat(i.name,"/").concat(E.name,"/").concat(S.name)]=new lt(-1/0,[[[]]]))}),A["idb://".concat(i.name,"/").concat(E.name,"/")]=A["idb://".concat(i.name,"/").concat(E.name,"/:dels")]=new lt(-1/0,[[[]]])}),rn(Nn).fire(A),pi(A,!0)),i})}function mi(i){function s(h){return i.next(h)}var a=d(s),u=d(function(h){return i.throw(h)});function d(h){return function($){var y=h($),$=y.value;return y.done?$:$&&typeof $.then=="function"?$.then(a,u):f($)?Promise.all($).then(a,u):a($)}}return d(s)()}function yr(i,s,a){for(var u=f(i)?i.slice():[i],d=0;d<a;++d)u.push(s);return u}var ca={stack:"dbcore",name:"VirtualIndexMiddleware",level:1,create:function(i){return o(o({},i),{table:function(s){var a=i.table(s),u=a.schema,d={},h=[];function g(v,A,E){var S=Un(v),P=d[S]=d[S]||[],k=v==null?0:typeof v=="string"?1:v.length,R=0<A,R=o(o({},E),{name:R?"".concat(S,"(virtual-from:").concat(E.name,")"):E.name,lowLevelIndex:E,isVirtual:R,keyTail:A,keyLength:k,extractKey:ri(v),unique:!R&&E.unique});return P.push(R),R.isPrimaryKey||h.push(R),1<k&&g(k===2?v[0]:v.slice(0,k-1),A+1,E),P.sort(function(I,B){return I.keyTail-B.keyTail}),R}s=g(u.primaryKey.keyPath,0,u.primaryKey),d[":id"]=[s];for(var y=0,$=u.indexes;y<$.length;y++){var C=$[y];g(C.keyPath,0,C)}function _(v){var A,E=v.query.index;return E.isVirtual?o(o({},v),{query:{index:E.lowLevelIndex,range:(A=v.query.range,E=E.keyTail,{type:A.type===1?2:A.type,lower:yr(A.lower,A.lowerOpen?i.MAX_KEY:i.MIN_KEY,E),lowerOpen:!0,upper:yr(A.upper,A.upperOpen?i.MIN_KEY:i.MAX_KEY,E),upperOpen:!0})}}):v}return o(o({},a),{schema:o(o({},u),{primaryKey:s,indexes:h,getIndexByKeyPath:function(v){return(v=d[Un(v)])&&v[0]}}),count:function(v){return a.count(_(v))},query:function(v){return a.query(_(v))},openCursor:function(v){var A=v.query.index,E=A.keyTail,S=A.isVirtual,P=A.keyLength;return S?a.openCursor(_(v)).then(function(R){return R&&k(R)}):a.openCursor(v);function k(R){return Object.create(R,{continue:{value:function(I){I!=null?R.continue(yr(I,v.reverse?i.MAX_KEY:i.MIN_KEY,E)):v.unique?R.continue(R.key.slice(0,P).concat(v.reverse?i.MIN_KEY:i.MAX_KEY,E)):R.continue()}},continuePrimaryKey:{value:function(I,B){R.continuePrimaryKey(yr(I,i.MAX_KEY,E),B)}},primaryKey:{get:function(){return R.primaryKey}},key:{get:function(){var I=R.key;return P===1?I[0]:I.slice(0,P)}},value:{get:function(){return R.value}}})}}})}})}};function gi(i,s,a,u){return a=a||{},u=u||"",c(i).forEach(function(d){var h,g,y;z(s,d)?(h=i[d],g=s[d],typeof h=="object"&&typeof g=="object"&&h&&g?(y=x(h))!==x(g)?a[u+d]=s[d]:y==="Object"?gi(h,g,a,u+d+"."):h!==g&&(a[u+d]=s[d]):h!==g&&(a[u+d]=s[d])):a[u+d]=void 0}),c(s).forEach(function(d){z(i,d)||(a[u+d]=s[d])}),a}function bi(i,s){return s.type==="delete"?s.keys:s.keys||s.values.map(i.extractKey)}var ua={stack:"dbcore",name:"HooksMiddleware",level:2,create:function(i){return o(o({},i),{table:function(s){var a=i.table(s),u=a.schema.primaryKey;return o(o({},a),{mutate:function(d){var h=K.trans,g=h.table(s).hook,y=g.deleting,$=g.creating,C=g.updating;switch(d.type){case"add":if($.fire===se)break;return h._promise("readwrite",function(){return _(d)},!0);case"put":if($.fire===se&&C.fire===se)break;return h._promise("readwrite",function(){return _(d)},!0);case"delete":if(y.fire===se)break;return h._promise("readwrite",function(){return _(d)},!0);case"deleteRange":if(y.fire===se)break;return h._promise("readwrite",function(){return(function v(A,E,S){return a.query({trans:A,values:!1,query:{index:u,range:E},limit:S}).then(function(P){var k=P.result;return _({type:"delete",keys:k,trans:A}).then(function(R){return 0<R.numFailures?Promise.reject(R.failures[0]):k.length<S?{failures:[],numFailures:0,lastResult:void 0}:v(A,o(o({},E),{lower:k[k.length-1],lowerOpen:!0}),S)})})})(d.trans,d.range,1e4)},!0)}return a.mutate(d);function _(v){var A,E,S,P=K.trans,k=v.keys||bi(u,v);if(!k)throw new Error("Keys missing");return(v=v.type==="add"||v.type==="put"?o(o({},v),{keys:k}):o({},v)).type!=="delete"&&(v.values=n([],v.values)),v.keys&&(v.keys=n([],v.keys)),A=a,S=k,((E=v).type==="add"?Promise.resolve([]):A.getMany({trans:E.trans,keys:S,cache:"immutable"})).then(function(R){var I=k.map(function(B,L){var q,X,U,H=R[L],J={onerror:null,onsuccess:null};return v.type==="delete"?y.fire.call(J,B,H,P):v.type==="add"||H===void 0?(q=$.fire.call(J,B,v.values[L],P),B==null&&q!=null&&(v.keys[L]=B=q,u.outbound||st(v.values[L],u.keyPath,B))):(q=gi(H,v.values[L]),(X=C.fire.call(J,q,B,H,P))&&(U=v.values[L],Object.keys(X).forEach(function(Y){z(U,Y)?U[Y]=X[Y]:st(U,Y,X[Y])}))),J});return a.mutate(v).then(function(B){for(var L=B.failures,q=B.results,X=B.numFailures,B=B.lastResult,U=0;U<k.length;++U){var H=(q||k)[U],J=I[U];H==null?J.onerror&&J.onerror(L[U]):J.onsuccess&&J.onsuccess(v.type==="put"&&R[U]?v.values[U]:H)}return{failures:L,results:q,numFailures:X,lastResult:B}}).catch(function(B){return I.forEach(function(L){return L.onerror&&L.onerror(B)}),Promise.reject(B)})})}}})}})}};function go(i,s,a){try{if(!s||s.keys.length<i.length)return null;for(var u=[],d=0,h=0;d<s.keys.length&&h<i.length;++d)ye(s.keys[d],i[h])===0&&(u.push(a?D(s.values[d]):s.values[d]),++h);return u.length===i.length?u:null}catch{return null}}var da={stack:"dbcore",level:-1,create:function(i){return{table:function(s){var a=i.table(s);return o(o({},a),{getMany:function(u){if(!u.cache)return a.getMany(u);var d=go(u.keys,u.trans._cache,u.cache==="clone");return d?V.resolve(d):a.getMany(u).then(function(h){return u.trans._cache={keys:u.keys,values:u.cache==="clone"?D(h):h},h})},mutate:function(u){return u.type!=="add"&&(u.trans._cache=null),a.mutate(u)}})}}}};function bo(i,s){return i.trans.mode==="readonly"&&!!i.subscr&&!i.trans.explicit&&i.trans.db._options.cache!=="disabled"&&!s.schema.primaryKey.outbound}function yo(i,s){switch(i){case"query":return s.values&&!s.unique;case"get":case"getMany":case"count":case"openCursor":return!1}}var fa={stack:"dbcore",level:0,name:"Observability",create:function(i){var s=i.schema.name,a=new lt(i.MIN_KEY,i.MAX_KEY);return o(o({},i),{transaction:function(u,d,h){if(K.subscr&&d!=="readonly")throw new Q.ReadOnly("Readwrite transaction in liveQuery context. Querier source: ".concat(K.querier));return i.transaction(u,d,h)},table:function(u){var d=i.table(u),h=d.schema,g=h.primaryKey,v=h.indexes,y=g.extractKey,$=g.outbound,C=g.autoIncrement&&v.filter(function(E){return E.compound&&E.keyPath.includes(g.keyPath)}),_=o(o({},d),{mutate:function(E){function S(Y){return Y="idb://".concat(s,"/").concat(u,"/").concat(Y),B[Y]||(B[Y]=new lt)}var P,k,R,I=E.trans,B=E.mutatedParts||(E.mutatedParts={}),L=S(""),q=S(":dels"),X=E.type,J=E.type==="deleteRange"?[E.range]:E.type==="delete"?[E.keys]:E.values.length<50?[bi(g,E).filter(function(Y){return Y}),E.values]:[],U=J[0],H=J[1],J=E.trans._cache;return f(U)?(L.addKeys(U),(J=X==="delete"||U.length===H.length?go(U,J):null)||q.addKeys(U),(J||H)&&(P=S,k=J,R=H,h.indexes.forEach(function(Y){var te=P(Y.name||"");function de(pe){return pe!=null?Y.extractKey(pe):null}function he(pe){return Y.multiEntry&&f(pe)?pe.forEach(function(xt){return te.addKey(xt)}):te.addKey(pe)}(k||R).forEach(function(pe,ct){var ue=k&&de(k[ct]),ct=R&&de(R[ct]);ye(ue,ct)!==0&&(ue!=null&&he(ue),ct!=null&&he(ct))})}))):U?(H={from:(H=U.lower)!==null&&H!==void 0?H:i.MIN_KEY,to:(H=U.upper)!==null&&H!==void 0?H:i.MAX_KEY},q.add(H),L.add(H)):(L.add(a),q.add(a),h.indexes.forEach(function(Y){return S(Y.name).add(a)})),d.mutate(E).then(function(Y){return!U||E.type!=="add"&&E.type!=="put"||(L.addKeys(Y.results),C&&C.forEach(function(te){for(var de=E.values.map(function(ue){return te.extractKey(ue)}),he=te.keyPath.findIndex(function(ue){return ue===g.keyPath}),pe=0,xt=Y.results.length;pe<xt;++pe)de[pe][he]=Y.results[pe];S(te.name).addKeys(de)})),I.mutatedParts=gr(I.mutatedParts||{},B),Y})}}),v=function(S){var P=S.query,S=P.index,P=P.range;return[S,new lt((S=P.lower)!==null&&S!==void 0?S:i.MIN_KEY,(P=P.upper)!==null&&P!==void 0?P:i.MAX_KEY)]},A={get:function(E){return[g,new lt(E.key)]},getMany:function(E){return[g,new lt().addKeys(E.keys)]},count:v,query:v,openCursor:v};return c(A).forEach(function(E){_[E]=function(S){var P=K.subscr,k=!!P,R=bo(K,d)&&yo(E,S)?S.obsSet={}:P;if(k){var I=function(H){return H="idb://".concat(s,"/").concat(u,"/").concat(H),R[H]||(R[H]=new lt)},B=I(""),L=I(":dels"),P=A[E](S),k=P[0],P=P[1];if((E==="query"&&k.isPrimaryKey&&!S.values?L:I(k.name||"")).add(P),!k.isPrimaryKey){if(E!=="count"){var q=E==="query"&&$&&S.values&&d.query(o(o({},S),{values:!1}));return d[E].apply(this,arguments).then(function(H){if(E==="query"){if($&&S.values)return q.then(function(de){return de=de.result,B.addKeys(de),H});var J=S.values?H.result.map(y):H.result;(S.values?B:L).addKeys(J)}else if(E==="openCursor"){var Y=H,te=S.values;return Y&&Object.create(Y,{key:{get:function(){return L.addKey(Y.primaryKey),Y.key}},primaryKey:{get:function(){var de=Y.primaryKey;return L.addKey(de),de}},value:{get:function(){return te&&B.addKey(Y.primaryKey),Y.value}}})}return H})}L.add(a)}}return d[E].apply(this,arguments)}}),_}})}};function vo(i,s,a){if(a.numFailures===0)return s;if(s.type==="deleteRange")return null;var u=s.keys?s.keys.length:"values"in s&&s.values?s.values.length:1;return a.numFailures===u?null:(s=o({},s),f(s.keys)&&(s.keys=s.keys.filter(function(d,h){return!(h in a.failures)})),"values"in s&&f(s.values)&&(s.values=s.values.filter(function(d,h){return!(h in a.failures)})),s)}function yi(i,s){return a=i,((u=s).lower===void 0||(u.lowerOpen?0<ye(a,u.lower):0<=ye(a,u.lower)))&&(i=i,(s=s).upper===void 0||(s.upperOpen?ye(i,s.upper)<0:ye(i,s.upper)<=0));var a,u}function wo(i,s,A,u,d,h){if(!A||A.length===0)return i;var g=s.query.index,y=g.multiEntry,$=s.query.range,C=u.schema.primaryKey.extractKey,_=g.extractKey,v=(g.lowLevelIndex||g).extractKey,A=A.reduce(function(E,S){var P=E,k=[];if(S.type==="add"||S.type==="put")for(var R=new lt,I=S.values.length-1;0<=I;--I){var B,L=S.values[I],q=C(L);R.hasKey(q)||(B=_(L),(y&&f(B)?B.some(function(Y){return yi(Y,$)}):yi(B,$))&&(R.addKey(q),k.push(L)))}switch(S.type){case"add":var X=new lt().addKeys(s.values?E.map(function(te){return C(te)}):E),P=E.concat(s.values?k.filter(function(te){return te=C(te),!X.hasKey(te)&&(X.addKey(te),!0)}):k.map(function(te){return C(te)}).filter(function(te){return!X.hasKey(te)&&(X.addKey(te),!0)}));break;case"put":var U=new lt().addKeys(S.values.map(function(te){return C(te)}));P=E.filter(function(te){return!U.hasKey(s.values?C(te):te)}).concat(s.values?k:k.map(function(te){return C(te)}));break;case"delete":var H=new lt().addKeys(S.keys);P=E.filter(function(te){return!H.hasKey(s.values?C(te):te)});break;case"deleteRange":var J=S.range;P=E.filter(function(te){return!yi(C(te),J)})}return P},i);return A===i?i:(A.sort(function(E,S){return ye(v(E),v(S))||ye(C(E),C(S))}),s.limit&&s.limit<1/0&&(A.length>s.limit?A.length=s.limit:i.length===s.limit&&A.length<s.limit&&(d.dirty=!0)),h?Object.freeze(A):A)}function xo(i,s){return ye(i.lower,s.lower)===0&&ye(i.upper,s.upper)===0&&!!i.lowerOpen==!!s.lowerOpen&&!!i.upperOpen==!!s.upperOpen}function ha(i,s){return(function(a,u,d,h){if(a===void 0)return u!==void 0?-1:0;if(u===void 0)return 1;if((u=ye(a,u))===0){if(d&&h)return 0;if(d)return 1;if(h)return-1}return u})(i.lower,s.lower,i.lowerOpen,s.lowerOpen)<=0&&0<=(function(a,u,d,h){if(a===void 0)return u!==void 0?1:0;if(u===void 0)return-1;if((u=ye(a,u))===0){if(d&&h)return 0;if(d)return-1;if(h)return 1}return u})(i.upper,s.upper,i.upperOpen,s.upperOpen)}function pa(i,s,a,u){i.subscribers.add(a),u.addEventListener("abort",function(){var d,h;i.subscribers.delete(a),i.subscribers.size===0&&(d=i,h=s,setTimeout(function(){d.subscribers.size===0&&M(h,d)},3e3))})}var ma={stack:"dbcore",level:0,name:"Cache",create:function(i){var s=i.schema.name;return o(o({},i),{transaction:function(a,u,d){var h,g,y=i.transaction(a,u,d);return u==="readwrite"&&(g=(h=new AbortController).signal,d=function($){return function(){if(h.abort(),u==="readwrite"){for(var C=new Set,_=0,v=a;_<v.length;_++){var A=v[_],E=fn["idb://".concat(s,"/").concat(A)];if(E){var S=i.table(A),P=E.optimisticOps.filter(function(te){return te.trans===y});if(y._explicit&&$&&y.mutatedParts)for(var k=0,R=Object.values(E.queries.query);k<R.length;k++)for(var I=0,B=(X=R[k]).slice();I<B.length;I++)di((U=B[I]).obsSet,y.mutatedParts)&&(M(X,U),U.subscribers.forEach(function(te){return C.add(te)}));else if(0<P.length){E.optimisticOps=E.optimisticOps.filter(function(te){return te.trans!==y});for(var L=0,q=Object.values(E.queries.query);L<q.length;L++)for(var X,U,H,J=0,Y=(X=q[L]).slice();J<Y.length;J++)(U=Y[J]).res!=null&&y.mutatedParts&&($&&!U.dirty?(H=Object.isFrozen(U.res),H=wo(U.res,U.req,P,S,U,H),U.dirty?(M(X,U),U.subscribers.forEach(function(te){return C.add(te)})):H!==U.res&&(U.res=H,U.promise=V.resolve({result:H}))):(U.dirty&&M(X,U),U.subscribers.forEach(function(te){return C.add(te)})))}}}C.forEach(function(te){return te()})}}},y.addEventListener("abort",d(!1),{signal:g}),y.addEventListener("error",d(!1),{signal:g}),y.addEventListener("complete",d(!0),{signal:g})),y},table:function(a){var u=i.table(a),d=u.schema.primaryKey;return o(o({},u),{mutate:function(h){var g=K.trans;if(d.outbound||g.db._options.cache==="disabled"||g.explicit||g.idbtrans.mode!=="readwrite")return u.mutate(h);var y=fn["idb://".concat(s,"/").concat(a)];return y?(g=u.mutate(h),h.type!=="add"&&h.type!=="put"||!(50<=h.values.length||bi(d,h).some(function($){return $==null}))?(y.optimisticOps.push(h),h.mutatedParts&&br(h.mutatedParts),g.then(function($){0<$.numFailures&&(M(y.optimisticOps,h),($=vo(0,h,$))&&y.optimisticOps.push($),h.mutatedParts&&br(h.mutatedParts))}),g.catch(function(){M(y.optimisticOps,h),h.mutatedParts&&br(h.mutatedParts)})):g.then(function($){var C=vo(0,o(o({},h),{values:h.values.map(function(_,v){var A;return $.failures[v]?_:(_=(A=d.keyPath)!==null&&A!==void 0&&A.includes(".")?D(_):o({},_),st(_,d.keyPath,$.results[v]),_)})}),$);y.optimisticOps.push(C),queueMicrotask(function(){return h.mutatedParts&&br(h.mutatedParts)})}),g):u.mutate(h)},query:function(h){if(!bo(K,u)||!yo("query",h))return u.query(h);var g=((C=K.trans)===null||C===void 0?void 0:C.db._options.cache)==="immutable",v=K,y=v.requery,$=v.signal,C=(function(S,P,k,R){var I=fn["idb://".concat(S,"/").concat(P)];if(!I)return[];if(!(P=I.queries[k]))return[null,!1,I,null];var B=P[(R.query?R.query.index.name:null)||""];if(!B)return[null,!1,I,null];switch(k){case"query":var L=B.find(function(q){return q.req.limit===R.limit&&q.req.values===R.values&&xo(q.req.query.range,R.query.range)});return L?[L,!0,I,B]:[B.find(function(q){return("limit"in q.req?q.req.limit:1/0)>=R.limit&&(!R.values||q.req.values)&&ha(q.req.query.range,R.query.range)}),!1,I,B];case"count":return L=B.find(function(q){return xo(q.req.query.range,R.query.range)}),[L,!!L,I,B]}})(s,a,"query",h),_=C[0],v=C[1],A=C[2],E=C[3];return _&&v?_.obsSet=h.obsSet:(v=u.query(h).then(function(S){var P=S.result;if(_&&(_.res=P),g){for(var k=0,R=P.length;k<R;++k)Object.freeze(P[k]);Object.freeze(P)}else S.result=D(P);return S}).catch(function(S){return E&&_&&M(E,_),Promise.reject(S)}),_={obsSet:h.obsSet,promise:v,subscribers:new Set,type:"query",req:h,dirty:!1},E?E.push(_):(E=[_],(A=A||(fn["idb://".concat(s,"/").concat(a)]={queries:{query:{},count:{}},objs:new Map,optimisticOps:[],unsignaledParts:{}})).queries.query[h.query.index.name||""]=E)),pa(_,E,y,$),_.promise.then(function(S){return{result:wo(S.result,h,A?.optimisticOps,u,_,g)}})}})}})}};function vr(i,s){return new Proxy(i,{get:function(a,u,d){return u==="db"?s:Reflect.get(a,u,d)}})}var Vt=(Ye.prototype.version=function(i){if(isNaN(i)||i<.1)throw new Q.Type("Given version is not a positive number");if(i=Math.round(10*i)/10,this.idbdb||this._state.isBeingOpened)throw new Q.Schema("Cannot add version when database is open");this.verno=Math.max(this.verno,i);var s=this._versions,a=s.filter(function(u){return u._cfg.version===i})[0];return a||(a=new this.Version(i),s.push(a),s.sort(ia),a.stores({}),this._state.autoSchema=!1,a)},Ye.prototype._whenReady=function(i){var s=this;return this.idbdb&&(this._state.openComplete||K.letThrough||this._vip)?i():new V(function(a,u){if(s._state.openComplete)return u(new Q.DatabaseClosed(s._state.dbOpenError));if(!s._state.isBeingOpened){if(!s._state.autoOpen)return void u(new Q.DatabaseClosed);s.open().catch(se)}s._state.dbReadyPromise.then(a,u)}).then(i)},Ye.prototype.use=function(i){var s=i.stack,a=i.create,u=i.level,d=i.name;return d&&this.unuse({stack:s,name:d}),i=this._middlewares[s]||(this._middlewares[s]=[]),i.push({stack:s,create:a,level:u??10,name:d}),i.sort(function(h,g){return h.level-g.level}),this},Ye.prototype.unuse=function(i){var s=i.stack,a=i.name,u=i.create;return s&&this._middlewares[s]&&(this._middlewares[s]=this._middlewares[s].filter(function(d){return u?d.create!==u:!!a&&d.name!==a})),this},Ye.prototype.open=function(){var i=this;return cn(Ne,function(){return la(i)})},Ye.prototype._close=function(){var i=this._state,s=kn.indexOf(this);if(0<=s&&kn.splice(s,1),this.idbdb){try{this.idbdb.close()}catch{}this.idbdb=null}i.isBeingOpened||(i.dbReadyPromise=new V(function(a){i.dbReadyResolve=a}),i.openCanceller=new V(function(a,u){i.cancelOpen=u}))},Ye.prototype.close=function(a){var s=(a===void 0?{disableAutoOpen:!0}:a).disableAutoOpen,a=this._state;s?(a.isBeingOpened&&a.cancelOpen(new Q.DatabaseClosed),this._close(),a.autoOpen=!1,a.dbOpenError=new Q.DatabaseClosed):(this._close(),a.autoOpen=this._options.autoOpen||a.isBeingOpened,a.openComplete=!1,a.dbOpenError=null)},Ye.prototype.delete=function(i){var s=this;i===void 0&&(i={disableAutoOpen:!0});var a=0<arguments.length&&typeof arguments[0]!="object",u=this._state;return new V(function(d,h){function g(){s.close(i);var y=s._deps.indexedDB.deleteDatabase(s.name);y.onsuccess=Te(function(){var $,C,_;$=s._deps,C=s.name,_=$.indexedDB,$=$.IDBKeyRange,li(_)||C===ir||ai(_,$).delete(C).catch(se),d()}),y.onerror=Lt(h),y.onblocked=s._fireOnBlocked}if(a)throw new Q.InvalidArgument("Invalid closeOptions argument to db.delete()");u.isBeingOpened?u.dbReadyPromise.then(g):g()})},Ye.prototype.backendDB=function(){return this.idbdb},Ye.prototype.isOpen=function(){return this.idbdb!==null},Ye.prototype.hasBeenClosed=function(){var i=this._state.dbOpenError;return i&&i.name==="DatabaseClosed"},Ye.prototype.hasFailed=function(){return this._state.dbOpenError!==null},Ye.prototype.dynamicallyOpened=function(){return this._state.autoSchema},Object.defineProperty(Ye.prototype,"tables",{get:function(){var i=this;return c(this._allTables).map(function(s){return i._allTables[s]})},enumerable:!1,configurable:!0}),Ye.prototype.transaction=function(){var i=function(s,a,u){var d=arguments.length;if(d<2)throw new Q.InvalidArgument("Too few arguments");for(var h=new Array(d-1);--d;)h[d-1]=arguments[d];return u=h.pop(),[s,En(h),u]}.apply(this,arguments);return this._transaction.apply(this,i)},Ye.prototype._transaction=function(i,s,a){var u=this,d=K.trans;d&&d.db===this&&i.indexOf("!")===-1||(d=null);var h,g,y=i.indexOf("?")!==-1;i=i.replace("!","").replace("?","");try{if(g=s.map(function(C){if(C=C instanceof u.Table?C.name:C,typeof C!="string")throw new TypeError("Invalid table argument to Dexie.transaction(). Only Table or String are allowed");return C}),i=="r"||i===Xr)h=Xr;else{if(i!="rw"&&i!=Gr)throw new Q.InvalidArgument("Invalid transaction mode: "+i);h=Gr}if(d){if(d.mode===Xr&&h===Gr){if(!y)throw new Q.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");d=null}d&&g.forEach(function(C){if(d&&d.storeNames.indexOf(C)===-1){if(!y)throw new Q.SubTransaction("Table "+C+" not included in parent transaction.");d=null}}),y&&d&&!d.active&&(d=null)}}catch(C){return d?d._promise(null,function(_,v){v(C)}):Ve(C)}var $=function C(_,v,A,E,S){return V.resolve().then(function(){var P=K.transless||K,k=_._createTransaction(v,A,_._dbSchema,E);if(k.explicit=!0,P={trans:k,transless:P},E)k.idbtrans=E.idbtrans;else try{k.create(),k.idbtrans._explicit=!0,_._state.PR1398_maxLoop=3}catch(B){return B.name===Be.InvalidState&&_.isOpen()&&0<--_._state.PR1398_maxLoop?(console.warn("Dexie: Need to reopen db"),_.close({disableAutoOpen:!1}),_.open().then(function(){return C(_,v,A,null,S)})):Ve(B)}var R,I=Xe(S);return I&&Cn(),P=V.follow(function(){var B;(R=S.call(k,k))&&(I?(B=en.bind(null,null),R.then(B,B)):typeof R.next=="function"&&typeof R.throw=="function"&&(R=mi(R)))},P),(R&&typeof R.then=="function"?V.resolve(R).then(function(B){return k.active?B:Ve(new Q.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"))}):P.then(function(){return R})).then(function(B){return E&&k._resolve(),k._completion.then(function(){return B})}).catch(function(B){return k._reject(B),Ve(B)})})}.bind(null,this,h,g,d,a);return d?d._promise(h,$,"lock"):K.trans?cn(K.transless,function(){return u._whenReady($)}):this._whenReady($)},Ye.prototype.table=function(i){if(!z(this._allTables,i))throw new Q.InvalidTable("Table ".concat(i," does not exist"));return this._allTables[i]},Ye);function Ye(i,s){var a=this;this._middlewares={},this.verno=0;var u=Ye.dependencies;this._options=s=o({addons:Ye.addons,autoOpen:!0,indexedDB:u.indexedDB,IDBKeyRange:u.IDBKeyRange,cache:"cloned"},s),this._deps={indexedDB:s.indexedDB,IDBKeyRange:s.IDBKeyRange},u=s.addons,this._dbSchema={},this._versions=[],this._storeNames=[],this._allTables={},this.idbdb=null,this._novip=this;var d,h,g,y,$,C={dbOpenError:null,isBeingOpened:!1,onReadyBeingFired:null,openComplete:!1,dbReadyResolve:se,dbReadyPromise:null,cancelOpen:se,openCanceller:null,autoSchema:!0,PR1398_maxLoop:3,autoOpen:s.autoOpen};C.dbReadyPromise=new V(function(v){C.dbReadyResolve=v}),C.openCanceller=new V(function(v,A){C.cancelOpen=A}),this._state=C,this.name=i,this.on=In(this,"populate","blocked","versionchange","close",{ready:[yt,se]}),this.on.ready.subscribe=Ct(this.on.ready.subscribe,function(v){return function(A,E){Ye.vip(function(){var S,P=a._state;P.openComplete?(P.dbOpenError||V.resolve().then(A),E&&v(A)):P.onReadyBeingFired?(P.onReadyBeingFired.push(A),E&&v(A)):(v(A),S=a,E||v(function k(){S.on.ready.unsubscribe(A),S.on.ready.unsubscribe(k)}))})}}),this.Collection=(d=this,Bn(Qs.prototype,function(R,k){this.db=d;var E=Qi,S=null;if(k)try{E=k()}catch(I){S=I}var P=R._ctx,k=P.table,R=k.hook.reading.fire;this._ctx={table:k,index:P.index,isPrimKey:!P.index||k.schema.primKey.keyPath&&P.index===k.schema.primKey.name,range:E,keysOnly:!1,dir:"next",unique:"",algorithm:null,filter:null,replayFilter:null,justLimit:!0,isMatch:null,offset:0,limit:1/0,error:S,or:P.or,valueMapper:R!==fe?R:null}})),this.Table=(h=this,Bn(to.prototype,function(v,A,E){this.db=h,this._tx=E,this.name=v,this.schema=A,this.hook=h._allTables[v]?h._allTables[v].hook:In(null,{creating:[Me,se],reading:[bt,fe],updating:[jt,se],deleting:[Qt,se]})})),this.Transaction=(g=this,Bn(ea.prototype,function(v,A,E,S,P){var k=this;this.db=g,this.mode=v,this.storeNames=A,this.schema=E,this.chromeTransactionDurability=S,this.idbtrans=null,this.on=In(this,"complete","error","abort"),this.parent=P||null,this.active=!0,this._reculock=0,this._blockedFuncs=[],this._resolve=null,this._reject=null,this._waitingFor=null,this._waitingQueue=null,this._spinCount=0,this._completion=new V(function(R,I){k._resolve=R,k._reject=I}),this._completion.then(function(){k.active=!1,k.on.complete.fire()},function(R){var I=k.active;return k.active=!1,k.on.error.fire(R),k.parent?k.parent._reject(R):I&&k.idbtrans&&k.idbtrans.abort(),Ve(R)})})),this.Version=(y=this,Bn(aa.prototype,function(v){this.db=y,this._cfg={version:v,storesSource:null,dbschema:{},tables:{},contentUpgrade:null}})),this.WhereClause=($=this,Bn(so.prototype,function(v,A,E){if(this.db=$,this._ctx={table:v,index:A===":id"?null:A,or:E},this._cmp=this._ascending=ye,this._descending=function(S,P){return ye(P,S)},this._max=function(S,P){return 0<ye(S,P)?S:P},this._min=function(S,P){return ye(S,P)<0?S:P},this._IDBKeyRange=$._deps.IDBKeyRange,!this._IDBKeyRange)throw new Q.MissingAPI})),this.on("versionchange",function(v){0<v.newVersion?console.warn("Another connection wants to upgrade database '".concat(a.name,"'. Closing db now to resume the upgrade.")):console.warn("Another connection wants to delete database '".concat(a.name,"'. Closing db now to resume the delete request.")),a.close({disableAutoOpen:!1})}),this.on("blocked",function(v){!v.newVersion||v.newVersion<v.oldVersion?console.warn("Dexie.delete('".concat(a.name,"') was blocked")):console.warn("Upgrade '".concat(a.name,"' blocked by other connection holding version ").concat(v.oldVersion/10))}),this._maxKey=qn(s.IDBKeyRange),this._createTransaction=function(v,A,E,S){return new a.Transaction(v,A,E,a._options.chromeTransactionDurability,S)},this._fireOnBlocked=function(v){a.on("blocked").fire(v),kn.filter(function(A){return A.name===a.name&&A!==a&&!A._state.vcFired}).map(function(A){return A.on("versionchange").fire(v)})},this.use(da),this.use(ma),this.use(fa),this.use(ca),this.use(ua);var _=new Proxy(this,{get:function(v,A,E){if(A==="_vip")return!0;if(A==="table")return function(P){return vr(a.table(P),_)};var S=Reflect.get(v,A,E);return S instanceof to?vr(S,_):A==="tables"?S.map(function(P){return vr(P,_)}):A==="_createTransaction"?function(){return vr(S.apply(this,arguments),_)}:S}});this.vip=_,u.forEach(function(v){return v(a)})}var wr,St=typeof Symbol<"u"&&"observable"in Symbol?Symbol.observable:"@@observable",ga=(vi.prototype.subscribe=function(i,s,a){return this._subscribe(i&&typeof i!="function"?i:{next:i,error:s,complete:a})},vi.prototype[St]=function(){return this},vi);function vi(i){this._subscribe=i}try{wr={indexedDB:l.indexedDB||l.mozIndexedDB||l.webkitIndexedDB||l.msIndexedDB,IDBKeyRange:l.IDBKeyRange||l.webkitIDBKeyRange}}catch{wr={indexedDB:null,IDBKeyRange:null}}function $o(i){var s,a=!1,u=new ga(function(d){var h=Xe(i),g,y=!1,$={},C={},_={get closed(){return y},unsubscribe:function(){y||(y=!0,g&&g.abort(),v&&rn.storagemutated.unsubscribe(E))}};d.start&&d.start(_);var v=!1,A=function(){return Yr(S)},E=function(P){gr($,P),di(C,$)&&A()},S=function(){var P,k,R;!y&&wr.indexedDB&&($={},P={},g&&g.abort(),g=new AbortController,R=(function(I){var B=Se();try{h&&Cn();var L=Zt(i,I);return L=h?L.finally(en):L}finally{B&&Re()}})(k={subscr:P,signal:g.signal,requery:A,querier:i,trans:null}),Promise.resolve(R).then(function(I){a=!0,s=I,y||k.signal.aborted||($={},(function(B){for(var L in B)if(z(B,L))return;return 1})(C=P)||v||(rn(Nn,E),v=!0),Yr(function(){return!y&&d.next&&d.next(I)}))},function(I){a=!1,["DatabaseClosedError","AbortError"].includes(I?.name)||y||Yr(function(){y||d.error&&d.error(I)})}))};return setTimeout(A,0),_});return u.hasValue=function(){return a},u.getValue=function(){return s},u}var hn=Vt;function wi(i){var s=on;try{on=!0,rn.storagemutated.fire(i),pi(i,!0)}finally{on=s}}F(hn,o(o({},Ae),{delete:function(i){return new hn(i,{addons:[]}).delete()},exists:function(i){return new hn(i,{addons:[]}).open().then(function(s){return s.close(),!0}).catch("NoSuchDatabaseError",function(){return!1})},getDatabaseNames:function(i){try{return s=hn.dependencies,a=s.indexedDB,s=s.IDBKeyRange,(li(a)?Promise.resolve(a.databases()).then(function(u){return u.map(function(d){return d.name}).filter(function(d){return d!==ir})}):ai(a,s).toCollection().primaryKeys()).then(i)}catch{return Ve(new Q.MissingAPI)}var s,a},defineClass:function(){return function(i){m(this,i)}},ignoreTransaction:function(i){return K.trans?cn(K.transless,i):i()},vip:ci,async:function(i){return function(){try{var s=mi(i.apply(this,arguments));return s&&typeof s.then=="function"?s:V.resolve(s)}catch(a){return Ve(a)}}},spawn:function(i,s,a){try{var u=mi(i.apply(a,s||[]));return u&&typeof u.then=="function"?u:V.resolve(u)}catch(d){return Ve(d)}},currentTransaction:{get:function(){return K.trans||null}},waitFor:function(i,s){return s=V.resolve(typeof i=="function"?hn.ignoreTransaction(i):i).timeout(s||6e4),K.trans?K.trans.waitFor(s):s},Promise:V,debug:{get:function(){return ke},set:function(i){Oe(i)}},derive:le,extend:m,props:F,override:Ct,Events:In,on:rn,liveQuery:$o,extendObservabilitySet:gr,getByKeyPath:kt,setByKeyPath:st,delByKeyPath:function(i,s){typeof s=="string"?st(i,s,void 0):"length"in s&&[].map.call(s,function(a){st(i,a,void 0)})},shallowClone:Ut,deepClone:D,getObjectDiff:gi,cmp:ye,asap:zn,minKey:-1/0,addons:[],connections:kn,errnames:Be,dependencies:wr,cache:fn,semVer:"4.0.10",version:"4.0.10".split(".").map(function(i){return parseInt(i)}).reduce(function(i,s,a){return i+s/Math.pow(10,2*a)})})),hn.maxKey=qn(hn.dependencies.IDBKeyRange),typeof dispatchEvent<"u"&&typeof addEventListener<"u"&&(rn(Nn,function(i){on||(i=new CustomEvent(ei,{detail:i}),on=!0,dispatchEvent(i),on=!1)}),addEventListener(ei,function(i){i=i.detail,on||wi(i)}));var Pn,on=!1,Eo=function(){};return typeof BroadcastChannel<"u"&&((Eo=function(){(Pn=new BroadcastChannel(ei)).onmessage=function(i){return i.data&&wi(i.data)}})(),typeof Pn.unref=="function"&&Pn.unref(),rn(Nn,function(i){on||Pn.postMessage(i)})),typeof addEventListener<"u"&&(addEventListener("pagehide",function(i){if(!Vt.disableBfCache&&i.persisted){ke&&console.debug("Dexie: handling persisted pagehide"),Pn?.close();for(var s=0,a=kn;s<a.length;s++)a[s].close({disableAutoOpen:!1})}}),addEventListener("pageshow",function(i){!Vt.disableBfCache&&i.persisted&&(ke&&console.debug("Dexie: handling persisted pageshow"),Eo(),wi({all:new lt(-1/0,[[]])}))})),V.rejectionMapper=function(i,s){return!i||i instanceof Fe||i instanceof TypeError||i instanceof SyntaxError||!i.name||!Le[i.name]?i:(s=new Le[i.name](s||i.message,i),"stack"in i&&Z(s,"stack",{get:function(){return this.inner.stack}}),s)},Oe(ke),o(Vt,Object.freeze({__proto__:null,Dexie:Vt,liveQuery:$o,Entity:Ji,cmp:ye,PropModSymbol:Kt,PropModification:Ln,replacePrefix:function(i,s){return new Ln({replacePrefix:[i,s]})},add:function(i){return new Ln({add:i})},remove:function(i){return new Ln({remove:i})},default:Vt,RangeSet:lt,mergeRanges:Hn,rangesOverlap:fo}),{default:Vt}),Vt})})(_r)),_r.exports}var Xa=Ya();const Pi=Ka(Xa),Io=Symbol.for("Dexie"),Fr=globalThis[Io]||(globalThis[Io]=Pi);if(Pi.semVer!==Fr.semVer)throw new Error(`Two different versions of Dexie loaded in the same app: ${Pi.semVer} and ${Fr.semVer}`);const{liveQuery:gs,mergeRanges:Ld,rangesOverlap:Md,RangeSet:Nd,cmp:qd,Entity:Ud,PropModSymbol:Wd,PropModification:Hd,replacePrefix:Kd,add:Vd,remove:Yd}=Fr,Ga="easydb";let $r=null;function Qa(){if($r)return $r;const e=new Fr(Ga);return e.version(1).stores({workspaces:"id",tables:"id, workspaceId, updatedAt",rows:"id, tableId, updatedAt",settings:"key",plugins:"url"}),$r={raw:e,workspaces:e.table("workspaces"),tables:e.table("tables"),rows:e.table("rows"),settings:e.table("settings"),plugins:e.table("plugins")},$r}function Er(e){return{async find(t){if(!t||Object.keys(t).length===0)return e.toArray();const r=Object.entries(t);return e.filter(o=>bs(o,r)).toArray()},async findOne(t){return await e.get(t)??null},async insert(t){return await e.add(t),t},async bulkInsert(t){return t.length===0?[]:(await e.bulkAdd(t),t)},async upsert(t){return await e.put(t),t},async patch(t,r){if(await e.update(t,r)===0)throw new Error(`patch: no doc with id=${t}`);const n=await e.get(t);if(!n)throw new Error(`patch: doc id=${t} vanished after update`);return n},async remove(t){await e.delete(t)},async bulkRemove(t){t.length!==0&&await e.bulkDelete(t)},subscribe(t){const o=gs(()=>e.toArray()).subscribe({next:n=>t(n)});return()=>o.unsubscribe()}}}function Ja(e,t){return{async find(r){const o=e.where("tableId").equals(t);if(!r||Object.keys(r).length===0)return o.toArray();const n=Object.entries(r);return o.filter(l=>bs(l,n)).toArray()},async findOne(r){const o=await e.get(r);return o&&o.tableId===t?o:null},async insert(r){const o={...r,tableId:t};return await e.add(o),o},async bulkInsert(r){if(r.length===0)return[];const o=r.map(n=>({...n,tableId:t}));return await e.bulkAdd(o),o},async upsert(r){const o={...r,tableId:t};return await e.put(o),o},async patch(r,o){if(await e.update(r,o)===0)throw new Error(`row patch: no row ${r}`);const l=await e.get(r);if(!l)throw new Error(`row patch: row ${r} vanished after update`);return l},async remove(r){await e.delete(r)},async bulkRemove(r){r.length!==0&&await e.bulkDelete(r)},subscribe(r){const n=gs(()=>e.where("tableId").equals(t).toArray()).subscribe({next:l=>r(l)});return()=>n.unsubscribe()}}}function bs(e,t){for(const[r,o]of t)if(e[r]!==o)return!1;return!0}function Za(e){return{workspaces:Er(e.workspaces),tables:Er(e.tables),settings:Er(e.settings),plugins:Er(e.plugins),rows:t=>Ja(e.rows,t)}}function el(){const e=new Map;return{on(t,r){let o=e.get(t);return o||(o=new Set,e.set(t,o)),o.add(r),()=>{o.delete(r)}},emit(t,r){const o=e.get(t);if(o)for(const n of o)try{n(r)}catch(l){console.error(`[event:${String(t)}] listener threw`,l)}}}}const wn=ot`
  :host {
    display: contents;
  }
  dialog {
...
`;function xn(e){if(e.key!=="Enter"||!e.ctrlKey&&!e.metaKey)return;const t=e.currentTarget;if(!(t instanceof HTMLElement))return;const r=t.querySelector("form");r&&(e.preventDefault(),r.requestSubmit())}const Bo=new WeakSet;function $n(e,t){if(Bo.has(t))return;Bo.add(t);let r=0,o=0,n=0,l=0,c=!1;t.style.cursor="grab",t.style.touchAction="none",t.style.userSelect="none",t.addEventListener("pointerdown",m=>{if(m.target.closest("button, input, textarea, select, a, label"))return;c=!0,r=m.clientX,o=m.clientY;const j=e.getBoundingClientRect();n=j.left,l=j.top,t.setPointerCapture(m.pointerId),t.style.cursor="grabbing"}),t.addEventListener("pointermove",m=>{if(!c)return;const T=m.clientX-r,j=m.clientY-o,z=-e.offsetWidth+80,F=window.innerWidth-80,N=0,Z=window.innerHeight-40,le=Math.max(z,Math.min(F,n+T)),Ze=Math.max(N,Math.min(Z,l+j));e.style.position="fixed",e.style.left=`${le}px`,e.style.top=`${Ze}px`,e.style.margin="0"});const f=m=>{if(c){c=!1;try{t.releasePointerCapture(m.pointerId)}catch{}t.style.cursor="grab"}};t.addEventListener("pointerup",f),t.addEventListener("pointercancel",f)}var tl=Object.defineProperty,nl=Object.getOwnPropertyDescriptor,ys=(e,t,r,o)=>{for(var n=o>1?void 0:o?nl(t,r):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(o?c(t,r,n):c(n))||n);return o&&n&&tl(t,r,n),n};let _t=class extends Ge{constructor(){super(...arguments),this.current=null,this.queue=[],this.dialogEl=null,this.onCancel=e=>{e.preventDefault();const t=this.current;t&&(t.kind==="alert"?this.closeAndResolve(void 0):this.closeAndResolve(null))},this.submitPrompt=e=>{e.preventDefault(),this.current?.kind==="prompt"&&this.closeAndResolve(this.current.value)},this.submitAlert=e=>{e.preventDefault(),this.closeAndResolve(void 0)},this.cancelPrompt=()=>this.closeAndResolve(null),this.onCloseX=()=>{this.dialogEl&&!this.dialogEl.dispatchEvent(new Event("cancel",{cancelable:!0}))||this.onCancel(new Event("cancel",{cancelable:!0}))}}connectedCallback(){super.connectedCallback(),_t.instance=this}disconnectedCallback(){super.disconnectedCallback(),_t.instance===this&&(_t.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null}updated(){if(!this.dialogEl)return;const e=this.shadowRoot?.querySelector(".dialog-header");e&&$n(this.dialogEl,e)}alert(e,t="Notice"){return this.enqueue(r=>{this.current={kind:"alert",title:t,message:e,resolve:r}})}async confirm(e,t="Confirm"){return await this.choice(e,["Yes","No"],t)==="Yes"}prompt(e,t="",r="Input"){return this.enqueue(o=>{this.current={kind:"prompt",title:r,message:e,value:t,resolve:o}})}choice(e,t,r="Choose"){return this.enqueue(o=>{this.current={kind:"choice",title:r,message:e,options:t,resolve:o}})}enqueue(e){return new Promise(t=>{const r=()=>{e(t),this.updateComplete.then(()=>this.dialogEl?.showModal())};this.current?this.queue.push(r):r()})}closeAndResolve(e){const t=this.current;t&&(this.dialogEl?.close(),this.current=null,queueMicrotask(()=>{t.kind==="alert"?t.resolve():t.resolve(e);const r=this.queue.shift();r&&r()}))}render(){const e=this.current;return G`
    ...
    `}renderBody(e){switch(e.kind){case"alert":return G`
        ...
        `}}};_t.instance=null;_t.styles=[wn,ot`
      dialog {
        min-width: 360px;
        max-width: 520px;
      }
    ...
    `];ys([ne()],_t.prototype,"current",2);_t=ys([dt("host-dialogs")],_t);const Gt=ot`
  .mi {
          ...
          <div class="dialog-body">
            <label>
              ...
              <select .value=${String(this.presetIdx)} @change=${e=>this.onPresetChange(e)}>
                ...
                ${es.map((e,t)=>G`<option value=${String(t)} ?selected=${t===this.presetIdx}>
                      ${e.label}
                    </option>`)}
              </select>
            </label>
 ...
 */const qs=Symbol.for(""),ed=e=>{if(e?.r===qs)return e?._$litStatic$},td=e=>({_$litStatic$:e,r:qs}),is=new Map,nd=e=>(t,...r)=>{const o=r.length;let n,l;const c=[],f=[];let m,T=0,j=!1;for(;T<o;){for(m=t[T];T<o&&(l=r[T],(n=ed(l))!==void 0);)m+=n+t[++T],j=!0;T!==o&&f.push(l),c.push(m),T++}if(T===o&&c.push(t[o]),j){const z=c.join("$$lit$$");(t=is.get(z))===void 0&&(c.raw=c,is.set(z,t=c)),r=f}return e(t,...r)},rd=nd(G);var id=Object.defineProperty,od=Object.getOwnPropertyDescriptor,Hr=(e,t,r,o)=>{for(var n=o>1?void 0:o?od(t,r):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(o?c(t,r,n):c(n))||n);return o&&n&&id(t,r,n),n};let Dt=class extends Ge{constructor(){super(...arguments),this.values=[],this.current="",this.search="",this.resolveFn=null,this.onOutside=e=>{e.composedPath().includes(this)||this.close(null)}}open(e,t,r){return this.values=t,this.current=r,this.search="",this.style.top=`${Math.round(e.bottom+4)}px`,this.style.left=`${Math.round(e.left)}px`,this.removeAttribute("hidden"),new Promise(o=>{this.resolveFn=o,setTimeout(()=>document.addEventListener("mousedown",this.onOutside,!0),0)})}close(e){document.removeEventListener("mousedown",this.onOutside,!0),this.setAttribute("hidden","");const t=this.resolveFn;this.resolveFn=null,t?.(e)}connectedCallback(){super.connectedCallback(),Dt.instance=this,this.setAttribute("hidden","")}disconnectedCallback(){super.disconnectedCallback(),Dt.instance===this&&(Dt.instance=null)}render(){const e=this.search.toLowerCase(),t=this.values.filter(r=>r.value.toLowerCase().includes(e));return G`
  ...
  `;zt([Xt({type:String})],Et.prototype,"value",2);zt([Xt({type:Array})],Et.prototype,"options",2);zt([Xt({type:String})],Et.prototype,"placeholder",2);zt([ne()],Et.prototype,"open",2);zt([ne()],Et.prototype,"highlightIdx",2);zt([ne()],Et.prototype,"dropTop",2);zt([ne()],Et.prototype,"dropLeft",2);zt([ne()],Et.prototype,"dropMinWidth",2);zt([ne()],Et.prototype,"editing",2);zt([zr("input")],Et.prototype,"inputEl",2);Et=zt([dt("filter-combobox")],Et);var ld=Object.defineProperty,cd=Object.getOwnPropertyDescriptor,ft=(e,t,r,o)=>{for(var n=o>1?void 0:o?cd(t,r):t,l=e.length-1,c;l>=0;l--)(c=e[l])&&(n=(o?c(t,r,n):c(n))||n);return o&&n&&ld(t,r,n),n};let it=class extends Ge{constructor(){super(...arguments),this.tableId="",this.columns=[],this.rows=[],this.sortColumn=null,this.sortDir=null,this.filters={},this.globalQuery="",this.localQuery="",this.dragSourceField=null,this.dropTargetField=null,this.dropEdge=null,this.resizing=null,this.cellRenderers=new Map,this.scrollY=0,this.viewportHeight=0,this.rowHeight=28,this.resizeObs=null,this.filterSaveTimer=null,this.VIRT_THRESHOLD=200,this.OVERSCAN=8,this.onScroll=()=>{this.scrollY=this.scrollTop},this.onGlobalSearch=e=>{this.globalQuery=e.detail.query??""},this.onTableSearch=e=>{const t=e.detail;t.tableId===this.tableId&&(this.localQuery=t.query??"")}}async connectedCallback(){super.connectedCallback(),document.addEventListener("easydb:global-search",this.onGlobalSearch),document.addEventListener("easydb:table-search",this.onTableSearch),this.addEventListener("scroll",this.onScroll,{passive:!0}),this.resizeObs=new ResizeObserver(()=>{this.viewportHeight=this.clientHeight}),this.resizeObs.observe(this),await this.bind()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("easydb:global-search",this.onGlobalSearch),document.removeEventListener("easydb:table-search",this.onTableSearch),this.removeEventListener("scroll",this.onScroll),this.resizeObs?.disconnect(),this.resizeObs=null,this.unsubscribe?.(),this.tableSubUnsub?.()}async updated(e){e.has("tableId")&&this.tableId&&(this.unsubscribe?.(),await this.bind());const t=this.shadowRoot?.querySelector("tbody tr:not(.spacer)");t&&t.offsetHeight>0&&(this.rowHeight=t.offsetHeight),this.viewportHeight||(this.viewportHeight=this.clientHeight),this.markEmptyCells()}markEmptyCells(){const e=this.shadowRoot?.querySelectorAll("tbody tr:not(.spacer) > td");if(e)for(const t of e)t.className.startsWith("t-")&&t.classList.toggle("is-null",ud(t))}async bind(){if(!this.tableId)return;const e=await _e(),t=await e.store.tables.findOne(this.tableId);if(!t)return;this.applyTable(t),this.tableSubUnsub?.(),this.tableSubUnsub=e.store.tables.subscribe(o=>{const n=o.find(l=>l.id===this.tableId);n&&this.applyTable(n)}),this.cellRenderers=new Map(e.registries.cellRenderers),e.events.on("app:ready",()=>this.cellRenderers=new Map(e.registries.cellRenderers));const r=e.store.rows(this.tableId);this.unsubscribe=r.subscribe(o=>this.rows=o),this.rows=await r.find()}applyTable(e){this.columns=e.columns,this.sortColumn=e.sortColumn??null,this.sortDir=e.sortColumn?e.sortAsc===!1?"desc":"asc":null,this.filters={...e.filters??{}}}async setCell(e,t,r){const o=await _e();await this.commitCell(o,e,t,r)}async commitCell(e,t,r,o){const n=this.columns.find(l=>l.field===r);if(n){const l=dd(n,o,this.rows,t.id);if(l){await e.api.ui.dialogs.alert(l,`Cannot save ${n.label}`),this.requestUpdate();return}}await e.store.rows(this.tableId).patch(t.id,{data:{...t.data,[r]:o},updatedAt:Date.now()})}renderCell(e,t){const r=e.data[t.field],o=t.renderer,n=o?this.cellRenderers?.get(o):void 0;if(n){const l=td(n);return rd`<${l}
      ...
      <table>
        ...
        <thead>
          <tr>
            ${t.map(c=>{const f=this.sortColumn===c.field&&this.sortDir,m=f==="asc"?"▲":f==="desc"?"▼":"⇅",T=`t-${c.type}`,j=this.dragSourceField===c.field,z=this.dropTargetField===c.field,F=z&&this.dropEdge==="before"?" drop-before":z&&this.dropEdge==="after"?" drop-after":"";return G`
                <th
