 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ob={CHILD:2},qh=e=>(...t)=>({_$litDirective$:e,values:t});class Lb{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,r){this._$Ct=t,this._$AM=n,this._$Ci=r}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ls extends Lb{constructor(t){if(super(t),this.it=X,t.type!==Ob.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===X||t==null)return this._t=void 0,this.it=t;if(t===Nn)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const n=[t];return n.raw=n,this._t={_$litType$:this.constructor.resultType,strings:n,values:[]}}}Ls.directiveName="unsafeHTML",Ls.resultType=1;const ar=qh(Ls);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class Ba extends Ls{}Ba.directiveName="unsafeSVG",Ba.resultType=2;const Il=qh(Ba),mt=Se`
  :host {
    display: contents;
  }
  dialog {
...
`;function gt(e){if(e.key!=="Enter"||!e.ctrlKey&&!e.metaKey)return;const t=e.currentTarget;if(!(t instanceof HTMLElement))return;const n=t.querySelector("form");n&&(e.preventDefault(),n.requestSubmit())}const Mu=new WeakSet;function bt(e,t){if(Mu.has(t))return;Mu.add(t);let n=0,r=0,i=0,s=0,o=!1;t.style.cursor="grab",t.style.touchAction="none",t.style.userSelect="none",t.addEventListener("pointerdown",c=>{if(c.target.closest("button, input, textarea, select, a, label"))return;o=!0,n=c.clientX,r=c.clientY;const f=e.getBoundingClientRect();i=f.left,s=f.top,t.setPointerCapture(c.pointerId),t.style.cursor="grabbing"}),t.addEventListener("pointermove",c=>{if(!o)return;const d=c.clientX-n,f=c.clientY-r,p=-e.offsetWidth+80,b=window.innerWidth-80,y=0,k=window.innerHeight-40,$=Math.max(p,Math.min(b,i+d)),C=Math.max(y,Math.min(k,s+f));e.style.position="fixed",e.style.left=`${$}px`,e.style.top=`${C}px`,e.style.margin="0"});const a=c=>{if(o){o=!1;try{t.releasePointerCapture(c.pointerId)}catch{}t.style.cursor="grab"}};t.addEventListener("pointerup",a),t.addEventListener("pointercancel",a)}var Db=function(e,t,n,r){var i=arguments.length,s=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")s=Reflect.decorate(e,t,n,r);else for(var a=e.length-1;a>=0;a--)(o=e[a])&&(s=(i<3?o(s):i>3?o(t,n,s):o(t,n))||s);return i>3&&s&&Object.defineProperty(t,n,s),s};class lt extends $e{constructor(){super(...arguments),this.current=null,this.queue=[],this.dialogEl=null,this.onCancel=t=>{t.preventDefault();const n=this.current;n&&(n.kind==="alert"?this.closeAndResolve(void 0):this.closeAndResolve(null))},this.submitPrompt=t=>{t.preventDefault(),this.current?.kind==="prompt"&&this.closeAndResolve(this.current.value)},this.submitChoice=t=>{if(t.preventDefault(),this.current?.kind!=="choice")return;const n=this.current.options[0];n!==void 0&&this.closeAndResolve(n)},this.submitAlert=t=>{t.preventDefault(),this.closeAndResolve(void 0)},this.cancelPrompt=()=>this.closeAndResolve(null),this.onCloseX=()=>{this.dialogEl&&!this.dialogEl.dispatchEvent(new Event("cancel",{cancelable:!0}))||this.onCancel(new Event("cancel",{cancelable:!0}))}}static{this.instance=null}static{this.styles=[mt,Se`
    ...
    `}renderBody(t){switch(t.kind){case"alert":return v`
        ...
        `}}}Db([z()],lt.prototype,"current",void 0);function Mb(e="host-dialogs"){customElements.get(e)||customElements.define(e,lt)}const Pb=Se`
  .mi {
...
`))}</code></pre>`);continue}if(If.test(o)){const f=s(b=>b.trim()!==""),p=Dy(f.join(`
...
`))}</blockquote>`);continue}if(o.includes("|")&&i+1<n.length&&Tf.test(n[i+1])&&n[i+1].includes("-")){const f=_a(o),p=_a(n[i+1]).map(Uy);i+=2;const b=s($=>$.trim()!==""&&$.includes("|")),y=f.map(($,C)=>`<th${p[C]??""}>${nr($)}</th>`).join(""),k=b.map($=>`<tr>${_a($).map((C,E)=>`<td${p[E]??""}>${nr(C)}</td>`).join("")}</tr>`);r.push(`<table><thead><tr>${y}</tr></thead><tbody>${k.join("")}</tbody></table>`);continue}if(Ef.test(o)){const f=s(p=>p.trim()!==""&&!Wa.test(p)&&!Ga.test(p));r.push(Af(f));continue}const d=s(f=>f.trim()!==""&&!Fy(f));if(d.length===0){r.push(`<p>${nr(o)}</p>`),i++;continue}r.push(`<p>${nr(d.join(`
`))}</p>`)}return r.join(`
...
`)],c=t.tableNames[n.alias]??n.tableName;a.push(`FROM ${Qe(c)} AS ${Qe(n.alias)}`);for(const y of e.sources.slice(1)){const k=t.tableNames[y.alias]??y.tableName;if(!y.join){a.push(`CROSS JOIN ${Qe(k)} AS ${Qe(y.alias)}`);continue}const $=y.join.type==="inner"?"INNER JOIN":"LEFT JOIN",C=y.join.on.map(E=>`${Qe(y.alias)}.${Qe(E.field)} = ${Qe(E.eqAlias)}.${Qe(E.eqField)}`).join(" AND ");a.push(`${$} ${Qe(k)} AS ${Qe(y.alias)} ON ${C||"1 = 1"}`)}const d=[],f=[];for(const[y,k]of Object.entries(e.filters??{})){if(!k)continue;const $=Cd(e,y);if($){if($.computed){f.push(`-- filter on ${Qe(y)} (${Sd(k)}) applies to a computed column; enforced in-app only`);continue}d.push(`LOWER(${$.expr}) LIKE ${Sd(`%${k.toLowerCase()}%`)}`)}}d.length>0&&a.push(`WHERE ${d.join(`
  AND `)}`);const p=(t.orderBy??[]).map(y=>{const k=Cd(e,y.field);return!k||k.computed?null:`${k.expr} ${y.asc?"ASC":"DESC"}`}).filter(y=>y!==null);p.length>0&&a.push(`ORDER BY ${p.join(", ")}`);const b=i==null?"":r==="limit"?`
LIMIT ${i}`:r==="fetch"?`
...
`)}function rk(e){const t=new Map;for(const n of e)t.has(n.name)||t.set(n.name,mr(n.code||n.name));return n=>t.get(n)??mr(je(n))}function bp(e,t){const n=wp(e);return n||["-- easyDBAccess table export",`-- table:    ${e.name}`,`-- exported: ${new Date().toISOString()}`,"","BEGIN;","",yp(e,t),"","COMMIT;",""].join(`
    ...
    ></${i}>`}renderCell(e,t){const n=e.data[t.field];if(t.script?.trim())return this.renderScriptedCell(e,t);const r=this.readOnly||t.readonly===!0,i=t.renderer,s=i?this.cellRenderers?.get(i):void 0;if(s){const o=dl(s);return hl`<${o}
      ...
      <table style=${this.tableSizingStyle(t)??X}>
        <colgroup>
          ...
          <col style="width:${La}px" />
        </colgroup>
        <thead>
          <tr>
            ${t.map(a=>{const c=a.sortable!==!1,d=a.filterable!==!1&&!dm(a,this.rows),f=this.sortSpecs.findIndex(D=>D.field===a.field),p=f>=0?this.sortSpecs[f]:void 0,b=p?p.asc?"asc":"desc":null,y=c?b==="asc"?"▲":b==="desc"?"▼":"⇅":"",k=this.sortSpecs.length>1&&f>=0?String(f+1):"",$=`t-${a.type}`,C=this.dragSourceField===a.field,E=this.dropTargetField===a.field,T=E&&this.dropEdge==="before"?" drop-before":E&&this.dropEdge==="after"?" drop-after":"",Y=(a.description?`${a.description}
...
…and ${V.length-5} more.`:""}`;return}}const y=new Set(this.columns.map(I=>I.origField).filter(I=>!!I)),k=new Set(c.map(I=>I.field)),$=(f?.columns??[]).map(I=>I.field).filter(I=>!y.has(I)),C=f?.deletedColumns??[],E=[...new Set([...C,...$])].filter(I=>!k.has(I));let T=null;if(f&&f.name!==t){const I=(await n.store.viewInstances.find()).filter(K=>K.workspaceId===n.workspaceId);T=y2(f.name,r,I,d);const V=S2(T);if(V&&!await R2(f.name,t,V))return}const Y={name:t,title:a,columns:c,readonly:this.tableReadonly,updatedAt:Date.now()};(E.length>0||C.length>0)&&(Y.deletedColumns=E);const D=f?.name;await n.store.tables.patch(d,Y);const ne=$.filter(I=>!k.has(I)),W=this.fieldRenames();if(!f?.source&&(ne.length>0||W.length>0)){const I=await n.store.rows(d).find();for(const V of I){let K=!1,ie={...V.data};const de=Ju(ie,W);de&&(ie=de,K=!0);for(const H of ne)H in ie&&(delete ie[H],K=!0);K&&await n.store.rows(d).patch(V.id,{data:ie,updatedAt:Date.now()})}}await A2(d,D??t,W,r),D!==void 0&&D!==t&&await I2(d,D,t,T)}else await n.store.tables.insert({id:Ee(),workspaceId:n.workspaceId,name:t,title:a,code:je(t),columns:c,view:"table",updatedAt:Date.now()});this.close()}renderPreview(){if(this.previewRows.length===0){const i=this.previewState==="loading"?"Reading rows for the preview…":this.previewState==="error"?"The rows could not be read, so there is no preview. Your column changes still save.":"No rows to preview.";return v`<div class="preview"><div class="empty" data-testid="preview-empty">${i}</div></div>`}const e=this.fieldRenames(),t=e.length>0?this.previewRows.map(i=>({...i,data:Ju(i.data,e)??i.data})):this.previewRows,n=new Map;for(const i of this.columns){if(!i.unique)continue;const s=new Set,o=new Set;for(const a of t){const c=a.data[i.field];c==null||c===""||(s.has(c)&&o.add(c),s.add(c))}n.set(i.field,o)}const r=this.columns.filter(i=>!i.hidden);return v`
      <div class="preview">
        ...
        <table>
          ...
          <tbody>
            ${t.map(i=>v`
                <tr>
                  ${r.map(s=>{const o=i.data[s.field],a=L2(s,o,n.get(s.field));return v`<td class=${a?"violation":""} title=${a??""}>${O2(o)}</td>`})}
                </tr>
              `)}
          </tbody>
        </table>
  ...
  `;_g([z()],Js.prototype,"tables",2);Js=_g([Re("table-list")],Js);var rT=Object.defineProperty,iT=Object.getOwnPropertyDescriptor,Bc=(e,t,n,r)=>{for(var i=r>1?void 0:r?iT(t,n):t,s=e.length-1,o;s>=0;s--)(o=e[s])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&rT(t,n,i),i};let wi=class extends $e{constructor(){super(...arguments),this.workspaces=[],this.current=""}async connectedCallback(){super.connectedCallback();const e=await J();this.current=e.workspaceId,this.unsubscribe=e.store.workspaces.subscribe(t=>this.workspaces=t),this.workspaces=await e.store.workspaces.find()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.()}switchWorkspace(e){const t=this.workspaces.find(n=>n.id===e);t&&jo(t.name)}render(){return v`
    ...
    `];Lt([Kt("new-table-dialog")],pt.prototype,"dialog",2);Lt([Kt("csv-paste-dialog")],pt.prototype,"csvPasteDialog",2);Lt([Kt("plugin-manager-dialog")],pt.prototype,"pluginManagerDialog",2);Lt([Kt("settings-dialog")],pt.prototype,"settingsDialog",2);Lt([Kt("command-palette-dialog")],pt.prototype,"commandPaletteDialog",2);Lt([Kt("input.search")],pt.prototype,"searchInput",2);Lt([z()],pt.prototype,"footerButtons",2);Lt([z()],pt.prototype,"headerButtons",2);Lt([z()],pt.prototype,"searchQuery",2);Lt([z()],pt.prototype,"searchOpen",2);Lt([z()],pt.prototype,"workspaceTitle",2);pt=Lt([Re("app-shell")],pt);const Mh=document.title;function aT(e){const t=e.trim();document.title=t?`${t} — ${Mh}`:Mh}function lT(){return document.getElementById("easydb-panels")}function Ph(e){const t=e.dataTransfer;return t?t.types&&Array.from(t.types).includes("Files")?!0:(t.files?.length??0)>0:!1}typeof location<"u"&&new URLSearchParams(location.search).get("test")==="1"&&Promise.all([J(),Ie(()=>Promise.resolve().then(()=>Om),[])]).then(([e,t])=>{Object.assign(window,{__easydb:e,__autoSyncTick:()=>t.tick(e.api)}),document.dispatchEvent(new CustomEvent("easydb:test-ready"))});export{X as A,Bb as a,v as b,gt as c,mt as d,xT as e,Se as f,hT as g,$e as i,bt as m,z as r,Re as t,Xt as w};
//# sourceMappingURL=index-Dwdkph9w.js.map
