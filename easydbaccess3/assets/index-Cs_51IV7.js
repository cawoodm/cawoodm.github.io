(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function r(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(n){if(n.ep)return;n.ep=!0;const s=r(n);fetch(n.href,s)}})();const Td="modulepreload",Ad=function(e){return"/easydbaccess3/"+e},ga={},ln=function(t,r,i){let n=Promise.resolve();if(r&&r.length>0){let a=function(p){return Promise.all(p.map(w=>Promise.resolve(w).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const c=document.querySelector("meta[property=csp-nonce]"),u=c?.nonce||c?.getAttribute("nonce");n=a(r.map(p=>{if(p=Ad(p),p in ga)return;ga[p]=!0;const w=p.endsWith(".css"),b=w?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${b}`))return;const $=document.createElement("link");if($.rel=w?"stylesheet":Td,w||($.as="script"),$.crossOrigin="",$.href=p,u&&$.setAttribute("nonce",u),document.head.appendChild($),w)return new Promise((D,P)=>{$.addEventListener("load",D),$.addEventListener("error",()=>P(new Error(`Unable to preload CSS for ${p}`)))})}))}function s(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return n.then(a=>{for(const c of a||[])c.status==="rejected"&&s(c.reason);return t().catch(s)})};/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const vi=globalThis,oo=vi.ShadowRoot&&(vi.ShadyCSS===void 0||vi.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,ao=Symbol(),ba=new WeakMap;let Pl=class{constructor(t,r,i){if(this._$cssResult$=!0,i!==ao)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=r}get styleSheet(){let t=this.o;const r=this.t;if(oo&&t===void 0){const i=r!==void 0&&r.length===1;i&&(t=ba.get(r)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&ba.set(r,t))}return t}toString(){return this.cssText}};const Id=e=>new Pl(typeof e=="string"?e:e+"",void 0,ao),We=(e,...t)=>{const r=e.length===1?e[0]:t.reduce((i,n,s)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+e[s+1],e[0]);return new Pl(r,e,ao)},Pd=(e,t)=>{if(oo)e.adoptedStyleSheets=t.map(r=>r instanceof CSSStyleSheet?r:r.styleSheet);else for(const r of t){const i=document.createElement("style"),n=vi.litNonce;n!==void 0&&i.setAttribute("nonce",n),i.textContent=r.cssText,e.appendChild(i)}},ya=oo?e=>e:e=>e instanceof CSSStyleSheet?(t=>{let r="";for(const i of t.cssRules)r+=i.cssText;return Id(r)})(e):e;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Rd,defineProperty:Dd,getOwnPropertyDescriptor:Od,getOwnPropertyNames:jd,getOwnPropertySymbols:zd,getPrototypeOf:Ld}=Object,Li=globalThis,wa=Li.trustedTypes,Fd=wa?wa.emptyScript:"",Md=Li.reactiveElementPolyfillSupport,Rr=(e,t)=>e,ki={toAttribute(e,t){switch(t){case Boolean:e=e?Fd:null;break;case Object:case Array:e=e==null?e:JSON.stringify(e)}return e},fromAttribute(e,t){let r=e;switch(t){case Boolean:r=e!==null;break;case Number:r=e===null?null:Number(e);break;case Object:case Array:try{r=JSON.parse(e)}catch{r=null}}return r}},lo=(e,t)=>!Rd(e,t),va={attribute:!0,type:String,converter:ki,reflect:!1,useDefault:!1,hasChanged:lo};Symbol.metadata??=Symbol("metadata"),Li.litPropertyMetadata??=new WeakMap;let sr=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,r=va){if(r.state&&(r.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((r=Object.create(r)).wrapped=!0),this.elementProperties.set(t,r),!r.noAccessor){const i=Symbol(),n=this.getPropertyDescriptor(t,i,r);n!==void 0&&Dd(this.prototype,t,n)}}static getPropertyDescriptor(t,r,i){const{get:n,set:s}=Od(this.prototype,t)??{get(){return this[r]},set(a){this[r]=a}};return{get:n,set(a){const c=n?.call(this);s?.call(this,a),this.requestUpdate(t,c,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??va}static _$Ei(){if(this.hasOwnProperty(Rr("elementProperties")))return;const t=Ld(this);t.finalize(),t.l!==void 0&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty(Rr("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Rr("properties"))){const r=this.properties,i=[...jd(r),...zd(r)];for(const n of i)this.createProperty(n,r[n])}const t=this[Symbol.metadata];if(t!==null){const r=litPropertyMetadata.get(t);if(r!==void 0)for(const[i,n]of r)this.elementProperties.set(i,n)}this._$Eh=new Map;for(const[r,i]of this.elementProperties){const n=this._$Eu(r,i);n!==void 0&&this._$Eh.set(n,r)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const r=[];if(Array.isArray(t)){const i=new Set(t.flat(1/0).reverse());for(const n of i)r.unshift(ya(n))}else t!==void 0&&r.push(ya(t));return r}static _$Eu(t,r){const i=r.attribute;return i===!1?void 0:typeof i=="string"?i:typeof t=="string"?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),this.renderRoot!==void 0&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,r=this.constructor.elementProperties;for(const i of r.keys())this.hasOwnProperty(i)&&(t.set(i,this[i]),delete this[i]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Pd(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,r,i){this._$AK(t,i)}_$ET(t,r){const i=this.constructor.elementProperties.get(t),n=this.constructor._$Eu(t,i);if(n!==void 0&&i.reflect===!0){const s=(i.converter?.toAttribute!==void 0?i.converter:ki).toAttribute(r,i.type);this._$Em=t,s==null?this.removeAttribute(n):this.setAttribute(n,s),this._$Em=null}}_$AK(t,r){const i=this.constructor,n=i._$Eh.get(t);if(n!==void 0&&this._$Em!==n){const s=i.getPropertyOptions(n),a=typeof s.converter=="function"?{fromAttribute:s.converter}:s.converter?.fromAttribute!==void 0?s.converter:ki;this._$Em=n;const c=a.fromAttribute(r,s.type);this[n]=c??this._$Ej?.get(n)??c,this._$Em=null}}requestUpdate(t,r,i,n=!1,s){if(t!==void 0){const a=this.constructor;if(n===!1&&(s=this[t]),i??=a.getPropertyOptions(t),!((i.hasChanged??lo)(s,r)||i.useDefault&&i.reflect&&s===this._$Ej?.get(t)&&!this.hasAttribute(a._$Eu(t,i))))return;this.C(t,r,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(t,r,{useDefault:i,reflect:n,wrapped:s},a){i&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??r??this[t]),s!==!0||a!==void 0)||(this._$AL.has(t)||(this.hasUpdated||i||(r=void 0),this._$AL.set(t,r)),n===!0&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(r){Promise.reject(r)}const t=this.scheduleUpdate();return t!=null&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,s]of this._$Ep)this[n]=s;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[n,s]of i){const{wrapped:a}=s,c=this[n];a!==!0||this._$AL.has(n)||c===void 0||this.C(n,void 0,s,c)}}let t=!1;const r=this._$AL;try{t=this.shouldUpdate(r),t?(this.willUpdate(r),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(r)):this._$EM()}catch(i){throw t=!1,this._$EM(),i}t&&this._$AE(r)}willUpdate(t){}_$AE(t){this._$EO?.forEach(r=>r.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(r=>this._$ET(r,this[r])),this._$EM()}updated(t){}firstUpdated(t){}};sr.elementStyles=[],sr.shadowRootOptions={mode:"open"},sr[Rr("elementProperties")]=new Map,sr[Rr("finalized")]=new Map,Md?.({ReactiveElement:sr}),(Li.reactiveElementVersions??=[]).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const co=globalThis,xa=e=>e,Ci=co.trustedTypes,$a=Ci?Ci.createPolicy("lit-html",{createHTML:e=>e}):void 0,Rl="$lit$",Dn=`lit$${Math.random().toFixed(9).slice(2)}$`,Dl="?"+Dn,Bd=`<${Dl}>`,Gn=document,Dr=()=>Gn.createComment(""),Or=e=>e===null||typeof e!="object"&&typeof e!="function",uo=Array.isArray,Nd=e=>uo(e)||typeof e?.[Symbol.iterator]=="function",Ps=`[ 	
\f\r]`,Tr=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ka=/-->/g,Ca=/>/g,qn=RegExp(`>|${Ps}(?:([^\\s"'>=/]+)(${Ps}*=${Ps}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ea=/'/g,Sa=/"/g,Ol=/^(?:script|style|textarea|title)$/i,Ud=e=>(t,...r)=>({_$litType$:e,strings:t,values:r}),_=Ud(1),Yn=Symbol.for("lit-noChange"),fe=Symbol.for("lit-nothing"),_a=new WeakMap,Kn=Gn.createTreeWalker(Gn,129);function jl(e,t){if(!uo(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return $a!==void 0?$a.createHTML(t):t}const Hd=(e,t)=>{const r=e.length-1,i=[];let n,s=t===2?"<svg>":t===3?"<math>":"",a=Tr;for(let c=0;c<r;c++){const u=e[c];let p,w,b=-1,$=0;for(;$<u.length&&(a.lastIndex=$,w=a.exec(u),w!==null);)$=a.lastIndex,a===Tr?w[1]==="!--"?a=ka:w[1]!==void 0?a=Ca:w[2]!==void 0?(Ol.test(w[2])&&(n=RegExp("</"+w[2],"g")),a=qn):w[3]!==void 0&&(a=qn):a===qn?w[0]===">"?(a=n??Tr,b=-1):w[1]===void 0?b=-2:(b=a.lastIndex-w[2].length,p=w[1],a=w[3]===void 0?qn:w[3]==='"'?Sa:Ea):a===Sa||a===Ea?a=qn:a===ka||a===Ca?a=Tr:(a=qn,n=void 0);const D=a===qn&&e[c+1].startsWith("/>")?" ":"";s+=a===Tr?u+Bd:b>=0?(i.push(p),u.slice(0,b)+Rl+u.slice(b)+Dn+D):u+Dn+(b===-2?c:D)}return[jl(e,s+(e[r]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),i]};class jr{constructor({strings:t,_$litType$:r},i){let n;this.parts=[];let s=0,a=0;const c=t.length-1,u=this.parts,[p,w]=Hd(t,r);if(this.el=jr.createElement(p,i),Kn.currentNode=this.el.content,r===2||r===3){const b=this.el.content.firstChild;b.replaceWith(...b.childNodes)}for(;(n=Kn.nextNode())!==null&&u.length<c;){if(n.nodeType===1){if(n.hasAttributes())for(const b of n.getAttributeNames())if(b.endsWith(Rl)){const $=w[a++],D=n.getAttribute(b).split(Dn),P=/([.?@])?(.*)/.exec($);u.push({type:1,index:s,name:P[2],strings:D,ctor:P[1]==="."?Wd:P[1]==="?"?Kd:P[1]==="@"?Vd:Fi}),n.removeAttribute(b)}else b.startsWith(Dn)&&(u.push({type:6,index:s}),n.removeAttribute(b));if(Ol.test(n.tagName)){const b=n.textContent.split(Dn),$=b.length-1;if($>0){n.textContent=Ci?Ci.emptyScript:"";for(let D=0;D<$;D++)n.append(b[D],Dr()),Kn.nextNode(),u.push({type:2,index:++s});n.append(b[$],Dr())}}}else if(n.nodeType===8)if(n.data===Dl)u.push({type:2,index:s});else{let b=-1;for(;(b=n.data.indexOf(Dn,b+1))!==-1;)u.push({type:7,index:s}),b+=Dn.length-1}s++}}static createElement(t,r){const i=Gn.createElement("template");return i.innerHTML=t,i}}function ar(e,t,r=e,i){if(t===Yn)return t;let n=i!==void 0?r._$Co?.[i]:r._$Cl;const s=Or(t)?void 0:t._$litDirective$;return n?.constructor!==s&&(n?._$AO?.(!1),s===void 0?n=void 0:(n=new s(e),n._$AT(e,r,i)),i!==void 0?(r._$Co??=[])[i]=n:r._$Cl=n),n!==void 0&&(t=ar(e,n._$AS(e,t.values),n,i)),t}class qd{constructor(t,r){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=r}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:r},parts:i}=this._$AD,n=(t?.creationScope??Gn).importNode(r,!0);Kn.currentNode=n;let s=Kn.nextNode(),a=0,c=0,u=i[0];for(;u!==void 0;){if(a===u.index){let p;u.type===2?p=new Mr(s,s.nextSibling,this,t):u.type===1?p=new u.ctor(s,u.name,u.strings,this,t):u.type===6&&(p=new Gd(s,this,t)),this._$AV.push(p),u=i[++c]}a!==u?.index&&(s=Kn.nextNode(),a++)}return Kn.currentNode=Gn,n}p(t){let r=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(t,i,r),r+=i.strings.length-2):i._$AI(t[r])),r++}}class Mr{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,r,i,n){this.type=2,this._$AH=fe,this._$AN=void 0,this._$AA=t,this._$AB=r,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const r=this._$AM;return r!==void 0&&t?.nodeType===11&&(t=r.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,r=this){t=ar(this,t,r),Or(t)?t===fe||t==null||t===""?(this._$AH!==fe&&this._$AR(),this._$AH=fe):t!==this._$AH&&t!==Yn&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):Nd(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==fe&&Or(this._$AH)?this._$AA.nextSibling.data=t:this.T(Gn.createTextNode(t)),this._$AH=t}$(t){const{values:r,_$litType$:i}=t,n=typeof i=="number"?this._$AC(t):(i.el===void 0&&(i.el=jr.createElement(jl(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(r);else{const s=new qd(n,this),a=s.u(this.options);s.p(r),this.T(a),this._$AH=s}}_$AC(t){let r=_a.get(t.strings);return r===void 0&&_a.set(t.strings,r=new jr(t)),r}k(t){uo(this._$AH)||(this._$AH=[],this._$AR());const r=this._$AH;let i,n=0;for(const s of t)n===r.length?r.push(i=new Mr(this.O(Dr()),this.O(Dr()),this,this.options)):i=r[n],i._$AI(s),n++;n<r.length&&(this._$AR(i&&i._$AB.nextSibling,n),r.length=n)}_$AR(t=this._$AA.nextSibling,r){for(this._$AP?.(!1,!0,r);t!==this._$AB;){const i=xa(t).nextSibling;xa(t).remove(),t=i}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Fi{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,r,i,n,s){this.type=1,this._$AH=fe,this._$AN=void 0,this.element=t,this.name=r,this._$AM=n,this.options=s,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=fe}_$AI(t,r=this,i,n){const s=this.strings;let a=!1;if(s===void 0)t=ar(this,t,r,0),a=!Or(t)||t!==this._$AH&&t!==Yn,a&&(this._$AH=t);else{const c=t;let u,p;for(t=s[0],u=0;u<s.length-1;u++)p=ar(this,c[i+u],r,u),p===Yn&&(p=this._$AH[u]),a||=!Or(p)||p!==this._$AH[u],p===fe?t=fe:t!==fe&&(t+=(p??"")+s[u+1]),this._$AH[u]=p}a&&!n&&this.j(t)}j(t){t===fe?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class Wd extends Fi{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===fe?void 0:t}}class Kd extends Fi{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==fe)}}class Vd extends Fi{constructor(t,r,i,n,s){super(t,r,i,n,s),this.type=5}_$AI(t,r=this){if((t=ar(this,t,r,0)??fe)===Yn)return;const i=this._$AH,n=t===fe&&i!==fe||t.capture!==i.capture||t.once!==i.once||t.passive!==i.passive,s=t!==fe&&(i===fe||n);n&&this.element.removeEventListener(this.name,this,i),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class Gd{constructor(t,r,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=r,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){ar(this,t)}}const Yd=co.litHtmlPolyfillSupport;Yd?.(jr,Mr),(co.litHtmlVersions??=[]).push("3.3.3");const Xd=(e,t,r)=>{const i=r?.renderBefore??t;let n=i._$litPart$;if(n===void 0){const s=r?.renderBefore??null;i._$litPart$=n=new Mr(t.insertBefore(Dr(),s),s,void 0,r??{})}return n._$AI(e),n};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ho=globalThis;let Ue=class extends sr{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const r=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=Xd(r,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return Yn}};Ue._$litElement$=!0,Ue.finalized=!0,ho.litElementHydrateSupport?.({LitElement:Ue});const Qd=ho.litElementPolyfillSupport;Qd?.({LitElement:Ue});(ho.litElementVersions??=[]).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
    ...
    `}renderBody(e){switch(e.kind){case"alert":return _`
        ...
        `;case"choice":return _`
          <form @submit=${this.submitChoice}>
            ...
            <div class="dialog-body">
              ${e.message?_`<p class="message">${e.message}</p>`:fe}
              <div class="choices">
...
`;var bu=Object.defineProperty,yu=Object.getOwnPropertyDescriptor,Bl=(e,t,r,i)=>{for(var n=i>1?void 0:i?yu(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&bu(t,r,n),n};let Cn=class extends Ue{constructor(){super(...arguments),this.toasts=[],this.nextId=1}connectedCallback(){super.connectedCallback(),Cn.instance=this}disconnectedCallback(){super.disconnectedCallback(),Cn.instance===this&&(Cn.instance=null)}show(e,t){const r={id:this.nextId++,kind:t?.kind??"info",message:e,...t?.title?{title:t.title}:{}};this.toasts=[...this.toasts,r];const i=t?.durationMs??(r.kind==="error"||r.kind==="warning"?7e3:4e3);r.timer=window.setTimeout(()=>this.dismiss(r.id),i)}dismiss(e){const t=this.toasts.find(r=>r.id===e);t?.timer!=null&&window.clearTimeout(t.timer),this.toasts=this.toasts.filter(r=>r.id!==e)}render(){return _`
      ${this.toasts.map(e=>_`
          <div class="toast ${e.kind}" role="status">
            <span class="mi lg">${vu(e.kind)}</span>
            <span class="body">
              ${e.title?_`<strong>${e.title}</strong>`:""}${wu(e.message)}
            </span>
    ...
    `];Bl([K()],Cn.prototype,"toasts",2);Cn=Bl([nt("toast-host")],Cn);function wu(e){const t=/(https?:\/\/[^\s)]+)/g,r=[];let i=0,n;for(;(n=t.exec(e))!==null;)n.index>i&&r.push(e.slice(i,n.index)),r.push({url:n[0]}),i=n.index+n[0].length;return i<e.length&&r.push(e.slice(i)),r.length===0?e:r.map(s=>typeof s=="string"?s:_`<a href=${s.url} target="_blank" rel="noopener noreferrer">${s.url}</a>`)}function vu(e){switch(e){case"success":return"check_circle";case"error":return"error";case"warning":return"warning";default:return"info"}}function xu(){return{headerButtons:[],footerButtons:[],tableButtons:[],importers:[],connectors:[],exporters:[],urlSources:[],dropHandlers:[],cellRenderers:new Map,rowRenderers:new Map,tableRenderers:new Map,rowSources:new Map,settings:new Map,commands:[]}}function kn(e,t){return e.push(t),()=>{const r=e.indexOf(t);r>=0&&e.splice(r,1)}}function Rs(e,t,r){return e.set(t,r),()=>{e.get(t)===r&&e.delete(t)}}function $u(e){return{registerHeaderButton:t=>kn(e.headerButtons,t),registerFooterButton:t=>kn(e.footerButtons,t),registerTableButton:t=>kn(e.tableButtons,t),registerImporter:t=>kn(e.importers,t),registerConnector:t=>kn(e.connectors,t),registerExporter:t=>kn(e.exporters,t),registerUrlSource:t=>kn(e.urlSources,t),registerDropHandler:t=>kn(e.dropHandlers,t),registerCellRenderer:(t,r)=>Rs(e.cellRenderers,t,r),registerRowRenderer:(t,r)=>Rs(e.rowRenderers,t,r),registerTableRenderer:(t,r)=>Rs(e.tableRenderers,t,r),openNewTableDialog:()=>{document.dispatchEvent(new CustomEvent("easydb:open-new-table"))},openCsvPasteDialog:()=>{document.dispatchEvent(new CustomEvent("easydb:open-csv-paste"))},openPluginManager:()=>{document.dispatchEvent(new CustomEvent("easydb:open-plugin-manager"))},openSettings:()=>{document.dispatchEvent(new CustomEvent("easydb:open-settings"))},registerCommand:t=>kn(e.commands,t),openCommandPalette:()=>{document.dispatchEvent(new CustomEvent("easydb:open-command-palette"))},registerSettings:(t,r,i)=>(e.settings.set(t,{name:r,fields:i}),()=>{e.settings.get(t)?.name===r&&e.settings.delete(t)}),dialogs:ku}}const ku={async alert(e,t){const r=Yt.instance;if(r)return r.alert(e,t);window.alert(e)},async confirm(e,t){const r=Yt.instance;return r?r.confirm(e,t):window.confirm(e)},async prompt(e,t,r){const i=Yt.instance;return i?i.prompt(e,t,r):window.prompt(e,t)??null},async choice(e,t,r){const i=Yt.instance;if(i)return i.choice(e,t,r);const n=window.prompt(`${e}

Options: ${t.join(", ")}`);return n&&t.includes(n)?n:null},toast(e,t){const r=Cn.instance;r?r.show(e,t):console.log(`[toast:${t?.kind??"info"}]`,t?.title??"",e)}},po="/easydbaccess/settings.json",Nl="/easydbaccess/secrets.txt";function Br(e){try{return globalThis.localStorage??null}catch{return null}}function Mi(e){const t=Br();if(!t)return{};const r=t.getItem(po);if(!r)return{};try{const i=JSON.parse(r);return i&&typeof i=="object"?i:{}}catch{return{}}}function mo(e,t){return Mi()[e]}function Cu(e,t,r){const i=Br();if(!i)return;const n=Mi();n[e]=t,i.setItem(po,JSON.stringify(n))}function Eu(e,t){const r=Br();if(!r)return;const i=Mi();e in i&&(delete i[e],r.setItem(po,JSON.stringify(i)))}function Ws(e,t){return e in Mi()}function Bi(e){return Br()?.getItem(Nl)??""}function Ul(e,t){Br()?.setItem(Nl,e)}function Ni(e){const t={};for(const r of e.split(/\r?\n/)){const i=r.trim();if(!i||i.startsWith("#"))continue;const n=i.indexOf(":");if(n<0)continue;const s=i.slice(0,n).trim(),a=i.slice(n+1).trim();s&&(t[s]=a)}return t}function Hl(e,t){return e.replace(/\$\{secret:([^}]+)\}/g,(r,i)=>{const n=t[i.trim()];return n===void 0?r:n})}function Su(e){const t=$u(e.registries),r=e.registries.rowSources,i=a=>(r.set(a.type,a),()=>{r.get(a.type)===a&&r.delete(a.type)}),n=Tu(e.store,e.registries),s={open(a){return console.warn("[host] windows.open is stubbed until Phase 5",a.id),{id:a.id,close:()=>{},focus:()=>{},setTitle:()=>{},setGeometry:()=>{}}},list:()=>[],find:()=>null};return{store:e.store,events:e.events,ui:t,windows:s,registerRowSource:i,settings:n,backend:{fetch:async(a,c)=>{const u=await _u(e.store),p=c?.body instanceof ArrayBuffer;if(!u||p)return globalThis.fetch(a,c);const w={url:a};return c?.method&&(w.method=c.method),c?.headers&&(w.headers=c.headers),typeof c?.body=="string"&&(w.body=c.body),globalThis.fetch(`${u}/fetch`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(w)})},async saveFile(a,c,u){const p=typeof c=="string"?new Blob([c],{type:u??"application/octet-stream"}):c,w=URL.createObjectURL(p),b=document.createElement("a");b.href=w,b.download=a,b.rel="noopener",document.body.appendChild(b),b.click(),b.remove(),setTimeout(()=>URL.revokeObjectURL(w),1e3)}},workspaceId:()=>e.workspaceId(),selfUrl:()=>e.selfUrl??"(builtin)"}}async function _u(e){const t="server-sync:url";let r=Ws(t)?mo(t):void 0;return r===void 0&&(r=(await e.settings.findOne(t))?.value),typeof r!="string"||r.length===0?null:Hl(r,Ni(Bi())).replace(/\/+$/,"")}function Tu(e,t){const r=(s,a)=>`${s}:${a}`,i=(s,a)=>t.settings.get(s)?.fields.find(c=>c.key===a),n=s=>typeof s=="string"?Hl(s,Ni(Bi())):s;return{async get(s,a){const c=r(s,a);let u;if(Ws(c))u=mo(c);else{const p=await e.settings.findOne(c);u=p?p.value:i(s,a)?.default}return n(u)},async set(s,a,c,u){const p=r(s,a);(u??i(s,a)?.scope??"workspace")==="user"?(Cu(p,c),await e.settings.remove(p).catch(()=>{})):(await e.settings.upsert({key:p,value:c}),Eu(p))},async placement(s,a){const c=r(s,a);return Ws(c)?"user":await e.settings.findOne(c)?"workspace":null}}}function Pa(e,t){return e.has(t)?e.get(t)!=="0":!1}function Au(){if(typeof location>"u")return"off";const e=new URLSearchParams(location.search);return Pa(e,"safemode")?"all-optional":Pa(e,"safemode1")?"url-plugins":"off"}const Vt=Au();function go(e){let t;try{t=new URL(e)}catch{return e}const r=t.hostname.toLowerCase();if(r==="github.com"||r==="www.github.com"){const i=t.pathname.split("/").filter(Boolean);if(i.length>=5&&(i[2]==="blob"||i[2]==="raw")){const n=i[0],s=i[1];let a=i.slice(3);return a.length>=3&&a[0]==="refs"&&(a[1]==="heads"||a[1]==="tags")&&(a=a.slice(2)),`https://raw.githubusercontent.com/${[n,s,...a].join("/")}`}}return e}function ql(e){if(e.length>1024)return!1;const t=e.split(`
`);return t[0]?.startsWith("version https://git-lfs.github.com/spec/v1")===!0&&t.some(r=>r.startsWith("oid "))&&t.some(r=>r.startsWith("size "))}function Wl(e){const t=go(e);let r;try{r=new URL(t)}catch{return null}if(r.hostname.toLowerCase()!=="raw.githubusercontent.com")return null;const i=r.pathname.replace(/^\/+/,"");return i.split("/").filter(Boolean).length<4?null:`https://media.githubusercontent.com/media/${i}`}async function Kl(e,t){const r=Number(e.headers?.get?.("content-length")),i=e.body?.getReader?.();if(i&&Number.isFinite(r)&&r>0){const n=[];let s=0;for(;;){const{done:u,value:p}=await i.read();if(u)break;p&&(n.push(p),s+=p.length,t?.(Math.min(1,s/r)))}const a=new Uint8Array(s);let c=0;for(const u of n)a.set(u,c),c+=u.length;return new TextDecoder().decode(a)}return await e.text()}const Iu=50*1024*1024;function Ra(e){try{return new URL(e).host}catch{return e}}function ur(e){try{const r=new URL(e).pathname.split("/").filter(Boolean).pop();return r&&r.length>0?r:"sample.db.json"}catch{return"sample.db.json"}}async function Pu(e){try{return(await e.text()).replace(/\s+/g," ").trim().slice(0,300)}catch{return""}}function Da(e){const t=e/1048576;return`${Number.isInteger(t)?t:t.toFixed(1)} MB`}async function Ru(e,t,r={}){const i=go(t),n=r.slowMs??2e3;let s=setTimeout(()=>{s=void 0,r.onSlow?.()},n);const a=()=>{s!==void 0&&(clearTimeout(s),s=void 0)},c=r.maxBytes===null?null:r.maxBytes??Iu,u=async p=>{let w;try{w=await e.backend.fetch(p)}catch($){throw new Error(`Could not reach ${Ra(p)} — no response. The server may be down, blocking cross-origin (CORS) requests, or the transfer may have failed (e.g. a very large file). [${$.message}]`)}if(!w.ok){const $=await Pu(w);throw new Error(`HTTP ${w.status} ${w.statusText||""}`.trim()+($?` — ${$}`:""))}const b=Number(w.headers.get("content-length"));if(c!==null&&Number.isFinite(b)&&b>c)throw w.body?.cancel().catch(()=>{}),new Error(`Response is ${Da(b)}, over the ${Da(c)} browser import limit. Set a row limit, import it as a Reference instead of a Copy, take a smaller extract, or connect to a server/Datasette for large datasets.`);try{return await Kl(w,r.onProgress)}catch($){throw new Error(`Failed reading the response body from ${Ra(p)}: ${$.message}`)}};try{const p=await u(i);if(ql(p)){const w=Wl(i);if(w)return await u(w)}return p}finally{a()}}async function Ui(e,t,r,i={}){const{TopProgress:n}=await ln(async()=>{const{TopProgress:a}=await import("./top-progress-ixDxdj9D.js");return{TopProgress:a}},[]),s={handle:null};try{return await Ru(e,t,{onSlow:()=>{s.handle=n.begin(r)},onProgress:a=>s.handle?.fraction(a),...i.maxBytes!==void 0?{maxBytes:i.maxBytes}:{}})}finally{s.handle?.done()}}function it(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}function Tt(e){return e.toLowerCase().trim().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"table"}function Ks(e){return e.toLowerCase().trim().replace(/[^a-z0-9_]+/g,"_").replace(/^_+|_+$/g,"").replace(/_+/g,"_")||"col"}const Du={id:"csv-import",name:"CSV Import",type:"importer",version:"0.1.0",description:"Drag-and-drop CSV or TSV files to create typed tables.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/csv-import.ts"};function Ou(e){e.ui.registerImporter(zu),ln(()=>import("./csv-import-options-B3Ud9_h0.js"),[]),e.ui.registerHeaderButton({id:"csv-import:paste",label:"Paste CSV",icon:"content_paste",tooltip:"Paste CSV text to create a new table",onClick:()=>e.ui.openCsvPasteDialog()}),e.ui.registerDropHandler(async t=>{const i=Gu(t).filter(Yu);if(i.length===0)return!1;t.preventDefault();for(const n of i)await Lu(e,n);return!0})}function Vs(e){return e.kind==="file"&&e.file?e.file.name:e.kind==="url"&&e.url?ur(e.url):"pasted"}function ju(e){return wo(Vs(e))||"imported"}const zu={id:"csv",label:"CSV / TSV",icon:"table_view",order:10,accept:[".csv",".tsv",".tab","text/csv","text/tab-separated-values"],panel:"csv-import-options",samples:[{label:"Air quality — 2016 readings (CSV)",url:"https://raw.githubusercontent.com/MainakRepositor/Datasets/master/Air%20Quality/real_2016_air.csv"}],supports:{url:!0,file:!0,text:!0,reference:!0,kernel:!0},detect(e){const t=e.kind==="file"?e.file?.name??"":e.url??e.text??"";return/\.(csv|tsv|tab)$/i.test(t)?.95:e.file?.type==="text/csv"?.9:e.kind==="text"?.2:0},async list(e,t){return[{name:ju(t),rowCount:null,handle:t}]},async*read(e,t){const r=t.handle;let i;r.kind==="file"&&r.file?i=e.maxRows!=null?await Yl(r.file,e.maxRows):await r.file.text():r.kind==="url"&&r.url?i=await e.fetchText(r.url,`Reading ${Vs(r)}…`):i=r.text??"";const s=(typeof e.panel.separator=="string"?e.panel.separator:void 0)??vo(Vs(r)),a={...e.maxRows!=null?{maxRows:e.maxRows}:{},...s?{separator:s}:{}},c=e.targetColumns;if(c&&c.length>0){yield{rows:bo(i,a).rows.map(b=>{const $={};for(let D=0;D<c.length;D++){const P=c[D];$[P.field]=yo(b[D]??"",P.type)}return $})};return}const u=hr(i,a);yield{columns:u.columns,rows:u.rows}},reference(e,t){const r=t.handle;if(r.kind!=="url"||!r.url)throw new Error("A reference needs a re-fetchable URL — an upload cannot be referenced.");return{type:"url",config:{url:r.url,format:"csv"}}}};async function Lu(e,t){await Vl(e,await t.text(),t.name)}async function Vl(e,t,r,i={}){const n=e.workspaceId();if(!n)throw new Error("csv-import: no active workspace");const s=wo(r||"imported")||"imported",a=i.separator??vo(r),c=(await e.store.tables.find()).find($=>$.workspaceId===n&&$.name===s);let u,p;if(c){const $=await e.ui.dialogs.choice(`A table named "${s}" already exists in this workspace.`,["Append rows","Overwrite rows","Create as new table"],"CSV import");if(!$)return;$==="Append rows"?(p="append",u=c.id):$==="Overwrite rows"?(p="overwrite",u=c.id):(p="new",u=it())}else p="new",u=it();e.events.emit("import:before",{source:"csv",tableId:u});let w;if(p==="new"){const $=hr(t,{maxRows:i.maxRows,separator:a});let D=$.columns,P=$.rows;if(i.editColumns){const B=await i.editColumns(D);if(B===null)return;P=Xu(P,D,B),D=B}i.maxRows!=null&&(P=P.slice(0,i.maxRows));const S=c?`${s} (${Date.now().toString(36)})`:s;await e.store.tables.insert({id:u,workspaceId:n,name:S,code:Ks(S),columns:D,view:"table",...i.origin?{origin:i.origin}:{},updatedAt:Date.now()}),w=P.map(B=>({id:it(),tableId:u,data:B,updatedAt:Date.now()}))}else{const $=c.columns,D=bo(t,{maxRows:i.maxRows,separator:a});if(w=(i.maxRows!=null?D.rows.slice(0,i.maxRows):D.rows).map(S=>{const B={};for(let q=0;q<$.length;q++){const Q=$[q];B[Q.field]=yo(S[q]??"",Q.type)}return{id:it(),tableId:u,data:B,updatedAt:Date.now()}}),p==="overwrite"){const S=e.store.rows(u),B=await S.find();await S.bulkRemove(B.map(q=>q.id))}}await e.store.rows(u).bulkInsert(w),e.events.emit("import:after",{source:"csv",tableId:u,rowCount:w.length})}function bo(e,t={}){const r=e.replace(/﻿/,""),i=t.separator??Xl(r),n=Ql(r,i,Gl(t.maxRows));if(n.length===0)return{header:[],rows:[]};const s=n[0],a=n.slice(1).filter(c=>!(c.length===1&&c[0]===""));return{header:s,rows:a}}function Gl(e){return e!=null?e+1:void 0}async function Yl(e,t){const i=new TextDecoder,n=t+1;let s="",a=0,c=!1,u=0;for(;u<e.size;){const p=new Uint8Array(await e.slice(u,u+1048576).arrayBuffer());u+=1048576;const w=i.decode(p,{stream:!0});for(let b=0;b<w.length;b++){const $=w[b];if($==='"')c=!c;else if($===`
`&&!c&&(a+=1,a>=n))return s+w.slice(0,b+1)}s+=w}return s}function hr(e,t={}){const r=e.replace(/﻿/,""),i=t.separator??Xl(r),n=Ql(r,i,Gl(t.maxRows));if(n.length===0)return{columns:[],rows:[]};const s=n[0],a=n.slice(1).filter(D=>!(D.length===1&&D[0]==="")),c=s.map((D,P)=>Bu(D,P)),u=ec(c.map(D=>D.field)),p=a.map(D=>{const P={};for(let S=0;S<u.length;S++)P[u[S]]=D[S]??"";return P}),w=c.map((D,P)=>D.type?D.type:Nu(p.map(S=>S[u[P]]??"").filter(S=>S.length>0))),b=c.map((D,P)=>{const S=w[P]??"string",B={field:u[P],label:D.label,type:S},q=Mu(S),Q=D.renderer??q;return Q&&(B.renderer=Q),D.default!==void 0&&(B.default=D.default),D.max!=null&&(B.max=D.max),D.unique&&(B.unique=!0),D.notnull&&(B.notnull=!0),D.hidden&&(B.hidden=!0),B}),$=p.map(D=>{const P={};for(let S=0;S<u.length;S++){const B=u[S],q=w[S]??"string";P[B]=yo(D[B]??"",q)}return P});return{columns:b,rows:$}}const Fu=new Set(["string","number","boolean","date","datetime"]),Oa={color:"color",image:"image"};function Mu(e){if(e==="date"||e==="datetime"||e==="boolean")return e}function Bu(e,t){const r=e.trim();if(!r.includes(":"))return{field:Ks(r||`col_${t+1}`),label:r||`Column ${t+1}`};const i=r.split(":"),n=Ks(i[0]||`col_${t+1}`),s=(i[1]??i[0]??"").trim()||n,a={field:n,label:s},c=(i[2]??"").trim();c&&(Fu.has(c)?a.type=c:Oa[c]&&(a.type="string",a.renderer=Oa[c]));const u=(i[3]??"").trim();u&&(a.default=u);const p=(i[4]??"").trim();if(p){const b=Number(p);Number.isFinite(b)&&b>0&&(a.max=b)}const w=(i[5]??"").toLowerCase();return w.includes("u")&&(a.unique=!0),w.includes("n")&&(a.notnull=!0),w.includes("h")&&(a.hidden=!0),a}function Xl(e){const t=e.split(/\r?\n/).slice(0,5).join(`
...
`||u==="\r"){if(u==="\r"&&e[c+1]===`
`&&c++,n.push(s),i.push(n),n=[],s="",r!=null&&i.length>=r)return i}else s+=u}return(s.length>0||n.length>0)&&(n.push(s),i.push(n)),i}function Nu(e){return e.length===0?"string":e.every(Hu)?"boolean":e.every(qu)?"number":e.every(Ku)?"datetime":e.every(Wu)?"date":"string"}const Uu=/^(true|false|yes|no|0|1)$/i;function Hu(e){return Uu.test(e.trim())}function qu(e){const t=e.trim();if(t==="")return!1;const r=Number(t);return Number.isFinite(r)}function Wu(e){const t=e.trim();return t===""||/^\d+$/.test(t)?!1:!!(/^\d{4}-\d{2}-\d{2}$/.test(t)||/^\d{1,2}[/\-.]\d{1,2}[/\-.]\d{2,4}$/.test(t))}function Ku(e){const t=e.trim();return t===""?!1:!!(/^\d{4}-\d{2}-\d{2}[T ]\d{1,2}:\d{2}(:\d{2})?/.test(t)||/^\d{1,2}[/\-.]\d{1,2}[/\-.]\d{2,4}[T ]\d{1,2}:\d{2}/.test(t))}function yo(e,t){const r=e.trim();switch(t){case"number":{if(r==="")return null;const i=Number(r);return Number.isFinite(i)?i:r}case"boolean":return r===""?null:/^(true|yes|1)$/i.test(r);case"date":return Jl(r);case"datetime":return Vu(r);default:return e}}function Jl(e){if(e==="")return"";if(/^\d{4}-\d{2}-\d{2}$/.test(e))return e;const t=/^(\d{1,2})[/\-.](\d{1,2})[/\-.](\d{2,4})$/.exec(e);if(t){let i=parseInt(t[1],10),n=parseInt(t[2],10);const s=t[3];let a=parseInt(s,10);s.length===2&&(a+=2e3);let c,u;return i>12?(c=i,u=n):n>12?(u=i,c=n):(c=i,u=n),`${a.toString().padStart(4,"0")}-${u.toString().padStart(2,"0")}-${c.toString().padStart(2,"0")}`}const r=new Date(e);return Number.isNaN(r.getTime())?e:r.toISOString().slice(0,10)}function Vu(e){if(e==="")return"";const t=e.replace(/\s+/,"T"),r=/^(\d{4}-\d{2}-\d{2})T(\d{1,2}:\d{2})(?::\d{2})?/.exec(t);if(r)return`${r[1]}T${r[2].padStart(5,"0")}`;const i=/^(\d{1,2})[/\-.](\d{1,2})[/\-.](\d{2,4})[T ](\d{1,2}:\d{2})/.exec(e);if(i)return`${Jl(`${i[1]}/${i[2]}/${i[3]}`)}T${i[4].padStart(5,"0")}`;const n=new Date(e);if(!Number.isNaN(n.getTime())){const s=n.toISOString();return`${s.slice(0,10)}T${s.slice(11,16)}`}return e}function Gu(e){const t=e.dataTransfer;if(!t)return[];if(t.files&&t.files.length>0)return Array.from(t.files);if(t.items){const r=[];for(const i of Array.from(t.items))if(i.kind==="file"){const n=i.getAsFile();n&&r.push(n)}return r}return[]}const Zl=/\.(csv|tsv|tab)$/i;function wo(e){return e.replace(Zl,"")}function vo(e){return/\.(tsv|tab)$/i.test(e)?"	":void 0}function Yu(e){return!!(Zl.test(e.name)||e.type==="text/csv"||e.type==="application/csv"||e.type==="text/tab-separated-values")}function ec(e){const t=new Map,r=new Set,i=[];for(const n of e){let s=n,a=t.get(n)??0;for(;r.has(s);)a+=1,s=`${n}_${a+1}`;t.set(n,a),r.add(s),i.push(s)}return i}function Xu(e,t,r){return e.map(i=>{const n={};for(let s=0;s<t.length;s++)n[r[s].field]=i[t[s].field];return n})}const Qu=Object.freeze(Object.defineProperty({__proto__:null,dedupeFields:ec,importCsvText:Vl,init:Ou,meta:Du,parseCsv:hr,parseCsvRaw:bo,readCsvHead:Yl,separatorForName:vo,stripDelimitedExt:wo},Symbol.toStringTag,{value:"Module"})),Ju={id:"csv-export",name:"CSV Export",type:"exporter",version:"0.1.0",description:"CSV serializer for the per-table export menu (see dump-export.ts) and the importer/exporter registry.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/csv-export.ts"},Zu={id:"csv",label:"CSV",extension:".csv",async serialize(e,t){return xo(e,t)}};function eh(e){e.ui.registerExporter(Zu)}function xo(e,t){const r=e.columns.map(s=>s.field),i=e.columns.map(s=>ja(s.label??s.field)),n=t.map(s=>r.map(a=>ja(th(s.data[a]))).join(","));return[i.join(","),...n].join(`\r
`)}function th(e){return e==null?"":typeof e=="boolean"?e?"true":"false":typeof e=="number"||typeof e=="string"?String(e):JSON.stringify(e)}function ja(e){return e===""?"":/[",\r\n]/.test(e)?`"${e.replace(/"/g,'""')}"`:e}const nh=Object.freeze(Object.defineProperty({__proto__:null,init:eh,meta:Ju,serializeCsv:xo},Symbol.toStringTag,{value:"Module"}));var rh=Object.defineProperty,ih=Object.getOwnPropertyDescriptor,fr=(e,t,r,i)=>{for(var n=i>1?void 0:i?ih(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&rh(t,r,n),n};function _i(e,t={}){return(Ft.instance??sh()).open(e,t)}function sh(){const e=document.createElement("table-select-dialog");return document.body.appendChild(e),e}function oh(e){return e==null?"":`${e.toLocaleString()} row${e===1?"":"s"}`}let Ft=class extends Ue{constructor(){super(...arguments),this.items=[],this.selected=[],this.heading="Select tables",this.message="",this.confirmLabel="Import",this.dialogEl=null,this.resolveFn=null,this.onCancel=e=>{e.preventDefault(),this.finish(null)},this.submit=e=>{e.preventDefault();const t=this.selected.map((r,i)=>r?i:-1).filter(r=>r>=0);t.length!==0&&this.finish(t)}}connectedCallback(){super.connectedCallback(),Ft.instance=this}disconnectedCallback(){super.disconnectedCallback(),Ft.instance===this&&(Ft.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}open(e,t){return this.items=e,this.selected=e.map(r=>!r.hidden),this.heading=t.title??"Select tables",this.message=t.message??"",this.confirmLabel=t.confirmLabel??"Import",new Promise(r=>{this.resolveFn=r,this.updateComplete.then(()=>this.dialogEl?.showModal())})}finish(e){this.dialogEl?.close();const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}toggle(e){const t=this.selected.slice();t[e]=!t[e],this.selected=t}setAll(e){this.selected=this.items.map(()=>e)}get selectedCount(){return this.selected.filter(Boolean).length}render(){const e=this.selectedCount;return _`
      <dialog @cancel=${this.onCancel} @keydown=${Zt}>
              ...
              ${this.items.map((t,r)=>_`
                  <li>
                    ...
                    <label for=${`tsel-${r}`}>
                      ...
                      <span class="size">${oh(t.size)}</span>
    ...
    `];fr([K()],Ft.prototype,"items",2);fr([K()],Ft.prototype,"selected",2);fr([K()],Ft.prototype,"heading",2);fr([K()],Ft.prototype,"message",2);fr([K()],Ft.prototype,"confirmLabel",2);Ft=fr([nt("table-select-dialog")],Ft);function $o(e,t){return e.every((r,i)=>r.field===t[i]?.field)?null:r=>{const i={};for(let n=0;n<e.length;n++)i[t[n].field]=r[e[n].field];return i}}function Hi(e,t,r=[]){const i=new Set(e.map(c=>c.field)),n=new Set(r),s=[...e],a=[];for(const c of t)i.has(c.field)||n.has(c.field)||(s.push(c),a.push(c.field),i.add(c.field));return{columns:s,newFields:a}}function tc(e,t){const r=new Set([...e].map(n=>n.toLowerCase())),i=t.trim()||"imported";if(!r.has(i.toLowerCase()))return i;for(let n=2;;n++){const s=`${i}-${n}`;if(!r.has(s.toLowerCase()))return s}}async function nc(e,t){return(await e.store.tables.find()).filter(r=>r.workspaceId===t).map(r=>r.name)}async function ah(e,t,r,i){const{workspaceId:n,importerId:s,target:a,maxRows:c}=i;let u,p,w,b=!1,$=0,D,P=null;const S=q=>e.store.rows(q),B=async q=>{if(b)return!0;if(a.kind==="new"){let Q=q.columns??[];if(i.editColumns){const J=await i.editColumns(Q);if(J===null)return!1;P=$o(Q,J),Q=J}u=it(),p=tc(await nc(e,n),t);const X={id:u,workspaceId:n,name:p,code:Tt(p),columns:Q,view:"table",...i.origin?{origin:i.origin}:{},updatedAt:Date.now()};await e.store.tables.insert(X),w=!0}else{const Q=await e.store.tables.findOne(a.tableId);if(!Q)throw new Error("The table to import into no longer exists.");if(u=Q.id,p=Q.name,w=!1,a.kind==="overwrite"){const X=await S(u).find();await S(u).bulkRemove(X.map(J=>J.id))}if(q.columns?.length){const X=Hi(Q.columns,q.columns,Q.deletedColumns??[]);X.newFields.length>0&&await e.store.tables.patch(u,{columns:X.columns,updatedAt:Date.now()})}}return e.events.emit("import:before",{source:s,tableId:u}),b=!0,!0};for await(const q of r){if(c!=null&&$>=c)break;if(!await B(q))return null;q.totalCount!=null&&(D=q.totalCount);let Q=q.rows;if(c!=null&&$+Q.length>c&&(Q=Q.slice(0,c-$)),Q.length===0)continue;P&&(Q=Q.map(P));const X=Date.now(),J=Q.map(W=>({id:it(),tableId:u,data:W,updatedAt:X}));await S(u).bulkInsert(J),$+=J.length,i.onProgress?.($,D)}return!b&&!await B({})?null:(e.events.emit("import:after",{source:s,tableId:u,rowCount:$}),{tableId:u,tableName:p,rowCount:$,created:w})}function za(e,t,r={}){const i=t.mode==="reference"||t.maxRows!=null;return{api:e,fetchText:(n,s)=>Ui(e,n,s??"Reading…",i?{maxBytes:null}:{}),panel:t.panel??{},...t.cursor!==void 0?{cursor:t.cursor}:{},...t.maxRows!==void 0?{maxRows:t.maxRows}:{},...r}}async function lh(e,t){if(t.length<=1)return t;const r=await _i(t.map(i=>({name:i.name,size:i.rowCount,...i.detail!==void 0?{detail:i.detail}:{},...i.hidden!==void 0?{hidden:i.hidden}:{}})),{title:`Import from ${e.label}`,message:`This source offers ${t.length} tables. Choose which to import.`,confirmLabel:"Import"});return r?r.map(i=>t[i]):null}async function ch(e,t,r,i,n){if(!t.reference)throw new Error(`${t.label} cannot be referenced — import a copy instead.`);const s=t.reference(r,i);let a=[];for await(const p of t.read(r,i)){a=p.columns??[];break}if(a.length===0)throw new Error("No columns found in the referenced data.");const c=tc(await nc(e,n),i.name),u=it();return await e.store.tables.insert({id:u,workspaceId:n,name:c,code:Tt(c),columns:a,view:"table",source:s,updatedAt:Date.now()}),{tableId:u,tableName:c,rowCount:0,created:!0}}async function rc(e,t,r,i){const n=e.workspaceId();if(!n)throw new Error("No active workspace.");const s=za(e,i),a=await t.list(s,r);if(a.length===0)throw new Error("No tables found at that source.");const c=await lh(t,a);if(c===null)return{landed:[],failed:[],cancelled:!0};const u=[],p=[];for(const w of c)try{if(i.mode==="reference"){u.push(await ch(e,t,s,w,n));continue}const b=i.target;let $;b.kind!=="new"&&($=(await e.store.tables.findOne(b.tableId))?.columns);const D=za(e,i,{...$?{targetColumns:$}:{}}),P=t.read(D,w),S=i.origin??(r.kind==="url"&&r.url?{type:t.id,url:r.url}:void 0),B=await ah(e,w.name,P,{workspaceId:n,importerId:t.id,target:b,...S?{origin:S}:{},...i.editColumns?{editColumns:i.editColumns}:{},...i.maxRows!==void 0?{maxRows:i.maxRows}:{}});if(B===null)return{landed:u,failed:p,cancelled:!0};u.push(B)}catch(b){p.push({name:w.name,error:b?.message??String(b)})}return{landed:u,failed:p,cancelled:!1}}const dh={id:"json-import",name:"JSON Import",type:"importer",version:"0.1.0",description:"Drag-and-drop JSON to create tables. Supports native dumps and arrays of objects.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M8 3a2 2 0 0 0-2 2v4a2 2 0 0 1-2 2 2 2 0 0 1 2 2v4a2 2 0 0 0 2 2"/><path d="M16 3a2 2 0 0 1 2 2v4a2 2 0 0 0 2 2 2 2 0 0 0-2 2v4a2 2 0 0 1-2 2"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/json-import.ts"};function uh(e){e.ui.registerImporter(ic),e.ui.registerDropHandler(async t=>{const i=xh(t).filter($h);if(i.length===0)return!1;t.preventDefault();for(const n of i)await fh(e,n);return!0})}function ko(e){return mt(e)?Gs(e)?!0:Array.isArray(e.tables):!1}function hh(e){return e.kind==="file"&&e.file?Ds(e.file.name):e.kind==="url"&&e.url?Ds(ur(e.url)):Ds(e.name??"imported")}const ic={id:"json",label:"JSON (array of objects or a dump)",icon:"data_object",order:20,accept:[".json",".db.json","application/json"],samples:[{label:"Northwind — sample database (JSON dump)",url:"https://raw.githubusercontent.com/cawoodm/easydbaccess/main/data/northwind.db.json"}],supports:{url:!0,file:!0,text:!0,reference:!0,multiTable:!0,kernel:!0},detect(e){const t=e.kind==="file"?e.file?.name??"":e.url??"";if(/\.db\.json$/i.test(t))return 1;if(/\.json$/i.test(t))return .95;if(e.file?.type==="application/json")return .9;const r=(e.text??"").trimStart();return r.startsWith("{")||r.startsWith("[")?.3:0},async list(e,t){let r;t.kind==="file"&&t.file?r=await t.file.text():t.kind==="url"&&t.url?r=await e.fetchText(t.url,`Reading ${ur(t.url)}…`):r=t.text??"";const i=hh(t);let n;try{n=JSON.parse(r)}catch(a){throw new Error(`Invalid JSON in ${i}: ${a.message}`)}const s=qi(n,i);return s.map(a=>({name:a.name,rowCount:a.rows.length,handle:{table:a,input:t,single:s.length===1}}))},async*read(e,t){const{table:r}=t.handle;yield{columns:r.columns,rows:r.rows}},reference(e,t){const{input:r,single:i}=t.handle;if(r.kind!=="url"||!r.url)throw new Error("A reference needs a re-fetchable URL — an upload cannot be referenced.");if(!i)throw new Error("That URL holds several tables, so a reference would be ambiguous. Import a copy instead.");return{type:"url",config:{url:r.url,format:"json"}}}};function Ds(e){return e.replace(/\.db\.json$/i,"").replace(/\.json$/i,"")||"imported"}async function fh(e,t){const r=await t.text();let i;try{i=JSON.parse(r)}catch(a){e.events.emit("plugin:error",{url:"json-import",phase:"runtime",error:new Error(`Invalid JSON in ${t.name}: ${a.message}`)});return}if(ko(i)){await Co(e,r,t.name);return}const n=await rc(e,ic,{kind:"text",text:r,name:t.name},{mode:"copy",target:{kind:"new"}}),s=n.landed.reduce((a,c)=>a+c.rowCount,0);n.landed.length>0&&e.ui.dialogs.toast(`Imported ${t.name} (${s.toLocaleString()} rows).`,{kind:"success",title:"Import"})}async function Co(e,t,r,i={}){const n=e.workspaceId();if(!n)throw new Error("json-import: no active workspace");let s;try{s=JSON.parse(t)}catch(B){e.events.emit("plugin:error",{url:"json-import",phase:"runtime",error:new Error(`Invalid JSON in ${r}: ${B.message}`)});return}const a=r.replace(/\.db\.json$/i,"").replace(/\.json$/i,"")||"imported",c=qi(s,a);if(c.length===0)return;let u=c;if(c.length>1){const B=await _i(c.map(q=>({name:q.name,size:q.rows.length})),{title:"Import tables",message:`"${r}" contains ${c.length} tables. Choose which to import.`,confirmLabel:"Import"});if(!B)return;u=B.map(q=>c[q])}const p=(await e.store.tables.find()).filter(B=>B.workspaceId===n),w=new Set(u.map(B=>B.name)),b=p.filter(B=>w.has(B.name));let $;if(b.length===0&&u.length===1)$="append-new";else{const B=b.length>0?[`Overwrite matching (${b.length})`,"Replace entire workspace","Add as new tables"]:["Add to current workspace","Replace entire workspace"],q=await e.ui.dialogs.choice(`Importing ${u.length} table${u.length===1?"":"s"} from "${r}".${b.length>0?`

${b.length} table${b.length===1?"":"s"} share a name with existing data.`:""}`,B,"JSON import");if(!q)return;q.startsWith("Overwrite matching")?$="overwrite-matching":q==="Replace entire workspace"?$="replace-workspace":$="append-new"}const D=2e3,P=u.reduce((B,q)=>B+(q.source?0:Math.min(q.rows.length,i.maxRows??1/0)),0);let S=null;if(P>=D){const{TopProgress:B}=await ln(async()=>{const{TopProgress:q}=await import("./top-progress-ixDxdj9D.js");return{TopProgress:q}},[]);S=B.begin(`Importing ${r}…`)}try{if($==="replace-workspace")for(const X of p){const J=e.store.rows(X.id),W=await J.find();await J.bulkRemove(W.map(Z=>Z.id)),await e.store.tables.remove(X.id)}const B=new Map(p.map(X=>[X.name,X])),q=new Map;let Q=0;for(const X of u){const J=X.source,W=X.origin??(!J&&i.originUrl?{type:"json",url:i.originUrl}:void 0);let Z;const de=$==="overwrite-matching"?B.get(X.name):void 0;let we=X.columns,Te=X.rows;if(i.editColumns&&!de&&!J){const m=await i.editColumns(we,X.name);if(m===null)continue;Te=vh(Te,we,m),we=m}if(de){if(Z=de.id,!de.source){const m=e.store.rows(Z),x=await m.find();await m.bulkRemove(x.map(I=>I.id))}await e.store.tables.patch(Z,{columns:we,...X.title?{title:X.title}:{},...X.windowGeometry?{windowGeometry:X.windowGeometry}:{},...X.sortColumn?{sortColumn:X.sortColumn,sortAsc:X.sortAsc??!0}:{sortColumn:void 0,sortAsc:void 0},...X.filters?{filters:X.filters}:{},...X.labelColumn?{labelColumn:X.labelColumn}:{},...X.info?{info:X.info}:{},...X.deletedColumns?{deletedColumns:X.deletedColumns}:{},source:J??void 0,origin:W??void 0,updatedAt:Date.now()})}else Z=it(),e.events.emit("import:before",{source:"json",tableId:Z}),await e.store.tables.insert({id:Z,workspaceId:n,name:X.name,code:Tt(X.name),columns:we,view:"table",...X.title?{title:X.title}:{},...X.windowGeometry?{windowGeometry:X.windowGeometry}:{},...X.sortColumn?{sortColumn:X.sortColumn,sortAsc:X.sortAsc??!0}:{},...X.filters?{filters:X.filters}:{},...X.labelColumn?{labelColumn:X.labelColumn}:{},...X.info?{info:X.info}:{},...X.deletedColumns?{deletedColumns:X.deletedColumns}:{},...J?{source:J}:{},...W?{origin:W}:{},updatedAt:Date.now()});q.set(X.name,Z);let Pe=0;if(!J){const m=e.store.rows(Z),I=(i.maxRows!=null?Te.slice(0,i.maxRows):Te).map(y=>({id:it(),tableId:Z,data:y,updatedAt:Date.now()}));await m.bulkInsert(I),Pe=I.length,Q+=Pe,S?.fraction(P>0?Q/P:1)}e.events.emit("import:after",{source:"json",tableId:Z,rowCount:Pe})}await ph(e,s,n,q,$==="replace-workspace")}finally{S?.done()}document.dispatchEvent(new CustomEvent("easydb:restack-windows"))}async function ph(e,t,r,i,n){if(!mt(t))return;const s=t,a=Array.isArray(s.viewTemplates)?s.viewTemplates:[],c=Array.isArray(s.viewInstances)?s.viewInstances:[];if(!(a.length===0&&c.length===0)){if(n){const u=(await e.store.viewInstances.find()).filter(p=>p.workspaceId===r);await e.store.viewInstances.bulkRemove(u.map(p=>p.id))}for(const u of a)!mt(u)||typeof u.id!="string"||await e.store.viewTemplates.upsert({...u,workspaceId:r});for(const u of c){if(!mt(u)||typeof u.id!="string")continue;const p=(u.tableName?i.get(u.tableName):void 0)??u.tableId;p&&await e.store.viewInstances.upsert({...u,workspaceId:r,tableId:p})}}}function qi(e,t){if(mt(e)&&Gs(e))return La(e);if(mt(e)&&Array.isArray(e.tables)){const r=e,i=[];for(const n of r.tables){if(gh(n)){const s=n,a=mt(s.windowGeometry)?s.windowGeometry:void 0,c=typeof s.sortColumn=="string"?s.sortColumn:void 0,u=typeof s.sortAsc=="boolean"?s.sortAsc:void 0,p=typeof s.title=="string"?s.title:void 0,w=mt(s.filters)?s.filters:void 0,b=typeof s.labelColumn=="string"?s.labelColumn:void 0,$=mt(s.info)?s.info:void 0,D=Array.isArray(s.deletedColumns)?s.deletedColumns.filter(B=>typeof B=="string"):void 0,P=mt(s.source)&&typeof s.source.type=="string"?s.source:void 0,S=mt(s.origin)&&typeof s.origin.type=="string"&&typeof s.origin.url=="string"?s.origin:void 0;i.push({name:String(n.name),columns:n.columns.map(bh),rows:Array.isArray(n.rows)?n.rows.filter(mt):[],...p?{title:p}:{},...a?{windowGeometry:a}:{},...c?{sortColumn:c,sortAsc:u??!0}:{},...w?{filters:w}:{},...b?{labelColumn:b}:{},...$?{info:$}:{},...D?{deletedColumns:D}:{},...P?{source:P}:{},...S?{origin:S}:{}});continue}mt(n)&&Gs(n)&&i.push(...La(n))}return i}if(Array.isArray(e)){const r=e.filter(mt);return r.length===0?[]:[{name:t,...Fa(r)}]}return mt(e)?[{name:t,...Fa([e])}]:[]}function Gs(e){for(const[t,r]of Object.entries(e)){if(!/\.table\.json$/.test(t)||!mt(r))continue;const i=r;if(Array.isArray(i.dataArray)&&Array.isArray(i.columns))return!0}return!1}function La(e){const t=[];for(const[r,i]of Object.entries(e)){if(!/\.table\.json$/.test(r)||!mt(i))continue;const n=i;if(!Array.isArray(n.dataArray)||!Array.isArray(n.columns))continue;const s=r.replace(/\.table\.json$/,""),a=n.columns.map(w=>mh(w)),c=a.map(w=>w.field),u=n.dataArray.filter(w=>Array.isArray(w)).map(w=>{const b={};for(let $=0;$<c.length;$++)b[c[$]]=w[$];return b}),p={name:s,columns:a,rows:u};if(n.elementRect&&typeof n.elementRect.x=="number"&&typeof n.elementRect.y=="number"){const w=n.elementRect;p.windowGeometry={x:w.x,y:w.y,w:w.width??600,h:w.height??400,z:w.zIndex??100,minimized:!!w.minimized,maximized:!!w.maximized}}typeof n.sortColumn=="number"&&n.sortColumn>=0&&n.sortColumn<c.length&&(p.sortColumn=c[n.sortColumn],p.sortAsc=(n.sortDirection??"asc")!=="desc"),t.push(p)}return t}function mh(e){const t=String(e.field??"col"),r=String(e.name??t),i=typeof e.type=="string"?e.type:"string",n={field:t,label:r,type:i};return e.isUnique&&(n.unique=!0),e.isNotNull&&(n.notnull=!0),n}function gh(e){return mt(e)&&"name"in e&&"columns"in e&&Array.isArray(e.columns)}function bh(e){if(!mt(e))return{field:"col",label:"Col",type:"string"};const t=e,r=String(t.field??"col");let i=typeof t.type=="string"?t.type:"string",n=typeof t.renderer=="string"?t.renderer:void 0;(i==="color"||i==="image")&&(n=n??i,i="string");const s={field:r,label:String(t.label??r),type:i};return n&&(s.renderer=n),typeof t.script=="string"&&(s.script=t.script),s}function Fa(e){const t=new Set;for(const n of e)for(const s of Object.keys(n))t.add(s);return{columns:Array.from(t).map(n=>({field:n,label:n,type:yh(e.map(s=>s[n]))})),rows:e}}function yh(e){const t=e.filter(r=>r!=null&&r!=="");return t.length===0?"string":t.every(r=>typeof r=="boolean")?"boolean":t.every(r=>typeof r=="number"&&Number.isFinite(r))?"number":t.every(r=>typeof r=="string"&&wh(r))?"date":"string"}function wh(e){if(/^\d+$/.test(e))return!1;const t=new Date(e);return!Number.isNaN(t.getTime())}function vh(e,t,r){const i=$o(t,r);return i?e.map(i):e}function mt(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}function xh(e){const t=e.dataTransfer;if(!t)return[];if(t.files&&t.files.length>0)return Array.from(t.files);if(t.items){const r=[];for(const i of Array.from(t.items))if(i.kind==="file"){const n=i.getAsFile();n&&r.push(n)}return r}return[]}function $h(e){return!!(/\.json$/i.test(e.name)||e.type==="application/json")}const kh=Object.freeze(Object.defineProperty({__proto__:null,init:uh,isWorkspaceDump:ko,meta:dh,parsedToTables:qi,restoreWorkspaceDump:Co},Symbol.toStringTag,{value:"Module"}));var Ch=Object.defineProperty,Eh=Object.getOwnPropertyDescriptor,Eo=(e,t,r,i)=>{for(var n=i>1?void 0:i?Eh(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Ch(t,r,n),n};let pi=null;function Sh(){return pi||(pi=document.createElement("anchored-menu"),document.body.appendChild(pi)),pi}let Xn=class extends Ue{constructor(){super(...arguments),this.items=[],this.shown=!1,this.resolveFn=null,this.onOutside=e=>{e.composedPath().includes(this)||this.finish(null)},this.onKey=e=>{e.key==="Escape"&&(e.preventDefault(),this.finish(null))}}static open(e,t){return Sh().openMenu(e,t)}connectedCallback(){super.connectedCallback(),this.setAttribute("hidden","")}openMenu(e,t){return this.items=t,this.style.left=`${Math.round(e.left)}px`,this.style.top=`${Math.round(e.bottom+4)}px`,this.removeAttribute("hidden"),this.shown=!0,this.updateComplete.then(()=>{const r=this.shadowRoot?.querySelector(".menu");if(!r)return;const i=r.getBoundingClientRect();i.bottom>window.innerHeight&&(this.style.top=`${Math.round(e.top-i.height-4)}px`)}),new Promise(r=>{this.resolveFn=r,setTimeout(()=>{document.addEventListener("mousedown",this.onOutside,!0),document.addEventListener("keydown",this.onKey,!0)},0)})}finish(e){this.setAttribute("hidden",""),this.shown=!1,document.removeEventListener("mousedown",this.onOutside,!0),document.removeEventListener("keydown",this.onKey,!0);const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}render(){return this.shown?_`
    ...
    `];Eo([K()],Xn.prototype,"items",2);Eo([K()],Xn.prototype,"shown",2);Xn=Eo([nt("anchored-menu")],Xn);const zr=Object.freeze(Object.defineProperty({__proto__:null,get AnchoredMenu(){return Xn}},Symbol.toStringTag,{value:"Module"})),Ys='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3.9 12a3.1 3.1 0 0 1 3.1-3.1h4V7H7a5 5 0 0 0 0 10h4v-1.9H7A3.1 3.1 0 0 1 3.9 12zM8 13h8v-2H8v2zm9-6h-4v1.9h4A3.1 3.1 0 0 1 17 15h-4v1.9h4a5 5 0 0 0 0-10z"/></svg>',_h={id:"connect-menu",name:"Connect",type:"ui",version:"0.1.0",description:"Header Connect button listing every registered live-backend connector. Chrome only — it knows no backend.",author:"Marc Cawood",icon:Ys,repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/connect-menu.ts"};function Th(e){e.ui.registerHeaderButton({id:"connect-menu:open",label:"Connect",icon:Ys,tooltip:"Connect a live table on a remote backend (rows are never stored locally)",onClick:(t,r)=>Ma(t,r?.anchor)}),e.ui.registerCommand({id:"connect-menu:open",title:"Connect a live table…",group:"Data",icon:Ys,keywords:["datasette","live","remote","backend"],run:t=>Ma(t)})}async function Ah(){const{registries:e}=await pe();return[...e.connectors].sort((t,r)=>(t.order??Number.MAX_SAFE_INTEGER)-(r.order??Number.MAX_SAFE_INTEGER))}async function Ma(e,t){const r=await Ah();if(r.length===0){await e.ui.dialogs.alert("No backends are installed to connect to. Install a connector plugin from the Plugin Manager first.","Connect");return}let i=r[0];if(r.length>1){const n=t?.getBoundingClientRect(),s=n?await Xn.open(n,r.map(a=>({id:a.id,label:a.label,icon:a.icon}))):await e.ui.dialogs.choice("Which backend do you want to connect to?",r.map(a=>a.label),"Connect");if(!s)return;i=n?r.find(a=>a.id===s):r.find(a=>a.label===s)}if(i)try{await i.connect(e)}catch(n){await e.ui.dialogs.alert(n?.message??String(n),`Connect ${i.label} failed`)}}const Ih=Object.freeze(Object.defineProperty({__proto__:null,init:Th,meta:_h},Symbol.toStringTag,{value:"Module"}));function Ba(e,t){return JSON.stringify(t.map(r=>e[r]))}function Ph(e,t){return t.every(r=>e[r]!==null&&e[r]!==void 0)}function sc(e){const{oldRows:t,freshRows:r,pks:i,userAddedFields:n,deletedRemoteFields:s=[]}=e,a=new Set(s),c=b=>{const $={...b};for(const D of a)delete $[D];return $};if(!(i.length>0&&r.every(b=>Ph(b,i))))return{data:r.map(c),merged:!1};const p=new Map;for(const b of t){const $=Ba(b.data,i);p.has($)||p.set($,b)}return{data:r.map(b=>{const $=c(b),D=Ba(b,i),P=p.get(D);if(P)for(const S of n)Object.prototype.hasOwnProperty.call(P.data,S)&&($[S]=P.data[S]);return $}),merged:!0}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const oc=Symbol.for(""),Rh=e=>{if(e?.r===oc)return e?._$litStatic$},Na=e=>({_$litStatic$:e,r:oc}),Ua=new Map,Dh=e=>(t,...r)=>{const i=r.length;let n,s;const a=[],c=[];let u,p=0,w=!1;for(;p<i;){for(u=t[p];p<i&&(s=r[p],(n=Rh(s))!==void 0);)u+=n+t[++p],w=!0;p!==i&&c.push(s),a.push(u),p++}if(p===i&&a.push(t[i]),w){const b=a.join("$$lit$$");(t=Ua.get(b))===void 0&&(a.raw=a,Ua.set(b,t=a)),r=c}return e(t,...r)},Ha=Dh(_);function qa(e){return e==null||String(e).trim()===""}function ac(e){const t=[];let r="",i=!1,n=!1,s=!1,a=!1,c=!1,u=!0;const p=()=>{const w=s?r:r.trim();(i||a)&&t.push(c?{term:w,negate:a,prefix:c}:{term:w,negate:a}),r="",i=!1,n=!1,s=!1,a=!1,c=!1,u=!0};for(let w=0;w<e.length;w++){const b=e[w];if(b==='"'){if(n&&e[w+1]==='"'){r+='"',i=!0,w++;continue}n=!n,s=!0,i=!0,u=!1;continue}if(b===","&&!n){p();continue}if(b==="!"&&!n&&u&&!a&&!c){a=!0;continue}if(b==="^"&&!n&&u&&!c){c=!0;continue}u&&!n&&/\s/.test(b)||(u=!1),r+=b,/\s/.test(b)||(i=!0)}return p(),t}function Oh(e){return e.includes(",")||e.includes('"')||e!==e.trim()||e===""||e.startsWith("!")||e.startsWith("^")}function lc(e){return e.map(t=>{const r=t.term===""&&t.negate?"":Oh(t.term)?`"${t.term.replace(/"/g,'""')}"`:t.term;return(t.negate?"!":"")+(t.prefix?"^":"")+r}).join(",")}function Wa(e,t){const r=t.term;if(r.trim()===""||!t.prefix&&r.toUpperCase()==="NULL")return qa(e);const i=String(e??"").toLowerCase(),n=r.toLowerCase();return t.prefix?i.startsWith(n):i.includes(n)}function Ti(e,t){const r=ac(t);if(r.length===0)return!0;for(const n of r)if(n.negate&&Wa(e,n))return!1;const i=r.filter(n=>!n.negate);return i.length===0?!0:i.some(n=>Wa(e,n))}var jh=Object.defineProperty,zh=Object.getOwnPropertyDescriptor,pr=(e,t,r,i)=>{for(var n=i>1?void 0:i?zh(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&jh(t,r,n),n};function Os(e){return lc([{...e,negate:!1}])}let Mt=class extends Ue{constructor(){super(...arguments),this.values=[],this.blanks=0,this.current="",this.search="",this.states=new Map,this.resolveFn=null,this.onChange=null,this.onOutside=e=>{e.composedPath().includes(this)||this.close(null)}}open(e,t,r,i=0,n){return this.values=t,this.blanks=i,this.onChange=n??null,this.states=new Map(ac(r??"").map(s=>[Os(s),{state:s.negate?"not":"on",token:s}])),this.current=r??"",this.search="",this.style.top=`${Math.round(e.bottom+4)}px`,this.style.left=`${Math.round(e.left)}px`,this.removeAttribute("hidden"),new Promise(s=>{this.resolveFn=s,setTimeout(()=>document.addEventListener("mousedown",this.onOutside,!0),0)})}cycle(e){const t={term:e,negate:!1},r=Os(t),i=new Map(this.states),n=i.get(r);n===void 0?i.set(r,{state:"on",token:t}):n.state==="on"?i.set(r,{state:"not",token:n.token}):i.delete(r),this.states=i;const s=[...i.values()].map(a=>({...a.token,negate:a.state==="not"}));this.current=lc(s),this.onChange?.(this.current)}close(e){this.onChange=null,document.removeEventListener("mousedown",this.onOutside,!0),this.setAttribute("hidden","");const t=this.resolveFn;this.resolveFn=null,t?.(e)}connectedCallback(){super.connectedCallback(),Mt.instance=this,this.setAttribute("hidden","")}disconnectedCallback(){super.disconnectedCallback(),Mt.instance===this&&(Mt.instance=null)}render(){const e=this.search.toLowerCase(),t=this.values.filter(a=>a.value.toLowerCase().includes(e)),r=this.blanks>0&&"(blanks)".includes(e),i=a=>this.states.get(Os({term:a,negate:!1}))?.state,n=a=>_`
      <span class=${`cb${a?` ${a}`:""}`}
        >${a==="on"?"✓":a==="not"?"✕":""}</span
      >
...
return render(row);`);return Ka.set(e,r),r}function Hh(e,t){if(!e||!e.trim())return{ok:!1,label:"no script",message:""};let r;try{r=Uh(e)}catch(i){return{ok:!1,label:"compile error",message:Va(i)}}try{return{ok:!0,value:r(t)}}catch(i){return{ok:!1,label:"runtime error",message:Va(i)}}}function Va(e){return e instanceof Error?e.message:String(e)}const Ii="easydb:visible-count";function cc(e,t,r){e&&document.dispatchEvent(new CustomEvent(Ii,{detail:{key:e,count:t,total:r}}))}function dc(e,t){return e<0||t<0?"":e===t?` (${t})`:` (${e}/${t})`}const uc="#dc2626",hc="cell-invalid",qh=`border-color:${uc};background:#fef2f2`;function So(e,t){e.classList.add(hc),e.style.border=`1px solid ${uc}`,e.style.background="#fef2f2",t&&(e.title=t)}const Wh=/^\s*(true|1)\s*$/i,Kh=/^\s*(false|0)\s*$/i;function Vh(e){return e===!0||e===1?"true":e===!1||e===0?"false":e==null?"empty":typeof e=="string"?e.trim()===""?"empty":Wh.test(e)?"true":Kh.test(e)?"false":"invalid":"invalid"}var Gh=Object.defineProperty,Yh=Object.getOwnPropertyDescriptor,ht=(e,t,r,i)=>{for(var n=i>1?void 0:i?Yh(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Gh(t,r,n),n};const Xh=200,Qh=10,js=32;let ot=class extends Ue{constructor(){super(...arguments),this.tableId="",this.viewInstanceId="",this.columns=[],this.rows=[],this.sortColumn=null,this.sortDir=null,this.filters={},this.globalQuery="",this.localQuery="",this.dragSourceField=null,this.dropTargetField=null,this.dropEdge=null,this.resizing=null,this.cellRenderers=new Map,this.scrollY=0,this.viewportHeight=0,this.loading=!1,this.externalLoading=!1,this.externalProgress=null,this.rowHeight=28,this.resizeObs=null,this.filterSaveTimer=null,this.viewInst=null,this.tableColumns=[],this.renderedCount=0,this.lastEmittedCount=-1,this.lastEmittedTotal=-1,this.VIRT_THRESHOLD=200,this.OVERSCAN=8,this.onScroll=()=>{this.scrollY=this.scrollTop},this.onGlobalSearch=e=>{this.globalQuery=e.detail.query??""},this.onTableSearch=e=>{const t=e.detail;(t.tableId===this.tableId||this.viewMode&&t.tableId===this.viewInstanceId)&&(this.localQuery=t.query??"")},this.onTableLoading=e=>{const t=e.detail;t.tableId===this.tableId&&(this.externalLoading=t.loading,this.externalProgress=t.loading&&typeof t.progress=="number"?t.progress:null)}}get viewMode(){return!!this.viewInstanceId}get readOnlyView(){return this.viewMode&&!!this.viewInst?.readonly}async connectedCallback(){super.connectedCallback(),document.addEventListener("easydb:global-search",this.onGlobalSearch),document.addEventListener("easydb:table-search",this.onTableSearch),document.addEventListener("easydb:table-loading",this.onTableLoading),this.addEventListener("scroll",this.onScroll,{passive:!0}),this.resizeObs=new ResizeObserver(()=>{this.viewportHeight=this.clientHeight}),this.resizeObs.observe(this),await this.bind()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener("easydb:global-search",this.onGlobalSearch),document.removeEventListener("easydb:table-search",this.onTableSearch),document.removeEventListener("easydb:table-loading",this.onTableLoading),this.removeEventListener("scroll",this.onScroll),this.resizeObs?.disconnect(),this.resizeObs=null,this.unsubscribe?.(),this.tableSubUnsub?.(),this.viewSubUnsub?.()}async updated(e){(e.has("tableId")||e.has("viewInstanceId"))&&this.tableId&&(this.unsubscribe?.(),this.tableSubUnsub?.(),this.viewSubUnsub?.(),await this.bind());const t=this.shadowRoot?.querySelector("tbody tr:not(.spacer)");t&&t.offsetHeight>0&&(this.rowHeight=t.offsetHeight),this.viewportHeight||(this.viewportHeight=this.clientHeight),this.markEmptyCells(),this.emitCount()}emitCount(){const e=this.viewMode?this.viewInstanceId:this.tableId;if(!e)return;const t=this.renderedCount,r=this.rows.length;t===this.lastEmittedCount&&r===this.lastEmittedTotal||(this.lastEmittedCount=t,this.lastEmittedTotal=r,cc(e,t,r))}markEmptyCells(){const e=this.shadowRoot?.querySelectorAll("tbody tr:not(.spacer) > td");if(e)for(const t of e)t.className.startsWith("t-")&&t.classList.toggle("is-null",Jh(t))}async bind(){if(!this.tableId)return;const e=await pe(),t=await e.store.tables.findOne(this.tableId);if(!t)return;this.viewMode?(this.tableColumns=t.columns,this.viewInst=await e.store.viewInstances.findOne(this.viewInstanceId)??null,this.applyView(),this.tableSubUnsub?.(),this.tableSubUnsub=e.store.tables.subscribe(n=>{const s=n.find(a=>a.id===this.tableId);s&&(this.tableColumns=s.columns,this.applyView())}),this.viewSubUnsub?.(),this.viewSubUnsub=e.store.viewInstances.subscribe(n=>{const s=n.find(a=>a.id===this.viewInstanceId);s&&(this.viewInst=s,this.applyView())})):(this.applyTable(t),this.tableSubUnsub?.(),this.tableSubUnsub=e.store.tables.subscribe(n=>{const s=n.find(a=>a.id===this.tableId);s&&this.applyTable(s)})),this.cellRenderers=new Map(e.registries.cellRenderers),e.events.on("app:ready",()=>this.cellRenderers=new Map(e.registries.cellRenderers));const r=e.store.rows(this.tableId);this.unsubscribe=r.subscribe(n=>this.rows=n);const i=window.setTimeout(()=>this.loading=!0,Xh);try{this.rows=await r.find()}catch(n){this.rows=[],e.api.ui.dialogs.toast(`Couldn't load rows: ${n?.message??String(n)}`,{kind:"error",title:"Load failed"})}finally{window.clearTimeout(i),this.loading=!1}}applyTable(e){this.columns=e.columns,this.sortColumn=e.sortColumn??null,this.sortDir=e.sortColumn?e.sortAsc===!1?"desc":"asc":null,this.filterSaveTimer==null&&(this.filters={...e.filters??{}})}applyView(){const e=this.viewInst;if(!e)return;const t=new Map(this.tableColumns.map(i=>[i.field,i])),r=e.columnWidths??{};this.columns=e.visibleColumns.map(i=>t.get(i)).filter(i=>!!i).map(i=>{const n=r[i.field];return typeof n=="number"?{...i,width:n}:i}),this.sortColumn=e.sortColumn??null,this.sortDir=e.sortColumn?e.sortAsc===!1?"desc":"asc":null,this.filterSaveTimer==null&&(this.filters={...e.filters??{}})}async setCell(e,t,r){const i=await pe();await this.commitCell(i,e,t,r)}async commitCell(e,t,r,i){const n=this.columns.find(s=>s.field===r);if(n){const s=Zh(n,i,this.rows,t.id);if(s){await e.api.ui.dialogs.alert(s,`Cannot save ${n.label}`),this.requestUpdate();return}}try{await e.store.rows(this.tableId).patch(t.id,{data:{...t.data,[r]:i},updatedAt:Date.now()})}catch(s){await e.api.ui.dialogs.alert(s?.message??"Could not save the change.","Save failed"),this.requestUpdate()}}cancelCellEdit(e,t){if(e.key!=="Escape")return;e.stopPropagation();const r=e.target;typeof t=="boolean"?r.checked=t:r.value=t,r.blur()}renderInvalidCell(e,t,r,i){const n=String(r);return _`<input
    ...
    />`}renderReadonlyCell(e,t){return e.type==="boolean"?_`<input type="checkbox" .checked=${t===!0||t==="true"||t===1||t==="1"} disabled />`:t==null||t===""?_``:e.type==="date"?_`${mi(t)}`:e.type==="datetime"?_`${gi(t).replace("T"," ")}`:_`${String(t)}`}renderScriptedCell(e,t){const r=Hh(t.script,e.data);if(!r.ok)return _`<span class="script-err" title=${r.message}>⚠ ${r.label}</span>`;const i=t.renderer?this.cellRenderers?.get(t.renderer):void 0;if(!i)return _`${r.value==null?"":String(r.value)}`;const n=Na(i);return Ha`<${n}
      .value=${r.value??""}
      .column=${t}
      .row=${e.data}
      .readonly=${!0}
    ></${n}>`}renderCell(e,t){const r=e.data[t.field];if(t.script?.trim())return this.renderScriptedCell(e,t);const i=t.renderer,n=i?this.cellRenderers?.get(i):void 0;if(n){const s=Na(n);return Ha`<${s}
        .value=${r??""}
        .column=${t}
        .row=${e.data}
        .readonly=${this.readOnlyView}
        @change=${a=>this.setCell(e,t.field,a.detail.value)}
      ></${s}>`}if(this.readOnlyView)return this.renderReadonlyCell(t,r);switch(t.type){case"date":return Ga(r,mi(r))?this.renderInvalidCell(e,t,r,`Not a valid date: "${String(r)}"`):_`<input
          type="date"
          .value=${mi(r)}
          @keydown=${s=>this.cancelCellEdit(s,mi(r))}
          @change=${s=>this.setCell(e,t.field,s.target.value||null)}
        />`;case"datetime":return Ga(r,gi(r))?this.renderInvalidCell(e,t,r,`Not a valid datetime: "${String(r)}"`):_`<input
          type="datetime-local"
          .value=${gi(r)}
      ...
      ${this.loading||this.externalLoading?_`<div
            ...
            aria-valuemin="0"
            aria-valuemax="100"
            aria-valuenow=${a!=null?Math.round(a*100):fe}
          >
            <div
              class="load-bar-fill ${a!=null?"determinate":""}"
              style=${a!=null?`width:${Math.max(2,Math.round(a*100))}%`:fe}
            ></div>
          </div>`:fe}
      <table style=${this.tableSizingStyle(t)??fe}>
        <colgroup>
...
`)}`,{kind:"error",title:"Datasette import"});return}if(t.partial.length>0){e.ui.dialogs.toast(`Imported ${i} (${r}).${n} ${t.partial.length} loaded partially (stopped early — the server may have rate-limited us): ${t.partial.join(", ")}. Use Refresh to fetch the rest.`,{kind:"warning",title:"Datasette import"});return}if(t.capped.length>0){e.ui.dialogs.toast(`Imported ${i} (${r}).${n} ${t.capped.length} capped at ${on.maxImportRows} — more available: ${t.capped.join(", ")}.`,{kind:"warning",title:"Datasette import"});return}e.ui.dialogs.toast(`Imported ${i} (${r}) from Datasette.${n}`,{kind:"success",title:"Datasette import"})}async function Tf(e,t){const r=await e.store.tables.findOne(t);if(!(!r?.origin?.url||r.origin.type!=="datasette"))try{await Af(e,r)}catch(i){const n=i instanceof Bt?i.message:i?.message??String(i);e.ui.dialogs.toast(`Refresh failed: ${n}`,{kind:"error",title:"Refresh"})}}async function Af(e,t){const r=bn(t.origin.url),i=u=>e.backend.fetch(u);pn(t.id,!0);let n,s=[];try{let u=[],p=null,w=!1;try{const k=await Ki(i,r);u=k.columns,p=k.count,w=k.typed}catch{}p==null&&(p=await gc(i,r));const b=p&&p>0?Math.min(p,on.maxImportRows):0,{rows:$,hasMore:D,truncated:P,error:S,nextUrl:B}=await Nr(i,r,{maxRows:on.maxImportRows,pageSize:on.pageSize,onProgress:k=>{b>0&&pn(t.id,!0,Math.min(1,k/b))}});let q=u.length===0?Wi($):w?u:Io(u,$),Q={};try{const k=await To(i,r),he=Ao(k,q);q=he.columns,Q=he.patch}catch{}Q=Po(Q,r.base,r.db,r.table);const X=t.columns.length===0,J=Hi(t.columns,q,t.deletedColumns);s=J.newFields;const W=Date.now(),Z=Ro(S,B,$.length,p),de=X?{columns:J.columns,...Q,importResume:Z,updatedAt:W}:{columns:J.columns,...Q.info?{info:Q.info}:{},importResume:Z,updatedAt:W};await e.store.tables.patch(t.id,de);const we=t.origin?.pks??[],Te=new Set(q.map(k=>k.field)),Pe=t.columns.map(k=>k.field).filter(k=>!Te.has(k)&&!we.includes(k)),m=(t.deletedColumns??[]).filter(k=>Te.has(k)),x=e.store.rows(t.id),I=await x.find(),{data:y}=sc({oldRows:I.map(k=>({data:k.data})),freshRows:$,pks:we,userAddedFields:Pe,deletedRemoteFields:m});await x.bulkRemove(I.map(k=>k.id)),await x.bulkInsert(y.map(k=>({id:it(),tableId:t.id,data:k,updatedAt:W}))),n={rowCount:y.length,hasMore:D,truncated:P,error:S}}finally{pn(t.id,!1)}const a=[];n.error?a.push(`partial (${n.error})`):(n.hasMore||n.truncated)&&a.push(`capped at ${on.maxImportRows}`),s.length>0&&a.push(`${s.length} new column${s.length===1?"":"s"}`);const c=a.length?` — ${a.join(", ")}`:"";e.ui.dialogs.toast(`Refreshed ${n.rowCount} rows from ${r.db}/${r.table}${c}.`,{kind:n.error||n.hasMore||n.truncated||s.length>0?"warning":"success",title:"Refresh"}),s.length>0&&Pf(t.id,r,s)}async function If(e,t){const r=await e.store.tables.findOne(t),i=r?.importResume;if(!r||!r.origin?.url||!i)return;const n=bn(r.origin.url),s=$=>e.backend.fetch($),a=i.loadedRows,c=i.totalCount??null,u=c&&c>0?Math.min(c,on.maxImportRows):0;pn(t,!0,u>0?Math.min(1,a/u):void 0);let p=0,w;try{const $=await Nr(s,n,{startUrl:i.nextUrl,maxRows:Math.max(0,on.maxImportRows-a),pageSize:on.pageSize,onProgress:S=>{u>0&&pn(t,!0,Math.min(1,(a+S)/u))}});p=$.rows.length;const D=Date.now();await e.store.rows(t).bulkInsert($.rows.map(S=>({id:it(),tableId:t,data:S,updatedAt:D}))),w={error:$.error,nextUrl:$.nextUrl};const P=Ro($.error,$.nextUrl,a+p,c);await e.store.tables.patch(t,{importResume:P,updatedAt:D})}catch($){const D=$ instanceof Bt?$.message:$?.message??String($);e.ui.dialogs.toast(`Couldn't resume ${n.db}/${n.table}: ${D}. Try again later.`,{kind:"error",title:"Resume import"});return}finally{pn(t,!1)}const b=a+p;w.error?e.ui.dialogs.toast(`Resumed ${n.db}/${n.table}: +${p} rows (${b} total) — interrupted again (${w.error}). Resume to continue.`,{kind:"warning",title:"Resume import"}):e.ui.dialogs.toast(`Finished ${n.db}/${n.table}: +${p} rows (${b} total).`,{kind:"success",title:"Resume import"})}function Pf(e,t,r){const i=r.join(", "),n=r.length!==1,s=`Refreshing ${t.db}/${t.table} revealed ${r.length} new column${n?"s":""}: ${i}. Review, reorder or hide ${n?"them":"it"} here.`;document.dispatchEvent(new CustomEvent("easydb:edit-columns",{detail:{tableId:e,notice:s}}))}const Rf=Object.freeze(Object.defineProperty({__proto__:null,importDatasette:Do,init:$f,meta:vf},Symbol.toStringTag,{value:"Module"}));var Df=Object.defineProperty,Of=Object.getOwnPropertyDescriptor,Ur=(e,t,r,i)=>{for(var n=i>1?void 0:i?Of(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Df(t,r,n),n};const jf="https://latest.datasette.io/ephemeral";let Xt=class extends Ue{constructor(){super(...arguments),this.url="",this.token="",this.status="",this.statusKind="",this.dialogEl=null,this.resolveFn=null,this.onCancel=e=>{e.preventDefault(),this.finish(null)},this.submit=async e=>{e.preventDefault();const t=this.url.trim();if(!t)return;const r=this.token.trim();if(this.onConnect){this.status="Checking…",this.statusKind="busy";try{await this.onConnect(t,r)}catch(i){this.status=i?.message??String(i),this.statusKind="err";return}}this.finish({url:t,token:r})}}connectedCallback(){super.connectedCallback(),Xt.instance=this}disconnectedCallback(){super.disconnectedCallback(),Xt.instance===this&&(Xt.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}open(e={}){return this.url=e.initialUrl??"",this.token=e.initialToken??"",this.status="",this.statusKind="",this.onTest=e.onTest,this.onConnect=e.onConnect,new Promise(t=>{this.resolveFn=t,this.updateComplete.then(()=>this.dialogEl?.showModal())})}finish(e){this.dialogEl?.close();const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}async runTest(){const e=this.url.trim();if(!(!e||!this.onTest)){this.status="Testing…",this.statusKind="busy";try{this.status=await this.onTest(e,this.token.trim()),this.statusKind=/read-write|reachable|ok\b/i.test(this.status)?"ok":"err"}catch(t){this.status=t?.message??String(t),this.statusKind="err"}}}render(){return _`
    ...
    `];Ur([K()],Xt.prototype,"url",2);Ur([K()],Xt.prototype,"token",2);Ur([K()],Xt.prototype,"status",2);Ur([K()],Xt.prototype,"statusKind",2);Xt=Ur([nt("datasette-connect-dialog")],Xt);class zf extends Error{constructor(t){super(`This Datasette table is read-only — ${t} is not permitted.`),this.name="SourceReadOnlyError"}}function vc(e){return`datasette:token:${e}`}function Lf(e,t){for(const[r,i]of Object.entries(t))if(r!=="data"&&e[r]!==i)return!1;return!0}function Ff(e,t){const r=e.source,i=r?.config??{},n={base:i.base,db:i.db,table:i.table,query:{}},s=Array.isArray(i.pks)&&i.pks.length>0?i.pks:["rowid"],a=r?.writable===!0,c=i.maxRows??1e4,u=i.pollIntervalMs??0,p=(J,W)=>t.backend.fetch(J,W);async function w(){const W=(await t.settings.findOne(vc(i.base)))?.value;return typeof W=="string"&&W.length>0?W:void 0}const b=async(J,W)=>cr(p,await w())(J,W);function $(J){return{id:af(J,s)??it(),tableId:e.id,data:J,updatedAt:Date.now()}}function D(J){if(!a)throw new zf(J)}function P(J){const W={};for(const[Z,de]of Object.entries(J))s.includes(Z)||(W[Z]=de);return W}const S=new Set;let B=[],q=!1,Q=null;function X(){return Q||(Q=(async()=>{try{const{rows:J}=await Nr(b,n,{maxRows:c});B=J.map($),q=!0;for(const W of S)W(B);return B}finally{Q=null}})(),Q)}return{async find(J){const W=q?B:await X();return!J||Object.keys(J).length===0?W:W.filter(Z=>Lf(Z,J))},async findOne(J){return(q?B:await X()).find(Z=>Z.id===J)??null},async insert(J){D("insert");const[W]=await Qa(b,n,[J.data]),Z=$(W??J.data);return t.events.emit("row:created",{tableId:e.id,row:Z}),X(),Z},async bulkInsert(J){if(J.length===0)return[];D("insert");const W=await Qa(b,n,J.map(de=>de.data)),Z=(W.length?W:J.map(de=>de.data)).map($);return X(),Z},async upsert(J){D("upsert");const[W]=await mf(b,n,[J.data]),Z=$(W??J.data);return X(),Z},async patch(J,W){D("update");const Z=W.data,de=P(Z??{}),we=await pf(b,n,J,de),Te=$(we??{...Z??{}});return t.events.emit("row:updated",{tableId:e.id,row:Te,prev:Te}),X(),Te},async remove(J){D("delete"),await Ja(b,n,J),t.events.emit("row:deleted",{tableId:e.id,rowId:J}),X()},async bulkRemove(J){if(J.length!==0){D("delete");for(const W of J)await Ja(b,n,W);X()}},subscribe(J){S.add(J),q?J(B):X();let W=null;return u>0&&(W=setInterval(()=>void X(),u)),()=>{S.delete(J),W&&clearInterval(W)}},async refresh(){await X()}}}const Mf='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M3.9 12a3.1 3.1 0 0 1 3.1-3.1h4V7H7a5 5 0 0 0 0 10h4v-1.9H7A3.1 3.1 0 0 1 3.9 12zM8 13h8v-2H8v2zm9-6h-4v1.9h4A3.1 3.1 0 0 1 17 15h-4v1.9h4a5 5 0 0 0 0-10z"/></svg>',Bf={id:"datasette-connect",name:"Datasette Connect",type:"source",version:"0.3.0",description:"Connect a live, editable table on any Datasette instance — rows are never stored locally",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"/><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/datasette-connect.ts"};function Nf(e){e.ui.registerConnector({id:"datasette",label:"Datasette",icon:Mf,order:10,description:"A live, editable table on any Datasette instance",connect:t=>Hf(t)}),e.ui.registerTableButton({id:"datasette:refresh-live",label:"Refresh",icon:"refresh",tooltip:"Re-read this live table from its Datasette instance",visible:t=>t.source?.type==="datasette",onClick:(t,{tableId:r})=>Uf(t,r)}),typeof e.registerRowSource=="function"&&e.registerRowSource({type:"datasette",create:Ff})}async function Uf(e,t){if((await e.store.tables.findOne(t))?.source?.type==="datasette")try{const i=e.store.rows(t);typeof i.refresh=="function"&&await i.refresh();const n=await i.find();e.ui.dialogs.toast(`Reloaded ${n.length} rows from Datasette.`,{kind:"success",title:"Refresh"})}catch(i){const n=i instanceof Bt?i.message:i?.message??String(i);e.ui.dialogs.toast(`Refresh failed: ${n}`,{kind:"error",title:"Refresh"})}}async function Hf(e){const t=Xt.instance??qf(),r=(n,s)=>e.backend.fetch(n,s),i=await t.open({initialUrl:"https://datasette.io",async onTest(n,s){const a=bn(n),c=await bc(r,a.base,{token:s||void 0});if(a.db&&a.table){await Xs(cr(r,s||void 0),a);const p=c.version?` (Datasette ${c.version})`:"";return c.writable?`Reachable${p} — table found, signed in, read-write.`:`Reachable${p} — table found, read-only (no token / not authenticated).`}if(!c.reachable)return`Unreachable: ${c.error??"no response"}`;const u=c.version?` (Datasette ${c.version})`:"";return c.writable?`Reachable${u} — signed in, read-write.`:`Reachable${u} — read-only (no token / not authenticated).`},async onConnect(n,s){const a=bn(n);a.db&&a.table&&await Xs(cr(r,s||void 0),a)}});if(i)try{await xc(e,i.url,i.token)}catch(n){const s=n instanceof Bt?n.message:n?.message??String(n);await e.ui.dialogs.alert(s,"Connect Datasette failed")}}function qf(){const e=document.createElement("datasette-connect-dialog");return document.body.appendChild(e),e}async function xc(e,t,r){const i=e.workspaceId();if(!i)throw new Error("datasette-source: no active workspace");const n=bn(t),s=(b,$)=>e.backend.fetch(b,$),a=cr(s,r||void 0),c=await bc(s,n.base,{token:r||void 0});r&&await e.store.settings.upsert({key:vc(n.base),value:r});let u;try{u=await wc(a,n,"Connect")}catch(b){const $=b instanceof Bt?b.message:b?.message??String(b);throw new Error(`Couldn't read tables from ${Ri(n.base)}: ${$}`)}if(u===null)return;if(u.length===0){await e.ui.dialogs.alert("No tables found at that URL.","Connect Datasette");return}const p=[];for(const b of u){const $=await Wf(e,i,n.base,b,c.writable,r);$!==null&&p.push({tableId:$,c:b})}if(p.length===0)return;const w=c.writable?"read-write":"read-only";e.ui.dialogs.toast(`Connected ${p.length} live table${p.length===1?"":"s"} from Datasette (${w}).`,{kind:"success",title:"Connect Datasette"});for(const{tableId:b,c:$}of p)Kf(e,b,n.base,$,r)}async function Wf(e,t,r,i,n,s){const a=(await e.store.tables.find()).filter($=>$.workspaceId===t);let c=`${i.db}/${i.table}`,u=a.find($=>{const D=$.source?.config;return $.source?.type==="datasette"&&D?.base===r&&D?.db===i.db&&D?.table===i.table});if(!u){const $=a.find(D=>D.name.toLowerCase()===c.toLowerCase());if($){const D=await e.ui.dialogs.choice(`A table named "${c}" already exists in this workspace.`,["Overwrite","Rename","Skip"],"Connect — table already exists");if(!D||D==="Skip")return null;D==="Overwrite"?u=$:c=yc(new Set(a.map(P=>P.name)),c)}}let p=i.pks??[];if(p.length===0){const $=cr((D,P)=>e.backend.fetch(D,P),s||void 0);try{p=await gf($,{base:r,db:i.db,table:i.table,query:{}})}catch{p=[]}}const w=u?.id??it(),b={...u??{},id:w,workspaceId:t,name:c,code:Tt(`${i.db}-${i.table}`),columns:u?.columns??[],view:u?.view??"table",source:{type:"datasette",writable:n,config:{base:r,db:i.db,table:i.table,pks:p}},updatedAt:Date.now()};return u?await e.store.tables.upsert(b):await e.store.tables.insert(b),w}async function Kf(e,t,r,i,n){const s={base:r,db:i.db,table:i.table,query:{}},a=cr((c,u)=>e.backend.fetch(c,u),n||void 0);try{let c=[],u=!1;try{const S=await Ki(a,s);c=S.columns,u=S.typed}catch{}const{rows:p}=await Nr(a,s,{maxRows:50,pageSize:50}),w=c.length===0?Wi(p):u?c:Io(c,p);if(w.length===0)return;const b=await e.store.tables.findOne(t);if(!b)return;const $=b.source?.config?.pks??[];let D=w.map(S=>$.includes(S.field)?{...S,unique:!0,notnull:!0}:S),P={};try{const S=await To(a,s),B=Ao(S,D);D=B.columns,P=B.patch}catch{}P=Po(P,s.base,i.db,i.table),await e.store.tables.patch(t,{columns:D,...P,updatedAt:Date.now()})}catch{}}const Vf=Object.freeze(Object.defineProperty({__proto__:null,connectDatasette:xc,init:Nf,meta:Bf},Symbol.toStringTag,{value:"Module"})),Gf={id:"url-source",name:"URL Reference",type:"source",version:"0.1.0",description:'Backs a table with a live read-only fetch of a plain CSV or JSON URL — a "reference" table whose rows are never persisted locally.',author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="9"/><path d="M3 12h18"/><path d="M12 3a15 15 0 0 1 0 18a15 15 0 0 1 0-18z"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/url-source.ts"};function Yf(e){typeof e.registerRowSource=="function"&&e.registerRowSource({type:"url",create:$c}),e.ui.registerTableButton({id:"url-source:refresh",label:"Refresh",icon:"refresh",tooltip:"Re-fetch this reference from its source URL",visible:t=>t.source?.type==="url",onClick:async(t,{tableId:r})=>{try{const i=t.store.rows(r);typeof i.refresh=="function"&&await i.refresh(),t.ui.dialogs.toast("Reference refreshed.",{kind:"success",title:"Refresh"})}catch(i){t.ui.dialogs.toast(`Refresh failed: ${i.message}`,{kind:"error",title:"Refresh"})}}})}class Wn extends Error{constructor(t){super(`This is a reference (read-only) table — ${t} is not permitted. Import a copy to edit.`),this.name="ReadOnlyReferenceError"}}function Xf(e,t){for(const[r,i]of Object.entries(t))if(r!=="data"&&e[r]!==i)return!1;return!0}function Qf(e){const t=r=>typeof r=="object"&&r!==null&&!Array.isArray(r);if(Array.isArray(e))return e.filter(t);if(t(e)){for(const r of["rows","records","data"]){const i=e[r];if(Array.isArray(i))return i.filter(t)}for(const r of Object.values(e))if(Array.isArray(r))return r.filter(t)}return[]}function $c(e,t){const r=e.source?.config??{},i=typeof r.url=="string"?r.url:"",n=r.format==="json"?"json":"csv",s=new Set;let a=[],c=!1,u=null;function p(D){return D.map((P,S)=>({id:`url:${S}`,tableId:e.id,data:P,updatedAt:0}))}async function w(D){let P;try{P=await t.backend.fetch(D)}catch(S){throw new Error(`Could not reach ${i}: ${S?.message??String(S)}`)}if(!P.ok)throw new Error(`Could not load ${i}: HTTP ${P.status} ${P.statusText}`);try{return await Kl(P)}catch(S){throw new Error(`Could not read response from ${i}: ${S?.message??String(S)}`)}}async function b(){if(!i)throw new Error("This reference table has no URL configured.");const D=go(i);let P=await w(D);if(ql(P)){const S=Wl(D);S&&(P=await w(S))}try{return n==="json"?Qf(JSON.parse(P)):hr(P).rows}catch(S){throw new Error(`Could not parse ${n.toUpperCase()} from ${i}: ${S?.message??String(S)}`)}}function $(){return u||(u=(async()=>{try{const D=await b();a=p(D),c=!0;for(const P of s)P(a);return a}finally{u=null}})(),u)}return{async find(D){const P=c?a:await $();return!D||Object.keys(D).length===0?P:P.filter(S=>Xf(S,D))},async findOne(D){return(c?a:await $()).find(S=>S.id===D)??null},async insert(){throw new Wn("insert")},async bulkInsert(){throw new Wn("insert")},async upsert(){throw new Wn("upsert")},async patch(){throw new Wn("update")},async remove(){throw new Wn("delete")},async bulkRemove(){throw new Wn("delete")},subscribe(D){return s.add(D),c?D(a):$(),()=>{s.delete(D)}},async refresh(){c=!1,a=[],await $()}}}const Jf=Object.freeze(Object.defineProperty({__proto__:null,ReadOnlyReferenceError:Wn,createUrlCollection:$c,init:Yf,meta:Gf},Symbol.toStringTag,{value:"Module"})),Zf={id:"sql-export",name:"SQL Export",type:"exporter",version:"0.1.0",description:"Export the current workspace as a portable .sql script (CREATE TABLE + INSERT).",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/sql-export.ts"};function ep(){}async function kc(e){const t=e.workspaceId();if(!t)throw new Error("sql-export: no active workspace");const r=(await e.store.tables.find()).filter(n=>n.workspaceId===t),i=["-- easyDBAccess SQL dump",`-- workspace: ${t}`,`-- exported:  ${new Date().toISOString()}`,`-- tables:    ${r.length}`,"-- Compatible with PostgreSQL and SQLite. For MySQL run","--   SET sql_mode='ANSI_QUOTES';",'-- before executing, or rewrite "ident" to `ident`.',"","BEGIN;",""];for(const n of r){const s=await e.store.rows(n.id).find();i.push(Ec(n,s),"")}return i.push("COMMIT;",""),i.join(`
`)}function Cc(e,t){return["-- easyDBAccess table export",`-- table:    ${e.name}`,`-- exported: ${new Date().toISOString()}`,"","BEGIN;","",Ec(e,t),"","COMMIT;",""].join(`
`)}function Ec(e,t){const r=Qs(e.code||e.name||`table_${e.id}`),i=['  "__id" TEXT PRIMARY KEY',...e.columns.map(s=>`  ${tp(s)}`)],n=[`DROP TABLE IF EXISTS "${r}";`,`CREATE TABLE "${r}" (`,i.join(`,
`),");"];if(t.length>0){const a=["__id",...e.columns.map(c=>c.field)].map(c=>`"${Qs(c)}"`).join(", ");for(const c of t){const u=[el(c.id),...e.columns.map(p=>el(c.data[p.field],p.type))];n.push(`INSERT INTO "${r}" (${a}) VALUES (${u.join(", ")});`)}}return n.join(`
`)}function tp(e){const t=[`"${Qs(e.field)}"`,np(e.type)];return e.notnull&&t.push("NOT NULL"),e.unique&&t.push("UNIQUE"),t.join(" ")}function np(e){switch(e){case"number":return"NUMERIC";case"boolean":return"BOOLEAN";case"date":return"CHAR(8)";case"datetime":return"TIMESTAMP";case"string":default:return"TEXT"}}function el(e,t){if(e==null)return"NULL";if(t==="date"){if(typeof e=="string"&&e.trim()==="")return"NULL";const r=rp(e);return r===null?"NULL":bi(r)}return typeof e=="number"?Number.isFinite(e)?String(e):"NULL":typeof e=="boolean"?e?"TRUE":"FALSE":e instanceof Date?bi(e.toISOString()):bi(typeof e=="string"?e:JSON.stringify(e))}function rp(e){if(e==null)return null;if(e instanceof Date)return Number.isFinite(e.getTime())?tl(e):null;if(typeof e=="string"){const t=e.trim();if(t.length===0)return null;const r=/^(\d{4})-(\d{2})-(\d{2})/.exec(t);if(r)return`${r[1]}${r[2]}${r[3]}`;const i=new Date(t);return Number.isFinite(i.getTime())?tl(i):null}return null}function tl(e){const t=String(e.getUTCFullYear()).padStart(4,"0"),r=String(e.getUTCMonth()+1).padStart(2,"0"),i=String(e.getUTCDate()).padStart(2,"0");return`${t}${r}${i}`}function bi(e){return`'${e.replace(/'/g,"''")}'`}function Qs(e){let t=e.replace(/[^a-zA-Z0-9_]/g,"_");return/^[0-9]/.test(t)&&(t=`_${t}`),t||"_"}const ip=Object.freeze(Object.defineProperty({__proto__:null,init:ep,meta:Zf,serializeTableAsSql:Cc,serializeWorkspaceAsSql:kc},Symbol.toStringTag,{value:"Module"})),Sc=/\$(input[.:])?([A-Za-z_][A-Za-z0-9_]*)/g;function nl(...e){const t=new Set;for(const r of e)if(r)for(const i of r.matchAll(Sc))t.add(i[2]);return[...t]}const _c=e=>e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),yi=e=>_c(e).replace(/"/g,"&quot;").replace(/'/g,"&#39;");function sp(e){return typeof e=="boolean"?e:typeof e=="number"?e!==0:typeof e=="string"?["true","1","yes","y","t","on"].includes(e.trim().toLowerCase()):!1}function op(e,t,r,i,n){const s=i?.type??"string",a=_c(i?.label||e),c=`class="eda-input" data-eda-row="${yi(r)}" data-eda-field="${yi(e)}" data-eda-type="${yi(s)}"`,u=n?" disabled":"";let p;if(s==="boolean")p=`<input type="checkbox" ${c}${sp(t)?" checked":""}${u} />`;else{const w=s==="number"?"number":"text",b=t==null?"":yi(String(t));p=`<input type="${w}" ${c} value="${b}"${u} />`}return`<label class="eda-input-field" title="${a}">${p}<span class="eda-input-label">${a}</span></label>`}function ap(e,t,r,i={}){return e.replace(Sc,(n,s,a)=>{const c=r[a];if(!c)return"";const u=t.data[c];return s?op(c,u,t.id,i.columns?.get(c),i.readonly===!0):u==null?"":String(u)})}function rl(e){return e==null||e===""}function lp(e,t){const r=Object.entries(t).filter(([,i])=>i!=null&&String(i).trim()!=="");return r.length===0?e:e.filter(i=>r.every(([n,s])=>Ti(i.data[n],s)))}function cp(e,t,r=!0){if(!t)return e;const i=r?1:-1;return[...e].sort((n,s)=>{const a=n.data[t],c=s.data[t],u=rl(a),p=rl(c);if(u||p)return u===p?0:u?1:-1;const w=Number(a),b=Number(c);return!Number.isNaN(w)&&!Number.isNaN(b)?(w-b)*i:String(a).localeCompare(String(c),void 0,{numeric:!0,sensitivity:"base"})*i})}function Tc(e,t){return cp(lp(e,t.filters??{}),t.sortColumn,t.sortAsc??!0)}function dp(e){return!!e&&e.trim().length>0}function up(e,t){return t==="raw"||t==="structure"?e.columns:e.columns.filter(r=>r.hidden!==!0)}function hp(e,t){return t==="raw"||t==="structure"?e:{...e,columns:up(e,t)}}function fp(e,t,r){return r==="structure"?[]:r==="raw"?t:Tc(t,{filters:e.filters??{},sortColumn:e.sortColumn,sortAsc:e.sortAsc})}function Oo(e,t){const r=e.columns.map(n=>n.field),i=e.source!=null;return{name:e.name,title:e.title,columns:e.columns,view:e.view,windowGeometry:e.windowGeometry,sortColumn:e.sortColumn,sortAsc:e.sortAsc,filters:e.filters,labelColumn:e.labelColumn,deletedColumns:e.deletedColumns,info:e.info,source:e.source,origin:e.origin,rows:i?[]:t.map(n=>{const s={};for(const a of r)s[a]=n.data[a];return s})}}const pp={id:"dump-export",name:"Dump Export",type:"exporter",version:"0.1.0",description:"Export the current workspace as a single .db.json dump file, and — per table — CSV/JSON/SQL with a Raw vs. Visible vs. Structure Only choice.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="21 8 21 21 3 21 3 8"/><rect x="1" y="3" width="22" height="5"/><line x1="10" y1="12" x2="14" y2="12"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/dump-export.ts"};function mp(e){e.ui.registerFooterButton({id:"export:menu",label:"Export",icon:"download",tooltip:"Export the current workspace (JSON or SQL)",onClick:async(t,r)=>{const i=t.workspaceId();if(!i)return;const{AnchoredMenu:n}=await ln(async()=>{const{AnchoredMenu:c}=await Promise.resolve().then(()=>zr);return{AnchoredMenu:c}},void 0),s=r?.anchor?.getBoundingClientRect()??new DOMRect(16,window.innerHeight-48,0,0),a=await n.open(s,[{id:"json",label:"JSON dump (.db.json)",icon:"data_object"},{id:"sql",label:"SQL script (.sql)",icon:"storage"}]);if(a)try{if(a==="json"){const c=await Gi(t);await t.backend.saveFile(`workspace-${i}.db.json`,c,"application/json")}else if(a==="sql"){const c=await kc(t);await t.backend.saveFile(`workspace-${i}.sql`,c,"application/sql")}}catch(c){t.ui.dialogs.toast(`Export failed: ${c.message}`,{kind:"error",title:"Export"})}}}),e.ui.registerTableButton({id:"table-export:menu",label:"Export",icon:"file_download",tooltip:"Export this table as CSV, JSON, or SQL",onClick:async(t,r)=>{const{AnchoredMenu:i}=await ln(async()=>{const{AnchoredMenu:p}=await Promise.resolve().then(()=>zr);return{AnchoredMenu:p}},void 0),n=r.anchor?.getBoundingClientRect()??new DOMRect(16,window.innerHeight-48,0,0),s=await i.open(n,[{id:"csv",label:"CSV (.csv)",icon:"table_chart"},{id:"json",label:"JSON (.table.json)",icon:"data_object"},{id:"sql",label:"SQL (.sql)",icon:"storage"}]);if(!s)return;const a=await t.store.tables.findOne(r.tableId);if(!a)return;const c=await t.ui.dialogs.choice(`Export "${a.name}" as ${s.toUpperCase()} — which rows/columns?`,["Visible Data","Raw Data","Structure Only"],"Export table");if(!c)return;const u=c==="Visible Data"?"visible":c==="Raw Data"?"raw":"structure";try{const p=await t.store.rows(a.id).find(),w=hp(a,u),b=fp(a,p,u),$=Tt(a.code||a.name||"table"),D=u!=="structure"&&a.source!=null&&p.length===0;if(s==="csv")D&&t.ui.dialogs.toast(`"${a.name}" is a live table with no local rows — exporting column definitions only.`,{kind:"warning",title:"Export"}),await t.backend.saveFile(`${$}.csv`,xo(w,b),"text/csv");else if(s==="json"){const P=JSON.stringify(Oo(w,b),null,2);await t.backend.saveFile(`${$}.table.json`,P,"application/json")}else s==="sql"&&(D&&t.ui.dialogs.toast(`"${a.name}" is a live table with no local rows — exporting the CREATE TABLE only.`,{kind:"warning",title:"Export"}),await t.backend.saveFile(`${$}.sql`,Cc(w,b),"application/sql"))}catch(p){t.ui.dialogs.toast(`Export failed: ${p.message}`,{kind:"error",title:"Export"})}}})}async function Gi(e){const t=e.workspaceId();if(!t)throw new Error("dump-export: no active workspace");const r=(await e.store.tables.find()).filter(a=>a.workspaceId===t),i=(await e.store.viewTemplates.find()).filter(a=>a.workspaceId===t),n=(await e.store.viewInstances.find()).filter(a=>a.workspaceId===t),s={workspaceId:t,exportedAt:Date.now(),tables:[],viewTemplates:i,viewInstances:n};for(const a of r){const c=await e.store.rows(a.id).find();s.tables.push({name:a.name,columns:a.columns,rows:c.map(u=>u.data),...a.title?{title:a.title}:{},...a.windowGeometry?{windowGeometry:a.windowGeometry}:{},...a.sortColumn?{sortColumn:a.sortColumn,sortAsc:a.sortAsc??!0}:{},...a.filters?{filters:a.filters}:{},...a.labelColumn?{labelColumn:a.labelColumn}:{},...a.info?{info:a.info}:{},...a.deletedColumns?{deletedColumns:a.deletedColumns}:{},...a.source?{source:a.source}:{},...a.origin?{origin:a.origin}:{}})}return JSON.stringify(s,null,2)}const gp=Object.freeze(Object.defineProperty({__proto__:null,init:mp,meta:pp,serializeWorkspace:Gi},Symbol.toStringTag,{value:"Module"})),bp={id:"gist-sync",name:"Gist Sync",type:"sync",version:"0.1.0",description:"Push and pull the current workspace to a private GitHub Gist.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/gist-sync.ts"},yp="gist:",il='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 .5C5.37.5 0 5.87 0 12.5c0 5.3 3.44 9.8 8.21 11.39.6.11.82-.26.82-.58 0-.29-.01-1.04-.02-2.05-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.75.08-.73.08-.73 1.21.09 1.84 1.24 1.84 1.24 1.07 1.84 2.81 1.31 3.5 1 .11-.78.42-1.31.76-1.61-2.67-.3-5.47-1.34-5.47-5.95 0-1.31.47-2.39 1.24-3.23-.12-.3-.54-1.53.12-3.18 0 0 1.01-.32 3.3 1.23a11.5 11.5 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.24 2.88.12 3.18.77.84 1.24 1.92 1.24 3.23 0 4.62-2.81 5.64-5.49 5.94.43.37.81 1.1.81 2.22 0 1.6-.01 2.9-.01 3.29 0 .32.22.7.83.58A12.01 12.01 0 0 0 24 12.5C24 5.87 18.63.5 12 .5z"/></svg>';function wp(e){e.ui.registerSettings("gist-sync","Gist Sync",[{key:"user",label:"GitHub user",type:"string",scope:"workspace",description:"GitHub username that owns the gist."},{key:"gist_id",label:"Gist ID",type:"string",scope:"workspace",description:"Leave empty to create a new gist on the first Push."},{key:"gist_token",label:"GitHub token (PAT)",type:"secret",scope:"user",description:'Personal access token with the "gist" scope. Stored on this device only (not synced).'}]),e.ui.registerFooterButton({id:"gist-sync:menu",label:"Gist",icon:il,tooltip:"Gist sync — push, pull, share…",onClick:async(t,r)=>{const{AnchoredMenu:i}=await ln(async()=>{const{AnchoredMenu:a}=await Promise.resolve().then(()=>zr);return{AnchoredMenu:a}},void 0),n=r?.anchor?.getBoundingClientRect()??new DOMRect(16,window.innerHeight-48,0,0),s=await i.open(n,[{id:"push",label:"Push",icon:"cloud_upload"},{id:"pull",label:"Pull",icon:"cloud_download"},{id:"share",label:"Share",icon:"share"},{id:"view",label:"View gist",icon:"open_in_new"}]);if(s)try{if(s==="push"||s==="pull"){const a=await i.open(n,[{id:"all",label:"Everything",icon:"sync"},{id:"data",label:"Data only (tables + rows)",icon:"table_rows"},{id:"settings",label:"Settings only (views + settings)",icon:"tune"}]);if(!a)return;const c=a;s==="push"?await Ep(t,c):await Ic(t,c)}else s==="share"?await kp(t):s==="view"&&await Cp(t)}catch(a){t.ui.dialogs.toast(`Gist ${s} failed: ${a.message}`,{kind:"error",title:"Gist sync"})}}}),e.ui.registerTableButton({id:"gist-sync:table",label:"Gist",icon:il,tooltip:"Gist sync for this table — push, pull, view file",onClick:async(t,r)=>{const{AnchoredMenu:i}=await ln(async()=>{const{AnchoredMenu:a}=await Promise.resolve().then(()=>zr);return{AnchoredMenu:a}},void 0),n=r.anchor?.getBoundingClientRect()??new DOMRect(16,window.innerHeight-48,0,0),s=await i.open(n,[{id:"push",label:"Push this table",icon:"cloud_upload"},{id:"pull",label:"Pull this table",icon:"cloud_download"},{id:"view",label:"View gist file",icon:"open_in_new"}]);if(s)try{s==="push"?await Sp(t,r.tableId):s==="pull"?await _p(t,r.tableId):s==="view"&&await Tp(t,r.tableId)}catch(a){t.ui.dialogs.toast(`Gist ${s} failed: ${a.message}`,{kind:"error",title:"Gist sync"})}}})}async function vp(e){const t=new URLSearchParams(location.hash.replace(/^#/,"")).get("gist");if(!t)return;history.replaceState(null,"",location.pathname+location.search);let r;try{r=atob(t)}catch{return}const i=xp(r);if(!i){await e.ui.dialogs.alert("The shared gist link is invalid.","Gist sync");return}await e.ui.dialogs.confirm(`Load shared workspace from gist ${i.gistId||"(new)"} (owner: ${i.user})?

This pulls its tables into the current workspace.`,"Gist sync")&&(await jo(e,i),await Ic(e))}async function Ac(e){const t=e.workspaceId();return`${yp}${t??"default"}`}async function Hr(e){const[t,r,i]=await Promise.all([e.settings.get("gist-sync","user"),e.settings.get("gist-sync","gist_id"),e.settings.get("gist-sync","gist_token")]);if(t&&i)return{user:t,gistId:r??"",token:i};const s=(await e.store.settings.findOne(await Ac(e)))?.value;if(s?.user&&s?.token){const a={user:s.user,gistId:s.gistId??"",token:s.token};return await jo(e,a),a}return null}async function jo(e,t){await e.settings.set("gist-sync","user",t.user),await e.settings.set("gist-sync","gist_id",t.gistId),await e.settings.set("gist-sync","gist_token",t.token),await e.store.settings.upsert({key:await Ac(e),value:t})}function xp(e){const t={};for(const r of e.split(";")){const i=r.indexOf("=");if(i<0)continue;const n=r.slice(0,i).trim(),s=r.slice(i+1).trim();n&&(t[n]=s)}return!t.user||!t.gist_token?null:{user:t.user,gistId:t.gist_id??"",token:t.gist_token}}async function zo(e){const t=await Hr(e);return t||(e.ui.dialogs.toast("Add your GitHub user and token in Settings → Gist Sync, then try again.",{kind:"warning",title:"Gist sync"}),e.ui.openSettings(),null)}function $p(e){return`user=${e.user};gist_id=${e.gistId};gist_token=${e.token}`}async function kp(e){const t=await Hr(e);if(!t||!t.gistId){await e.ui.dialogs.alert("Configure a gist and Push first — there is nothing to share yet.","Gist sync");return}const i=`${location.origin+location.pathname}#gist=${encodeURIComponent(btoa($p(t)))}`,{GistShareDialog:n}=await ln(async()=>{const{GistShareDialog:s}=await import("./gist-share-dialog-B7z5IGln.js");return{GistShareDialog:s}},[]);await n.open(i)}async function Cp(e){const t=await Hr(e);if(!t||!t.gistId){await e.ui.dialogs.alert("No gist configured yet — Push first.","Gist sync");return}window.open(`https://gist.github.com/${t.user}/${t.gistId}`,"_blank","noopener")}async function Ep(e,t="all"){const r=await zo(e);if(!r)return;const i=e.workspaceId();if(!i)throw new Error("no active workspace");const n=t!=="settings",s=t!=="data",a=(await e.store.tables.find()).filter(S=>S.workspaceId===i);if(n&&a.length===0){await e.ui.dialogs.alert("Nothing to push: the current workspace has no tables.","Gist sync");return}const c=1e8,u=1e7,p={},w=[],b=[];if(n)for(const S of a){const B=S.source!=null?[]:await e.store.rows(S.id).find(),q=JSON.stringify(Oo(S,B),null,2),Q=`${S.name} (${(q.length/1e6).toFixed(2)} MB)`;q.length>c?w.push(Q):q.length>u&&b.push(Q),p[`${Tt(S.name)}.table.json`]={content:q}}if(w.length>0||b.length>0){const S=[];if(w.length>0&&S.push(`Over Gist's 100 MB per-file limit — GitHub will REJECT these:
${w.join(`
 ...
 */let M={version:"4.16.1",date:"2022-11-03 09:18",ajaxAlwaysCallbacks:[],autopositionSpacing:4,closeOnEscape:(()=>{document.addEventListener("keydown",e=>{(e.key==="Escape"||e.code==="Escape"||e.key==="Esc")&&M.getPanels(t=>t.classList.contains("jsPanel")).some(t=>t.options.closeOnEscape?typeof t.options.closeOnEscape=="function"?t.options.closeOnEscape.call(t,t):(t.close(null,!0),!0):!1)},!1)})(),defaults:{boxShadow:3,container:"window",contentSize:{width:"400px",height:"200px"},dragit:{cursor:"move",handles:".jsPanel-headerlogo, .jsPanel-titlebar, .jsPanel-ftr",opacity:.8,disableOnMaximized:!0},header:!0,headerTitle:"jsPanel",headerControls:{size:"md"},iconfont:void 0,maximizedMargin:0,minimizeTo:"default",paneltype:"standard",position:{my:"center",at:"center"},resizeit:{handles:"n, e, s, w, ne, se, sw, nw",minWidth:128,minHeight:38},theme:"default"},defaultAutocloseConfig:{time:"8s",progressbar:!0},defaultSnapConfig:{sensitivity:70,trigger:"panel",active:"both"},extensions:{},globalCallbacks:!1,icons:{close:'<svg focusable="false" class="jsPanel-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path fill="currentColor" d="M13.7,11l6.1-6.1c0.4-0.4,0.4-0.9,0-1.3l-1.4-1.4c-0.4-0.4-0.9-0.4-1.3,0L11,8.3L4.9,2.3C4.6,1.9,4,1.9,3.7,2.3L2.3,3.7 C1.9,4,1.9,4.6,2.3,4.9L8.3,11l-6.1,6.1c-0.4,0.4-0.4,0.9,0,1.3l1.4,1.4c0.4,0.4,0.9,0.4,1.3,0l6.1-6.1l6.1,6.1 c0.4,0.4,0.9,0.4,1.3,0l1.4-1.4c0.4-0.4,0.4-0.9,0-1.3L13.7,11z"/></svg>',maximize:'<svg focusable="false" class="jsPanel-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path fill="currentColor" d="M18.3,2H3.7C2.8,2,2,2.9,2,3.9v14.1C2,19.1,2.8,20,3.7,20h14.6c0.9,0,1.7-0.9,1.7-1.9V3.9C20,2.9,19.2,2,18.3,2z M18.3,17.8 c0,0.1-0.1,0.2-0.2,0.2H3.9c-0.1,0-0.2-0.1-0.2-0.2V8.4h14.6V17.8z"/></svg>',normalize:'<svg focusable="false" class="jsPanel-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path fill="currentColor" d="M18.3,2H7.1C6.1,2,5.4,2.8,5.4,3.7v1.7H3.7C2.8,5.4,2,6.1,2,7.1v11.3C2,19.2,2.8,20,3.7,20h11.3c0.9,0,1.7-0.8,1.7-1.7v-1.7 h1.7c0.9,0,1.7-0.8,1.7-1.7V3.7C20,2.8,19.2,2,18.3,2z M14.9,18.3H3.7V11h11.3V18.3z M18.3,14.9h-1.7V7.1c0-0.9-0.8-1.7-1.7-1.7H7.1 V3.7h11.3V14.9z"/></svg>',minimize:'<svg focusable="false" class="jsPanel-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path fill="currentColor" d="M18.9,19.8H3.1c-0.6,0-1.1-0.5-1.1-1.1s0.5-1.1,1.1-1.1h15.8c0.6,0,1.1,0.5,1.1,1.1S19.5,19.8,18.9,19.8z"/></svg>',smallify:'<svg focusable="false" class="jsPanel-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22"><path fill="currentColor" d="M2.1,15.2L2.9,16c0.2,0.2,0.5,0.2,0.7,0L11,8.7l7.4,7.3c0.2,0.2,0.5,0.2,0.7,0l0.8-0.8c0.2-0.2,0.2-0.5,0-0.7L11.3,6 c-0.2-0.2-0.5-0.2-0.7,0l-8.5,8.5C2,14.7,2,15,2.1,15.2z"/></svg>'},idCounter:0,isIE:document.documentMode||!1,pointerdown:"onpointerdown"in window?["pointerdown"]:"ontouchend"in window?["touchstart","mousedown"]:["mousedown"],pointermove:"onpointermove"in window?["pointermove"]:"ontouchend"in window?["touchmove","mousemove"]:["mousemove"],pointerup:"onpointerup"in window?["pointerup"]:"ontouchend"in window?["touchend","mouseup"]:["mouseup"],polyfills:(()=>{Object.assign||Object.defineProperty(Object,"assign",{enumerable:!1,configurable:!0,writable:!0,value:function(e){if(e==null)throw new TypeError("Cannot convert first argument to object");let t=Object(e);for(let r=1;r<arguments.length;r++){let i=arguments[r];if(i==null)continue;i=Object(i);let n=Object.keys(Object(i));for(let s=0,a=n.length;s<a;s++){let c=n[s],u=Object.getOwnPropertyDescriptor(i,c);u!==void 0&&u.enumerable&&(t[c]=i[c])}}return t}}),Object.entries||(Object.entries=function(e){for(var t=Object.keys(e),r=t.length,i=new Array(r);r--;)i[r]=[t[r],e[t[r]]];return i}),window.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=function(e,t){t=t||window;for(let r=0;r<this.length;r++)e.call(t,this[r],r,this)}),(function(e){e.forEach(function(t){t.append=t.append||function(){let r=Array.prototype.slice.call(arguments),i=document.createDocumentFragment();r.forEach(function(n){let s=n instanceof Node;i.appendChild(s?n:document.createTextNode(String(n)))}),this.appendChild(i)}})})([Element.prototype,Document.prototype,DocumentFragment.prototype]),window.Element&&!Element.prototype.closest&&(Element.prototype.closest=function(e){let t=(this.document||this.ownerDocument).querySelectorAll(e),r,i=this;do for(r=t.length;--r>=0&&t.item(r)!==i;);while(r<0&&(i=i.parentElement));return i}),(function(){if(typeof window.CustomEvent=="function")return!1;function e(t,r){r=r||{bubbles:!1,cancelable:!1,detail:void 0};let i=document.createEvent("CustomEvent");return i.initCustomEvent(t,r.bubbles,r.cancelable,r.detail),i}e.prototype=window.Event.prototype,window.CustomEvent=e})(),String.prototype.endsWith||(String.prototype.endsWith=function(e,t){return(t===void 0||t>this.length)&&(t=this.length),this.substring(t-e.length,t)===e}),String.prototype.startsWith||Object.defineProperty(String.prototype,"startsWith",{value:function(e,t){var r=t>0?t|0:0;return this.substring(r,r+e.length)===e}}),String.prototype.includes||(String.prototype.includes=function(e,t){if(e instanceof RegExp)throw TypeError("first argument must not be a RegExp");return t===void 0&&(t=0),this.indexOf(e,t)!==-1}),String.prototype.repeat||(String.prototype.repeat=function(e){if(this==null)throw new TypeError("can't convert "+this+" to object");var t=""+this;if(e=+e,e!=e&&(e=0),e<0)throw new RangeError("repeat count must be non-negative");if(e==1/0)throw new RangeError("repeat count must be less than infinity");if(e=Math.floor(e),t.length==0||e==0)return"";if(t.length*e>=1<<28)throw new RangeError("repeat count must not overflow maximum string size");var r=t.length*e;for(e=Math.floor(Math.log(e)/Math.log(2));e;)t+=t,e--;return t+=t.substring(0,r-t.length),t}),Number.isInteger=Number.isInteger||function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e},Array.prototype.includes||Object.defineProperty(Array.prototype,"includes",{value:function(e,t){if(this==null)throw new TypeError('"this" is null or not defined');let r=Object(this),i=r.length>>>0;if(i===0)return!1;let n=t|0,s=Math.max(n>=0?n:i-Math.abs(n),0);function a(c,u){return c===u||typeof c=="number"&&typeof u=="number"&&isNaN(c)&&isNaN(u)}for(;s<i;){if(a(r[s],e))return!0;s++}return!1}})})(),ziBase:100,colorFilledLight:.81,colorFilledDark:.08,colorFilled:0,colorBrightnessThreshold:.55,colorNames:{default:"b0bec5",secondary:"b0bec5",primary:"01579b",info:"039be5",success:"2e7d32",warning:"f57f17",danger:"dd2c00",light:"e0e0e0",dark:"263238",aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"00ffff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000000",blanchedalmond:"ffebcd",blue:"0000ff",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"00ffff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgrey:"a9a9a9",darkgreen:"006400",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"ff00ff",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",grey:"808080",green:"008000",greenyellow:"adff2f",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgrey:"d3d3d3",lightgreen:"90ee90",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"778899",lightslategrey:"778899",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"00ff00",limegreen:"32cd32",linen:"faf0e6",magenta:"ff00ff",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370d8",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"d87093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"ff0000",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"ffffff",whitesmoke:"f5f5f5",yellow:"ffff00",yellowgreen:"9acd32",grey50:"fafafa",grey100:"f5f5f5",grey200:"eeeeee",grey300:"e0e0e0",grey400:"bdbdbd",grey500:"9e9e9e",grey600:"757575",grey700:"616161",grey800:"424242",grey900:"212121",gray50:"fafafa",gray100:"f5f5f5",gray200:"eeeeee",gray300:"e0e0e0",gray400:"bdbdbd",gray500:"9e9e9e",gray600:"757575",gray700:"616161",gray800:"424242",gray900:"212121",bluegrey50:"eceff1",bluegrey100:"CFD8DC",bluegrey200:"B0BEC5",bluegrey300:"90A4AE",bluegrey400:"78909C",bluegrey500:"607D8B",bluegrey600:"546E7A",bluegrey700:"455A64",bluegrey800:"37474F",bluegrey900:"263238",bluegray50:"eceff1",bluegray100:"CFD8DC",bluegray200:"B0BEC5",bluegray300:"90A4AE",bluegray400:"78909C",bluegray500:"607D8B",bluegray600:"546E7A",bluegray700:"455A64",bluegray800:"37474F",bluegray900:"263238",red50:"FFEBEE",red100:"FFCDD2",red200:"EF9A9A",red300:"E57373",red400:"EF5350",red500:"F44336",red600:"E53935",red700:"D32F2F",red800:"C62828",red900:"B71C1C",reda100:"FF8A80",reda200:"FF5252",reda400:"FF1744",reda700:"D50000",pink50:"FCE4EC",pink100:"F8BBD0",pink200:"F48FB1",pink300:"F06292",pink400:"EC407A",pink500:"E91E63",pink600:"D81B60",pink700:"C2185B",pink800:"AD1457",pink900:"880E4F",pinka100:"FF80AB",pinka200:"FF4081",pinka400:"F50057",pinka700:"C51162",purple50:"F3E5F5",purple100:"E1BEE7",purple200:"CE93D8",purple300:"BA68C8",purple400:"AB47BC",purple500:"9C27B0",purple600:"8E24AA",purple700:"7B1FA2",purple800:"6A1B9A",purple900:"4A148C",purplea100:"EA80FC",purplea200:"E040FB",purplea400:"D500F9",purplea700:"AA00FF",deeppurple50:"EDE7F6",deeppurple100:"D1C4E9",deeppurple200:"B39DDB",deeppurple300:"9575CD",deeppurple400:"7E57C2",deeppurple500:"673AB7",deeppurple600:"5E35B1",deeppurple700:"512DA8",deeppurple800:"4527A0",deeppurple900:"311B92",deeppurplea100:"B388FF",deeppurplea200:"7C4DFF",deeppurplea400:"651FFF",deeppurplea700:"6200EA",indigo50:"E8EAF6",indigo100:"C5CAE9",indigo200:"9FA8DA",indigo300:"7986CB",indigo400:"5C6BC0",indigo500:"3F51B5",indigo600:"3949AB",indigo700:"303F9F",indigo800:"283593",indigo900:"1A237E",indigoa100:"8C9EFF",indigoa200:"536DFE",indigoa400:"3D5AFE",indigoa700:"304FFE",blue50:"E3F2FD",blue100:"BBDEFB",blue200:"90CAF9",blue300:"64B5F6",blue400:"42A5F5",blue500:"2196F3",blue600:"1E88E5",blue700:"1976D2",blue800:"1565C0",blue900:"0D47A1",bluea100:"82B1FF",bluea200:"448AFF",bluea400:"2979FF",bluea700:"2962FF",lightblue50:"E1F5FE",lightblue100:"B3E5FC",lightblue200:"81D4FA",lightblue300:"4FC3F7",lightblue400:"29B6F6",lightblue500:"03A9F4",lightblue600:"039BE5",lightblue700:"0288D1",lightblue800:"0277BD",lightblue900:"01579B",lightbluea100:"80D8FF",lightbluea200:"40C4FF",lightbluea400:"00B0FF",lightbluea700:"0091EA",cyan50:"E0F7FA",cyan100:"B2EBF2",cyan200:"80DEEA",cyan300:"4DD0E1",cyan400:"26C6DA",cyan500:"00BCD4",cyan600:"00ACC1",cyan700:"0097A7",cyan800:"00838F",cyan900:"006064",cyana100:"84FFFF",cyana200:"18FFFF",cyana400:"00E5FF",cyana700:"00B8D4",teal50:"E0F2F1",teal100:"B2DFDB",teal200:"80CBC4",teal300:"4DB6AC",teal400:"26A69A",teal500:"009688",teal600:"00897B",teal700:"00796B",teal800:"00695C",teal900:"004D40",teala100:"A7FFEB",teala200:"64FFDA",teala400:"1DE9B6",teala700:"00BFA5",green50:"E8F5E9",green100:"C8E6C9",green200:"A5D6A7",green300:"81C784",green400:"66BB6A",green500:"4CAF50",green600:"43A047",green700:"388E3C",green800:"2E7D32",green900:"1B5E20",greena100:"B9F6CA",greena200:"69F0AE",greena400:"00E676",greena700:"00C853",lightgreen50:"F1F8E9",lightgreen100:"DCEDC8",lightgreen200:"C5E1A5",lightgreen300:"AED581",lightgreen400:"9CCC65",lightgreen500:"8BC34A",lightgreen600:"7CB342",lightgreen700:"689F38",lightgreen800:"558B2F",lightgreen900:"33691E",lightgreena100:"CCFF90",lightgreena200:"B2FF59",lightgreena400:"76FF03",lightgreena700:"64DD17",lime50:"F9FBE7",lime100:"F0F4C3",lime200:"E6EE9C",lime300:"DCE775",lime400:"D4E157",lime500:"CDDC39",lime600:"C0CA33",lime700:"AFB42B",lime800:"9E9D24",lime900:"827717",limea100:"F4FF81",limea200:"EEFF41",limea400:"C6FF00",limea700:"AEEA00",yellow50:"FFFDE7",yellow100:"FFF9C4",yellow200:"FFF59D",yellow300:"FFF176",yellow400:"FFEE58",yellow500:"FFEB3B",yellow600:"FDD835",yellow700:"FBC02D",yellow800:"F9A825",yellow900:"F57F17",yellowa100:"FFFF8D",yellowa200:"FFFF00",yellowa400:"FFEA00",yellowa700:"FFD600",amber50:"FFF8E1",amber100:"FFECB3",amber200:"FFE082",amber300:"FFD54F",amber400:"FFCA28",amber500:"FFC107",amber600:"FFB300",amber700:"FFA000",amber800:"FF8F00",amber900:"FF6F00",ambera100:"FFE57F",ambera200:"FFD740",ambera400:"FFC400",ambera700:"FFAB00",orange50:"FFF3E0",orange100:"FFE0B2",orange200:"FFCC80",orange300:"FFB74D",orange400:"FFA726",orange500:"FF9800",orange600:"FB8C00",orange700:"F57C00",orange800:"EF6C00",orange900:"E65100",orangea100:"FFD180",orangea200:"FFAB40",orangea400:"FF9100",orangea700:"FF6D00",deeporange50:"FBE9E7",deeporange100:"FFCCBC",deeporange200:"FFAB91",deeporange300:"FF8A65",deeporange400:"FF7043",deeporange500:"FF5722",deeporange600:"F4511E",deeporange700:"E64A19",deeporange800:"D84315",deeporange900:"BF360C",deeporangea100:"FF9E80",deeporangea200:"FF6E40",deeporangea400:"FF3D00",deeporangea700:"DD2C00",brown50:"EFEBE9",brown100:"D7CCC8",brown200:"BCAAA4",brown300:"A1887F",brown400:"8D6E63",brown500:"795548",brown600:"6D4C41",brown700:"5D4037",brown800:"4E342E",brown900:"3E2723","mdb-default":"2BBBAD","mdb-default-dark":"00695c","mdb-primary":"4285F4","mdb-primary-dark":"0d47a1","mdb-secondary":"aa66cc","mdb-secondary-dark":"9933CC","mdb-danger":"ff4444","mdb-danger-dark":"CC0000","mdb-warning":"ffbb33","mdb-warning-dark":"FF8800","mdb-success":"00C851","mdb-success-dark":"007E33","mdb-info":"33b5e5","mdb-info-dark":"0099CC","mdb-elegant":"2E2E2E","mdb-elegant-dark":"212121","mdb-stylish":"4B515D","mdb-stylish-dark":"3E4551","mdb-unique":"3F729B","mdb-unique-dark":"1C2331","mdb-special":"37474F","mdb-special-dark":"263238"},errorReporting:1,modifier:!1,helper:(()=>{document.addEventListener("keydown",e=>M.modifier=e),document.addEventListener("keyup",()=>M.modifier=!1)})(),usePointerEvents(e=!0){e?(this.pointerdown="onpointerdown"in window?["pointerdown"]:"ontouchend"in window?["touchstart","mousedown"]:["mousedown"],this.pointermove="onpointermove"in window?["pointermove"]:"ontouchend"in window?["touchmove","mousemove"]:["mousemove"],this.pointerup="onpointerup"in window?["pointerup"]:"ontouchend"in window?["touchend","mouseup"]:["mouseup"]):(this.pointerdown="ontouchend"in window?["touchstart","mousedown"]:["mousedown"],this.pointermove="ontouchend"in window?["touchmove","mousemove"]:["mousemove"],this.pointerup="ontouchend"in window?["touchend","mouseup"]:["mouseup"])},pOcontainer(e){if(e==="window")return document.body;if(typeof e=="string"){let t=document.querySelectorAll(e);return t.length&&t.length>0?t:!1}else{if(e.nodeType===1)return e;if(e.length)return e[0]}return!1},pOcontainment(e){let t=e;if(typeof e=="function"&&(t=e()),typeof t=="number")return[t,t,t,t];if(Array.isArray(t)){if(t.length===1)return[t[0],t[0],t[0],t[0]];if(t.length===2)return t.concat(t);t.length===3&&(t[3]=t[1])}return t},pOsize(e,t){let r=t||this.defaults.contentSize;const i=e.parentElement;if(typeof r=="string"){const n=r.trim().split(" ");r={},r.width=n[0],n.length===2?r.height=n[1]:r.height=n[0]}else r.width&&!r.height?r.height=r.width:r.height&&!r.width&&(r.width=r.height);if(String(r.width).match(/^[\d.]+$/gi))r.width+="px";else if(typeof r.width=="string"&&r.width.endsWith("%"))if(i===document.body)r.width=window.innerWidth*(parseFloat(r.width)/100)+"px";else{const n=window.getComputedStyle(i),s=parseFloat(n.borderLeftWidth)+parseFloat(n.borderRightWidth);r.width=(parseFloat(n.width)-s)*(parseFloat(r.width)/100)+"px"}else typeof r.width=="function"&&(r.width=r.width.call(e,e),(typeof r.width=="number"||typeof r.width=="string"&&r.width.match(/^[\d.]+$/gi))&&(r.width+="px"));if(String(r.height).match(/^[\d.]+$/gi))r.height+="px";else if(typeof r.height=="string"&&r.height.endsWith("%"))if(i===document.body)r.height=window.innerHeight*(parseFloat(r.height)/100)+"px";else{const n=window.getComputedStyle(i),s=parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth);r.height=(parseFloat(n.height)-s)*(parseFloat(r.height)/100)+"px"}else typeof r.height=="function"&&(r.height=r.height.call(e,e),(typeof r.height=="number"||typeof r.height=="string"&&r.height.match(/^[\d.]+$/gi))&&(r.height+="px"));return r},pOborder(e){let t=[],r=e.trim().replace(/\s*\(\s*/g,"(").replace(/\s*\)/g,")").replace(/\s+/g," ").split(" ");return r.forEach((i,n)=>{(i.startsWith("--")||i.startsWith("var"))&&(r[n]=M.getCssVariableValue(i))}),r.forEach(i=>{M.colorNames[i]?t[2]="#"+M.colorNames[i]:i.match(/(none|hidden|dotted|dashed|solid|double|groove|ridge|inset|outset)/)?t[1]=i:i.match(/(thin|medium|thick)|(\d*\.?\d*(cap|ch|em|ex|ic|lh|rem|rlh|vh|vw|vmax|vmin|vb|vi|px|cm|mm|Q|in|pc|pt))/)?t[0]=i:t[2]=i}),t[0]||(t[0]="medium"),t[1]||(t[1]="solid"),t[2]||(t[2]=""),t},pOheaderControls(e){if(typeof e=="string"){let t={},r=e.toLowerCase(),i=r.match(/xl|lg|md|sm|xs/),n=r.match(/closeonly|none/);return i&&(t.size=i[0]),n&&(t=Object.assign({},t,{maximize:"remove",normalize:"remove",minimize:"remove",smallify:"remove"}),n[0]==="none"&&(t.close="remove")),Object.assign({},this.defaults.headerControls,t)}else return Object.assign({},this.defaults.headerControls,e)},pOtheme(e){e=e.trim();let t,r="";if(e.match(/^(rgb|hsl|var)/)){let i=e.indexOf(")");t=e.slice(0,i+1).replace(/\s+/g,""),t.startsWith("var")&&(t=M.getCssVariableValue(t)),r=e.slice(i+1,e.length).trim()}else if(e.match(/^(#|\w|--)/)){let i=e.indexOf(" ");i>0?(t=e.slice(0,i+1).replace(/\s+/g,""),r=e.slice(i+1,e.length).trim()):t=e,t.startsWith("--")&&(t=M.getCssVariableValue(t))}if(t.match(/^([\da-f]{3}|[\da-f]{6})$/gi)&&(t="#"+t),r.startsWith("fillcolor")){let i=r.indexOf(" ");r=r.slice(i+1,r.length).trim().replace(/\s+/g,""),r.match(/^([\da-f]{3}|[\da-f]{6})$/gi)?r="#"+r:M.colorNames[r]?r="#"+M.colorNames[r]:r.match(/^(--|var)/)?r=M.getCssVariableValue(r):r="#fff"}return{color:t,colors:!1,filling:r}},color(e){let t=e.toLowerCase(),r,i,n,s,a,c,u,p,w,b={};const $=/^#?([\da-f]{3}|[\da-f]{6})$/gi,D=/^rgba?\((\d{1,3}),(\d{1,3}),(\d{1,3}),?(0|1|0\.\d{1,2}|\.\d{1,2})?\)$/gi,P=/^hsla?\((\d{1,3}),(\d{1,3}%),(\d{1,3}%),?(0|1|0\.\d{1,2}|\.\d{1,2})?\)$/gi,S=this.colorNames;return S[t]&&(t=S[t]),t.match($)!==null?(t=t.replace("#",""),t.length%2===1?(r=t.slice(0,1).repeat(2),i=t.slice(1,2).repeat(2),n=t.slice(2,3).repeat(2),b.rgb={r:parseInt(r,16),g:parseInt(i,16),b:parseInt(n,16)},b.hex=`#${r}${i}${n}`):(b.rgb={r:parseInt(t.slice(0,2),16),g:parseInt(t.slice(2,4),16),b:parseInt(t.slice(4,6),16)},b.hex=`#${t}`),w=this.rgbToHsl(b.rgb.r,b.rgb.g,b.rgb.b),b.hsl=w,b.rgb.css=`rgb(${b.rgb.r},${b.rgb.g},${b.rgb.b})`):t.match(D)?(u=D.exec(t),b.rgb={css:t,r:u[1],g:u[2],b:u[3]},b.hex=this.rgbToHex(u[1],u[2],u[3]),w=this.rgbToHsl(u[1],u[2],u[3]),b.hsl=w):t.match(P)?(u=P.exec(t),s=u[1]/360,a=u[2].slice(0,u[2].length-1)/100,c=u[3].slice(0,u[3].length-1)/100,p=this.hslToRgb(s,a,c),b.rgb={css:`rgb(${p[0]},${p[1]},${p[2]})`,r:p[0],g:p[1],b:p[2]},b.hex=this.rgbToHex(b.rgb.r,b.rgb.g,b.rgb.b),b.hsl={css:`hsl(${u[1]},${u[2]},${u[3]})`,h:u[1],s:u[2],l:u[3]}):(b.hex="#f5f5f5",b.rgb={css:"rgb(245,245,245)",r:245,g:245,b:245},b.hsl={css:"hsl(0,0%,96%)",h:0,s:"0%",l:"96%"}),b},calcColors(e){const t=this.colorBrightnessThreshold,r=this.color(e),i=this.lighten(e,this.colorFilledLight),n=this.darken(e,this.colorFilled),s=this.perceivedBrightness(e)<=t?"#ffffff":"#000000",a=this.perceivedBrightness(i)<=t?"#ffffff":"#000000",c=this.perceivedBrightness(n)<=t?"#ffffff":"#000000",u=this.lighten(e,this.colorFilledDark),p=this.perceivedBrightness(u)<=t?"#ffffff":"#000000";return[r.hsl.css,i,n,s,a,c,u,p]},darken(e,t){const r=this.color(e).hsl,i=parseFloat(r.l),n=Math.round(i-i*t)+"%";return`hsl(${r.h},${r.s},${n})`},lighten(e,t){const r=this.color(e).hsl,i=parseFloat(r.l),n=Math.round(i+(100-i)*t)+"%";return`hsl(${r.h},${r.s},${n})`},hslToRgb(e,t,r){let i,n,s;if(t===0)i=n=s=r;else{let a=(p,w,b)=>(b<0&&(b+=1),b>1&&(b-=1),b<.16666666666666666?p+(w-p)*6*b:b<.5?w:b<.6666666666666666?p+(w-p)*(.6666666666666666-b)*6:p),c=r<.5?r*(1+t):r+t-r*t,u=2*r-c;i=a(u,c,e+1/3),n=a(u,c,e),s=a(u,c,e-1/3)}return[Math.round(i*255),Math.round(n*255),Math.round(s*255)]},rgbToHsl(e,t,r){e/=255,t/=255,r/=255;let i=Math.max(e,t,r),n=Math.min(e,t,r),s,a,c=(i+n)/2;if(i===n)s=a=0;else{let u=i-n;switch(a=c>.5?u/(2-i-n):u/(i+n),i){case e:s=(t-r)/u+(t<r?6:0);break;case t:s=(r-e)/u+2;break;case r:s=(e-t)/u+4;break}s/=6}return s=Math.round(s*360),a=Math.round(a*100)+"%",c=Math.round(c*100)+"%",{css:"hsl("+s+","+a+","+c+")",h:s,s:a,l:c}},rgbToHex(e,t,r){let i=Number(e).toString(16),n=Number(t).toString(16),s=Number(r).toString(16);return i.length===1&&(i=`0${i}`),n.length===1&&(n=`0${n}`),s.length===1&&(s=`0${s}`),`#${i}${n}${s}`},perceivedBrightness(e){const t=this.color(e).rgb;return t.r/255*.2126+t.g/255*.7152+t.b/255*.0722},pOposition(e){let t={},r=e.trim().split(/\s+/),i=r.filter(a=>a.match(/^(down|right|up|left)$/i));i.length&&(t.autoposition=i[0],r.splice(r.indexOf(i[0]),1));let n=r.filter(a=>a.match(/^(left-|right-)(top|center|bottom)$|(^center-)(top|bottom)$|(^center$)/i));n.length?(t.my=n[0],t.at=n[1]||n[0],r.splice(r.indexOf(n[0]),1),n[1]&&r.splice(r.indexOf(n[1]),1)):(t.my="center",t.at="center");let s=r.filter(a=>a.match(/^[+-]?\d*\.?\d+[a-z%]*$/i));return s.length&&(t.offsetX=s[0].match(/^[+-]?\d*\.?\d+$/i)?`${s[0]}px`:s[0],s[1]?t.offsetY=s[1].match(/^[+-]?\d*\.?\d+$/i)?`${s[1]}px`:s[1]:t.offsetY=t.offsetX,r.splice(r.indexOf(s[0]),1),s[1]&&r.splice(r.indexOf(s[1]),1)),r.length&&(t.of=r.join(" ")),t},position(e,t){if(!t)return e.style.opacity=1,e;typeof t=="string"?t=Object.assign({},this.defaults.position,this.pOposition(t)):t=Object.assign({},this.defaults.position,t),["my","at","of"].forEach(S=>{typeof t[S]=="function"&&(t[S]=t[S].call(e,e))}),e.options.container==="window"&&(e.style.position="fixed"),typeof e=="string"?e=document.querySelector(e):Object.getPrototypeOf(e).jquery&&(e=e[0]);const r=e.options.container==="window"?"window":e.parentElement,i=e.getBoundingClientRect(),n=e.parentElement.getBoundingClientRect(),s=r==="window"?{left:0,top:0,width:document.documentElement.clientWidth,height:window.innerHeight}:{width:n.width,height:n.height,left:n.left,top:n.top},a=r==="window"?{x:1,y:1}:{x:s.width/r.offsetWidth,y:s.height/r.offsetHeight},c=r==="window"?{borderTopWidth:"0px",borderRightWidth:"0px",borderBottomWidth:"0px",borderLeftWidth:"0px"}:window.getComputedStyle(r);s.width-=(parseFloat(c.borderLeftWidth)+parseFloat(c.borderRightWidth))*a.x,s.height-=(parseFloat(c.borderTopWidth)+parseFloat(c.borderBottomWidth))*a.y;let u;t.of?typeof t.of=="string"?u=t.of==="window"?{borderTopWidth:"0px",borderRightWidth:"0px",borderBottomWidth:"0px",borderLeftWidth:"0px"}:document.querySelector(t.of).getBoundingClientRect():Object.getPrototypeOf(t.of).jquery?u=t.of[0].getBoundingClientRect():u=t.of.getBoundingClientRect():u=s;let p=this.getScrollbarWidth(document.body),w=this.getScrollbarWidth(e.parentElement),b="0px";t.my.startsWith("left-")?t.at.startsWith("left-")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)+"px":b="0px":t.at.startsWith("center")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)+u.width/2+"px":b=s.width/2+"px":t.at.startsWith("right-")&&(t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)+u.width+"px":b=s.width+"px"):t.my.startsWith("center")?t.at.startsWith("left-")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)-i.width/2+"px":b=-i.width/2+"px":t.at.startsWith("center")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)-(i.width-u.width)/2+"px":b=s.width/2-i.width/2+"px":t.at.startsWith("right-")&&(t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)+(u.width-i.width/2)+"px":b=s.width-i.width/2+"px"):t.my.startsWith("right-")&&(t.at.startsWith("left-")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)-i.width+"px":b=-i.width+"px":t.at.startsWith("center")?t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)-i.width+u.width/2+"px":b=s.width/2-i.width+"px":t.at.startsWith("right-")&&(t.of?b=u.left-s.left-parseFloat(c.borderLeftWidth)+u.width-i.width+"px":b=s.width-i.width+"px",r!=="window"&&(b=parseFloat(b)-w.y+"px")));let $="0px";t.my.endsWith("-top")?t.at.endsWith("-top")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)+"px":$="0px":t.at.endsWith("center")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)+u.height/2+"px":$=s.height/2+"px":t.at.endsWith("-bottom")&&(t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)+u.height+"px":$=s.height+"px"):t.my.endsWith("center")?t.at.endsWith("-top")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height/2+"px":$=-i.height/2+"px":t.at.endsWith("center")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height/2+u.height/2+"px":$=s.height/2-i.height/2+"px":t.at.endsWith("-bottom")&&(t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height/2+u.height+"px":$=s.height-i.height/2+"px"):t.my.endsWith("-bottom")&&(t.at.endsWith("-top")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height+"px":$=-i.height+"px":t.at.endsWith("center")?t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height+u.height/2+"px":$=s.height/2-i.height+"px":t.at.endsWith("-bottom")&&(t.of?$=u.top-s.top-parseFloat(c.borderTopWidth)-i.height+u.height+"px":$=s.height-i.height+"px",r!=="window"?$=parseFloat($)-w.x+"px":$=parseFloat($)-p.x+"px")),e.style.left=a.x===1?b:parseFloat(b)/a.x+"px",e.style.top=a.y===1?$:parseFloat($)/a.y+"px";let D=getComputedStyle(e),P={left:D.left,top:D.top};return t.autoposition&&t.my===t.at&&["left-top","center-top","right-top","left-bottom","center-bottom","right-bottom"].indexOf(t.my)>=0&&(P=this.applyPositionAutopos(e,P,t)),(t.offsetX||t.offsetY)&&(P=this.applyPositionOffset(e,P,t)),(t.minLeft||t.minTop||t.maxLeft||t.maxTop)&&(P=this.applyPositionMinMax(e,P,t)),t.modify&&(P=this.applyPositionModify(e,P,t)),typeof e.options.opacity=="number"?e.style.opacity=e.options.opacity:e.style.opacity=1,e},applyPositionAutopos(e,t,r){const i=`${r.my}-${r.autoposition.toLowerCase()}`;e.classList.add(i);const n=Array.prototype.slice.call(document.querySelectorAll(`.${i}`)),s=n.indexOf(e);if(n.length>1){switch(r.autoposition){case"down":n.forEach((a,c)=>{c>0&&c<=s&&(t.top=parseFloat(t.top)+n[--c].getBoundingClientRect().height+M.autopositionSpacing+"px")});break;case"up":n.forEach((a,c)=>{c>0&&c<=s&&(t.top=parseFloat(t.top)-n[--c].getBoundingClientRect().height-M.autopositionSpacing+"px")});break;case"right":n.forEach((a,c)=>{c>0&&c<=s&&(t.left=parseFloat(t.left)+n[--c].getBoundingClientRect().width+M.autopositionSpacing+"px")});break;case"left":n.forEach((a,c)=>{c>0&&c<=s&&(t.left=parseFloat(t.left)-n[--c].getBoundingClientRect().width-M.autopositionSpacing+"px")});break}e.style.left=t.left,e.style.top=t.top}return{left:t.left,top:t.top}},applyPositionOffset(e,t,r){["offsetX","offsetY"].forEach(n=>{r[n]?(typeof r[n]=="function"&&(r[n]=r[n].call(t,t,r)),isNaN(r[n])===!1&&(r[n]=`${r[n]}px`)):r[n]="0px"}),e.style.left=`calc(${e.style.left} + ${r.offsetX})`,e.style.top=`calc(${e.style.top} + ${r.offsetY})`;const i=getComputedStyle(e);return{left:i.left,top:i.top}},applyPositionMinMax(e,t,r){if(["minLeft","minTop","maxLeft","maxTop"].forEach(n=>{r[n]&&(typeof r[n]=="function"&&(r[n]=r[n].call(t,t,r)),(Number.isInteger(r[n])||r[n].match(/^\d+$/))&&(r[n]=`${r[n]}px`))}),r.minLeft){e.style.left=r.minLeft;let n=getComputedStyle(e).left;parseFloat(n)<parseFloat(t.left)?e.style.left=t.left:t.left=n}if(r.minTop){e.style.top=r.minTop;let n=getComputedStyle(e).top;parseFloat(n)<parseFloat(t.top)?e.style.top=t.top:t.top=n}if(r.maxLeft){e.style.left=r.maxLeft;let n=getComputedStyle(e).left;parseFloat(n)>parseFloat(t.left)?e.style.left=t.left:t.left=n}if(r.maxTop){e.style.top=r.maxTop;let n=getComputedStyle(e).top;parseFloat(n)>parseFloat(t.top)?e.style.top=t.top:t.top=n}const i=getComputedStyle(e);return{left:i.left,top:i.top}},applyPositionModify(e,t,r){if(r.modify&&typeof r.modify=="function"){const n=r.modify.call(t,t,r);e.style.left=Number.isInteger(n.left)||n.left.match(/^\d+$/)?`${n.left}px`:n.left,e.style.top=Number.isInteger(n.top)||n.top.match(/^\d+$/)?`${n.top}px`:n.top}const i=getComputedStyle(e);return{left:i.left,top:i.top}},autopositionRemaining(e){let t,r=e.options.container;["left-top-down","left-top-right","center-top-down","right-top-down","right-top-left","left-bottom-up","left-bottom-right","center-bottom-up","right-bottom-up","right-bottom-left"].forEach(i=>{e.classList.contains(i)&&(t=i)}),t&&(r==="window"?document.body:typeof r=="string"?document.querySelector(r):r).querySelectorAll(`.${t}`).forEach(n=>n.reposition())},getThemeDetails(e){const t=this.pOtheme(e);if(t.color.startsWith("bootstrap-")){let r=t.color.indexOf("-"),i=document.createElement("button");i.className="btn btn"+t.color.slice(r),document.body.appendChild(i),t.color=getComputedStyle(i).backgroundColor.replace(/\s+/gi,""),document.body.removeChild(i),i=void 0}return t.colors=this.calcColors(t.color),t},clearTheme(e,t){return e.content.classList.remove("jsPanel-content-filled","jsPanel-content-filledlight"),e.header.classList.remove("jsPanel-hdr-light"),e.header.classList.remove("jsPanel-hdr-dark"),e.style.backgroundColor="",this.setStyles(e.headertoolbar,{boxShadow:"",width:"",marginLeft:"",borderTopColor:"transparent"}),this.setStyles(e.content,{background:"",borderTopColor:"transparent"}),e.header.style.background="",Array.prototype.slice.call(e.controlbar.querySelectorAll(".jsPanel-icon")).concat([e.headerlogo,e.headertitle,e.headertoolbar,e.content]).forEach(r=>r.style.color=""),t&&t.call(e,e),e},applyColorTheme(e,t){if(e.style.backgroundColor=t.colors[0],e.header.style.backgroundColor=t.colors[0],e.header.style.color=t.colors[3],[".jsPanel-headerlogo",".jsPanel-title",".jsPanel-hdr-toolbar"].forEach(r=>e.querySelector(r).style.color=t.colors[3]),e.querySelectorAll(".jsPanel-controlbar .jsPanel-btn").forEach(r=>r.style.color=t.colors[3]),typeof e.options.theme=="string"&&t.filling==="filled"&&(e.content.style.borderTop=t.colors[3]==="#000000"?"1px solid rgba(0,0,0,0.15)":"1px solid rgba(255,255,255,0.15)"),t.colors[3]==="#000000"?e.header.classList.add("jsPanel-hdr-light"):e.header.classList.add("jsPanel-hdr-dark"),t.filling)switch(t.filling){case"filled":this.setStyles(e.content,{backgroundColor:t.colors[2],color:t.colors[3]});break;case"filledlight":e.content.style.backgroundColor=t.colors[1];break;case"filleddark":this.setStyles(e.content,{backgroundColor:t.colors[6],color:t.colors[7]});break;default:e.content.style.backgroundColor=t.filling,e.content.style.color=this.perceivedBrightness(t.filling)<=this.colorBrightnessThreshold?"#fff":"#000"}return e},applyCustomTheme(e,t){let r={bgPanel:"#ffffff",bgContent:"#ffffff",bgFooter:"#f5f5f5",colorHeader:"#000000",colorContent:"#000000",colorFooter:"#000000",border:void 0,borderRadius:void 0},i=typeof t=="object"?Object.assign(r,t):r,n=i.bgPanel,s=i.bgContent,a=i.colorHeader,c=i.colorContent,u=i.bgFooter,p=i.colorFooter;return this.colorNames[n]?e.style.background="#"+this.colorNames[n]:e.style.background=this.getCssVariableValue(n),this.colorNames[a]&&(a="#"+this.colorNames[a]),[".jsPanel-headerlogo",".jsPanel-title",".jsPanel-hdr-toolbar"].forEach($=>e.querySelector($).style.color=this.getCssVariableValue(a)),e.querySelectorAll(".jsPanel-controlbar .jsPanel-btn").forEach($=>$.style.color=this.getCssVariableValue(a)),this.colorNames[s]?e.content.style.background="#"+this.colorNames[s]:e.content.style.background=this.getCssVariableValue(s),this.colorNames[c]?e.content.style.color="#"+this.colorNames[c]:e.content.style.color=this.getCssVariableValue(c),this.perceivedBrightness(a)>this.colorBrightnessThreshold?e.header.classList.add("jsPanel-hdr-dark"):e.header.classList.add("jsPanel-hdr-light"),this.perceivedBrightness(c)>this.colorBrightnessThreshold?e.content.style.borderTop="1px solid rgba(255,255,255,0.15)":e.content.style.borderTop="1px solid rgba(0,0,0,0.15)",this.colorNames[u]?e.footer.style.background="#"+this.colorNames[u]:e.footer.style.background=this.getCssVariableValue(u),this.colorNames[p]?e.footer.style.color="#"+this.colorNames[p]:e.footer.style.color=this.getCssVariableValue(p),i.border&&e.setBorder(i.border),i.borderRadius&&(e.options.borderRadius=void 0,e.setBorderRadius(i.borderRadius)),e},getCssVariableValue(e){if(e.startsWith("--"))return getComputedStyle(document.documentElement).getPropertyValue(e).replace(/\s+/g,"");if(e.startsWith("var")){let t=e.slice(e.indexOf("(")+1,e.indexOf(")"));return getComputedStyle(document.documentElement).getPropertyValue(t).replace(/\s+/g,"")}return e},getScrollbarWidth(e=document.body){if(e===document.body)return{y:window.innerWidth-document.documentElement.clientWidth,x:window.innerHeight-document.documentElement.clientHeight};{let t=getComputedStyle(e);return{y:e.offsetWidth-e.clientWidth-parseFloat(t.borderRightWidth)-parseFloat(t.borderLeftWidth),x:e.offsetHeight-e.clientHeight-parseFloat(t.borderBottomWidth)-parseFloat(t.borderTopWidth)}}},remClass(e,t){return t.trim().split(/\s+/).forEach(r=>e.classList.remove(r)),e},setClass(e,t){return t.trim().split(/\s+/).forEach(r=>e.classList.add(r)),e},setStyles(e,t){for(const[r,i]of Object.entries(t))e.style[r]=typeof i=="string"?M.getCssVariableValue(i):i;return e},setStyle(e,t){return this.setStyles.call(e,e,t)},strToHtml(e){return document.createRange().createContextualFragment(e)},toggleClass(e,t){return t.trim().split(/\s+/).forEach(r=>e.classList.contains(r)?e.classList.remove(r):e.classList.add(r)),e},emptyNode(e){for(;e.firstChild;)e.removeChild(e.firstChild);return e},addScript(e,t="application/javascript",r){if(!document.querySelector(`script[src="${e}"]`)){const i=document.createElement("script");i.src=e,i.type=t,document.head.appendChild(i),r&&(i.onload=r)}},ajax(e,t){let r,i,n=new XMLHttpRequest;const s={method:"GET",async:!0,user:"",pwd:"",done:function(){if(t){let a=M.strToHtml(this.responseText);r.urlSelector&&(a=a.querySelector(r.urlSelector)),t.contentRemove(),t.content.append(a)}},autoresize:!0,autoreposition:!0};if(t&&typeof e=="string")r=Object.assign({},s,{url:e});else if(typeof e=="object"&&e.url)r=Object.assign({},s,e),r.url=e.url,r.async===!1&&(r.timeout=0,r.withCredentials&&(r.withCredentials=void 0),r.responseType&&(r.responseType=void 0));else{this.errorReporting&&M.errorpanel("XMLHttpRequest seems to miss the <mark>url</mark> parameter!");return}i=r.url.trim().split(/\s+/),r.url=encodeURI(i[0]),i.length>1&&(i.shift(),r.urlSelector=i.join(" ")),n.onreadystatechange=()=>{n.readyState===4&&(n.status===200?t?r.done.call(n,n,t):r.done.call(n,n):r.fail&&(t?r.fail.call(n,n,t):r.fail.call(n,n)),r.always&&(t?r.always.call(n,n,t):r.always.call(n,n)),t&&(r.autoresize||r.autoreposition)&&M.ajaxAutoresizeAutoreposition(t,r),M.ajaxAlwaysCallbacks.length&&M.ajaxAlwaysCallbacks.forEach(a=>{t?a.call(n,n,t):a.call(n,n)}))},n.open(r.method,r.url,r.async,r.user,r.pwd),n.timeout=r.timeout||0,r.withCredentials&&(n.withCredentials=r.withCredentials),r.responseType&&(n.responseType=r.responseType),r.beforeSend&&(t?r.beforeSend.call(n,n,t):r.beforeSend.call(n,n)),r.data?n.send(r.data):n.send(null)},fetch(e,t){let r;const i={bodyMethod:"text",autoresize:!0,autoreposition:!0,done:function(s,a){if(a){let c=M.strToHtml(s);a.contentRemove(),a.content.append(c)}}};if(t&&typeof e=="string")r=Object.assign({},i,{resource:encodeURI(e)});else if(typeof e=="object"&&e.resource)r=Object.assign({},i,e),r.resource=encodeURI(e.resource);else{this.errorReporting&&M.errorpanel("Fetch Request seems to miss the <mark>resource</mark> parameter!");return}const n=r.fetchInit||{};r.beforeSend&&(t?r.beforeSend.call(e,e,t):r.beforeSend.call(e,e)),fetch(r.resource,n).then(s=>{if(s.ok)return s[r.bodyMethod]()}).then(s=>{t?r.done.call(s,s,t):r.done.call(s,s),t&&(r.autoresize||r.autoreposition)&&M.ajaxAutoresizeAutoreposition(t,r)})},ajaxAutoresizeAutoreposition(e,t){const r=e.options.contentSize;if(typeof r=="string"&&r.match(/auto/i)){const i=r.split(" "),n=Object.assign({},{width:i[0],height:i[1]});t.autoresize&&e.resize(n),e.classList.contains("jsPanel-contextmenu")||t.autoreposition&&e.reposition()}else if(typeof r=="object"&&(r.width==="auto"||r.height==="auto")){const i=Object.assign({},r);t.autoresize&&e.resize(i),e.classList.contains("jsPanel-contextmenu")||t.autoreposition&&e.reposition()}},createPanelTemplate(e=!0){const t=document.createElement("div");return t.className="jsPanel",t.style.left="0",t.style.top="0",e&&["close","maximize","normalize","minimize","smallify"].forEach(r=>{t.setAttribute(`data-btn${r}`,"enabled")}),t.innerHTML=`<div class="jsPanel-hdr">
      ...
      <dialog @cancel=${this.close} @keydown=${Zt}>
        ...
        <form @submit=${this.onSubmit}>
          ...
          <div class="dialog-body">
            ...
            ${e?.descriptionHtml?_`<div class="desc">${or(e.descriptionHtml)}</div>`:e?.description?_`<div class="desc">${e.description}</div>`:fe}
            ${t?_`<dl>
                  ${this.row("Source",e?.source,e?.sourceUrl)}
                  ${this.row("License",e?.license,e?.licenseUrl)}
                  ${this.row("About",e?.about,e?.aboutUrl)}
                </dl>`:fe}
            ${!e?.description&&!e?.descriptionHtml&&!t&&!r?_`<p class="empty">No additional information.</p>`:fe}
          </div>
        </form>
      </dialog>
    ...
    `];Zi([K()],an.prototype,"name",2);Zi([K()],an.prototype,"info",2);Zi([K()],an.prototype,"provenance",2);an=Zi([nt("table-info-dialog")],an);const Rm=.25,Dm=4;function Om(e){return Math.min(Dm,Math.max(Rm,e))}function ul(e,t,r){return{x:e.x+t,y:e.y+r,scale:e.scale}}const Ar={x:0,y:0,scale:1};function hl(e,t){return Math.hypot(e.clientX-t.clientX,e.clientY-t.clientY)}function jm(e){return e instanceof Element&&e.closest(".jsPanel")!=null}function zm(e,t){let r={...Ar};t.style.transformOrigin="0 0";const i=new Set,n=()=>{t.style.transform=`translate(${r.x}px, ${r.y}px) scale(${r.scale})`;for(const x of i)x({...r})};let s="none",a={...Ar},c=0,u=0,p=0,w=0,b=0,$=0;const D=(x,I)=>{const y=e.getBoundingClientRect();return{x:x-y.left,y:I-y.top}},P=x=>{if(x.touches.length===2){s="pinch",a={...r};const[I,y]=[x.touches[0],x.touches[1]];p=hl(I,y)||1;const k=D((I.clientX+y.clientX)/2,(I.clientY+y.clientY)/2);w=(k.x-r.x)/r.scale,b=(k.y-r.y)/r.scale,x.preventDefault();return}if(x.touches.length===1&&!jm(x.target)){const I=x.timeStamp;if(I-$<300){r={...Ar},n(),$=0,s="none",x.preventDefault();return}$=I,s="pan",a={...r},c=x.touches[0].clientX,u=x.touches[0].clientY}else s="none"},S=x=>{if(s==="pan"&&x.touches.length===1){const I=x.touches[0];r=ul(a,I.clientX-c,I.clientY-u),n(),x.preventDefault()}else if(s==="pinch"&&x.touches.length>=2){const[I,y]=[x.touches[0],x.touches[1]],k=Om(a.scale*(hl(I,y)/p)),he=D((I.clientX+y.clientX)/2,(I.clientY+y.clientY)/2);r={x:he.x-w*k,y:he.y-b*k,scale:k},n(),x.preventDefault()}},B=x=>{x.touches.length===0?s="none":x.touches.length===1&&s==="pinch"&&(s="pan",a={...r},c=x.touches[0].clientX,u=x.touches[0].clientY)};let q=!1,Q={...Ar},X=0,J=0,W=!1;const Z=(x,I)=>{const y=e.getBoundingClientRect();return x>=y.left&&x<=y.right&&I>=y.top&&I<=y.bottom},de=x=>{if(!q)return;const I=x.clientX-X,y=x.clientY-J;!W&&Math.hypot(I,y)<4||(W=!0,document.body.style.cursor="grabbing",r=ul(Q,I,y),n(),x.preventDefault())},we=()=>{q&&(q=!1,document.body.style.cursor="",window.removeEventListener("mousemove",de,!0),window.removeEventListener("mouseup",Te,!0))};function Te(){we()}const Pe=x=>{x.button===2&&Z(x.clientX,x.clientY)&&(q=!0,W=!1,Q={...r},X=x.clientX,J=x.clientY,window.addEventListener("mousemove",de,!0),window.addEventListener("mouseup",Te,!0))},m=x=>{W&&(x.preventDefault(),W=!1)};return e.addEventListener("touchstart",P,{passive:!1}),e.addEventListener("touchmove",S,{passive:!1}),e.addEventListener("touchend",B),e.addEventListener("touchcancel",B),window.addEventListener("mousedown",Pe,!0),window.addEventListener("contextmenu",m,!0),{snapshot:()=>({...r}),reset:()=>{r={...Ar},n()},restore:x=>{r={...x},n()},subscribe:x=>(i.add(x),()=>i.delete(x)),dispose:()=>{e.removeEventListener("touchstart",P),e.removeEventListener("touchmove",S),e.removeEventListener("touchend",B),e.removeEventListener("touchcancel",B),window.removeEventListener("mousedown",Pe,!0),window.removeEventListener("contextmenu",m,!0),we()}}}function Mc(e,t){let r=null;const i=n=>{const s=document.getElementById(e);s&&(s.style.transformOrigin="0 0",s.style.transform=`translate(${-n.x/n.scale}px, ${-n.y/n.scale}px) scale(${1/n.scale})`)};return{enter(){const n=t();r||!n||(i(n.snapshot()),r=n.subscribe(i))},exit(){r?.(),r=null;const n=document.getElementById(e);n&&(n.style.transform="",n.style.transformOrigin="")}}}function Lm(){for(const e of document.querySelectorAll(".jsPanel"))e.status==="maximized"&&e.maximize?.(void 0,!0)}function Fm(e){let t=0;const r=()=>{t||(t=requestAnimationFrame(()=>{t=0,Lm()}))},i=typeof ResizeObserver<"u"?new ResizeObserver(r):null;return i?.observe(e),window.addEventListener("resize",r),()=>{t&&cancelAnimationFrame(t),t=0,i?.disconnect(),window.removeEventListener("resize",r)}}const Mm="input, textarea, select, button, a, .jsPanel-controlbar",Bm=".jsPanel-headerlogo, .jsPanel-titlebar, .jsPanel-ftr",zs=new WeakMap;function Bc(e){const t=e.status==="maximized";for(const r of e.querySelectorAll(Bm))zs.has(r)||zs.set(r,r.style.cursor||"move"),r.style.cursor=t?"pointer":zs.get(r)??"move"}function Nm(){for(const e of document.querySelectorAll(".jsPanel"))Bc(e)}function Um(){const e=r=>{let i=null;for(const s of r.composedPath())if(s instanceof HTMLElement){if(s.matches(Mm))return;if(s.classList.contains("jsPanel-titlebar")){i=s;break}}if(!i)return;const n=i.closest(".jsPanel");n&&(n.status==="maximized"||n.status==="minimized"?n.normalize?.():n.maximize?.())},t=r=>{const i=r.detail,n=typeof i=="string"?document.getElementById(i):null;n?Bc(n):Nm()};return document.addEventListener("dblclick",e,!0),document.addEventListener("jspanelstatuschange",t),document.addEventListener("jspanelloaded",t),()=>{document.removeEventListener("dblclick",e,!0),document.removeEventListener("jspanelstatuschange",t),document.removeEventListener("jspanelloaded",t)}}const Hm=200,qm=100;function Wm(e){return!e||!Number.isFinite(e.w)||!Number.isFinite(e.h)||!Number.isFinite(e.x)||!Number.isFinite(e.y)||e.w<Hm||e.h<qm?null:{...e}}function Oi(e,t){return(e.windowGeometry?.z??-1/0)-(t.windowGeometry?.z??-1/0)}let Ls=0;function Nc(){return Ls=Math.max(Date.now(),Ls+1),Ls}const es=new Map;function Uc(e,t){es.set(e,t)}function ts(e){es.delete(e)}function Km(e){return es.has(e)}function Vm(e){try{es.get(e)?.()}catch{}}const ji=(()=>{const e=new URLSearchParams(location.search).get("minimize");return e===null?!1:!/^(0|false|no)$/i.test(e)})();function Gm(e){return e.filter(t=>!t.minimized).slice().sort((t,r)=>(t.z??-1/0)-(r.z??-1/0)).map(t=>t.id)}let fl=!1;async function Ym(){fl||(fl=!0,document.addEventListener("easydb:restack-windows",()=>void pl())),await pl()}async function pl(){if(ji)return;const e=await pe();for(let t=0;t<=12;t++){const[r,i]=await Promise.all([e.store.tables.find(),e.store.viewInstances.find()]),n=[...r.filter(a=>a.workspaceId===e.workspaceId&&!a.windowGeometry?.closed).map(a=>({id:a.id,z:a.windowGeometry?.z,minimized:a.windowGeometry?.minimized===!0})),...i.filter(a=>a.workspaceId===e.workspaceId&&a.open).map(a=>({id:a.id,z:a.windowGeometry?.z,minimized:a.windowGeometry?.minimized===!0}))],s=Gm(n);if(t<12&&!s.every(a=>Km(a))){await new Promise(a=>setTimeout(a,80));continue}for(const a of s)Vm(a);return}}var Xm=Object.defineProperty,Qm=Object.getOwnPropertyDescriptor,qr=(e,t,r,i)=>{for(var n=i>1?void 0:i?Qm(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Xm(t,r,n),n};let Jn=class extends Ue{constructor(){super(...arguments),this.tableId="",this.query="",this.open=!1,this.focusPending=!1,this.onInput=e=>{this.query=e.target.value,this.dispatchQuery()},this.openSearch=()=>{this.open=!0,this.focusPending=!0},this.onBlur=()=>{this.open=!1}}dispatchQuery(){document.dispatchEvent(new CustomEvent("easydb:table-search",{detail:{tableId:this.tableId,query:this.query}}))}updated(){this.focusPending&&this.inputEl&&(this.inputEl.focus(),this.focusPending=!1)}render(){if(!this.open){const e=this.query.trim().length>0;return _`<button
        class="icon ${e?"active":""}"
    ...
    `];qr([Ht({type:String})],Jn.prototype,"tableId",2);qr([K()],Jn.prototype,"query",2);qr([K()],Jn.prototype,"open",2);qr([yn("input")],Jn.prototype,"inputEl",2);Jn=qr([nt("panel-search")],Jn);var Jm=Object.defineProperty,Zm=Object.getOwnPropertyDescriptor,mr=(e,t,r,i)=>{for(var n=i>1?void 0:i?Zm(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Jm(t,r,n),n};let jn=class extends Ue{constructor(){super(...arguments),this.tableId="",this.active=!0,this.rowCount=0,this.tableButtons=[],this.table=null,this.rowsActive=!1,this.runTableButton=async(e,t)=>{const r=t?.currentTarget??void 0,i=await pe();try{await Promise.resolve(e.onClick(i.api,{tableId:this.tableId,anchor:r}))}catch(n){console.error(`[table-button:${e.id}]`,n)}}}async connectedCallback(){super.connectedCallback();const e=await pe();this.tableButtons=[...e.registries.tableButtons],e.events.on("app:ready",()=>this.tableButtons=[...e.registries.tableButtons]),this.table=await e.store.tables.findOne(this.tableId)??null,this.unsubTables=e.store.tables.subscribe(t=>{this.table=t.find(r=>r.id===this.tableId)??null}),this.active&&this.startRows()}disconnectedCallback(){super.disconnectedCallback(),this.stopRows(),this.unsubTables?.()}updated(e){e.has("active")&&(this.active?this.startRows():this.stopRows())}async startRows(){if(this.rowsActive)return;this.rowsActive=!0;const e=await pe();this.rowsActive&&(this.unsubRows=e.store.rows(this.tableId).subscribe(t=>this.rowCount=t.length))}stopRows(){this.rowsActive=!1,this.unsubRows?.(),this.unsubRows=void 0}async addRow(){const e=await pe(),t=await e.store.tables.findOne(this.tableId);if(!t)return;const r={};for(const i of t.columns)r[i.field]=eg(i);await e.store.rows(this.tableId).insert({id:crypto.randomUUID(),tableId:this.tableId,data:r,updatedAt:Date.now()})}editColumns(){document.dispatchEvent(new CustomEvent("easydb:edit-columns",{detail:{tableId:this.tableId}}))}render(){return _`
      ...
      ${this.tableButtons.filter(e=>!e.visible||this.table!=null&&e.visible(this.table)).map(e=>_`<button
            ...
            >
              ${e.icon?e.icon.trimStart().startsWith("<svg")?_`<span class="icon-svg">${fo(e.icon)}</span>`:_`<span class="mi sm">${e.icon}</span>`:_`<span>${e.label}</span>`}
            </button>`)}
    ...
    `];mr([Ht({type:String})],jn.prototype,"tableId",2);mr([Ht({type:Boolean})],jn.prototype,"active",2);mr([K()],jn.prototype,"rowCount",2);mr([K()],jn.prototype,"tableButtons",2);mr([K()],jn.prototype,"table",2);jn=mr([nt("panel-footer")],jn);function eg(e){if(e.default!==void 0)return e.default;switch(e.type){case"boolean":return!1;case"number":return null;default:return""}}function Fs(e){return e.title?.trim()?e.title.trim():e.name}function tg(){return document.getElementById("easydb-panels-viewport")??document.getElementById("easydb-panels")??document.body}function ng(e){const t=document.querySelector("app-shell")?.shadowRoot,r=t?.querySelector("header"),i=t?.querySelector("footer");r&&(e.style.top=`${r.offsetHeight}px`),i&&(e.style.bottom=`${i.offsetHeight}px`)}const Vn=new Map,Hc=new Set;let ml=!1,Lo=null;function qc(){return Lo}function rg(e){const t=Vn.get(e);return t?(t.status==="minimized"&&t.normalize?.(),t.front?.(),!0):(ig(e),!0)}async function ig(e){const t=await pe(),r=await t.store.tables.findOne(e);r?.windowGeometry?.closed&&await t.store.tables.patch(e,{windowGeometry:{...r.windowGeometry,closed:!1},updatedAt:Date.now()})}async function sg(e){const t=await pe();await hg(e,t)}async function og(){if(ml)return;ml=!0;const e=await pe(),t=document.getElementById("easydb-panels"),r=document.getElementById("easydb-panels-viewport");if(t&&r){Lo=zm(t,r);const n=()=>ng(t);n(),window.addEventListener("resize",n);const s=document.querySelector("app-shell")?.shadowRoot,a=s?.querySelector("header"),c=s?.querySelector("footer");if(typeof ResizeObserver<"u"&&(a||c)){const u=new ResizeObserver(n);a&&u.observe(a),c&&u.observe(c)}Fm(r)}Um();const i=(await e.store.tables.find()).filter(n=>n.workspaceId===e.workspaceId);i.sort(Oi);for(const n of i)n.windowGeometry?.closed||gl(n,e);e.store.tables.subscribe(n=>{const s=n.filter(u=>u.workspaceId===e.workspaceId),a=new Map(s.map(u=>[u.id,u]));for(const[u,p]of Vn){const w=a.get(u);if(!w||w.windowGeometry?.closed){Vn.delete(u),ts(u),Hc.add(u);try{p.status!=="closed"&&p.close()}catch{}}}const c=s.filter(u=>!Vn.has(u.id)&&!u.windowGeometry?.closed).sort(Oi);for(const u of c)gl(u,e)}),Ym()}const ag=720,lg=360;function gl(e,t){const r=`panel-${Wc(e.id)}`,i=tg(),n=Wm(e.windowGeometry),s=ji||n?.minimized===!0,a=()=>{const y=document.createElement("data-table");return y.tableId=e.id,y.style.height="100%",y},c=s?document.createElement("div"):a();let u=s?null:c,p=Fs(e),w=-1,b=-1;const $=()=>{typeof W.setHeaderTitle=="function"&&W.setHeaderTitle(p+dc(w,b))},D=y=>{const k=y.detail;k.key===e.id&&(w=k.count,b=k.total,$())};document.addEventListener(Ii,D);const P=()=>{q.active=!1,u?.remove(),u=null},S=()=>{if(u)return;const y=document.getElementById(r)?.querySelector(".jsPanel-content");if(!y)return;y.replaceChildren();const k=a();y.appendChild(k),u=k,q.active=!0},B=document.createElement("panel-search");B.tableId=e.id;const q=document.createElement("panel-footer");q.tableId=e.id,q.active=!s;const Q=Mc(r,()=>Lo),X=n?{my:"left-top",at:"left-top",offsetX:n.x,offsetY:n.y}:dg(),J=n?{panelSize:`${n.w} ${n.h}`}:{contentSize:`${ag} ${lg}`},W=M.create({id:r,container:i,headerTitle:p,headerLogo:dl[$i(e)],footerToolbar:q,theme:"primary",content:c,...J,position:X,minimizeTo:"#easydb-minimized-dock",dragit:{containment:!1,stop:()=>Ms(e.id,t)},resizeit:{containment:!1,stop:()=>Ms(e.id,t)},onfronted:()=>ug(e.id,t),onclosed:async()=>{if(Vn.delete(e.id),ts(e.id),Hc.delete(e.id))return;const y=await t.store.tables.findOne(e.id);if(!y)return;const k=y.windowGeometry??{x:60,y:60,w:720,h:360,z:1,minimized:!1,maximized:!1};await t.store.tables.patch(e.id,{windowGeometry:{...k,closed:!0},updatedAt:Date.now()})},onstatuschange:y=>{y.status==="minimized"?P():(y.status==="normalized"||y.status==="maximized")&&S(),y.status==="maximized"?Q.enter():Q.exit(),Ms(e.id,t)}});Vn.set(e.id,W),Uc(e.id,()=>W.front?.(void 0,!1));const Z=document.getElementById(r),de=Z?.querySelector(".jsPanel-controlbar");de&&de.prepend(B),cl(e)&&Z?.classList.add("eda-refreshable");const we=Z?.querySelector(".jsPanel-titlebar");we&&(we.tabIndex=-1,we.style.outline="none",we.addEventListener("pointerdown",()=>we.focus()));let Te=null;const Pe=document.createElement("button");Pe.type="button",Pe.title="Table info",Pe.setAttribute("aria-label","Table info"),Pe.className="eda-info-btn",Pe.textContent="ⓘ",Pe.style.cssText="display:none;background:none;border:0;color:inherit;cursor:pointer;font-size:1rem;line-height:1;padding:0 0.3rem;",Pe.addEventListener("click",y=>{y.stopPropagation(),Te&&Am(p,Te.info??{},{source:Te.source,origin:Te.origin})}),de?.prepend(Pe);const m=y=>{Te=y??null;const k=!!(y?.info||y?.source||y?.origin);Pe.style.display=k?"inline-flex":"none"};m(e),s&&typeof W.minimize=="function"?queueMicrotask(()=>W.minimize?.()):n?.maximized&&typeof W.maximize=="function"&&queueMicrotask(()=>W.maximize?.());let x=$i(e);t.store.tables.subscribe(y=>{const k=y.find(ge=>ge.id===e.id);if(!k)return;m(k),Fs(k)!==p&&(p=Fs(k),$());const he=$i(k);he!==x&&(x=he,typeof W.setHeaderLogo=="function"&&W.setHeaderLogo(dl[he]),Z?.classList.toggle("eda-refreshable",cl(k)))});const I=W.close.bind(W);W.close=()=>(document.removeEventListener(Ii,D),I())}let cg=0;function dg(){const e=cg++;return{my:"left-top",at:"left-top",offsetX:40+e%8*30,offsetY:80+e%8*30}}async function Ms(e,t){const r=document.getElementById(`panel-${Wc(e)}`);if(!r)return;const i=Vn.get(e)?.status??"normalized";try{const s=(await t.store.tables.findOne(e))?.windowGeometry,a=ji?s?.minimized??!1:i==="minimized",c=ji?s?.maximized??!1:i==="maximized";let u=r.offsetLeft,p=r.offsetTop,w=r.offsetWidth,b=r.offsetHeight;const $=i==="minimized"||i==="maximized";if($&&!s)return;$&&s&&(u=s.x,p=s.y,w=s.w,b=s.h),u<=-9e3&&(u=s?.x??40);const D={x:u,y:p,w,h:b,z:s?.z??0,minimized:a,maximized:c};await t.store.tables.patch(e,{windowGeometry:D,updatedAt:Date.now()})}catch{}}async function ug(e,t){try{const r=await t.store.tables.findOne(e);if(!r)return;const i=r.windowGeometry??{x:0,y:0,w:720,h:360,z:0,minimized:!1,maximized:!1};await t.store.tables.patch(e,{windowGeometry:{...i,z:Nc()},updatedAt:Date.now()})}catch{}}async function hg(e,t){if(!(await t.store.tables.findOne(e))?.source){const i=t.store.rows(e),n=await i.find();await i.bulkRemove(n.map(s=>s.id))}await t.store.tables.remove(e)}function Wc(e){return e.replace(/[^a-zA-Z0-9_-]/g,"_")}const fg={id:"delete-table",name:"Delete Table",type:"ui",version:"0.1.0",description:"Adds a trash button to each table window that permanently deletes the table and its rows (with confirmation).",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/delete-table.ts"};function pg(e){e.ui.registerTableButton({id:"delete-table:delete",label:"Delete",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="#7f1d1d" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',tooltip:"Delete this table permanently",onClick:async(t,r)=>{const i=await t.store.tables.findOne(r.tableId);!i||!await t.ui.dialogs.confirm(i.source?`Delete the live table "${i.name}"? Its data stays on the server — only the local connection is removed.`:`Permanently delete table "${i.name}" and all its rows? This can't be undone.`,"Delete table")||(await sg(r.tableId),t.ui.dialogs.toast(`Deleted "${i.name}".`,{kind:"success",title:"Delete table"}))}})}const mg=Object.freeze(Object.defineProperty({__proto__:null,init:pg,meta:fg},Symbol.toStringTag,{value:"Module"}));var gg=Object.defineProperty,bg=Object.getOwnPropertyDescriptor,Fo=(e,t,r,i)=>{for(var n=i>1?void 0:i?bg(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&gg(t,r,n),n};function yg(e,t){return(mn.instance??wg()).open(e,t)}function wg(){const e=document.createElement("column-names-dialog");return document.body.appendChild(e),e}let mn=class extends Ue{constructor(){super(...arguments),this.rows=[],this.subject="",this.source=[],this.dialogEl=null,this.resolveFn=null,this.onCancel=e=>{e.preventDefault(),this.finish(null)},this.submit=e=>{if(e.preventDefault(),this.invalidIndices().size>0)return;const t=this.source.map((r,i)=>{const n=this.rows[i],s=n.field.trim(),a=n.label.trim()||s;return{...r,field:s,label:a,hidden:n.hidden}});this.finish(t)},this.toggleAllHidden=()=>{const e=this.rows.length>0&&this.rows.every(t=>t.hidden);this.rows=this.rows.map(t=>({...t,hidden:!e}))}}connectedCallback(){super.connectedCallback(),mn.instance=this}disconnectedCallback(){super.disconnectedCallback(),mn.instance===this&&(mn.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}open(e,t){return this.source=e,this.subject=t??"",this.rows=e.map(r=>({field:r.field,label:r.label,hidden:!!r.hidden})),new Promise(r=>{this.resolveFn=r,this.updateComplete.then(()=>this.dialogEl?.showModal())})}invalidIndices(){const e=new Set,t=new Map;this.rows.forEach((r,i)=>{const n=r.field.trim().toLowerCase();if(n===""){e.add(i);return}(t.get(n)??t.set(n,[]).get(n)).push(i)});for(const r of t.values())if(r.length>1)for(const i of r)e.add(i);return e}finish(e){this.dialogEl?.close();const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}updateRow(e,t,r){this.rows=this.rows.map((i,n)=>n===e?{...i,[t]:r}:i)}setHidden(e,t){this.rows=this.rows.map((r,i)=>i===e?{...r,hidden:t}:r)}render(){const e=this.invalidIndices(),t=e.size;return _`
      <dialog @cancel=${this.onCancel} @keydown=${Zt}>
        <button type="button" class="close-x" title="Close" @click=${()=>this.finish(null)}>
          ×
        </button>
    ...
    `];Fo([K()],mn.prototype,"rows",2);Fo([K()],mn.prototype,"subject",2);mn=Fo([nt("column-names-dialog")],mn);async function vg(e,t,r){const i=t.origin?.url;if(!i)throw new Error(`"${t.name}" has no source URL to reload from.`);const n={api:e,fetchText:(W,Z)=>Ui(e,W,Z??`Reading ${t.name}…`,{maxBytes:null}),panel:{}},s=await r.list(n,{kind:"url",url:i});if(s.length===0)throw new Error(`Nothing to read at ${i} any more.`);const a=s.find(W=>W.name===t.name)??(s.length===1?s[0]:void 0);if(!a)throw new Error(`"${t.name}" is no longer one of the tables at ${i}.`);let c=[];const u=[];for await(const W of r.read(n,a))W.columns?.length&&(c=W.columns),u.push(...W.rows);const{columns:p,newFields:w}=Hi(t.columns,c,t.deletedColumns??[]),b=t.origin?.pks??[],$=new Set(c.map(W=>W.field)),D=t.columns.map(W=>W.field).filter(W=>!$.has(W)&&!b.includes(W)),P=(t.deletedColumns??[]).filter(W=>$.has(W)),S=e.store.rows(t.id),B=await S.find(),{data:q,merged:Q}=sc({oldRows:B.map(W=>({data:W.data})),freshRows:u,pks:b,userAddedFields:D,deletedRemoteFields:P}),X=Date.now();p.length>0&&await e.store.tables.patch(t.id,{columns:p,updatedAt:X}),await S.bulkRemove(B.map(W=>W.id));const J=q.map(W=>({id:it(),tableId:t.id,data:W,updatedAt:X}));return await S.bulkInsert(J),{rowCount:J.length,newFields:w,merged:Q}}var xg=Object.defineProperty,$g=Object.getOwnPropertyDescriptor,vt=(e,t,r,i)=>{for(var n=i>1?void 0:i?$g(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&xg(t,r,n),n};const kg="https://raw.githubusercontent.com/cawoodm/easydbaccess/main/data/northwind.db.json",Cg="https://raw.githubusercontent.com/MainakRepositor/Datasets/master/Air%20Quality/real_2016_air.csv",Eg='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/></svg>',bl=[{label:"Northwind — sample database (JSON dump)",url:kg,kind:"json"},{label:"Air quality — 2016 readings (CSV)",url:Cg,kind:"csv"},{label:"Datasette — US legislators (whole database, pick tables)",url:"https://datasette.io/legislators",kind:"datasette"},{label:"Datasette — datasette.io (whole instance, pick database & tables)",url:"https://datasette.io",kind:"datasette"}],Sg={id:"import-data",name:"Import Data",type:"importer",version:"0.2.0",description:"Header button that imports data from a URL — a JSON dump (e.g. Northwind) or a Datasette table, database, or whole instance — with a picker of sample sources.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/import-data.ts"};function _g(e){e.ui.registerHeaderButton({id:"import-data:open",label:"Import",icon:Eg,tooltip:"Import data from a URL (snapshot into a local table)",onClick:()=>Ag(e)}),e.ui.registerTableButton({id:"import-data:refresh",label:"Refresh",icon:"refresh",tooltip:"Reload this table from the URL it was imported from",visible:t=>t.origin?.type==="csv"||t.origin?.type==="json",onClick:(t,{tableId:r})=>Tg(t,r)})}async function Tg(e,t){const r=await e.store.tables.findOne(t);if(r?.origin?.url)try{const i=await Kc(r.origin.type);if(!i)throw new Error(`No importer is installed that can read a "${r.origin.type}" source.`);const n=await vg(e,r,i),s=[];n.newFields.length>0&&s.push(`${n.newFields.length} new column${n.newFields.length===1?"":"s"}`),!n.merged&&n.rowCount>0&&s.push("rows replaced (no primary key to match on)"),e.ui.dialogs.toast(`Refreshed "${r.name}" (${n.rowCount.toLocaleString()} rows)${s.length?` — ${s.join(", ")}`:""}.`,{kind:n.newFields.length>0?"warning":"success",title:"Refresh"})}catch(i){e.ui.dialogs.toast(`Couldn't refresh "${r.name}": ${i.message}`,{kind:"error",title:"Refresh"})}}async function Ag(e,t="auto"){const i=await(Qe.instance??zg()).open({presetKind:t,async listDatabases(S){const B=bn(S);return _o(q=>e.backend.fetch(q),B.base)},async listTables(){const S=e.workspaceId();return(await e.store.tables.find()).filter(B=>B.workspaceId===S&&!B.source).map(B=>({id:B.id,name:B.name})).sort((B,q)=>B.name.localeCompare(q.name))}});if(!i)return;const{url:n,file:s,kind:a,dbChosen:c,editColumns:u,maxRows:p,mode:w,panel:b,target:$}=i,D=s?.name??n,P=u?(S,B)=>yg(S,B):void 0;typeof b.separator=="string"&&b.separator;try{const S=await Kc(a);if(S){const B=a==="json"?await Ig(e,n,s,p,w):null;if(B?.isDump&&await e.ui.dialogs.confirm(`"${D}" is a workspace dump, not a plain table. Restore it — tables, window layout, views and filters? Choose Cancel to import only its tables as data.`,"Restore workspace")){await Co(e,B.text,D,{maxRows:p,editColumns:P,...s?{}:{originUrl:n}});return}const q=s?s.name:ur(n),Q=B?{kind:"text",text:B.text,name:q}:s?{kind:"file",file:s}:{kind:"url",url:n},X=await rc(e,S,Q,{mode:w,target:$,maxRows:p,panel:b,...B&&!s?{origin:{type:S.id,url:n}}:{},...P?{editColumns:J=>P(J)}:{}});S.ownToasts||Pg(e,X,D);return}if(w==="reference"&&!s){a==="datasette"?await jg(e,n):await Vc(e,n,a);return}await Do(e,n,{skipTablePicker:c,maxRows:p,editColumns:P})}catch(S){e.ui.dialogs.toast(`Could not import ${D}: ${S.message}`,{kind:"error",title:"Import"})}}async function Ig(e,t,r,i,n){if(n==="reference")return null;const s=r?await r.text():await Ui(e,t,`Reading ${ur(t)}…`,i!=null?{maxBytes:null}:{});try{return{text:s,isDump:ko(JSON.parse(s))}}catch{return{text:s,isDump:!1}}}async function Kc(e){const{registries:t}=await pe();return t.importers.find(r=>r.id===e&&r.supports?.kernel===!0)}function Pg(e,t,r){if(t.cancelled&&t.landed.length===0)return;const i=t.landed.reduce((a,c)=>a+c.rowCount,0),n=t.landed.length===1?`"${t.landed[0].tableName}"`:`${t.landed.length} tables from ${r}`;if(t.landed.length>0){const a=t.failed.length>0?` — ${t.failed.length} failed`:"";e.ui.dialogs.toast(`Imported ${n} (${i.toLocaleString()} rows)${a}.`,{kind:t.failed.length>0?"warning":"success",title:"Import"});return}const s=t.failed.map(a=>`${a.name}: ${a.error}`).join("; ");e.ui.dialogs.toast(`Could not import ${r}${s?` — ${s}`:""}.`,{kind:"error",title:"Import"})}function Rg(e){const t=JSON.parse(e),r=i=>Array.isArray(i)&&i.every(n=>n!=null&&typeof n=="object"&&!Array.isArray(n));if(r(t))return t;if(t&&typeof t=="object"){const i=t;for(const n of["rows","records","data"])if(r(i[n]))return i[n];for(const n of Object.values(i))if(r(n))return n}return[]}function Dg(e){const t=Rg(e).slice(0,50),r=n=>typeof n=="number"?"number":typeof n=="boolean"?"boolean":"string",i=new Map;for(const n of t)for(const[s,a]of Object.entries(n))!i.has(s)&&a!=null?i.set(s,r(a)):i.has(s)||i.set(s,"string");return[...i.entries()].map(([n,s])=>({field:n,label:n,type:s}))}function Og(e,t,r){return`${e}/${encodeURIComponent(t)}/${encodeURIComponent(r)}.json?_size=max`}async function jg(e,t){const r=bn(t),i=c=>e.backend.fetch(c),n=[];if(r.db&&r.table)n.push({db:r.db,table:r.table});else if(r.db)for(const c of await Pi(i,r.base,r.db))c.hidden||n.push({db:c.db,table:c.table});else for(const c of await _o(i,r.base))for(const u of await Pi(i,r.base,c))u.hidden||n.push({db:u.db,table:u.table});if(n.length===0)throw new Error("No tables found to reference at that URL.");let s=0;const a=[];for(const c of n)try{await Vc(e,Og(r.base,c.db,c.table),"json",{nameHint:`${c.db}/${c.table}`,silent:!0}),s++}catch(u){a.push(`${c.table}: ${u.message}`)}e.ui.dialogs.toast(`Referenced ${s} table${s===1?"":"s"}${a.length?` — ${a.length} failed`:""}.`,{kind:a.length?"warning":"success",title:"Reference"})}async function Vc(e,t,r,i={}){const n=e.workspaceId();if(!n)throw new Error("No active workspace.");const s=i.nameHint??ur(t),a=await Ui(e,t,`Reading ${s}…`,{maxBytes:null}),c=r==="csv"?hr(a).columns:Dg(a);if(c.length===0)throw new Error("No columns found in the referenced data.");const u=new Set((await e.store.tables.find()).filter(b=>b.workspaceId===n).map(b=>b.name.toLowerCase()));let p=s;for(let b=2;u.has(p.toLowerCase());b++)p=`${s}-${b}`;const w={id:it(),workspaceId:n,name:p,code:Tt(p),columns:c,view:"table",source:{type:"url",config:{url:t,format:r}},updatedAt:Date.now()};await e.store.tables.insert(w),i.silent||e.ui.dialogs.toast(`Referenced ${p} — live, read-only.`,{kind:"success",title:"Reference"})}function zg(){const e=document.createElement("import-dialog");return document.body.appendChild(e),e}function Lg(e){try{const t=new URL(e),r=t.hostname.toLowerCase(),i=[...t.searchParams.keys()].some(s=>s.startsWith("_")),n=r.includes("datasette")||i;return!i&&/\.(csv|tsv|tab)$/i.test(t.pathname)?"csv":!i&&/\.json$/i.test(t.pathname)?"json":n?"datasette":"json"}catch{return"json"}}function yl(e,t){if(t!=="datasette"||!e)return!1;try{const r=bn(e);return!r.db&&!r.table}catch{return!1}}function Fg(e){return/\.(csv|tsv|tab)$/i.test(e)?"csv":"json"}let Qe=class extends Ue{constructor(){super(...arguments),this.url="",this.kind="auto",this.presetIdx=-1,this.dbList=null,this.dbLoading=!1,this.dbError="",this.selectedDb="",this.editColumns=!1,this.file=null,this.maxRowsInput="",this.mode="copy",this.targetKind="new",this.targetTableId="",this.tables=[],this.dialogEl=null,this.resolveFn=null,this.listDatabases=null,this.panelEl=null,this.mountedPanel="",this.panelGeneration=0,this.formats=[],this.acceptAttr=".txt",this.onCancel=e=>{e.preventDefault(),this.finish(null)},this.submit=e=>{e.preventDefault();const t=this.url.trim();if(!t&&!this.file)return;const r=this.resolvedKind,i=this.maxRows,n=this.editColumns&&this.mode==="copy",s=this.panelValue(),a=this.supportsTarget?this.target:{kind:"new"},c=this.file?"copy":this.mode;if(this.file){this.finish({url:"",file:this.file,kind:r,editColumns:n,maxRows:i,mode:c,panel:s,target:a});return}const u=r==="datasette"&&!!this.selectedDb&&yl(t,r),p=u?`${t.replace(/\/+$/,"")}/${encodeURIComponent(this.selectedDb)}`:t;this.finish({url:p,kind:r,dbChosen:u,editColumns:n,maxRows:i,mode:c,panel:s,target:a})}}get supportsTarget(){return this.formats.find(e=>e.id===this.resolvedKind)?.kernel===!0}get target(){return this.mode==="reference"||this.targetKind==="new"||!this.targetTableId?{kind:"new"}:{kind:this.targetKind,tableId:this.targetTableId}}get resolvedKind(){return this.kind!=="auto"?this.kind:this.file?Fg(this.file.name):Lg(this.url.trim())}get maxRows(){const e=Math.floor(Number(this.maxRowsInput));return Number.isFinite(e)&&e>0?e:void 0}resetDbList(){this.dbList=null,this.selectedDb="",this.dbError="",this.dbLoading=!1}async loadDatabases(){const e=this.url.trim();if(!(!e||!this.listDatabases)){this.dbLoading=!0,this.dbError="",this.dbList=null,this.selectedDb="";try{const t=await this.listDatabases(e);this.dbList=t,t.length===0?this.dbError="No databases found at that instance.":t.length===1&&(this.selectedDb=t[0])}catch(t){this.dbError=t?.message??"Could not list databases."}finally{this.dbLoading=!1}}}connectedCallback(){super.connectedCallback(),Qe.instance=this}disconnectedCallback(){super.disconnectedCallback(),Qe.instance===this&&(Qe.instance=null)}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}updated(){const e=this.shadowRoot?.querySelector(".panel-slot");if(!e){this.panelEl=null,this.mountedPanel="";return}const t=this.activePanelTag,r=t?`${t}#${this.panelGeneration}`:"";if(r===this.mountedPanel||(e.replaceChildren(),this.panelEl=null,this.mountedPanel=r,!t))return;const i=document.createElement(t);i.addEventListener("change",()=>this.requestUpdate()),e.appendChild(i),this.panelEl=i}get activePanelTag(){return this.formats.find(e=>e.id===this.resolvedKind)?.panel}get activeLabel(){return this.formats.find(e=>e.id===this.resolvedKind)?.label??this.resolvedKind}panelValue(){const e=this.panelEl?.value;return e&&typeof e=="object"?e:{}}async loadFormats(){const{registries:e}=await pe(),t=[...e.importers].sort((n,s)=>(n.order??Number.MAX_SAFE_INTEGER)-(s.order??Number.MAX_SAFE_INTEGER)).map(n=>({id:n.id,label:n.label,panel:n.panel,kernel:n.supports?.kernel})),r=t.some(n=>n.id==="datasette")?t:[...t,{id:"datasette",label:"Datasette (table or instance)"}];this.formats=r;const i=new Set([".txt"]);for(const n of e.importers)for(const s of n.accept??[])i.add(s);this.acceptAttr=[...i].join(",")}open(e){this.targetKind="new",this.targetTableId="",this.tables=[],e?.listTables?.().then(r=>{this.tables=r}),this.url="",this.kind=e?.presetKind??"auto",this.presetIdx=-1,this.editColumns=!1,this.file=null,this.maxRowsInput="",this.mode="copy",this.panelGeneration+=1,this.resetDbList(),this.listDatabases=e?.listDatabases??null;const t=this.loadFormats();return new Promise(r=>{this.resolveFn=r,t.then(()=>this.updateComplete).then(()=>this.dialogEl?.showModal())})}finish(e){this.dialogEl?.close();const t=this.resolveFn;this.resolveFn=null,queueMicrotask(()=>t?.(e))}onPresetChange(e){const t=Number(e.target.value);this.presetIdx=t,this.resetDbList();const r=bl[t];r&&(this.url=r.url,this.kind=r.kind)}onFileChange(e){const r=e.target.files?.[0]??null;this.file=r,r&&(this.url="",this.presetIdx=-1,this.resetDbList())}renderDbPicker(){return!this.listDatabases||!yl(this.url.trim(),this.resolvedKind)?fe:_`
      <label>
        Database
      ...
      ${this.dbError?_`<p class="hint error">${this.dbError}</p>`:fe}
    `}renderTarget(){if(!this.supportsTarget||this.mode==="reference")return fe;const e=this.targetKind!=="new";return _`
      <label>
        Import into
        <div class="row db-row">
          <select
    ...
    `}renderPluginBlock(){const e=this.renderDbPicker();return!!!this.activePanelTag&&e===fe?fe:_`
            ...
            <fieldset class="block">
              ...
              <label>
                ...
                >
                  ...
                  ${bl.map((e,t)=>_`<option value=${String(t)} ?selected=${t===this.presetIdx}>
                        ${e.label}
                      </option>`)}
                </select>
              </label>
              ...
              ${this.file?_`<p class="hint">Uploaded files can only be imported as a Copy.</p>`:fe}
              ${this.renderTarget()}
      ...
      <div class="section">
        ...
        <ul class="list">
          ${this.templates.map(e=>_`<li>
                <span class="name">${e.name}</span>
                ${e.builtin?_`<span class="badge">built-in</span>`:fe}
    ...
    `];gr([K()],Nt.prototype,"mode",2);gr([K()],Nt.prototype,"instances",2);gr([K()],Nt.prototype,"templates",2);gr([K()],Nt.prototype,"tDraft",2);gr([K()],Nt.prototype,"iDraft",2);Nt=gr([nt("views-dialog")],Nt);const Vg={id:"views",name:"Views",type:"ui",version:"0.1.0",description:"Display tables through HTML view templates in read-only windows.",author:"easyDBAccess built-ins",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/views.ts"},Gg="grid_view",Yg={slug:"rss",name:"RSS Feed",header:'<div style="display:flex;flex-direction:column;gap:12px;padding:12px;">',row:['<div style="border:1px solid #e5e7eb;border-radius:12px;padding:12px 16px;background:#ffffff;box-shadow:0 1px 2px rgba(0,0,0,0.06);">','<a href="$URL" target="_blank" rel="noopener noreferrer" style="font-size:1.05rem;font-weight:600;color:#2563eb;text-decoration:none;">$TITLE</a>','<div style="color:#6b7280;font-size:0.78rem;margin:4px 0;">$DATE</div>','<div style="color:#374151;font-size:0.9rem;line-height:1.45;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:20;line-clamp:20;overflow:hidden;">$DESCRIPTION</div>','<div style="display:flex;gap:16px;margin-top:8px;">$input.CHECK1$input.CHECK2</div>',"</div>"].join(""),footer:"</div>"},Xg={slug:"todo-list",name:"Todo List",header:'<div style="display:flex;flex-direction:column;gap:6px;padding:12px;max-width:720px;margin:0 auto;">',row:['<div style="display:flex;align-items:center;gap:10px;border:1px solid #e5e7eb;border-radius:8px;padding:8px 12px;background:#ffffff;">',"$input.DONE",'<span style="flex:1;font-weight:500;color:#111827;">$TITLE</span>','<span style="color:#6b7280;font-size:0.8rem;white-space:nowrap;">$DUE</span>',"</div>"].join(""),footer:"</div>"},Qg={slug:"gallery",name:"Gallery",header:'<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(180px,1fr));gap:12px;padding:12px;">',row:['<figure style="margin:0;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;background:#ffffff;box-shadow:0 1px 2px rgba(0,0,0,0.06);">','<img src="$IMAGE" alt="$TITLE" loading="lazy" style="width:100%;height:150px;object-fit:cover;display:block;background:#f3f4f6;" />','<figcaption style="padding:6px 8px;font-size:0.85rem;color:#374151;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">$TITLE</figcaption>',"</figure>"].join(""),footer:"</div>"},Jg={slug:"contact-cards",name:"Contact Cards",header:'<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:12px;padding:12px;">',row:['<div style="border:1px solid #e5e7eb;border-radius:10px;padding:12px 14px;background:#ffffff;box-shadow:0 1px 2px rgba(0,0,0,0.06);">','<div style="font-weight:600;color:#111827;font-size:0.95rem;">$NAME</div>','<a href="mailto:$EMAIL" style="color:#2563eb;text-decoration:none;font-size:0.85rem;word-break:break-all;">$EMAIL</a>','<div style="color:#6b7280;font-size:0.85rem;margin-top:2px;">$PHONE</div>',"</div>"].join(""),footer:"</div>"},Zg=[Yg,Xg,Qg,Jg];function eb(e){e.ui.registerTableButton({id:"views:open",label:"Views",icon:Gg,tooltip:"Views -- display this table through a template",onClick:(t,{tableId:r})=>ro(r)})}async function tb(e){await rb(e)}function nb(e){let t=5381;const r=`${e.header} ${e.row} ${e.footer}`;for(let i=0;i<r.length;i++)t=(t<<5)+t+r.charCodeAt(i)|0;return(t>>>0).toString(36)}async function rb(e){const t=e.workspaceId();if(!t)return;const r=await e.store.viewTemplates.find({workspaceId:t});for(const i of Zg)await ib(e,t,i,r)}async function ib(e,t,r,i){const n=`views:seeded:${r.slug}:${t}`,s=`views:sig:${r.slug}:${t}`,a=nb(r),c=i.find(p=>p.builtin&&p.name===r.name);if(c){(await e.store.settings.findOne(s))?.value!==a&&(await e.store.viewTemplates.patch(c.id,{headerHtml:r.header,rowHtml:r.row,footerHtml:r.footer,updatedAt:Date.now()}),await e.store.settings.upsert({key:s,value:a})),await e.store.settings.upsert({key:n,value:!0});return}(await e.store.settings.findOne(n))?.value||(await e.store.viewTemplates.insert({id:sb(),workspaceId:t,name:r.name,headerHtml:r.header,rowHtml:r.row,footerHtml:r.footer,builtin:!0,updatedAt:Date.now()}),await e.store.settings.upsert({key:n,value:!0}),await e.store.settings.upsert({key:s,value:a}))}function sb(){return globalThis.crypto?.randomUUID?.()??`${Date.now().toString(36)}-${Math.random().toString(36).slice(2)}`}const ob=Object.freeze(Object.defineProperty({__proto__:null,init:eb,load:tb,meta:Vg},Symbol.toStringTag,{value:"Module"})),ab={id:"settings",name:"Settings",type:"ui",fixed:!0,version:"0.1.0",description:"Header gear button that opens the tabbed Settings dialog; imports dropped secrets.txt.",author:"Marc Cawood",icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',repo:"https://github.com/cawoodm/easydbaccess/blob/main/packages/renderer/src/plugins/settings.ts"};function lb(e){e.ui.registerHeaderButton({id:"settings:open",label:"Settings",icon:"settings",tooltip:"Workspace and plugin settings",variant:"secondary",onClick:()=>e.ui.openSettings()}),e.ui.registerDropHandler(async(t,r)=>{const n=Array.from(t.dataTransfer?.files??[]).find(c=>c.name.toLowerCase()==="secrets.txt");if(!n)return!1;const s=await n.text(),a=Object.keys(Ni(s)).length;return Bi().trim().length>0&&!await r.ui.dialogs.confirm(`Replace your current secrets with ${a} secret${a===1?"":"s"} from "${n.name}"?`,"Import secrets")||(Ul(s),r.ui.dialogs.toast(`Imported ${a} secret${a===1?"":"s"}.`,{kind:"success",title:"Secrets"})),!0})}const cb=Object.freeze(Object.defineProperty({__proto__:null,init:lb,meta:ab},Symbol.toStringTag,{value:"Module"})),db=[cb,Fp,Qu,kh,Ih,Rf,Vf,Jf,nh,gp,ip,Ap,jp,Hp,Gp,Jp,nm,om,pm,ym,Em,mg,Mg,Yc,ob];function ub(e){if(!e.meta)throw new Error("Built-in plugin is missing meta");return e.meta}const Xc=db.map(e=>{const t=ub(e);return{id:t.id,meta:t,module:e}}),hb=Xc;function io(e){return`builtin:${e}`}async function fb(e){const t=[];for(const r of Xc)if(!await pb(e,r)){t.push(r);try{await r.module.init?.(e)}catch(i){e.events.emit("plugin:error",{url:r.id,phase:"init",error:i})}}return async()=>{for(const r of t)try{await r.module.load?.(e)}catch(i){e.events.emit("plugin:error",{url:r.id,phase:"load",error:i})}}}async function pb(e,t){return t.meta.fixed?!1:Vt==="all-optional"?!0:(await e.store.plugins.findOne(io(t.id)))?.enabled===!1}function br(){const e=M.getPanels;return typeof e!="function"?[]:Array.from(e.call(M)??[])}function mb(){for(const e of br())e.close?.()}function gb(){for(const e of br())e.minimize?.()}function bb(){for(const e of br())e.normalize?.()}function yb(){for(const e of br())e.maximize?.()}function Qc(){const e=document.getElementById("easydb-panels"),t=e?.clientWidth??window.innerWidth,r=e?.clientHeight??window.innerHeight,i=qc()?.snapshot(),n=i?.scale&&i.scale>0?i.scale:1,s=i?.x??0,a=i?.y??0;return{x:-s/n,y:-a/n,w:t/n,h:r/n}}function Jc(e,t,r,i,n){e.style.left=`${Math.round(t)}px`,e.style.top=`${Math.round(r)}px`,e.style.width=`${Math.round(i)}px`,e.style.height=`${Math.round(n)}px`}function wb(){const e=br().reverse();if(e.length===0)return;const t=Qc(),r=32,i=Math.min(680,Math.max(320,t.w*.6)),n=Math.min(480,Math.max(240,t.h*.6));e.forEach((s,a)=>{s.normalize?.(),Jc(s,t.x+24+a*r,t.y+24+a*r,i,n)})}function vb(){const e=br().reverse(),t=e.length;if(t===0)return;const r=Qc(),i=Math.ceil(Math.sqrt(t)),n=Math.ceil(t/i),s=8,a=(r.w-s*(i+1))/i,c=(r.h-s*(n+1))/n;e.forEach((u,p)=>{u.normalize?.();const w=p%i,b=Math.floor(p/i);Jc(u,r.x+s+w*(a+s),r.y+s+b*(c+s),a,c)})}function xb(e){const t=[{id:"windows:minimize-all",title:"Minimize all windows",icon:"remove",run:gb},{id:"windows:restore-all",title:"Restore all windows",icon:"crop_square",run:bb},{id:"windows:maximize-all",title:"Maximize all windows",icon:"fullscreen",run:yb},{id:"windows:cascade",title:"Cascade windows",icon:"view_agenda",run:wb},{id:"windows:tile",title:"Tile windows",icon:"grid_view",run:vb},{id:"windows:close-all",title:"Close all windows",icon:"close",run:mb}];for(const n of t)e.ui.registerCommand({id:n.id,title:n.title,group:"Windows",icon:n.icon,run:n.run});const r="https://github.com/cawoodm/easydbaccess/blob/main/CHANGELOG.md",i="https://github.com/cawoodm/easydbaccess/tree/main/docs";e.ui.registerCommand({id:"app:search",title:"Search all tables",group:"App",icon:"search",keywords:["find","global search","filter"],run:()=>{document.dispatchEvent(new CustomEvent("easydb:focus-search"))}}),e.ui.registerCommand({id:"app:plugins",title:"Plugins",group:"App",icon:"extension",keywords:["plugin manager","install","extensions"],run:n=>n.ui.openPluginManager()}),e.ui.registerCommand({id:"app:changelog",title:"Changelog",group:"App",icon:"history",keywords:["releases","version","whats new"],run:()=>{window.open(r,"_blank","noopener")}}),e.ui.registerCommand({id:"app:docs",title:"Documentation",group:"App",icon:"menu_book",keywords:["docs","help","guide","manual"],run:()=>{window.open(i,"_blank","noopener")}})}async function $b(e){if(Vt==="url-plugins"||Vt==="all-optional")return async()=>{};const t=e.workspaceId();if(!t)return async()=>{};const i=(await e.store.workspaces.findOne(t))?.pluginUrls??[],n=[];for(const s of i)try{const a=await e.store.plugins.findOne(s);if(a&&a.enabled===!1)continue;let c=a?.cachedBody??"";if(c)kb(e,s,c);else{try{c=await Zc(s)}catch(w){await e.store.plugins.upsert({url:s,enabled:a?.enabled??!0,lastFetched:Date.now(),lastError:`fetch: ${w.message}`}),e.events.emit("plugin:error",{url:s,phase:"fetch",error:w});continue}await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),cachedBody:c})}const u=new Blob([c],{type:"text/javascript"}),p=URL.createObjectURL(u);try{const w=await import(p);await w.init?.(e),n.push({url:s,mod:w})}finally{setTimeout(()=>URL.revokeObjectURL(p),5e3)}}catch(a){await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),lastError:`init: ${a.message}`}),e.events.emit("plugin:error",{url:s,phase:"init",error:a})}return async()=>{for(const{url:s,mod:a}of n)try{await a.load?.(e)}catch(c){await e.store.plugins.upsert({url:s,enabled:!0,lastFetched:Date.now(),lastError:`load: ${c.message}`}),e.events.emit("plugin:error",{url:s,phase:"load",error:c})}}}async function Zc(e){const t=await fetch(e);if(!t.ok)throw new Error(`HTTP ${t.status} ${t.statusText}`);const r=await t.text();if((t.headers.get("content-type")??"").toLowerCase().includes("text/html")||/^\s*<(!doctype|html|head|body)/i.test(r))throw new Error("response is HTML, not a JS module (URL likely 404 → SPA fallback)");return r}function kb(e,t,r){return(async()=>{try{const i=await Zc(t);if(i===r)return;await e.store.plugins.upsert({url:t,enabled:!0,lastFetched:Date.now(),cachedBody:i})}catch{}})()}let Ns=null;function pe(){return Ns||(Ns=Cb()),Ns}async function Cb(){const e=await cu(),t=hu(e),r=pu(),i=xu(),n=new Map;t.tables.subscribe(S=>{n.clear();for(const B of S)n.set(B.id,B)});const s={...t.tables,insert:S=>(n.set(S.id,S),t.tables.insert(S)),upsert:S=>(n.set(S.id,S),t.tables.upsert(S))};let a=null;const c={get backend(){if(!a)throw new Error("[host] row-source ctx used before app init completed");return a.backend},events:r,settings:t.settings,workspaceId:()=>b},u=fu({base:{...t,tables:s},providers:i.rowSources,tableById:S=>n.get(S),ctx:c}),p=Eb(),w=await u.workspaces.find();let b;if(p){const S=Tb(p),B=w.find(q=>q.id===S||q.name===p);B?b=B.id:b=(await u.workspaces.insert({id:S,name:p,createdAt:Date.now(),pluginUrls:[]})).id}else{const S=Sb(),B=S?w.find(q=>q.id===S):void 0;B?b=B.id:w.length>0?b=w[0].id:b=(await u.workspaces.insert({id:"default",name:"default",createdAt:Date.now(),pluginUrls:[]})).id}_b(b);const $=Su({store:u,events:r,registries:i,workspaceId:()=>b});a=$,xb($),r.on("import:after",({source:S,tableId:B,rowCount:q})=>{S!=="datasette"&&$.store.tables.findOne(B).then(Q=>{$.ui.dialogs.toast(`Imported ${q} row${q===1?"":"s"} into "${Q?.name??B}".`,{kind:"success",title:S.toUpperCase()+" import"})})}),r.on("plugin:error",({url:S,phase:B,error:q})=>{$.ui.dialogs.toast(`[${B}] ${q?.message??String(q)}`,{kind:"error",title:`Plugin: ${S}`})});const D=await fb($),P=await $b($);return queueMicrotask(async()=>{r.emit("app:ready",{workspaceId:b}),await D(),await P(),Vt==="all-optional"?$.ui.dialogs.toast("Safe mode is ON: only fixed built-ins (Settings, core rendering) loaded. All other built-in plugins and URL-installed plugins are disabled for this session only — nothing was changed. Disable the culprit below, then reload without ?safemode.",{kind:"warning",title:"Safe mode"}):Vt==="url-plugins"&&$.ui.dialogs.toast("Safe mode (URL plugins) is ON: URL-installed plugins were not loaded this session. Built-in plugins are unaffected. Reload without ?safemode1 to restore them.",{kind:"warning",title:"Safe mode"}),Vt!=="off"&&$.ui.openPluginManager()}),{store:u,events:r,workspaceId:b,registries:i,api:$}}function Eb(){if(typeof location>"u")return null;const t=new URLSearchParams(location.search).get("space");return t&&t.trim().length>0?t.trim():null}const ed="eda:lastWorkspaceId";function Sb(){try{return globalThis.localStorage?.getItem(ed)??null}catch{return null}}function _b(e){try{globalThis.localStorage?.setItem(ed,e)}catch{}}function Tb(e){return e.toLowerCase().trim().replace(/[^a-z0-9_-]+/g,"-").replace(/^-+|-+$/g,"")||"default"}var Ab=Object.defineProperty,Ib=Object.getOwnPropertyDescriptor,ns=(e,t,r,i)=>{for(var n=i>1?void 0:i?Ib(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Ab(t,r,n),n};let dr=class extends Ue{constructor(){super(...arguments),this.name="",this.text="",this.errorMsg="",this.dialogEl=null}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}async open(){this.name="",this.text="",this.errorMsg="",await this.updateComplete,this.dialogEl?.showModal()}close(){this.dialogEl?.close()}async submit(e){e.preventDefault();const t=this.name.trim()||"pasted";if(this.text.trim().length===0){this.errorMsg="Paste some CSV first.";return}let r;try{r=hr(this.text)}catch(a){this.errorMsg=`Couldn't parse the CSV: ${a.message}`;return}if(r.columns.length===0||r.rows.length===0){this.errorMsg="No data found in the pasted text.";return}const i=await pe(),n=crypto.randomUUID();await i.store.tables.insert({id:n,workspaceId:i.workspaceId,name:t,code:Tt(t),columns:r.columns,view:"table",updatedAt:Date.now()});const s=r.rows.map(a=>({id:crypto.randomUUID(),tableId:n,data:a,updatedAt:Date.now()}));await i.store.rows(n).bulkInsert(s),i.api.ui.dialogs.toast(`Imported ${r.rows.length} row${r.rows.length===1?"":"s"} into "${t}".`,{kind:"success",title:"CSV paste"}),this.close()}render(){return _`
      <dialog @cancel=${this.close} @keydown=${Zt}>
        <button type="button" class="close-x" title="Close" @click=${this.close}>×</button>
        <form @submit=${this.submit}>
          <div class="dialog-header">
...
…and ${Z.length-5} more.`:""}`;return}}const D=new Set(this.columns.map(W=>W.origField).filter(W=>!!W)),P=new Set(u.map(W=>W.field)),S=(w?.columns??[]).map(W=>W.field).filter(W=>!D.has(W)),B=w?.deletedColumns??[],q=[...new Set([...B,...S])].filter(W=>!P.has(W)),Q={name:t,title:c,columns:u,updatedAt:Date.now()};(q.length>0||B.length>0)&&(Q.deletedColumns=q);const X=w?.name;await r.store.tables.patch(p,Q);const J=S.filter(W=>!P.has(W));if(J.length>0){const W=await r.store.rows(p).find();for(const Z of W){let de=!1;const we={...Z.data};for(const Te of J)Te in we&&(delete we[Te],de=!0);de&&await r.store.rows(p).patch(Z.id,{data:we,updatedAt:Date.now()})}}if(X!==void 0&&X!==t){const W=(await r.store.viewInstances.find()).filter(Z=>Z.tableId===p);for(const Z of W)Z.tableName!==t&&await r.store.viewInstances.patch(Z.id,{tableName:t,updatedAt:Date.now()})}}else await r.store.tables.insert({id:it(),workspaceId:r.workspaceId,name:t,title:c,code:Tt(t),columns:u,view:"table",updatedAt:Date.now()});this.close()}renderPreview(){if(this.previewRows.length===0)return _`<div class="preview"><div class="empty">No rows to preview.</div></div>`;const e=new Map;for(const r of this.columns){if(!r.unique)continue;const i=new Set,n=new Set;for(const s of this.previewRows){const a=s.data[r.field];a==null||a===""||(i.has(a)&&n.add(a),i.add(a))}e.set(r.field,n)}const t=this.columns.filter(r=>!r.hidden);return _`
        ...
        <table>
          ...
          <tbody>
            ${this.previewRows.map(r=>_`
                <tr>
                  ${t.map(i=>{const n=r.data[i.field],s=Mb(i,n,e.get(i.field));return _`<td class=${s?"violation":""} title=${s??""}>
                      ${Fb(n)}
                    </td>`})}
                </tr>
              `)}
            ...
            <div class="columns">
              ...
              ${this.columns.map((r,i)=>{const n=this.dragSrcIdx===i,s=this.dropTargetIdx===i,a=s&&this.dropEdge==="before"?" drop-before":s&&this.dropEdge==="after"?" drop-after":"";return _`
                  ...
                  >
                    ...
                    >
                      ${Lb.map(c=>_`<option value=${c} ?selected=${c===r.type}>${c}</option>`)}
                    </select>
                    <select
      ...
      <dialog @cancel=${this.close} @keydown=${Zt}>
        ...
        <form @submit=${this.addPlugin}>
          ...
          <div class="dialog-body">
            ...
            <div class="filters">
              <div class="chips">
                ${Wb.map(([t,r])=>this.renderTri(r,this.filterStates.get(t),()=>this.cycleFilter(t)))}
                ${this.renderTri("Enabled",this.statusFilter,()=>this.cycleStatusFilter(),"status",Vb)}
              </div>
              <div class="search">
                <input
                  type="text"
            ...
            <div class="type-filters">
              ...
              ${td.map(([t,r])=>this.renderTri(r,this.typeFilters.get(t),()=>this.cycleTypeFilter(t)))}
            </div>
    ...
    `];At([K()],wt.prototype,"urls",2);At([K()],wt.prototype,"records",2);At([K()],wt.prototype,"addUrl",2);At([K()],wt.prototype,"catalog",2);At([K()],wt.prototype,"catalogError",2);At([K()],wt.prototype,"serverCatalog",2);At([K()],wt.prototype,"serverCatalogError",2);At([K()],wt.prototype,"installing",2);At([K()],wt.prototype,"catalogUrls",2);At([K()],wt.prototype,"activeCatalogUrl",2);At([K()],wt.prototype,"search",2);At([K()],wt.prototype,"filterStates",2);At([K()],wt.prototype,"typeFilters",2);At([K()],wt.prototype,"statusFilter",2);wt=At([nt("plugin-manager-dialog")],wt);var Gb=Object.defineProperty,Yb=Object.getOwnPropertyDescriptor,Ln=(e,t,r,i)=>{for(var n=i>1?void 0:i?Yb(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&Gb(t,r,n),n};const Ir="__general__";let Qt=class extends Ue{constructor(){super(...arguments),this.tabs=[],this.active=Ir,this.values={},this.placements={},this.secretsText="",this.workspaceTitle="",this.secretError="",this.dialogEl=null,this.attemptClose=e=>{const t=this.invalidSecrets();if(t.length>0){e?.preventDefault();const r=t[0];this.active=r.tab.id,this.secretError=`“${r.field.label}” must be empty or a \${secret:name} reference. Move the value into the secrets store (General tab) and reference it, so the raw secret is never saved or synced.`;return}this.secretError="",this.dialogEl?.close()},this.onSubmit=e=>{e.preventDefault(),this.attemptClose()}}firstUpdated(){this.dialogEl=this.shadowRoot?.querySelector("dialog")??null;const e=this.shadowRoot?.querySelector(".dialog-header");this.dialogEl&&e&&en(this.dialogEl,e)}async open(){const e=await pe(),t=[...e.registries.settings];this.tabs=t.map(([s,a])=>({id:s,name:a.name,fields:a.fields}));const r=await e.store.workspaces.findOne(e.workspaceId);this.workspaceTitle=r?.title??"";const i={},n={};for(const s of this.tabs)for(const a of s.fields){const c=`${s.id}:${a.key}`,u=await e.api.settings.placement(s.id,a.key);u==="user"?(i[c]=mo(c),n[c]="user"):u==="workspace"?(i[c]=(await e.store.settings.findOne(c))?.value,n[c]="workspace"):(i[c]=a.default,n[c]=a.scope??"workspace")}this.values=i,this.placements=n,this.secretsText=Bi(),this.active=Ir,await this.updateComplete,this.dialogEl?.showModal()}static rawSecret(e){return typeof e=="string"&&e!==""&&!e.includes("${secret:")}invalidSecrets(){const e=[];for(const t of this.tabs)for(const r of t.fields)r.type==="secret"&&Qt.rawSecret(this.values[`${t.id}:${r.key}`])&&e.push({tab:t,field:r});return e}async setValue(e,t,r){const i=`${e.id}:${t.key}`;this.values={...this.values,[i]:r},this.secretError&&this.invalidSecrets().length===0&&(this.secretError=""),await(await pe()).api.settings.set(e.id,t.key,r,this.placements[i])}async toggleScope(e,t,r){const i=`${e.id}:${t.key}`,n=r?"user":"workspace";this.placements={...this.placements,[i]:n},await(await pe()).api.settings.set(e.id,t.key,this.values[i],n)}onSecretsInput(e){this.secretsText=e.target.value,Ul(this.secretsText)}downloadSecrets(){const e=new Blob([this.secretsText],{type:"text/plain;charset=utf-8"}),t=URL.createObjectURL(e),r=document.createElement("a");r.href=t,r.download="secrets.txt",r.click(),URL.revokeObjectURL(t)}async setWorkspaceTitle(e){this.workspaceTitle=e;const t=await pe();await t.store.workspaces.patch(t.workspaceId,{title:e.trim()||void 0})}renderControl(e,t){const r=`${e.id}:${t.key}`,i=this.values[r];switch(t.type){case"text":return _`<textarea
          .value=${String(i??"")}
      ...
      ${t.description?_`<p class="desc">${t.description}</p>`:fe}
    ...
    `:fe}render(){return _`
      <dialog @cancel=${this.attemptClose} @keydown=${Zt}>
        ...
        <form @submit=${this.onSubmit}>
          ...
          ${this.secretError?_`<div class="secret-error" role="alert">${this.secretError}</div>`:fe}
          <div class="dialog-body">
            <div class="layout">
              <nav class="tabs">
                <button
    ...
    `}renderTemplated(){const e=this.template;if(!e)return _`<div class="vw-empty">This view's template is missing.</div>`;if(dp(e.rowHtml)){const t=this.instance?.mapping??{},r=new Map(this.tableColumns.map(a=>[a.field,a])),i=this.instance?.readonly===!0,n=this.rows.map(a=>ap(e.rowHtml,a,t,{columns:r,readonly:i})).join(""),s=(e.headerHtml??"")+n+(e.footerHtml??"");return _`<div class="vw-root">${or(s)}</div>`}return _`<div class="vw-root">
      ${e.headerHtml?.trim()?_`<div class="vw-html">${or(e.headerHtml)}</div>`:fe}
      ${this.renderTable()}
      ${e.footerHtml?.trim()?_`<div class="vw-html">${or(e.footerHtml)}</div>`:fe}
    </div>`}renderSortBar(){if(!this.instance)return fe;const e=this.tableColumns.filter(i=>i.sortable!==!1),t=this.instance.sortColumn??"",r=this.instance.sortAsc??!0;return _`<div class="vw-sortbar">
    ...
    </div>`}renderFooter(){if(!this.instance)return fe;const e=this.templateOn,t=new Set(this.instance.visibleColumns);return _`<div class="vw-footer">
      ...
      >
        <span class="mi">table_view</span>
          ...
          ></data-table>
        </div>`;return _`${e?this.renderSortBar():fe}${t}${this.renderFooter()}`}};Pt.styles=[qt,We`
      :host {
        display: flex;
        flex-direction: column;
        height: 100%;
    ...
    `];tn([Ht({type:String})],Pt.prototype,"viewInstanceId",2);tn([K()],Pt.prototype,"loaded",2);tn([K()],Pt.prototype,"error",2);tn([K()],Pt.prototype,"instance",2);tn([K()],Pt.prototype,"template",2);tn([K()],Pt.prototype,"columns",2);tn([K()],Pt.prototype,"tableColumns",2);tn([K()],Pt.prototype,"rows",2);tn([K()],Pt.prototype,"showColsMenu",2);tn([K()],Pt.prototype,"searchQuery",2);tn([K()],Pt.prototype,"globalQuery",2);Pt=tn([nt("view-window")],Pt);const Gt=new Map;function Jb(e){const t=Gt.get(e);if(!t)return!1;const r=t.panel;return r.status==="minimized"&&r.normalize?.(),r.front?.(),!0}let kl=!1;function so(e){e.panel.setHeaderTitle?.(e.name+dc(e.count,e.total))}function Zb(){return document.getElementById("easydb-panels-viewport")??document.getElementById("easydb-panels")??document.body}function ey(e){return e.replace(/[^a-zA-Z0-9_-]/g,"_")}function nd(e){return`view-panel-${ey(e)}`}async function ty(){if(kl)return;kl=!0;const e=await pe(),t=i=>i.filter(n=>n.workspaceId===e.workspaceId&&n.open),r=t(await e.store.viewInstances.find()).sort(Oi);for(const i of r)Cl(i,e);e.store.viewInstances.subscribe(i=>{const n=new Map(t(i).map(a=>[a.id,a]));for(const a of[...Gt.keys()])n.has(a)||ry(a);const s=[...n.values()].filter(a=>!Gt.has(a.id)).sort(Oi);for(const a of s)Cl(a,e)}),e.store.tables.subscribe(i=>void ny(e,i)),document.addEventListener(Ii,i=>{const n=i.detail,s=Gt.get(n.key);s&&s.el&&(s.count=n.count,s.total=n.total,so(s))}),document.addEventListener("easydb:reload-view",i=>{const n=i.detail?.instanceId;if(!n)return;const s=Gt.get(n);s&&(async()=>{const a=await e.store.viewInstances.findOne(n);a&&(s.name=a.name,so(s)),s.el?.reload()})()}),document.addEventListener("easydb:reload-views",()=>{for(const{el:i}of Gt.values())i?.reload()})}async function ny(e,t){const r=t.filter(a=>a.workspaceId===e.workspaceId),i=new Set(r.map(a=>a.id)),n=new Map;for(const a of r)n.has(a.name)||n.set(a.name,a);const s=await e.store.viewInstances.find();for(const a of s){if(a.workspaceId!==e.workspaceId||i.has(a.tableId)||!a.tableName)continue;const c=n.get(a.tableName);c&&await e.store.viewInstances.patch(a.id,{tableId:c.id,updatedAt:Date.now()})}}function Cl(e,t){if(Gt.has(e.id))return;const r=nd(e.id),i=e.windowGeometry,n=i?.minimized===!0,s=()=>{const q=document.createElement("view-window");return q.viewInstanceId=e.id,q.style.height="100%",q},a=n?document.createElement("div"):s();let c;const u=()=>{c&&(c.el?.remove(),c.el=null,c.count=-1,c.total=-1,so(c))},p=()=>{if(!c||c.el)return;const q=document.getElementById(r)?.querySelector(".jsPanel-content");if(!q)return;q.replaceChildren();const Q=s();q.appendChild(Q),c.el=Q},w=i?{panelSize:`${i.w} ${i.h}`}:{contentSize:"480 520"},b=i?{my:"left-top",at:"left-top",offsetX:i.x,offsetY:i.y}:{my:"center-top",at:"center-top",offsetY:60},$=Mc(r,qc),D=M.create({id:r,container:Zb(),headerTitle:e.name,headerLogo:Sm,theme:"#0891b2",content:a,...w,position:b,minimizeTo:"#easydb-minimized-dock",dragit:{containment:!1,stop:()=>void Us(e.id)},resizeit:{containment:!1,stop:()=>void Us(e.id)},onfronted:()=>void iy(e.id,t),onstatuschange:q=>{q.status==="maximized"?$.enter():$.exit(),q.status==="minimized"?u():(q.status==="normalized"||q.status==="maximized")&&p(),Us(e.id)},onclosed:()=>{Gt.delete(e.id),ts(e.id),$.exit(),t.store.viewInstances.patch(e.id,{open:!1,updatedAt:Date.now()}).catch(()=>{})}});c={panel:D,el:n?null:a,name:e.name,count:-1,total:-1},Gt.set(e.id,c),Uc(e.id,()=>D.front?.(void 0,!1));const P=document.getElementById(r),S=document.createElement("panel-search");S.tableId=e.id,P?.querySelector(".jsPanel-controlbar")?.prepend(S);const B=P?.querySelector(".jsPanel-titlebar");B&&(B.tabIndex=-1,B.style.outline="none",B.addEventListener("pointerdown",()=>B.focus())),i?.maximized?queueMicrotask(()=>D.maximize?.()):i?.minimized&&queueMicrotask(()=>D.minimize?.())}function ry(e){const t=Gt.get(e);if(t){Gt.delete(e),ts(e);try{t.panel.status!=="closed"&&t.panel.close()}catch{}}}async function iy(e,t){try{const r=await t.store.viewInstances.findOne(e);if(!r)return;const i=r.windowGeometry??{x:0,y:0,w:480,h:520,z:0,minimized:!1,maximized:!1};await t.store.viewInstances.patch(e,{windowGeometry:{...i,z:Nc()},updatedAt:Date.now()})}catch{}}async function Us(e){const t=document.getElementById(nd(e)),r=Gt.get(e);if(!t||!r)return;const i=r.panel.status,n=i==="minimized",s=i==="maximized";try{const a=await pe(),c=(await a.store.viewInstances.findOne(e))?.windowGeometry;let u=t.offsetLeft,p=t.offsetTop,w=t.offsetWidth,b=t.offsetHeight;(n||s)&&c&&(u=c.x,p=c.y,w=c.w,b=c.h),u<=-9e3&&(u=c?.x??40);const $={x:u,y:p,w,h:b,z:c?.z??0,minimized:n,maximized:s};await a.store.viewInstances.patch(e,{windowGeometry:$,updatedAt:Date.now()})}catch{}}var sy=Object.defineProperty,oy=Object.getOwnPropertyDescriptor,yr=(e,t,r,i)=>{for(var n=i>1?void 0:i?oy(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&sy(t,r,n),n};const ay={Windows:0,Actions:1,App:2,Tables:3,Views:4};function El(e){return ay[e]??3}function ly(e){return e?e.trimStart().startsWith("<svg")?_`<span class="cmd-svg">${fo(e)}</span>`:_`<span class="mi sm">${e}</span>`:_`<span class="mi sm">chevron_right</span>`}let zn=class extends Ue{constructor(){super(...arguments),this.search="",this.items=[],this.selected=0,this.api=null}async open(){const e=await pe();this.api=e.api,this.items=await this.buildItems(),this.search="",this.selected=0,await this.updateComplete,this.dialogEl&&!this.dialogEl.open&&this.dialogEl.showModal(),this.inputEl?.focus()}async buildItems(){const e=await pe(),t=e.api,r=[];for(const s of e.registries.commands)r.push({id:s.id,title:s.title,group:s.group??"Commands",...s.icon?{icon:s.icon}:{},haystack:[s.title,s.group,...s.keywords??[]].join(" ").toLowerCase(),run:()=>s.run(t)});for(const s of[...e.registries.headerButtons,...e.registries.footerButtons])r.push({id:`button:${s.id}`,title:s.label,group:"Actions",...s.icon?{icon:s.icon}:{},haystack:`${s.label} ${s.tooltip??""}`.toLowerCase(),run:()=>s.onClick(t)});const i=await t.store.tables.find({workspaceId:e.workspaceId});i.sort((s,a)=>s.name.localeCompare(a.name));for(const s of i)r.push({id:`goto:${s.id}`,title:`Go to: ${s.name}`,group:"Tables",icon:"table_chart",haystack:`${s.name} go to table`.toLowerCase(),run:()=>{rg(s.id)}});const n=await t.store.viewInstances.find({workspaceId:e.workspaceId});n.sort((s,a)=>s.name.localeCompare(a.name));for(const s of n)r.push({id:`goto-view:${s.id}`,title:`Go to view: ${s.name}`,group:"Views",icon:"view_quilt",haystack:`${s.name} go to view`.toLowerCase(),run:async()=>{await t.store.viewInstances.patch(s.id,{open:!0,updatedAt:Date.now()}),Jb(s.id)}});return r.map((s,a)=>({it:s,i:a})).sort((s,a)=>El(s.it.group)-El(a.it.group)||s.i-a.i).map(({it:s})=>s)}get filtered(){const e=this.search.trim().toLowerCase();return e?this.items.filter(t=>t.haystack.includes(e)):this.items}close(){this.dialogEl?.close()}onInput(e){this.search=e.target.value,this.selected=0}onKeydown(e){const t=this.filtered;if(e.key==="ArrowDown")e.preventDefault(),this.selected=t.length?(this.selected+1)%t.length:0;else if(e.key==="ArrowUp")e.preventDefault(),this.selected=t.length?(this.selected-1+t.length)%t.length:0;else if(e.key==="Enter"){e.preventDefault();const r=t[this.selected];r&&this.execute(r)}}async execute(e){this.close();try{await e.run()}catch(t){console.error(`[command:${e.id}]`,t)}}render(){const e=this.filtered;let t="";return _`
    ...
    `];yr([K()],zn.prototype,"search",2);yr([K()],zn.prototype,"items",2);yr([K()],zn.prototype,"selected",2);yr([yn("dialog")],zn.prototype,"dialogEl",2);yr([yn("input")],zn.prototype,"inputEl",2);zn=yr([nt("command-palette-dialog")],zn);var cy=Object.defineProperty,dy=Object.getOwnPropertyDescriptor,rd=(e,t,r,i)=>{for(var n=i>1?void 0:i?dy(t,r):t,s=e.length-1,a;s>=0;s--)(a=e[s])&&(n=(i?a(t,r,n):a(n))||n);return i&&n&&cy(t,r,n),n};let zi=class extends Ue{constructor(){super(...arguments),this.tables=[],this.workspaceId=""}async connectedCallback(){super.connectedCallback();const e=await pe();this.workspaceId=e.workspaceId,this.unsubscribe=e.store.tables.subscribe(r=>this.tables=r.filter(i=>i.workspaceId===this.workspaceId));const t=await e.store.tables.find();this.tables=t.filter(r=>r.workspaceId===this.workspaceId),await og(),await ty()}disconnectedCallback(){super.disconnectedCallback(),this.unsubscribe?.()}render(){return this.tables.length>0?_``:_`<div class="empty">
